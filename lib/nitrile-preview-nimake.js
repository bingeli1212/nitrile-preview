...
class NitrilePreviewMake {
  ...
  constructor() {
    ...
    this.top_cmd1 = o[0].cmd1;
    this.top_cmd2 = o[0].cmd2;
    this.top_cmd3 = o[0].cmd3;
  }

  async run() {
    this.do_target(this.top_target,this.top_deps,this.top_cmd1,this.top_cmd2,this.top_cmd3);
  }
