...
`;
  ...
  to_titlepage(){
    ...
    all.push(`\\tfd ${this.uncode(title)} \\crlf`);
    all.push(`\\blank[1cm]`)
    all.push(`\\tfa ${this.uncode(subtitle)} \\crlf`);
    all.push(`\\blank[0.2cm]`)
    all.push(`\\tfa ${this.uncode(institute)} \\crlf`);
    all.push(`\\blank[0.2cm]`)
    all.push(`\\tfa ${this.uncode(author)} \\crlf`);
    all.push(`\\blank[0.2cm]`)
    all.push(`\\tfa ${this.uncode(date)}`);
