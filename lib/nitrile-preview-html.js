...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  phrase_to_frac(cnt){
    ...
    if(ss.length>1){
      let top = ss[0];
      let bot = ss[1];
      return `<table border='0' style='display:inline-block;zoom:0.68;border-collapse:collapse'><tr><td style='text-align:center;border-bottom:1px solid'>${top}</td></tr><tr><td style='text-align:center;border-top:1px solid'>${bot}</td></tr></table>`
    }
    return `<table border='0' style='display:inline-block;zoom:0.68;border-collapse:collapse'><tr><td style='text-align:center;border-bottom:1px solid'>1</td></tr><tr><td style='text-align:center;border-top:1px solid'>${cnt}</td></tr></table>`
  }
