...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  cove_to_text(style,cove){
    ...
    o.push('</ul>')
    var text = o.join('\n')
    return `<div class='PARAGRAPH COVE' data-row='${style.row}' > <div class='INDENTING'> ${text} </div> </div>`;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //
  //
  ...
  math_to_text(style,math){
    let ss = math.body;
    var text = this.tokenizer.to_fence_math(style,ss);
    return `<div class='PARAGRAPH MATH' data-row='${style.row}' style='text-align:center;' > ${text} </div>`;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //
  //
