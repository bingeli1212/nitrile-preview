    ...
    let pp = itms.forEach((p,i,arr) => {
      ...
      if(p.type=='UL'){
        ...
        if(!p.bull.trim().length){
          d.push(`<label class='ITEM'>${squareboxo} ${text}</label>`);
        }else{
          d.push(`<label class='ITEM'>${squarebox} ${text}</label>`);
        }
      }
      else if(p.type == 'RB'){
        if(!p.bull.trim().length){
          d.push(`<label class='ITEM'>${circleboxo} ${text}</label>`);
        }else{
          d.push(`<label class='ITEM'>${circlebox} ${text}</label>`);
        }
      }
      else {
        d.push(`<label class='ITEM'>${text}</label>`);
