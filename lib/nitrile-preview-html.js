    ...
    if(item.more && item.more.length){
      ...
      item.more.forEach((p) => {
        ...
        if(p.lines){
          ...
          o.push(`<span class='PARA PR' data-row='${p.row}' > ${this.uncode(style,text)} </span>`);
        }else if(p.itemize) {
  ...
  itemize_to_text(style,itemize,cls){
    ...
    switch (bull) {
      case 'DL': {
        ...
        o.push(`<dl class='${cls}' data-row='${style.row}' >`);
      ...
      case 'OL': {
        ...
        o.push(`<ol class='${cls}' data-row='${style.row}' style='padding-left:2.0em;'>`);
        items.forEach((item,j) => {
          style.row = item.row;
      ...
      case 'UL': {
        ...
        o.push(`<ul class='${cls}' data-row='${style.row}' style='padding-left:2.0em;'>`);
        items.forEach((item,j) => {
          style.row = item.row;           
