...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_displaymath(style,ss) {
    ...
    var o = [];
    o.push({img:text,subc:'',stretch:1,fig:text});
    return o;
  }
  ...
  fence_to_dia(style,ss){
    ...
    o = o.map((p) => {
      ...
      var s_svg = `<svg style="${css}" width='${w}' height='${h}' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" viewBox="0 0 ${this.fix(p.vw)} ${this.fix(p.vh)}" >${p.svgtext}</svg>`;
  ...
  fence_to_tabular(style,ss) {
    ...
    var h = height*this.MM_TO_PX;
    var frame = (style.frame)?`frame='box'`:``;
    var rules = (style.rules)?style.rules:``;
    if(style.side){
  ...
  fence_to_par(style,ss){
    ...
    var img = `<div class='PAR'> ${text} </div>`;
    var subc = '';
    if(w){           
      var stretch = 1;
      var img = `\n<table ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 0;
      var img = `\n<table ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,w,h,fig});
