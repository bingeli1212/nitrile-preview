...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_canvas(style,ss,ssi){
    ...
    var canvaswidget = `<canvas style='position:relative;z-index:20;' width='${p.width}' height='${p.height}' onclick='canvas_onclick(this)' onfocusin='canvas_onfocusin(this)' onfocusout='canvas_onfocusout(this)' data-imgid='${imgid}' data-paletteid='${imgid}-palette' id='${imgid}-canvas' tabIndex='1' > </canvas>`;
    var palettewidget = `<div style='position:absolute;top:100%;left:0;' id='${imgid}-palette' ><button type='submit'>S</button><button type='button'>D</button><button type='button'>E</button></div>`;
