   ...
   onmouseup="mouseup(this)" onmousemove="mousemove(this)">
    ...
    <script type="application/ecmascript"> <![CDATA[
      ...
      function mousedown(svg){
        tx = event.clientX;
        ty = event.clientY;
        //only for shape elements
        if(svg.tagName=="rect"){
          elemX = svg.getAttribute("x");
          elemY = svg.getAttribute("y");
        }else if(svg.tagName=="polygon"){

        }
        tid = svg.id;
        console.log("mousedown",tx,tx,elemX,elemY,tid)
        ismousedown=1;
      }
      ...
      function rect_click(rect) {
        ...
        console.log("rect_click",tx,ty,elemX,elemY);
        tid=rect.id;
        if(event.altKey){
          var centerx = parseFloat(rect.getAttribute("data-centerx"))||0;
          var centery = parseFloat(rect.getAttribute("data-centery"))||0;
          var rotation = parseFloat(rect.getAttribute("data-rotation"))||0;
          var translatex = parseFloat(rect.getAttribute("data-translatex"))||0;
          var translatey = parseFloat(rect.getAttribute("data-translatey"))||0;
          rotation += 5;
          rect.setAttribute("data-rotation",rotation);
          rect.setAttribute("data-translatex",translatex);
          rect.setAttribute("data-translatey",translatey);
          rect.setAttribute("transform", "translate("+(translatex)+","+(translatey)+") translate("+(centerx)+","+(centery)+") rotate("+(rotation)+") translate("+(-centerx)+","+(-centery)+")");  
    ...
    <rect id="my" onclick="rect_click(this)" onmousedown="mousedown(this)" 
