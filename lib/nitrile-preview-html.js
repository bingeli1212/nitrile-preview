...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_tab(g,ss) {
    ...
    var tab  = `<table width='${width}' class='TAB' style='display:inline-table;margin:0;page-break-inside:avoid;table-layout:fixed;font-size:${textsmaller};' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${g.row}' >${text}</table>`;
    var itm = {};
    itm.tab = tab;
    itm.out = tab;
    return itm;
