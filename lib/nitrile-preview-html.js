...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  hdgs_to_part(title,label,partnum,chapternum,level,style){
    ...
    return(`<h1 data-row='${style.row}' class='${cls}' style='${css}' > <span style='font-weight:normal;font-size:80%' > Part ${partnum} </span> <br/> ${this.uncode(style,title)} </h1>`);
  }
  hdgs_to_chapter(title,label,partnum,chapternum,level,style){
    var cls = 'CHAPTER';
    var css = this.css('CHAPTER');
    this.addto_refmap(label,`${chapternum}`);
    return(`<h1 data-row='${style.row}' class='${cls}' style='${css}' > <span style='font-weight:normal;font-size:80%' > Chapter ${chapternum} </span> <br/> ${this.uncode(style,title)} </h1>`);
  }
  hdgs_to_section(title,label,partnum,chapternum,level,style){
    ...
    if(chapternum){
      ...
      return(`<h2 data-row='${style.row}' class='${cls}' style='${css}' > ${chapternum}.${level} &#160; ${this.uncode(style,title)} </h2>`);  
    }
    this.addto_refmap(label,`${level}`);
    return(`<h2 data-row='${style.row}' class='${cls}' style='${css}' > ${level} &#160; ${this.uncode(style,title)} </h2>`);
  }
  hdgs_to_subsection(title,label,partnum,chapternum,level,style){
    ...
    if(chapternum){
      this.addto_refmap(label,`${chapternum}.{level}`);
      return(`<h3 data-row='${style.row}' class='${cls}' style='${css}' > ${chapternum}.${level} &#160; ${this.uncode(style,title)} </h3>`);  
    }
    this.addto_refmap(label,`${level}`);
    return(`<h3 data-row='${style.row}' class='${cls}' style='${css}' > ${level} &#160; ${this.uncode(style,title)} </h3>`);
  }
  hdgs_to_subsubsection(title,label,partnum,chapternum,level,style){
    ...
    if(chapternum){
      this.addto_refmap(label,`${chapternum}.{level}`);
      return(`<h4 data-row='${style.row}' class='${cls}' style='${css}' > ${chapternum}.${level} &#160; ${this.uncode(style,title)} </h4>`);  
    }
    this.addto_refmap(label,`${level}`);
    return(`<h4 data-row='${style.row}' class='${cls}' style='${css}' > ${level} &#160; ${this.uncode(style,title)} </h4>`);
  }
  /////////////////////////////////////////////////////////////////////
  //
  /////////////////////////////////////////////////////////////////////
  ...
  fence_to_displaymath(style,ss,ssi) {
    ...
    var css1 = this.css('PARAGRAPH DISPLAYMATH');
    var css2 = this.css('DISPLAYMATH');
    var stretch = 0;
    var img = `\n<table class='PARAGRAPH DISPLAYMATH' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          DISPLAYMATH' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
  ...
  fence_to_ink(style,ss,ssi){
    ...
    var img = `\n<table class='PARAGRAPH INK' style='${css1}' ${frame} cellpadding='0' cellspacing='0' width='${width}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
    var fig = `\n<table class='          INK' style='${css2}' ${frame} cellpadding='0' cellspacing='0' width='${width}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${subc}</caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
    o.push({img,subc,w,h,stretch,width,fig,style});
    return o;
  }
  fence_to_dia(style,ss,ssi){
    ...
    o = o.map((p) => {
      ...
      p.style = style;
      var s_style = this.style_to_subcaption_style_s(style);
      var css = this.css('PARAGRAPH DIA');
      if(style.stretch){
        p.width = '100%';
      }else{
        p.width = w;
      ...
      p.img = `\n<table class='PARAGRAPH DIA' style='${css1}' ${frame} cellpadding='0' cellspacing='0' width='${p.width}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
  ...
  fence_to_verbatim(style,ss,ssi){
    ...
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH VERBATIM' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          VERBATIM' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
  ...
  fence_to_center(style,ss,ssi){
    ...
    var subc = this.uncode(style,subc);
    var s_style = this.style_to_subcaption_style_s(style);
    var css1 = this.css('PARAGRAPH CENTER');
    var css2 = this.css('CENTER');
    if(style.fontsize=='small'){
      css1 += ';font-size:80%';
      css2 += ';font-size:80%';
    }
    ...
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH CENTER' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          CENTER' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
    o.push({img,subc,stretch,fig,style});
    return o;
  }
  fence_to_flushright(style,ss,ssi){
    ...
    var subc = this.uncode(style,subc);
    var s_style = this.style_to_subcaption_style_s(style);
    var css1 = this.css('PARAGRAPH FLUSHRIGHT');
    var css2 = this.css('FLUSHRIGHT');
    if(style.fontsize=='small'){
      css1 += ';font-size:80%';
      css2 += ';font-size:80%';
    }
    ...
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH FLUSHRIGHT' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          FLUSHRIGHT' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
    o.push({img,subc,stretch,fig,style});
    return o;
  }
  fence_to_flushleft(style,ss,ssi){
    ...
    var subc = this.uncode(style,subc);
    var s_style = this.style_to_subcaption_style_s(style);
    var css1 = this.css('PARAGRAPH FLUSHLEFT'); 
    var css2 = this.css('FLUSHLEFT'); 
    if(style.fontsize=='small'){
      css1 += ';font-size:80%';
      css2 += ';font-size:80%';
    }
    ...
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH FLUSHLEFT' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          FLUSHLEFT' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
    o.push({img,subc,stretch,fig,style});
    return o;
  }
  fence_to_tabular(style,ss,ssi) {
    ...
    var img = `<table class='PARAGRAPH TABULAR' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n${colgroup}\n${text}\n</table>`;
    var fig = `<table class='          TABULAR' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    var o = [];
  ...
  fence_to_verse(style,ss,ssi) {
    ...
    var subc = this.uncode(style,subc);
    var s_style = this.style_to_subcaption_style_s(style);
    var css1 = this.css('PARAGRAPH VERSE');
    var css2 = this.css('VERSE');
    if(style.fontsize=='small'){
      css1 += ';font-size:80%';
      css2 += ';font-size:80%';
    }
    ...
    var img = text;
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH VERSE' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          VERSE' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
  ...
  fence_to_quote(style,ss,ssi){
    ...
    var subc = this.uncode(style,subc);
    var s_style = this.style_to_subcaption_style_s(style);
    var css1 = this.css('PARAGRAPH QUOTE');
    var css2 = this.css('QUOTE');
    if(style.fontsize=='small'){
      css1 += ';font-size:80%';
      css2 += ';font-size:80%';
    }
    ...
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH QUOTE' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          QUOTE' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
    o.push({img,subc,stretch,w,h,fig,style});
    return o;
  }
  fence_to_parbox(style,ss,ssi){
    ...
    if(w && h){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH PARBOX' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' height='${h}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' height='${h}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }else if(w){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH PARBOX' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARAGRAPH PARBOX' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,width,w,h,fig,style});
    return o;
  ...
  float_to_listing(title,label,style,ss,ssi){
    ...
    let idnum = this.to_idnum('listing');///should be overriden by subclasses
    let tag = this.to_tag('listng');
    if(label){
      this.addto_refmap(label,idnum);
    }  
    return `<figure class='PARAGRAPH LISTING' style='${css}' data-row='${style.row}' > ${this.to_caption_text(style,title,idnum,tag)} ${text} </figure>`;
  }
  float_to_figure(title,label,style,ss,ssi){
    ...
    if(style.type=='right'){
      ...
      let idnum = this.to_idnum('table');///should be overriden by subclasses
      let tag = this.to_tag('table');
      if(label){
        this.addto_refmap(label,idnum);
      }  
      return `<figure class='PARAGRAPH FIGURE' style='${css}' data-row='${style.row}' > ${this.to_caption_text(style,title,idnum,tag)} ${text} </figure>`;
    }else{
      let idnum = this.to_idnum('figure');///should be overriden by subclasses
      let tag = this.to_tag('figure');
      if(label){
        this.addto_refmap(label,idnum);
      }  
      return `<figure class='PARAGRAPH FIGURE' style='${css}' data-row='${style.row}' > ${this.to_caption_text(style,title,idnum,tag)} ${text} </figure>`;
  ...
  float_to_longtabu(title,label,style,ss,ssi){
    ...
    var caption = this.to_longtabu_caption_text(style,title,idnum,tag);
  ...
  float_to_columns(title,label,style,ss,ssi){
    ...
    var css_subrow = this.css('SUBROW');
    css_subrow += ';justify-content:space-between';
  ...
  text_to_text(style,text,row){
    ...
    return `<p class='PARAGRAPH NORMAL' style='${css}' data-row='${row}'>${text}</p>`;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //
  //
  ...
  cove_to_text(style,cove){
    ...
    if(n >= 2 && p0.text.startsWith('```') && pn.text.startsWith('```')){
      ...
      if(o.length){
        let fig = o[0].fig;
        fig = `<span class='COVE' style='--bull:"&#x25B8;";--pad:-1.0em;display:inline-flex;'> ${fig} </span>`;
        all.push(fig);
      }
      var text = all.join('\n');
      var css = this.css('PARAGRAPH INDENTING');
      return `<figure class='PARAGRAPH INDENTING' style='${css}' data-row='${style.row}' > ${text} </figure>`;  
    }else{
      let all = [];
      ...
      var text = all.join('\n');
      var text = `<span class='COVE' style='--bull:"&#x25B8;";--pad:-1.0em;' > ${text} </span>`;
      var css = this.css('PARAGRAPH INDENTING');
  ...
  math_to_text(style,cove){
    ...
    if(n >= 2 && p0.text.startsWith('```') && pn.text.startsWith('```')){
      ...
      if(o.length){
        let fig = o[0].fig;
        fig = `<span style='width:100%;display:inline-flex;justify-content:center;' > ${fig} </span>`;
        all.push(fig);
      }
      var text = all.join('\n');
      ...
      var text = all.join('\n');
      var text = `<span style='width:100%;display:inline-flex;justify-content:center;' > ${text} </span>`;
      var css = this.css('PARAGRAPH CENTERING');
  ...
  norm_to_text(style,body){
    ...
    if(n >= 2 && s0.startsWith('```') && sn.startsWith('```')){
      ...
      if(o.length){
        let fig = o[0].fig;
        fig = `<span style='width:100%;display:inline-flex;justify-content:flex-start;' > ${fig} </span>`;
        all.push(fig);
      }
      var text = all.join('\n');
      var css = this.css('PARAGRAPH NORMAL');
