...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_to_figure(title,label,style,ss,ssi){
    ...
    if(style.type=='right'){
      return `<figure class='PARAGRAPH FIGURE' style='${css}' data-row='${style.row}' style='float:right'> ${text} </figure>`;
    }else if(style.type=='left'){
      return `<figure class='PARAGRAPH FIGURE' style='${css}' data-row='${style.row}' style='float:left'> ${text} </figure>`;
  ...
  math_to_text(style,math){
    let ss = math.body;
    var text = this.tokenizer.to_fence_math(style,ss);
    var css = this.css('PARAGRAPH DISPLAYMATH');
    return `<p class='PARAGRAPH DISPLAYMATH' style='${css}' data-row='${style.row}' > ${text} </p>`;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //
  //
