...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  constructor(parser) {
    ...
    this.margin_p = '1em';
    this.padding_plst = '40px';
    this.padding_plst_inner = '20px';
  }
  do_PART(block) {
  ...
  do_PLST(block) {
    ...
    for (var item of items) {
      ...
      if(more && more.length){
        more.forEach((plitem) => {
          let {lines} = plitem;
          extra_text += `<div style='margin:${this.margin_p} 0'> ${this.untext(lines,style)} </div>`;
        });
      }
      switch (bull) {
        case 'OL': {
          ...
          var css = '';
          if(count>1){
            css += `padding-left:${this.padding_plst_inner};`;
          }else{
            css += `padding-left:${this.padding_plst};`;
          }
          o.push(`<ol style='${css}' >`);
          break;
        }
        ...
        case 'LI': {
          if(type=='hanginglist'){
            ...
            var css = '';
            css += `margin:${this.margin_p} 0;`;
            if(count>1){
              css += `padding-left:${this.padding_plst_inner};`;
              css += `text-indent:-${this.padding_plst_inner};`;
            }else{
              css += `padding-left:${this.padding_plst};`;
              css += `text-indent:-${this.padding_plst};`;
            }
            ...
            var css_dd = '';
            if(count>1){
              css_dd += `margin-left:${this.padding_plst_inner};`;
            }else{
              css_dd += `margin-left:${this.padding_plst};`;
            }
