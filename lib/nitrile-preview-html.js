...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_ink(style,ss,ssi){
    ...
    var frame = (style.frame)?`frame='box'`:``;
    if(style.stretch){
      var img = `\n<table class='INK' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
      var fig = `\n<table class='INK' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
    }else{
      var img = `\n<table class='INK' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
      var fig = `\n<table class='INK' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
    }
  ...
  fence_to_dia(style,ss,ssi){
    ...
    o = o.map((p) => {
      ...
      p.h = h;
      if(style.stretch){
        p.img = `\n<table class='DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' data-row='${ssi}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
        p.fig = `\n<table class='DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' data-row='${ssi}' >\n<caption align='bottom' class='SUBCAPTION'>${p.subc}</caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
      }else{
        p.img = `\n<table class='DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${ssi}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
        p.fig = `\n<table class='DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${ssi}' >\n<caption align='bottom' class='SUBCAPTION'>${p.subc}</caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
      }
      return p;
    });
