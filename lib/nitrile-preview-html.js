...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_tabular(style,ss,ssi) {
    ...
    var img = `<table class='PARAGRAPH TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n${colgroup}\n${text}\n</table>`;
    var fig = `<table class='          TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    var cov = `<table class='          TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n${colgroup}\n${text}\n</table>`;
    var o = [];
