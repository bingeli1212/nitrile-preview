  ...
  cove_to_text(style,cove){
    ...
    if(n >= 2 && p0.text.startsWith('```') && pn.text.startsWith('```')){
      ...
      if(o.length){
        ...
        img = `<span style='position:relative;padding-left:0em;display:inline-flex;'> <span style='position:absolute;left:-1em;'> &#x25B8; </span> ${img} </span>`;
        all.push(img);
      }
      var text = all.join('\n');
      ...
      var text = all.join('\n');
      var text = `<span style='position:relative;padding-left:0em;'> <span style='position:absolute;left:-1em;'> &#x25B8; </span> ${text} </span>`;
      var css = this.css('PARAGRAPH INDENTING');
