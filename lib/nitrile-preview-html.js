...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_ink(style,ss){
    ...
    if(ENCODE){
      ...
      img = `<svg style='${css}' width='${this.fix(vw)}' height='${this.fix(vh)}' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' fill='currentColor' stroke='none' viewBox='0 0 ${this.fix(vw)} ${this.fix(vh)}' >${img}</svg>`;
    }
    var o = [];
    var subc = '';
    o.push({img,subc,w});
