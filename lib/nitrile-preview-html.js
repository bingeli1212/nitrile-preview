...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_to_equation(title,label,idnum,idcap,style,ss,ssi){
    ...
    var text = all.join('\n');
    // let idnum = this.to_idnum('equation',this.the_block);///should be overriden by subclasses
    idnum = `(${idnum})`;
  ...
  float_to_listing(title,label,idnum,idcap,style,ss,ssi){
    ...
    // let idnum = this.to_idnum('listing',this.the_block);///should be overriden by subclasses
  ...
  float_to_figure(title,label,idnum,idcap,style,ss,ssi){
    ...
    if(style.type=='right'){
      ...
      // let idnum = this.to_idnum('table',this.the_block);///should be overriden by subclasses
      ...
      // let idnum = this.to_idnum('figure',this.the_block);///should be overriden by subclasses
      return `<figure class='PARAGRAPH FIGURE' style='${css}' data-row='${style.row}' > ${this.to_caption_text(style,title,idnum,idcap,'Figure')} ${text} </figure>`;
    }
  }
  /////////////////////////////////////////////////////////////////////
