...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  hdgs_to_section(title,label,level,style){
    ...
    return(`<h2 id='${label}' class='SECTION' style='${this.css("SECTION")}${css}' > ${leader} <span title='${this.polish(style,style.__note)}:${1+style.row}'>${this.uncode(style,title)}</span> </h2>`);
  }
  hdgs_to_subsection(title,label,level,style){
    ...
    return(`<h3 id='${label}' class='SECTION' style='${this.css("SECTION")}${css}' > ${leader} <span title='${this.polish(style,style.__note)}:${1+style.row}'>${this.uncode(style,title)}</span> </h3>`);
  }
  hdgs_to_subsubsection(title,label,level,style){
    ...
    return(`<h4 id='${label}' class='SECTION' style='${this.css("SECTION")}${css}' > ${leader} <span title='${this.polish(style,style.__note)}:${1+style.row}'>${this.uncode(style,title)}</span> </h4>`);
  }
  //////////////////////////////////////////////////////////////////////////
  //
  //////////////////////////////////////////////////////////////////////////
