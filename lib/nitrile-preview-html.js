...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_to_listing(title,label,style,ss){
    ...
    var figcss = this.to_figure_css(style);
    var text = `<figure style='${figcss}'  > ${this.to_caption_text(caption,style,"listing")} ${text} </figure>`;
    return text;
  }
  ...
  float_to_table(title,label,style,ss){
    ...
    var figcss = this.to_figure_css(style);
    var text = `<figure style='${figcss}'  > ${this.to_caption_text(title,style,"table")} ${text} </figure>`;
    return text;
  }
  ...
  to_caption_text(title,style,name){
