...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  phrase_to_frac(cnt){
    ...
    if(ss.length>1){
      ...
      top = this.smooth(top);
      bot = this.smooth(bot);
      return `<table border='0' style='vertical-align:middle;display:inline-block;zoom:0.68;border-collapse:collapse'><tr><td style='text-align:center;border-bottom:1px solid'>${top}</td></tr><tr><td style='text-align:center;border-top:1px solid'>${bot}</td></tr></table>`
    }
    cnt = this.smooth(cnt);
    return `<table border='0' style='vertical-align:middle;display:inline-block;zoom:0.68;border-collapse:collapse'><tr><td style='text-align:center;border-bottom:1px solid'>1</td></tr><tr><td style='text-align:center;border-top:1px solid'>${cnt}</td></tr></table>`
  }
  phrase_to_sfrac(cnt){
    var re = /\s*(?:\/|$)\s*/;
    var ss = cnt.split(re);
