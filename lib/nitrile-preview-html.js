...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_parbox(style,ss,ssi){
    ...
    if(w && h){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH PARBOX' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' height='${h}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' height='${h}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }else if(w){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH PARBOX' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARAGRAPH PARBOX' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,width,w,h,fig,style});
    return o;
  }
  ...
  float_to_columns(title,label,style,ss,ssi){
    ...
    var n = row.length;
    all.push(`<figure class='PARAGRAPH COLUMNS' data-row='${style.row}' >`);
    all.push(`<span class='SUBROW' style='justify-content:space-between;' >`)
    for(let i=0; i < n; ++i){
      let p = row[i];
      all.push(`${p.fig}`);
    }
  ...
  phrase_to_dia(style,cnt){
    var style = this.string_to_style(cnt,style);
    var ss = [];
    if(style.load){
