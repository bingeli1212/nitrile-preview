...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  hdgs_to_section(title,label,hdgn,level,style){
    ...
    if(hdgn==1){
      return(`<h2 id='${label}' data-row='${style.row}' class='${cls}' style='${css}' > ${leader} <span title='${style.note}:${1+style.row}'>${this.uncode(style,title)}</span> </h2>`);
    }else if(hdgn==2){
      return(`<h3 id='${label}' data-row='${style.row}' class='${cls}' style='${css}' > ${leader} <span title='${style.note}:${1+style.row}'>${this.uncode(style,title)}</span> </h3>`);
    }else{
      return(`<h4 id='${label}' data-row='${style.row}' class='${cls}' style='${css}' > ${leader} <span title='${style.note}:${1+style.row}'>${this.uncode(style,title)}</span> </h4>`);
    }
  }
  /////////////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////
