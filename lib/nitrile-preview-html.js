...
<?xml version="1.0" standalone="no"?>
  <svg width="6cm" height="5cm" viewBox="0 0 600 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" 
   onmouseup="mouseup(this)" onmousemove="mousemove(this)">
    ...
    <script type="application/ecmascript"> <![CDATA[
      ...
      function rect_click(rect) {
        ...
        if(event.altKey){
          ...
          rect.setAttribute("transform", "translate("+(x+w/2)+","+(y+h/2)+") rotate("+rot+") translate("+(-(x+w/2))+","+(-(y+h/2))+")");  
    ...
    <rect id="my" onclick="rect_click(this)" onmousedown="mousedown(this)" x="100" y="100" width="100" height="100" fill="red"/>
