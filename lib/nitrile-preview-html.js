...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_parbox(style,ss,ssi){
    ...
    if(w && h){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH PARBOX' ${frame} cellpadding='0' cellspacing='0' width='${w}' height='${h}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' ${frame} cellpadding='0' cellspacing='0' width='${w}' height='${h}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }else if(w){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH PARBOX' ${frame} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' ${frame} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARAGRAPH PARBOX' ${frame} cellpadding='0' cellspacing='0' width='100%'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          PARBOX' ${frame} cellpadding='0' cellspacing='0' width='100%'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
  ...
  fence_to_displaymath(style,ss,ssi) {
    ...
    if(w){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARAGRAPH DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,w,h,fig,style});
    return o;
  ...
  fence_to_math(style,ss,ssi) {
    ...
    if(w){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' >\n<caption align='bottom' class='SUBCAPTION' data-row='${style.row}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' >\n<caption align='bottom' class='SUBCAPTION' data-row='${style.row}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARAGRAPH DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' >\n<caption align='bottom' class='SUBCAPTION' data-row='${style.row}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          DISPLAYMATH' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' >\n<caption align='bottom' class='SUBCAPTION' data-row='${style.row}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,w,h,fig,style});
    return o;
  ...
  fence_to_ink(style,ss,ssi){
    ...
    if(style.stretch){
      var img = `\n<table class='PARAGRAPH INK' ${frame} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
      var fig = `\n<table class='          INK' ${frame} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${subc}</caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
    }else{
      var img = `\n<table class='PARAGRAPH INK' ${frame} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
      var fig = `\n<table class='          INK' ${frame} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${subc}</caption>\n<tr><td>${s_svg}</td></tr>\n</table>`;
    }
  ...
  fence_to_dia(style,ss,ssi){
    ...
    o = o.map((p) => {
      ...
      if(style.stretch){
        p.img = `\n<table class='PARAGRAPH DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
        p.fig = `\n<table class='          DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${p.subc}</caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
      }else{
        p.img = `\n<table class='PARAGRAPH DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
        p.fig = `\n<table class='          DIA' ${flt} ${frame} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${p.subc}</caption>\n<colgroup/><thead/><tbody><tr><td>${s_svg}</td></tr></tbody>\n</table>`;
      }
      return p;
    });
    return o;
  ...
  fence_to_verbatim(style,ss,ssi){
    ...
    var subc = '';
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH VERBATIM' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          VERBATIM' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
  ...
  fence_to_center(style,ss,ssi){
    ...
    var subc = '';
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH CENTER' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          CENTER' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
    o.push({img,subc,stretch,fig,style});
    return o;
  }
  fence_to_flushright(style,ss,ssi){
    ...
    var subc = '';
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH FLUSHRIGHT' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          FLUSHRIGHT' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
    o.push({img,subc,stretch,fig,style});
    return o;
  }
  fence_to_flushleft(style,ss,ssi){
    ...
    var subc = '';
    var stretch = 1;
    var img = `\n<table class='PARAGRAPH FLUSHLEFT' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          FLUSHLEFT' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
    o.push({img,subc,stretch,fig,style});
    return o;
  }
  fence_to_tabular(style,ss,ssi) {
    ...
    var img = `<table class='PARAGRAPH TABULAR' ${flt} ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n${colgroup}\n${text}\n</table>`;
    var fig = `<table class='          TABULAR' ${flt} ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    var o = [];
  ...
  fence_to_verse(style,ss,ssi) {
    ...
    if(w){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH VERSE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          VERSE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARAGRAPH VERSE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          VERSE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,w,h,fig,style});
    return o;
  ...
  fence_to_quote(style,ss,ssi){
    ...
    if(w){           
      var stretch = 0;
      var img = `\n<table class='PARAGRAPH QUOTE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          QUOTE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARAGRAPH QUOTE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='          QUOTE' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,w,h,fig,style});
    return o;
