...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  hdgs_to_part(title,label,partnum,chapternum,level,style){
    return(`<h1 class='PART' row='${style.row}'>Part. ${this.uncode(style,title)}</h1>`);
  }
  hdgs_to_chapter(title,label,partnum,chapternum,level,style){
    return(`<h1 class='CHAPTER' row='${style.row}'>${this.uncode(style,title)}</h1>`);
  }
  hdgs_to_section(title,label,partnum,chapternum,level,style){
    return(`<h2 class='SECTION' row='${style.row}'>${this.uncode(style,title)}</h2>`);
  }
  hdgs_to_subsection(title,label,partnum,chapternum,level,style){
    return(`<h3 class='SUBSECTION' row='${style.row}'>${this.uncode(style,title)}</h3>`);
  }
  hdgs_to_subsubsection(title,label,partnum,chapternum,level,style){
    return(`<h4 class='SUBSUBSECTION' row='${style.row}'>${this.uncode(style,title)}</h4>`);
  }
  /////////////////////////////////////////////////////////////////////
  //
  /////////////////////////////////////////////////////////////////////
  ...
  float_to_columns(title,label,style,ss){
    ...
    var text = o.join('\n');
    var text = `<figure name='COLUMNS' style='${this.css('COLUMNS')}' > ${text} </figure>`;  
    return text;
  }
  /////////////////////////////////////////////////////////////////////
  /// 
