...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_tabular(ss,g) {
    ...
    return `<table border='0' style='${css}' class='TABULAR' > ${text} </table>`;
  }
  fence_to_tabbing(ss,g){
    ...
    css += this.to_css_width(g,'100%');  
    css += this.to_css_bordercollapse(g);
    return `<table border='0' style='${css}' class='TABBING' > ${text} </table>`;
  }
  fence_to_list(ss,g) {
  ...
  para_to_equation(caption,ss,style){
    ...
    o.push(`<figure style='${figcss}' class='P EQUATION' >`);
    o.push(text);
    o.push(`</figure>`);
    text = o.join('\n');
    return text;
  ...
  para_to_listing(caption,ss,style){
    ...
    return `<figure style='${figcss}' class='P LISTING' > ${this.to_caption_text(caption,style,"listing")} ${text} </figure>`;
  }
  para_to_figure(caption,ss,style){
    ...
    var figcss = this.to_figure_css(style);
    var text = `<figure style='${figcss}' class='P FIGURE' > ${this.to_caption_text(caption,style,"figure")} ${text} </figure>`;
    return text;
  }
  para_to_table(caption,ss,style){
    ...
    var figcss = this.to_figure_css(style);
    var text = `<figure style='${figcss}' class='P TABLE' > ${this.to_caption_text(caption,style,"table")} ${text} </figure>`;
    return text;
  }
  para_to_longtable(caption,ss,style){
    ...
    var figcss = this.to_figure_css(style);
    var text = `<figure style='${figcss}' class='P LONGTABLE' > ${this.to_caption_text(caption,style,"table")} ${text} </figure>`;
    return text;
  }
