...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  phrase_to_hrule(style,cnt){
    ...
    return `<span class='hrule' style='display:inline-block;box-sizing:border-box;border-bottom:thin solid currentColor;padding:1px;min-width:${wd};text-align:center;'> ${s} </span>`;
  }
  //////////////////////////////////////////////////////////////////////////////////////
  /// 
  /// translator function
