...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_img(style,ss,ssi){
    ...
    if(1){
      ...
      var canvaswidget = `<canvas style='position:relative;z-index:1;width:${p.width}mm;${p.height}mm;' width='${p.vw}' height='${p.vh}' onmouseenter="canvas_onmouseenter(this)" onmouseleave="canvas_onmouseleave(this)" onmousedown="canvas_onmousedown(this)" onmousemove="canvas_onmousemove(this)" onmouseup="canvas_onmouseup(this)" ontouchstart="canvas_ontouchstart(this)" ontouchmove="canvas_ontouchmove(this)" ontouchend="canvas_ontouchend(this)" ontouchcancel="canvas_ontouchcancel(this)" onfocusin="canvas_onfocusin(this)" onfocusout="canvas_onfocusout(this)" onkeydown="canvas_onkeydown(this)" data-imgid='${imgid}' data-paletteid='${imgid}-palette' data-colorinputid='${imgid}-colorinput' id='${imgid}-canvas' data-type='${type}' data-imgid='${imgid}' data-ball='${ball}' data-unit='${unit}' tabIndex='1' > </canvas>`;
  ...
  to_caption_text(style,title,idnum,splitid,figid){
    ...
    var lead = `${figid} ${idnum}${splitid} : ${caption_text}`;
  ...
  float_to_listing(title,label,style,bundles){
    ...
    return `<figure class='LISTING' style='${css}' data-row='${style.row}' > ${this.to_caption_text(style,title,idnum,splitid,'Listing')} ${text} </figure>`;
  }
  float_to_figure(title,label,style,bundles){
    ...
    if(style.wrapfig=='right'){
      ...
      return `<figure id='${label}' class='FIGURE' style='${css};${flex_css}' data-row='${style.row}' > ${this.to_caption_text(style,title,idnum,splitid,'Figure')} ${text} </figure>`;
    }
  }
  float_to_table(title,label,style,bundles){
    ...
    return `<figure id='${label}' class='TABLE' style='${css};${flex_css}' data-row='${style.row}' > ${this.to_caption_text(style,title,idnum,splitid,'Table')} ${text} </figure>`;
  }
