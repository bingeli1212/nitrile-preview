...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  to_subfigure_img(img,sub,w,seq,subfigure){
    ...
    let o = [];
    if(w){
      o.push(`<table cellpadding='0' cellspacing='0' width='${w}' style='vertical-align:top;display:inline-table;'>`);
    }else{
      o.push(`<table cellpadding='0' cellspacing='0' style='vertical-align:top;display:inline-table;'>`);
    }
    if(subfigure){
