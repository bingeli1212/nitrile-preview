...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  itemize_to_text(style,itemize){
    ...
    switch (bull) {
      ...
      case 'OL': {
        ...
        o.push(`<ol class='${ol_cls}' style='padding-left:1.6em;'>`);
        items.forEach((item,j) => {
          style.row = item.row;
      ...
      case 'UL': {
        ...
        o.push(`<ul class='${ul_cls}' style='padding-left:1.6em;'>`);
        items.forEach((item,j) => {
          style.row = item.row;           
  ...
  cases_to_text(style,cases){
    var o = [];
    o.push(`<ul class='PARA UL' style='padding-left:1.0em;'>`)
