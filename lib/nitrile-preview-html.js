...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_img(style,ss,ssi){
    ...
    if(type=='canvas'){
      var imgwidget = `<img style='position:absolute;visibility:hidden;width:${p.width}mm;height:${p.height}mm;' width='${p.vw}' height='${p.vh}' src='${imgsrc}' data-canvasid='${imgid}-canvas' id='${imgid}' alt='${imgsrc}' onload="img_onload(this)"/>`;
  ...
  fence_to_dia(style,ss,ssi){
    ...
    o = o.map((p) => {
      ...
      var { imgid } = this.to_request_svgid(s_svg);
      if(type=='canvas'){
        var imgwidget = `<img style="position:absolute;visibility:hidden;width:${p.width}mm;height:${p.height}mm;" width="${p.vw}" height="${p.vh}" src="data:image/svg+xml;charset=UTF-8,${encodeURIComponent(s_svg)}" data-canvasid="${imgid}-canvas" id="${imgid}" onload="img_onload(this)"/>`;
        var canvaswidget = `<canvas style='position:relative;z-index:1;width:${p.width}mm;height:${p.height}mm;' width='${p.vw}' height='${p.vh}' onmouseenter="canvas_onmouseenter(this)" onmouseleave="canvas_onmouseleave(this)" onmousedown="canvas_onmousedown(this)" onmousemove="canvas_onmousemove(this)" onmouseup="canvas_onmouseup(this)" ontouchstart="canvas_ontouchstart(this)" ontouchmove="canvas_ontouchmove(this)" ontouchend="canvas_ontouchend(this)" ontouchcancel="canvas_ontouchcancel(this)" onfocusin="canvas_onfocusin(this)" onfocusout="canvas_onfocusout(this)" onkeydown="canvas_onkeydown(this)" data-imgid='${imgid}' data-paletteid='${imgid}-palette' data-colorinputid='${imgid}-colorinput' id='${imgid}-canvas' data-type='${type}' data-unit='${unit}' tabIndex='1' > </canvas>`;
