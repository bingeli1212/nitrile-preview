...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_to_listing(title,label,style,ss){
    ...
    var figcss = this.to_figure_css(style);
    var text = `<figure style='${figcss}'  > ${this.to_caption_text(title,label,style,"listing")} ${text} </figure>`;
    return text;
  }
  float_to_figure(title,label,style,ss){
    ...
    var text = all.join('\n');
    var figcss = this.to_figure_css(style);
    return `<figure style='${figcss}'  > ${this.to_caption_text(title,label,style,"figure")} ${text} </figure>`;
  }
  float_to_table(title,label,style,ss){
    ...
    var figcss = this.to_figure_css(style);
    var text = `<figure style='${figcss}'  > ${this.to_caption_text(title,label,style,"table")} ${text} </figure>`;
    return text;
  }
