  ...
  fence_to_dia(style,ss,ssi){
    ...
    o = o.map((p) => {
      ...
      if(type=='canvas'){
        ...
        var objectwidget = `<object style="width:${p.width}mm;height:${p.height}mm" type="image/svg+xml" data="data:image/svg+xml;charset=UTF-8,${encodeURIComponent(demo_svg)}"></object>`;
