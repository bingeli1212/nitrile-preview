...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_alignment(title,label,style,subtitles,body,bodyrow){
    ...
    var text = d.join('<br/>\n');
    return `<figure class='ALIGNMENT' style='${this.css("ALIGNMENT")};text-align:${align};Mk' data-row='${style.row}' >${text}</figure>`;
  }
