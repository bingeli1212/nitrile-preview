...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_parbox(style,ss){
    ...
    if(w && h){           
      var stretch = 0;
      var img = `\n<table class='PAR' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' height='${h}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='PAR' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' height='${h}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else if(w){           
      var stretch = 0;
      var img = `\n<table class='PAR' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='PAR' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PAR' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='PAR' ${frame} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'> </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }
    var o = [];
    o.push({img,subc,stretch,w,h,fig});
