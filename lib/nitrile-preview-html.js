...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_displaymath(style,ss) {
    ...
    var o = [];
    o.push({img:text,subc:'',stretch:1});
    return o;
  }
  ...
  fence_to_tabular(style,ss) {
    ...
    var text = `<table ${attrs.join(' ')} class='TABULAR'  >\n${colgroup}\n${text}\n</table>`;
    var o = [];
    var stretch = style.stretch;
    var subc = this.uncode(style,subtitle);
    o.push({img:text,subc,stretch});
    return o;
  }
  ...
  to_subfigure_img(img,sub,w,stretch,seq,subfigure){
    let o = [];
    if(stretch){
