...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  para_to_multi(ss,style){
    ...
    return `<div class='TEXT MULTI ${style.nspace?'NSPACE':''}' >${text}</div>`;
  }
  para_to_itemized(ss,style) {
    ...
    return `<div class='TEXT ITEMIZED ${style.nspace?'NSPACE':''}' >${text}</div>`;
  }
  para_to_verse(ss,style) {
    ...
    return `<div class='TEXT VERSE ${style.nspace?'NSPACE':''}' >${text}</div>`;
  }
  para_to_lines(ss,style) {
    ...
    let text = this.itms_to_lines(itms, style);
    return `<div class='TEXT LINES ${style.nspace?'NSPACE':''}' >${text}</div>`;
  }
  ...
  para_to_story(ss,style){
    let text = ss.join('\n');
    text = this.unmask(text, style);
    return `<div class='TEXT STORY ${style.nspace?'NSPACE':''}' >${text}</div>`;
  }
