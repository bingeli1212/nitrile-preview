...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_tabular(style,ss,ssi) {
    ...
    if(style.stretch){
      var img = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>       </caption>\n${colgroup}\n${text}\n</table>`;
      var fig = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    }else{
      var img = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table'              data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>       </caption>\n${colgroup}\n${text}\n</table>`;
      var fig = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table'              data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    }
    var o = [];
