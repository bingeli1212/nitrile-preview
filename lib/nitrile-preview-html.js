...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  item_dl_to_text(style,i,item,nblank){
    ...
    if(nblank){
      if(text){
        o.push(`<dt class='PARA DT' data-row='${item.row}' > ${value} </dt> <dd class='PACK DD' data-row='${item.row+1}' > ${text} </dd> <dd class='PARA DD'>`);
      }else{
        o.push(`<dt class='PARA DT' data-row='${item.row}' > ${value} </dt>                                                              <dd class='PARA DD'>`);
      }
    }else{
      if(text){
        o.push(`<dt class='PACK DT' data-row='${item.row}' > ${value} </dt> <dd class='PACK DD' data-row='${item.row+1}' > ${text} </dd> <dd class='PACK DD'>`);
      }else{
        o.push(`<dt class='PACK DT' data-row='${item.row}' > ${value} </dt>                                                              <dd class='PACK DD'>`);
      }
    }
    if(item.more && item.more.length){
      ...
      item.more.forEach((p) => {
        ...
        if(p.lines){
          o.push(`<div class='PARA PR' data-row='${p.row}' > ${this.untext(style,p.lines)} </div>`);
        }else if(p.itemize) {
  ...
  itemize_to_text(style,itemize){
    ...
    switch (bull) {
      ...
      case 'OL': {
        ...
        o.push(`<ol class='${ol_cls}' style='padding-left:1.0em;'>`);
        items.forEach((item,j) => {
          style.row = item.row;
      ...
      case 'UL': {
        ...
        o.push(`<ul class='${ul_cls}' style='padding-left:1.0em;'>`);
        items.forEach((item,j) => {
          style.row = item.row;           
  ...
  fence_to_center(style,ss,ssi){
    ...
    if(w){           
      var stretch = 0;
      var img = `\n<table class='CENTER' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='CENTER' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
  ...
  fence_to_flushright(style,ss,ssi){
    ...
    if(w){           
      var stretch = 1;
      var img = `\n<table class='FLUSHRIGHT' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='FLUSHRIGHT' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 0;
  ...
  fence_to_flushleft(style,ss,ssi){
    ...
    if(w){           
      var stretch = 0;
      var img = `\n<table class='FLUSHLEFT' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'>         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='FLUSHLEFT' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='${w}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION'> ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
  ...
  fence_to_tabular(style,ss,ssi) {
    ...
    if(style.stretch){
      var img = `<table class='TABULAR' ${flt} ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n${colgroup}\n${text}\n</table>`;
      var fig = `<table class='TABULAR' ${flt} ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    }else{
      var img = `<table class='TABULAR' ${flt} ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table'              data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >       </caption>\n${colgroup}\n${text}\n</table>`;
  ...
  fence_to_verse(style,ss,ssi) {
    ...
    itms.forEach((p,i,arr) => {
      ...
      if(p.type=='UL'){
        d.push(`<div data-row='${ssi+i}' >${bullet} ${p.text}</div>`);
      }
      else if(p.type=='OL'){
        d.push(`<div data-row='${ssi+i}' >${i+1}. ${p.text}</div>`);  
      }
      else if(p.type == '1'){
        if(!p.ending) p.ending = '.';
        d.push(`<div data-row='${ssi+i}' >${p.value}${p.ending} ${p.text}</div>`);
      }
      else if(p.type == 'a'){
        if(!p.ending) p.ending = '.';
        d.push(`<div data-row='${ssi+i}' >${this.int_to_letter_a(p.value)}${p.ending} ${p.text}</div>`);
      }
      else if(p.type == 'A'){
        if(!p.ending) p.ending = '.';
        d.push(`<div data-row='${ssi+i}' >${this.int_to_letter_A(p.value)}${p.ending} ${p.text}</div>`);
        ...
        d.push(`<div data-row='${ssi+i}' ><b>${p.value}</b> ${p.text}</div>`)
      }
      else if(p.type == 'INDENTED'){
        //empty CB
        let s = '&#160;'.repeat(p.value);
        d.push(`<div data-row='${ssi+i}' > ${s}${p.text}</div> `);
      }
      else {
        ///ordinary line without a leading bullet
        d.push(`<div data-row='${ssi+i}' >${p.text}</div>`);
      }
    });
    var text = d.join('\n')
    let width = this.g_to_width_float(style);
  ...
  text_to_text(style,text,row){
    ...
    return `<span data-row='${row}'>${text}</span>`;
  }
  /////////////////////////////////////////////////////////////////////
  ///
  ///
  ...
  float_to_paragraph(title,label,style,body){
    var style = {...style,title,label,float:'paragraph'};
    var issamp = this.is_samp(body);
    var iscase = this.is_case(body);
    var isplst = this.is_plst(body);
    if(issamp){
      let samps = this.ss_to_samps(body,style.row);
      var text = this.samps_to_text(style,samps);
    }else if(iscase){
      let cases = this.ss_to_cases(body,style.row);
      var text = this.cases_to_text(style,cases);
    }else if(isplst){
      let plitems = this.ss_to_plitems(body,style.row);
    ...
    if(title){
      ...
      var cls = 'PARAGRAPH INDENTING';
    }else{
      var cls = 'PARAGRAPH';
    }
    return `<div class='${cls}' data-row='${style.row}' > ${all.join('\n')} </div>`;
  }
  float_to_sample(title,label,style,ss,ssi){
    ...
    var text = `<div class='SAMPLE' data-row='${style.row}' > ${text} </div>`;
    return text;
  }
  float_to_itemize(title,label,style,itemize,ssi){
    ...
    all.push(text);
    return(`<div class='ITEMIZE' data-row='${style.row}' > ${all.join('\n')} </div>`)
  }
  ...
  float_to_listing(title,label,style,ss,ssi){
    ...
    var text = ss.join('\n');
    var text = `<table class='LISTINGBODY' data-row='${ssi}' > ${text} </table>`;
    return `<figure class='LISTING' data-row='${style.row}' > ${this.to_caption_text(title,label,style,"listing")} ${text} </figure>`;
  }
  float_to_figure(title,label,style,ss,ssi){
    ...
    if(style.wrap){
      ...
      var text = all.join('\n');
      if(style.type=='table'){
        return `<figure class='TABLE'  style='${s_style}' data-row='${style.row}' > ${this.to_caption_text(title,label,style,"table")} ${text} </figure>`;
      }else{
        return `<figure class='FIGURE' style='${s_style}' data-row='${style.row}' > ${this.to_caption_text(title,label,style,"figure")} ${text} </figure>`;
      }
    }else{
      ...
      var text = all.join('\n');
      if(style.type=='table'){
        return `<figure class='TABLE'   data-row='${style.row}' > ${this.to_caption_text(title,label,style,"table")} ${text} </figure>`;
      }else{
        return `<figure class='FIGURE'  data-row='${style.row}' > ${this.to_caption_text(title,label,style,"figure")} ${text} </figure>`;
      }
    }
  }
  float_to_longtabu(title,label,style,ss,ssi){
    ...
    if(style.stretch){
      text = `<table class='LONGTABUBODY' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:table' width='100%' data-row='${ssi}' >\n${colgroup}\n${text}\n</table>`;
    }else{
      text = `<table class='LONGTABUBODY' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:table'              data-row='${ssi}' >\n${colgroup}\n${text}\n</table>`;
    }
    return `<figure class='LONGTABU'  data-row='${style.row}' > ${this.to_caption_text(title,label,style,"table")} ${text} </figure>`;0
  }
  float_to_columns(title,label,style,ss,ssi){
    ...
    var n = row.length;
    all.push(`<div class='COLUMNS' style='column-count:${n}' data-row='${style.row}' >`);
    for(let i=0; i < n; ++i){
      let p = row[i];
      all.push(`<div style='break-before:column;'> ${p.img} </div>`);
    }
    all.push(`</div>`);
    return all.join('\n');
  }
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  cases_to_text(style,cases){
    var o = [];
    o.push(`<ul class='PARA UL' style='padding-left:1.0em;list-style-type:none;'>`)
    o.push(`<li class='PARA LI' data-row='${style.row}' style='--bull:"&#x25B8;";--pad:-1.0em;' >`);
    cases.forEach((p,i,arr) => {
  ...
  //
  ////////////////////////////////////////////////////////////////////////////////
  samps_to_text(style,samps){
    var o = [];
    o.push(`<div class='SAMPLE' >`)
    samps.forEach((p,i,arr) => {
      let x = p.text;
      x = x.trimRight();
      if(x.length==0){
        x = '&#160;';
      ...
      x = `<div data-row='${p.n}'><code>${x}</code></div>`;
      o.push(x);
    })
    o.push('</div>')
    return o.join('\n')
