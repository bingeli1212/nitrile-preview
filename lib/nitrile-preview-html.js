  ...
  fence_to_tabular(style,ss,ssi) {
    ...
    if(style.head && rows.length){
      ...
      pp.forEach((x,k) => {
        ...
        all.push(`<th class='TH' style='${css}' data-row='${x.row}' > ${text} </th>`);
      })
      all.push('</tr>');
      all.push('</thead>');
      lower = pp.lower;
    ...
    rows.forEach((pp,j,arr) => {
      ...
      pp.forEach((x,k) => {
        ...
        all.push(`<td class='TD' style='${css}' data-row='${x.row}' > ${text} </td>`); 
      });
      all.push('</tr>')
      lower = pp.lower;  
    });
    ...
    if(style.stretch){
      var img = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'>       </caption>\n${colgroup}\n${text}\n</table>`;
      var fig = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table' width='100%' >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    }else{
      var img = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table'              >\n<caption align='bottom' class='SUBCAPTION'>       </caption>\n${colgroup}\n${text}\n</table>`;
      var fig = `<table class='TABULAR' ${frame} ${rules} cellpadding='0' cellspacing='0' style='display:inline-table'              >\n<caption align='bottom' class='SUBCAPTION'>${subc}</caption>\n${colgroup}\n${text}\n</table>`;
    }
    var o = [];
