...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  item_ol_to_text(style,i,item,nblank){
    ...
    if(item.type == 'A'){
      ...
      o.push(`<li class='${li_cls}' type=''  data-row='${item.row}' value='${item.value}' style='--bull:"${value}.";--pad:-1.0em;' > ${text}`)
    }else if(item.type == 'a'){
      let value = i+1;
      value = this.int_to_letter_a(value);
      o.push(`<li class='${li_cls}' type=''  data-row='${item.row}' value='${item.value}' style='--bull:"${value}.";--pad:-1.0em;' > ${text}`)
      ...
      o.push(`<li class='${li_cls}'          data-row='${item.row}' value='${item.value}' style='--bull:"${value}.";--pad:-1.0em;' > ${text}`);
    }else if(item.bullet=='*'){
      let value = i+1;
      o.push(`<li class='${li_cls}'          data-row='${item.row}' value='${value}'      style='--bull:"${value}.";--pad:-1.0em;' > ${text}`);
    }else{
      let value = i+1;
      value = this.int_to_letter_i(value);
      o.push(`<li class='${li_cls}' type=''  data-row='${item.row}' value='${item.value}' style='--bull:"${value}.";--pad:-1.0em;' > ${text}`);
  ...
  itemize_to_text(style,itemize){
    ...
    switch (bull) {
      ...
      case 'OL': {
        ...
        o.push(`<ol class='${ol_cls}' style='padding-left:1.0em;list-style-type:none;position:relative;'>`);
        items.forEach((item,j) => {
          style.row = item.row;
      ...
      case 'UL': {
        ...
        o.push(`<ul class='${ul_cls}' style='padding-left:1.0em;list-style-type:none;position:relative;'>`);
        items.forEach((item,j) => {
          style.row = item.row;           
