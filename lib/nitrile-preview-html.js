...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_fml(style,ss,ssi) {
    ...
    itm.fig = `\n<table class='COLUMN    FML' style='${this.css("COLUMN    FML")}' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBTITLE' style='${s_style}' > ${subtitle} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    itm.text = text;
    itm.style = style;
  ...
  fence_to_ink(style,ss,ssi){
    ...
    itm.fig = `\n<table class='COLUMN    INK' style='${this.css("COLUMN    INK")}' ${frame} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n<caption align='bottom' class='SUBTITLE' style='${s_style}' > ${subtitle} </caption>\n<tr><td>${img}</td></tr>\n</table>`;
    itm.text = svg;
    itm.style = style;
    itm.subtitle = subtitle;
  ...
  fence_to_dia(style,ss,ssi){
    ...
    itm.fig = `\n<table class="COLUMN    DIA" style="${this.css("COLUMN    DIA")}" ${frame} cellpadding="0" cellspacing="0" data-row="${style.row}" >\n<caption align="bottom" class="SUBTITLE" style="${s_style}" >${subtitle}</caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    itm.text = text;
    itm.style = style;
    itm.subtitle = subtitle;
    return itm;
