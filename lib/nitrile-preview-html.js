...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_to_flushleft(title,label,style,splitid,body,bodyrow){
    ...
    var text = all.join('\n');
    return `<div class='FLUSHLEFT' style='${this.css("FLUSHLEFT")};display:flex;flex-direction:row;justify-content:center;align-items:flex-start;' data-row='${style.row}' >${text}</div>`;
  }
