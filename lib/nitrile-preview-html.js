    ...
    if(style['$'].buffers.hasOwnProperty(cnt)){
      ...
      if(o.length){
        ...
        if(style.width && style.height){
          s_svg = `<svg width='${style.width*this.MM_TO_PT}' height='${style.height*this.MM_TO_PT}' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" viewBox="0 0 ${this.fix(p.vw)} ${this.fix(p.vh)}" >${p.svgtext}</svg>`;
        }else if(style.width){
          s_svg = `<svg width='${style.width*this.MM_TO_PT}' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" viewBox="0 0 ${this.fix(p.vw)} ${this.fix(p.vh)}" >${p.svgtext}</svg>`;
        }else if(style.height){
          s_svg = `<svg height='${style.height*this.MM_TO_PT}' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" viewBox="0 0 ${this.fix(p.vw)} ${this.fix(p.vh)}" >${p.svgtext}</svg>`;
        }else{
