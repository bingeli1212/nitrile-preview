...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_displaymath(style,ss,ssi) {
    ...
    var img = `\n<table class='PARAGRAPH DISPLAYMATH' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${width}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' >         </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var fig = `\n<table class='          DISPLAYMATH' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${width}' data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > ${subc} </caption>\n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
    var o = [];
