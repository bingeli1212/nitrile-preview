...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_dia(style,ss,ssi){
    ...
    if(type=='canvas'){
      ...
      var img = `<form class='CANVASFORM' action='/action.php' method='post' onreset='form_onreset(this)' onsubmit='form_onsubmit(this)' style='position:relative;' data-imgsrc='' data-imgid='${imgid}' data-paletteid='${imgid}-palette' data-canvasid='${imgid}-canvas' > ${imgwidget} ${canvaswidget} ${palettewidget} </form>`
      itm.img  = img;
