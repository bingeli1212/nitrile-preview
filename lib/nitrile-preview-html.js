...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_formula(style,ss,ssi) {
    ...
    p.img = `\n<table class='PARAGRAPH FORMULA' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${p.width}' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_parbox(style,ss,ssi){
    ...
    p.img = `\n<table class='PARAGRAPH PARBOX' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${width}' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom;text-align:${talign};font-style:${fontst}'>${text}</td></tr></tbody>\n</table>`;
  ...
  plst_to_text(style,itemize){
    var text = this.itemize_to_text(style,itemize,'PARAGRAPH');
    return text;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //
  ...
  cove_to_text(style,cove){
    ...
    return `<p class='PARAGRAPH' style='${css}' > ${text} </p>`;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //
  // translator function
  ...
  float_to_equation(title,label,idnum,idcap,pagenum,style,ss,ssi){
    ...
    all = [];
    all.push(`<figure id='${label}' class='PARAGRAPH EQUATION' style='${css}' data-row='${style.row}' >`);
  ...
  float_to_column(title,label,idnum,idcap,pagenum,style,ss,ssi){
    ...
    all.push(`<figure class='PARAGRAPH COLUMN' style='${css}' data-row='${style.row}' >`);
