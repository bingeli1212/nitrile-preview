...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  phrase_to_frac(cnt){
    ...
    if(ss.length>1){
      ...
      top = this.smooth(top);
      bot = this.smooth(bot);
      return `<table border='0' style='vertical-align:middle;display:inline-block;border-collapse:collapse'><tr><td style='text-align:center;border-bottom:1px solid;font-size:smaller'>${top}</td></tr><tr><td style='text-align:center;border-top:1px solid;font-size:smaller'>${bot}</td></tr></table>`
    }
    cnt = this.smooth(cnt);
    return `<table border='0' style='vertical-align:middle;display:inline-block;border-collapse:collapse'><tr><td style='text-align:center;border-bottom:1px solid'><smaller>1</smaller></td></tr><tr><td style='text-align:center;border-top:1px solid;font-size:smaller'>${cnt}</td></tr></table>`
  }
  phrase_to_sfrac(cnt){
    var re = /\s*(?:\/|$)\s*/;
    var ss = cnt.split(re);
