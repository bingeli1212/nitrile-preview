...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  fence_to_displaymath(style,ss,ssi) {
    ...
    var css1 = this.css('DISPLAYMATH');
    var css2 = this.css('DISPLAYMATH');
    var stretch = 0;
    var img = `\n<table class='DISPLAYMATH' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_ink(style,ss,ssi){
    ...
    var img = `\n<table class='INK' style='${css1}' ${frame} cellpadding='0' cellspacing='0' width='${width}' data-row='${style.row}' >\n                                                                                \n<tr><td>${s_svg}</td></tr>\n</table>`;
  ...
  fence_to_verbatim(style,ss,ssi){
    ...
    var stretch = 1;
    var img = `\n<table class='VERBATIM' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_center(style,ss,ssi){
    ...
    var stretch = 1;
    var img = `\n<table class='CENTER' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_flushright(style,ss,ssi){
    ...
    var stretch = 1;
    var img = `\n<table class='FLUSHRIGHT' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_flushleft(style,ss,ssi){
    ...
    var stretch = 1;
    var img = `\n<table class='FLUSHLEFT' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_tabular(style,ss,ssi) {
    ...
    var img = `<table class='TABULAR' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' data-row='${style.row}' >\n                                                                                  \n${colgroup}\n${text}\n</table>`;
  ...
  fence_to_verse(style,ss,ssi) {
    ...
    var img = text;
    var stretch = 1;
    var img = `\n<table class='VERSE' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_quote(style,ss,ssi){
    ...
    var stretch = 1;
    var img = `\n<table class='QUOTE' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td>${text}</td></tr></tbody>\n</table>`;
  ...
  fence_to_parbox(style,ss,ssi){
    ...
    if(w && h){           
      var stretch = 0;
      var img = `\n<table class='PARBOX' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}' height='${h}' data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      ...
      var stretch = 0;
      var img = `\n<table class='PARBOX' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
      var fig = `\n<table class='PARBOX' style='${css2}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='${w}'               data-row='${style.row}' >\n<caption align='bottom' class='SUBCAPTION' style='${s_style}' > </caption>\n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
    }else{
      var stretch = 1;
      var img = `\n<table class='PARBOX' style='${css1}' ${frame} ${rules} cellpadding='0' cellspacing='0' width='100%'               data-row='${style.row}' >\n                                                                                  \n<colgroup/><thead/><tbody><tr><td style='vertical-align:bottom'>${text}</td></tr></tbody>\n</table>`;
