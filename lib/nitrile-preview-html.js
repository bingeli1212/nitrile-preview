...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_to_tabular(title,label,style,splitid,body,bodyrow){
    var bundles = this.body_to_all_bundles(style,body,bodyrow);
    var all = [];
    var maxn = 1;
    if(bundles.length) {
      ...
      all.push(`<div class='TABULAR' style='${this.css("TABULAR")};display:flex;flex-direction:column;align-items:flex-start;' data-row='${style.row}' >`);
      all.push(`<table>`);
