...
class NitrilePreviewHtml extends NitrilePreviewTranslator {
  ...
  float_to_paragraph(title,label,style,ss,ssi){
    ...
    if(issamp){
      let samps = this.ss_to_samp(ss,ssiw);
      var text = this.samp_to_text(style,samps);
    }else if(iscase){
      let cases = this.ss_to_case(ss,ssi);
      var text = this.case_to_text(style,cases);
    }else if(isplst){
