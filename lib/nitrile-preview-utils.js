...
async function read_text_file_async (filename) {
...
async function write_text_file_async (filename, data) {
...
async function to_glyphs(fname) {
  var out = await read_text_file_async(fname);
  var lines = out.split('\n');
  var o = [];
...
async function to_fontmap(fnames){
  ...
  for (let fname of fnames){
    var xxout = await read_text_file_async(fname);
