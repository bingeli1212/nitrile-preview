...
const { NitrilePreviewReport } = require('./nitrile-preview-nireport');
const { NitrilePreviewBeamer } = require('./nitrile-preview-nibeamer');
const { NitrilePreviewCreamer } = require('./nitrile-preview-nicreamer');
const { NitrilePreviewCamper } = require('./nitrile-preview-nicamper');
const { NitrilePreviewLamper } = require('./nitrile-preview-nilamper');
...
///console.log(`image ${fsrc} changed`);
  ...
  refreshView() {
    ...
    }else if(this.parser.conf_to_string('peek')=='flowerpot'){
      let translator = new NitrilePreviewSlide(this.parser);//still use slide.js
      translator.view = this;
      html = translator.to_peek_document();
