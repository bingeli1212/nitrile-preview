...
class NitrilePreviewPango extends NitrilePreviewHtml {
  ...
  constructor(parser) {
    ...
    this.mm_to_px = 3.779;
    this.frame_padding_left   = 3  * this.mm_to_px;
    this.frame_padding_top    = 10 * this.mm_to_px;
    this.frame_padding_right  = 3  * this.mm_to_px;
    this.frame_padding_bottom = 10 * this.mm_to_px;
  ...
  to_document() {
    ...
    //return title_html + '\n' + beamer_html; 
    var frame_htmls = this.frame_svgs.map((s) => {
