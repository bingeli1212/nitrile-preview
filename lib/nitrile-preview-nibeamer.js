...
console.log('this.latex=',this.latex);
    if(this.latex=='xelatex'||this.latex=='lualatex'){
      this.icon_checkedbox  = this.smooth(String.fromCodePoint(0x2612));
      this.icon_hollowbox   = this.smooth(String.fromCodePoint(0x2610));
      this.icon_coffeecup   = this.smooth(String.fromCodePoint(0x2615));
      this.icon_writinghand = this.smooth(String.fromCodePoint(0x270D));
    }else{
