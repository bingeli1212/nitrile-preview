...
`;
  ...
  to_beamer_title(){
    ...
    title = this.smooth(this.parser.jstyle,title);
    subtitle = this.smooth(this.parser.jstyle,subtitle);
    author = this.smooth(this.parser.jstyle,author);
    institute = this.smooth(this.parser.jstyle,institute);
