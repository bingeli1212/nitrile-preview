        ...
        switch(s) {
          ...
          default: {
            ...
            if(this.tokenizer.cc_symbol_map.has(cc)){
              let {tex,lmath,fonts} = this.tokenizer.cc_symbol_map.get(cc);
              s = this.tokenizer.get_tex_symbol(tex,lmath,cc,fonts);
            }    
            break;
          }
        } 
    ...
    while(line.length){
      if((v=re_entity.exec(line))!==null){
        ...
        if(this.tokenizer.name_symbol_map.has(s)){
          let {tex,lmath,cc,fonts} = this.tokenizer.name_symbol_map.get(s);
          s = this.tokenizer.get_tex_symbol(tex,lmath,cc,fonts);
        }
        safe+=s;
        continue;
