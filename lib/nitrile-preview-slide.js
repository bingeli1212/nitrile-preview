  ...
  write_frame(frame){
    ...
    if(frame.solutions.length){
      ...
      frame.solutions.forEach((o,i,arr) => {
        ...
        all.push(`<li class='SOLUTION' > <i>${o.title}</i> ${chevrondown} </li>`);
        if(i+1==arr.length){
          all.push(`</ul>`);
        }
      });
      ...
      frame.solutions.forEach((o,i,arr) => {
        ...
        all.push(`<ul class='SOLUTION' >`)
        if(o.text){
          all.push(`<li class='SOLUTION' > ${pencil} <i>${o.title}</i> : <u>${o.text}</u> </li>`);
        }else{
          all.push(`<li class='SOLUTION' > ${pencil} <i>${o.title}</i> : </li>`);
        }
