...
`;
  ...
  write_one_frame(id,order,frame,issub,topframe){
    ...
    //NOTE: main contents
    //
    all.push(`<article class='SLIDE' id='frame${id}' data-row='${frame.style.row}' style='background:url("${boardpng}") no-repeat 9mm 10mm;background-size:114mm 80mm;background-color:white;' >`);
    if(issub){
