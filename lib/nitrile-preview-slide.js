...
`;
  ...
  write_frame_toc(topframes){
    ...
    topframes.forEach((topframe,j,arr) => {
      ...
      if(n==0){
        ...
        all.push(`<h1 class='TITLE'    > Table Of Contents </h1>`);
        all.push(`<h2 class='SUBTITLE' > &#160; </h2>`);
        all.push(`<ul class='OL' style='padding-left:2.0em;list-style-type:none;position:relative;' >`);
      }
  ...
  write_frame_folder(id,frame,subframes){
    ...
    all.push(`<h1 class='TITLE'> ${id} ${this.uncode(frame.style,frame.title)} </h1>`);
    all.push(`<h2 class='SUBTITLE'> &#160; </h2>`);
