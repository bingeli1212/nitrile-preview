...
class NitrilePreviewSlide extends NitrilePreviewHtml {
  ...
  to_slide_document() {
    ...
    var fontfamily = '';
    var fontsize = this.conf('slide.font-size','10.5pt');
    var lineheight = this.conf('slide.line-height','1.4');
    var topmargin = 0;
...
`;
  ...
  to_html_frame(top,the_slides){
    ...
    if(sigs[0]=='HDGS'){
      ...
      w.forEach((o,i) => {
        all.push(`<li class='PLST'> <u>${o.title}</u> </li>`);
      });
      all.push(`</ul>`);
      all.push(`</section>`);
      all.push('');
      ...
      w.forEach((o,i) => {
        ...
        all.push(`<ul class='PLST'>`);
        if(o.text){
          all.push(`<li class='PLST SOLUTION'> <u>${o.title}:</u> &#160; ${o.text} `);
        }else{
          all.push(`<li class='PLST SOLUTION'> <u>${o.title}</u>`);
        }
        o.contents.forEach(x => all.push(`${x.html}`));
        all.push('</li>')
        all.push(`</ul>`);
