...
`;
  ...
  to_setup_script(){
    ...
    function ball_onmousemove(evt){
      ...
      let sy = canvas.getAttribute("height")/canvas.getBoundingClientRect().height;
      cx.d.dirty = 1;
      cx.d.currmousex = evt.offsetX*sx;
      cx.d.currmousey = evt.offsetY*sy
      if(cx.d.rotateflag){
    ...
    function ball_onmousedown(evt){
      ...
      if(cx.d.downball && cx.d.downcorner >= 0 && cx.d.downcorner != cx.d.hitcorner){
        ...
        cx.d.rotatex0 = x0;
        cx.d.rotatey0 = y0;
        cx.d.initmousex = evt.offsetX*sx;
        cx.d.initmousey = evt.offsetY*sy;
    ...
    function ball_onmouseup(evt){
      ...
      if(cx.d.rotateflag && cx.d.rotateangle != 0){
        ...
        cx.d.downmousex = evt.offsetX*sx;
        cx.d.downmousey = evt.offsetY*sy;
