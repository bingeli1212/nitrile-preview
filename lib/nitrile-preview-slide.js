...
`;
  ...
  write_one_frame(id,order,icon,frame,issub,topframe){
    ...
    //NOTE: board name
    //
    all.push(`<canvas class='EDITBOARD' id='${boardid}' data-type='board' data-boardimgid='${boardimgid}' data-boardname='${boardname}' data-frameid='${frameid}' width='484' height='361' style='background-image:url("${boardpng}")' ></canvas>`);
    all.push('</article>');
    all.push('');
    // 
