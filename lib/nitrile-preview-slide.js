...
`;
  ...
  to_setup_script(){
    ...
    function board_setup_canvas(canvas){
      ...
      canvas.addEventListener("touchstart", board_onmousedown,  false);
      canvas.addEventListener("touchmove",  board_onmouseup,    false);
      canvas.addEventListener("touchend",   board_onmousemove,  false);
