...
`;
  ...
  write_frame_folder(id,frame,subframes){
    ...
    all.push(`</div>`);
    all.push(`<canvas class='EDITBOARD' id='${boardid}' data-type='board' data-boardimgid='${boardimgid}' data-boardname='${boardname}' data-frameid='${frameid}' width='484' height='361' tabindex='1' ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
  ...
  write_one_frame(id,order,icon,frame,issub,topframe){
    ...
    frame.solutions.forEach((o,i,arr) => {
      ...
      all.push(`<canvas class='EDITBOARD' id='${boardid}x${i}' data-type='board' data-boardname='${boardname}' data-frameid='${frameid}' width='484' height='361' tabindex='1' ></canvas>`);
      all.push('</article>');
      all.push('');
    })
    //
