...
`);
  ...
  write_paper_part(top) {
    ...
    if(1){
      ...
      all.push(`<table width='100%' style='${css}; height:80vh;'><tr><td align='center' style='font-size:2rem; font-weight:bold;'>Part ${my.partnum} &#160; ${this.uncode(my.style,my.title)}</td></tr></table>`);
      var html = all.join('\n')
