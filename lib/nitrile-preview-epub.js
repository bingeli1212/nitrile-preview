...
`);
  ...
  write_paper_chapter(top) {
    ...
    let css = 'clear:both';
    all.push(`<h1 class='CHAPTER' style='${css}'>Chapter ${my.chapternum} &#160; ${this.uncode(my.style,my.title)}</h1>`);
  ...
  write_paper_section(top) {
    ...
    all.push('');
    if(my.chapternum){
      all.push(`<h1 class='SECTION' style='${css}'>${my.chapternum}.${my.level} &#160; ${this.uncode(my.style,my.title)}</h1>`);
      this.addto_refmap(my.label,`${my.chapternum}.${my.level}`);
    }else{
      all.push(`<h1 class='SECTION' style='${css}'>${my.level} &#160; ${this.uncode(my.style,my.title)}</h1>`);
  ...
  write_paper_subsection(top) {
    ...
    all.push('');
    if(my.chapternum){
      all.push(`<h1 class='SUBSECTION' style='${css}'>${my.chapternum}.${my.level} &#160; ${this.uncode(my.style,my.title)}</h1>`);
      this.addto_refmap(my.label,`${my.chapternum}.${my.level}`);
    }else{
      all.push(`<h1 class='SUBSECTION' style='${css}'>${my.level} &#160; ${this.uncode(my.style,my.title)}</h1>`);
      this.addto_refmap(my.label,`${my.level}`);
    }
    top.forEach((o,i) => {
      if(Array.isArray(o)){
  ...
  write_paper_subsubsection(top) {
    ...
    all.push('');
    if(my.chapternum){
      all.push(`<h1 class='SUBSUBSECTION' style='${css}'>${my.chapternum}.${my.level} &#160; ${this.uncode(my.style,my.title)}</h1>`);
      this.addto_refmap(my.label,`${my.chapternum}.${my.level}`);
    }else{
      all.push(`<h1 class='SUBSUBSECTION' style='${css}'>${my.level} &#160; ${this.uncode(my.style,my.title)}</h1>`);
      this.addto_refmap(my.label,`${my.level}`);
    }
    top.forEach((o,i) => {
      if(Array.isArray(o)){
