...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_CAPT(block){
    var {id,title,label,pagenum,bodyrow,body,style} = block;
    ...
    if(id=='@'){
      ...
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_table(title,label,style,body,bodyrow);
    }else if(id=='multicols'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_multicols(title,label,style,body,bodyrow);
    }else if(id=='alignment'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_alignment(title,label,style,body,bodyrow);
    }else if(id=='page'){
      var style = this.update_style_from_switches(style,id);
