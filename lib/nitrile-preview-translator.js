    ...
    var the_vars = the_vars.map((vv) => {
      if(vv.length==2){
        ...
        if(Number.isFinite(num1)){
          v.numbers = this.animation_numbers(num1,num1,steps);
          return v;
        }else{
          return null;
        }
        ...
        if(Number.isFinite(num1)&&Number.isFinite(num2)){
          v.numbers = this.animation_numbers(num1,num2,steps);
          return v;
        }else{
          return null;
        }
