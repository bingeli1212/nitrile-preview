...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  untext(style,body) {
    ...
    if(v0 && vZ){
      ...
      return this.do_fence(key,style1,body);
    }else{
  ...
  phrase_to_displaymath(style,cnt,cnt2,cnt3){
    ...
    return this.do_fence('displaymath',style,[cnt]);
  }
  phrase_to_img(style,cnt,cnt2,cnt3){
    var cnt2 = `{${cnt2}}`;
    style = this.string_to_style(cnt2,style)[0];
    return this.do_fence('img',style,[cnt]);
  }
  phrase_to_diagram(style,cnt,cnt2,cnt3){
    var cnt2 = `{${cnt2}}`;
    style = this.string_to_style(cnt2,style)[0];
    return this.do_fence('diagram',style,[cnt]);
  }
  phrase_to_framed(style,cnt,cnt2,cnt3){
    var cnt2 = `{${cnt2}}`;
    style = this.string_to_style(cnt2,style)[0];
    return this.do_fence('framed',style,[cnt]);
  }
}
