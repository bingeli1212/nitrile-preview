...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_CAPT(block){
    ...
    o.push('');
    if(id=='alignleft'){
      text = this.float_alignleft(title,label,style,subtitles,body,bodyrow);
    }else if(id=='aligncenter'){
      text = this.float_to_aligncenter(title,label,style,subtitles,body,bodyrow);
    }else if(id=='alignright'){
      text = this.float_to_alignright(title,label,style,subtitles,body,bodyrow);
    }else if(id=='equation'){
