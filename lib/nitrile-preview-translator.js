...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_fence(key,style,body){
    ...
    var newtext = '';
    if(key==='img'){
      newtext += this.fence_to_img(style,body);
    }else if(key==='diagram'){
      newtext += this.fence_to_diagram(style,body);
    }else if(key==='framed'){
      newtext += this.fence_to_framed(style,body);
    }else if(key==='math'){
      newtext += this.fence_to_math(style,body);
    }else if(key=='tabular'){
      newtext += this.fence_to_tabular(style,body);
    }else if(key=='tabbing'){
      newtext += this.fence_to_tabbing(style,body);
    }else if(key=='verbatim'){
      newtext += this.fence_to_verbatim(style,body);
    }else if(key=='parbox'){
      newtext += this.fence_to_parbox(style,body);
    }else if(key=='colorbutton'){
      newtext += this.fence_to_colorbutton(style,body);
    }else{
      newtext += this.fence_to_list(style,body);
    }
    return newtext;
  }
  untext(ss,style) {
