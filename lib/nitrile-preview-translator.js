...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_CAPT(block){
    ...
    if(id=='flushleft'){
      ...
      style = this.update_style_from_switches(style,id);
      text = this.float_to_multicol(title,label,style,splitid,body,bodyrow);
    }else if(id=='lines'){
      style = this.update_style_from_switches(style,id);
  ...
  do_PARA(block){
    ...
    if(this.body_is_bundle(body)){
      ...
      text = this.float_to_preformatted(title,label,style,splitid,body,bodyrow);
      ...
      text = this.float_to_description(title,label,style,splitid,body,bodyrow);
      ...
      text = this.float_to_enumeration(title,label,style,splitid,body,bodyrow);
