...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_CAPT(block){
    ...
    if(id=='@'){
      ...
      var text = this.float_to_equation(title,label,idnum,idcap,pagenum,style,body,bodyrow);
    }else if(id=='listing'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_listing(title,label,idnum,idcap,pagenum,style,body,bodyrow)
    }else if(id=='figure'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_figure(title,label,idnum,idcap,pagenum,style,body,bodyrow);
    }else if(id=='longtabu'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_longtabu(title,label,idnum,idcap,pagenum,style,body,bodyrow);
    }else if(id=='column'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_column(title,label,idnum,idcap,pagenum,style,body,bodyrow);
    }else if(id=='page'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_page(title,label,idnum,idcap,pagenum,style,body,bodyrow);
    }
    return text;
  }
  do_PARA(block){
