...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_PARA(block){
    ...
    }else if(this.re_body_is_hyphe.test(body[0])||this.re_body_is_enume.test(body[0])){
    ...
    }else if(this.re_body_is_dtabb.test(body[0])){
      body = this.body_to_body(body,this.re_body_is_dtabb,2);
      style = this.update_style_from_switches(style,'tabbing');
      text = this.float_to_tabbing(title,label,style,splitid,body,bodyrow);
    }else if(this.re_body_is_dterm.test(body[0])){
      body = this.body_to_body(body,this.re_body_is_dterm,1);
    ...
    }else if(this.re_body_is_denum.test(body[0])){
      body = this.body_to_body(body,this.re_body_is_denum);
