  ...
  untouch (line,style) {
    ...
    while ((v = re.exec(line)) !== null) {
      ...
      if (v[1] !== undefined) {
        ...
        if(key=='qquad' || key=='sub' || key=='sup' || key=='br' 
        || key=='em' || key=='b' || key=='i' || key=='u' || key=='tt'){
           newtext += this.text_to_typeface(key,this.untouch(cnt,style));
        }
          ...
          newtext += this.text_to_typeface(key,this.untouch(cnt,style),this.untouch(cnt2,style));
        }
        else if(key=='sum'){
          ///2nd-argument
          var next_i = this.extract2(line,start_i);
          ...
          newtext += this.text_to_typeface(key,this.untouch(cnt,style),this.untouch(cnt2,style),this.untouch(cnt3,style));
        }
        else {
