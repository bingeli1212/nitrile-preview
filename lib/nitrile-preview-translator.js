...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_PARA(block){
    ...
    if(this.body_is_bundle(body)){
      ...
      style = this.update_style_from_switches(style,'preformatted');
      ...
      body = this.body_to_body(body,this.re_body_is_colon,2);
      style = this.update_style_from_switches(style,'tabbing');
      ...
      style = this.update_style_from_switches(style,'description');
      ...
      style = this.update_style_from_switches(style,'enumeration');
