...
class NitrilePreviewTranslator extends NitrilePreviewBase {
  ...
  do_CAPT(block){
    ...
    if(id=='@'){
      ...
      var text = this.float_to_equation(title,label,style,bundles);
    }else if(id=='listing'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_listing(title,label,style,bundles)
    }else if(id=='figure'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_figure(title,label,style,bundles);
    }else if(id=='table'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_table(title,label,style,bundles);
    }else if(id=='multicols'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_multicols(title,label,style,bundles);
    }else if(id=='alignment'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_alignment(title,label,style,bundles);
    }else if(id=='page'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_page(title,label,style,bundles);
    }else if(id=='vspace'){
      var style = this.update_style_from_switches(style,id);
      var text = this.float_to_vspace(title,label,style,bundles);
    }
    return text;
  }
  do_PARA(block){
    ...
    var label = '';
    if(style.isbundle){
      var text = this.bundle_to_text(style,bundle)
      ...
      var style = this.update_style_from_switches(style,'sand');
      ...
      var style = this.update_style_from_switches(style,'cave');
      let cave = this.ss_to_cave(body,bodyrow);
      var text = this.cave_to_text(style,cave);
    }else if(style.isstep){
      var style = this.update_style_from_switches(style,'step');
      let step = this.ss_to_step(body,bodyrow);
      var text = this.step_to_text(style,step);  
      ...
      var style = this.update_style_from_switches(style,'body');
