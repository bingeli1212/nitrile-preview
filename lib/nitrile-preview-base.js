...
class NitrilePreviewBase {
  ...
  constructor(){
    ...
    this.hint_fill1      = 1 << 8;
    this.hint_fill2      = 1 << 9;
    this.hint_fill3      = 1 << 10;
    this.hint_fill4      = 1 << 11;
    this.hint_fill5      = 1 << 12;
    this.hint_fill6      = 1 << 13;
    this.hint_fill7      = 1 << 14;
    this.hint_fill8      = 1 << 15;
    this.hint_fill9      = 1 << 16;
    this.hint_stroke1    = 1 << 17;
    this.hint_stroke2    = 1 << 18;
    this.hint_stroke3    = 1 << 19;
    // type
    this.CC_NONE   = 0;
    this.CC_LETTER = 1;
    this.CC_NUMBER = 2;
