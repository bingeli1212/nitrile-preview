...
class NitrilePreviewBase {
  ...
  constructor(){
    ...
    this.re_body_is_examp = /^(>)(\s+)(.*)$/u;
    this.re_body_is_lline = /^(\|)(\s+)(.*)$/u;
    this.re_body_is_cline = /^(\$)(\s+)(.*)$/u;
    this.re_body_is_itemize  = /^(-)(\s+)(.*)$/u;
    this.re_body_is_enumerate  = /^(\d+\.|\*)(\s+)(.*)$/u;
    this.re_body_is_description  = /^(\+|:)(\s+)(.*)$/u;
