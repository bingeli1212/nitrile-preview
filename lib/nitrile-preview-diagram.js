  ...
  */
  ...
  name_to_path_string(str){
    switch(str){
      ...
      case 'house':
        var mypath = '&polyline{(-0.5,1),(1.25,3.5),(3,1),(-0.5,1)} &rectangle{(0,0),(1,1)} &rectangle{(1,0),(2.5,1)} &rectangle{(1.5,0),(2,0.5)}';
        break;

      case 'school':
        var mypath = '&rectangle{(0,0),(7,3)} &rectangle{(1,0),(2,2)} &rectangle{(3,0),(4,2)} &rectangle{(5,0),(6,2)} &polyline{(1,5),(2,4.5),(1,4),(1,5)} &polyline{(3,5),(4,4.5),(3,4),(3,5)} &polyline{(5,5),(6,4.5),(5,4),(5,5)} &polyline{(1,3),(1,4)} &polyline{(3,3),(3,4)} &polyline{(5,3),(5,4)}';
        break;
