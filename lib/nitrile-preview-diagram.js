...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  read_action_style_label(line) {
    var [g,line] = this.__read_action_style(line);
    var [txt,ts,line] = this.__read_action_label(line);
    if(ts==2){
      //math text
      g.math = 1;
    }
    return [g,txt,ts,line];
  }

  __read_action_label(line) {
    var v;
    var ts=0;
  ...
  exec_line(line,env) {
    ...
    if ((v = this.re_path_command.exec(line)) !== null) {
      ...
      if((v=re.exec(symbol))!==null){
        ...
        o.push(this.do_comment(`***ERR: ${symbol} is not a valid variable`));
      }
    }
    ///
    /// config
    ...
    ///NOTE: source
      ...
      if(source) {
        ...
        o.push(this.do_comment(`ERR:source does not exist: ${id}`));
      }
    }
    ///
    ...
    ///
      ...
      var line = v[2];
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var coords = this.read_action_coords(line);
      o.push(this.do_label(opts,g,txt,ts,coords));///own method
    }
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var coords = this.read_action_coords(line);
      o.push(this.do_text(opts,g,txt,ts,coords));///own method
    }
    ///
    ...
    ///
      ...
      var opts = this.string_to_command_opts(v[1]);
      var line = v[2];
      o.push(this.do_comment(line));///own method
    }
    ///
    ...
    ///
      ...
      var txt = '';
      var ts = 0;
      o.push(this.do_drawcontrolpoints(opts,g,txt,ts,coords));//not own method
    }
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var coords = this.read_action_coords(line);
      o.push(this.do_drawanglearc(opts,g,txt,ts,coords));//own method
    }
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var coords = this.read_action_coords(line);
      o.push(this.do_drawlinesegcong(opts,g,txt,ts,coords));//own method
    }
    ///
    ///NOTE: rec
    ///
    ...
    ///
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var coords = this.read_action_coords(line);
      o.push(this.do_node(opts,g,txt,ts,coords));///own method
    }
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var coords = this.read_action_coords(line);
      o.push(this.do_edge(opts,g,txt,ts,coords));///own method
    }
    ///
    ...
    ///
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var coords = this.read_action_coords(line);
      o.push(this.do_box(opts,g,txt,ts,coords));///own method
    }
    ///
    ...
    ///
      ...
      o.push(this.do_cartesian(opts,g,txt,ts,floats));///own method
    }
    ///
    ...
    ///
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var floats = this.read_action_floats(line);
      o.push(this.do_barchart(opts,g,txt,ts,floats));///own method
    }
    ///
    ...
    ///
      ...
      var [g,txt,ts,line] = this.read_action_style_label(line);
      var floats = this.read_action_floats(line);
      o.push(this.do_lego(opts,g,txt,ts,floats));///own method
    }
    return o.join('\n');
  }
