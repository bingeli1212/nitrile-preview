...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  */
  ...
  g_to_shear_float(g){
    return this.get_float_prop(g,'shear',this.shear);
  }
  g_to_w_float(g){
    return this.get_float_prop(g,'w',this.w);
  }
  g_to_h_float(g){
    return this.get_float_prop(g,'h',this.h);
  }
  g_to_r_float(g){
    return this.get_float_prop(g,'r',this.r);
  }
  g_to_dx_float(g){
