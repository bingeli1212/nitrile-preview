...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  to_diagram(style,ss){
    ...
    envs.forEach((env) => {
      let p = this.do_diagram(style,ss,env);
      o.push(p); 
    });
    return o;
  }
  do_diagram(style,ss,env) {
  ...
  exec_action_command(style,line,env) {
    ...
    ///
      ...
      for (var i = 0; i < coords.length; i++) {
        ...
        var x = pt[0];
        var y = pt[1];
        var q = q = this.to_q_RECT(x,y,w,h);
    ...
    ///
      ...
      for (var i = 0; i < coords.length; i++) {
        ...
        var x = pt[0];
        var y = pt[1];
        var q = q = this.to_PIE(x,y,r,start,span);
        o.push(this.p_draw(q,g));
      }
    }
    ///
    ...
    ///
      ...
      let start = this.g_to_start_float(g);
      let span = this.g_to_span_float(g);
      let inner = this.g_to_inner_float(g);
      let outer = this.g_to_outer_float(g);
      for (var i = 0; i < coords.length; i++) {
        var pt = this.point_at(coords, i);
        if (!this.is_valid_point(pt)) continue;
        var x = pt[0];
        var y = pt[1];
        var q = q = this.to_SECTOR(x,y,inner,outer,start,span);
        o.push(this.p_draw(q,g));
      }
    }
    ///
  ...
  g_to_inner_float(g){
    g = this.update_style_with_group(g);
    return this.get_float_prop(g,'inner',0);
  }
  g_to_outer_float(g){
    g = this.update_style_with_group(g);
    return this.get_float_prop(g,'outer',0);
  }
  g_to_abr_string(g){
    g = this.update_style_with_group(g);
  ...
  g_to_xgrid_float(g){
    g = this.update_style_with_group(g);
    return this.get_float_prop(g,'xgrid',1,this.MIN);
  }
  g_to_ygrid_float(g){
    g = this.update_style_with_group(g);
    return this.get_float_prop(g,'ygrid',1,this.MIN);
  }
  g_to_xaxis_string(g){
    g = this.update_style_with_group(g);
  ...
  //
  ///////////////////////////////////////////////////////////////////////////////////
  to_SECTOR(cx,cy,inner,outer,start,span){
    var p = [];
    if(span<0){
      start += span;
      span = -span;
