  ...
  do_lego(opts,g,txt,ts,floats) {
    ...
    switch( opt ) {
      ...
      case 'show'://LEGO
        ...
        A.q = [[0,1],[1,1,'L'],[1-wx,1-wy,'L'],[0-wx,1-wy,'L'],[0,0,'cycle'],
               [1,1],[1,0,'L'],[1-wx,0-wy,'L'],[1-wx,1-wy,'L'],[0,0,'cycle'],
               [0-wx,0-wy],[0-wx,1-wy,'L'],[1-wx,1-wy,'L'],[1-wx,0-wy,'L'],[0,0,'cycle']];
        A.f1 = [[0,1],[1,1,'L'],[1-wx,1-wy,'L'],[0-wx,1-wy,'L'],[0,0,'cycle']];
        A.f2 = [[1,1],[1,0,'L'],[1-wx,0-wy,'L'],[1-wx,1-wy,'L'],[0,0,'cycle']];
        A.f3 = [[0-wx,0-wy],[0-wx,1-wy,'L'],[1-wx,1-wy,'L'],[1-wx,0-wy,'L'],[0,0,'cycle']];
        ///export commands for each cube
        for(var z=1; z <= max_z; z++) {
          for(var x=1; x <= max_x; x++) {
            for(var y=1; y <= max_y; y++) {
              ...
              if(A.all.has(key)){
                var q = A.q;
                var offsetx = origin_x + (y-1) - ((x-1)*wx);
                var offsety = origin_y - ((x-1)*wy) + (z-1);
                if(1){
                  var q = this.offset_and_scale_coords(A.q,offsetx,offsety,1,1,0);
                  o.push(this.p_draw(q,g));
                }
