...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  exec_line(line,env) {
    ...
    var line1 = v[3];
    var [g,txt,line1] = this.read_action_style_label(line1);
    var coords = this.read_action_coords(line1);
    var floats = this.read_action_floats(line1);
    var [opt] = opts;
    ///
  ...
  */
  ...
  do_node(opts,g,txt,coords){
    ...
    var dx = this.get_float_prop(g,'dx',0);
    var dy = this.get_float_prop(g,'dy',0);
    var g = {...g,hints:this.hint_hallow};
