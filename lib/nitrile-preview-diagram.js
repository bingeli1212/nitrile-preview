  ...
  */
  ...
  to_multiws(x,y,g,txt){
    ...
    if(number && divisor){
      ...
      ///decimal points
      let decimalpoint1 = decimalpoints[0]||0;
      let decimalpoint2 = decimalpoints[1]||0;
      if(decimalpoint1){
        /// draw the decimal point for the first number
        d.push(this.p_dot_circle(x+n-decimalpoint1,y-1+0.2,g));
      }
      if(decimalpoint2){
        /// draw the decimal point for the second number
        d.push(this.p_dot_circle(x+n-decimalpoint2,y-2+0.3,g));
      }
      ...
      if(answer){
        ...
        if(dy>2){
          ...
          if(q3){
            /// draw the decimal point for the second number
            d.push(this.p_dot_circle(x+n-q3,y-dy-1+0.3,g));
          }
        }else{
          if(q3){
            /// draw the decimal point for the second number
