...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  constructor(translator) {
    ...
    */
    ...
    // path symbol
    this.re_parse_pathvar       = /^&([A-Za-z][A-Za-z0-9]*_\d+|[A-Za-z][A-Za-z0-9]*)\s*(.*)$/;
    // path function
  ...
  exec_body(style,body,env){
    ...
    while (lines.length) {
      ...
      if((v=this.re_var_command.exec(line))!==null){
        ...
        let index = v[2];
        let s1 = v[3];
        if(this.re_symbol_name.test(name)){
          if(index.length){
          ...
          }else if((v=this.re_s_is_format.exec(s1))!==null){
            let fmt = v[1];
  ...
  read_coords(line,env) {
    ...
    while (line.length) {
      ...
      if((v=this.re_parse_pathfunc.exec(line))!==null){
        ...
        var parm = v[2];
        line = v[3];
        var args = this.parse_pathfunc_parm(parm,env);
      ...
      if((v=this.re_parse_pathvar.exec(line))!==null){
        /// '&a'
        /// '&a_0'
        var symbol = v[1];
        line = v[2];
      ...
      if((v=this.re_coords_point.exec(line))!==null){
        let s = v[1];
        line = v[2];
        let from = [];
