...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  to_q_STOR(x,y,w,h){
    ...
    var my = h - hh;
    p.push([x,     y+my,'M']);
    p.push([x+hw,  y+my-hh,'L']);
    p.push([x+w-hw,y+my-hh,'L']);
    p.push([x+w,   y+my,'L']);
    p.push([x+w-hw,y+h,'L']);
    p.push([x+hw,  y+h,'L']);
    p.push([0,0,'cycle']);
    ...
    p.push([x,     y+my,'L']);
    p.push([x,     y+my-hh,'L']);
    p.push([x+hw,  y+my-hh-hh,'L']);
    p.push([x+w-hw,y+my-hh-hh,'L']);
    p.push([x+w   ,y+my-hh   ,'L']);
    p.push([x+w   ,y+my      ,'L']);
    p.push([x+w-hw,y+my-hh   ,'L']);
    p.push([x+hw  ,y+my-hh   ,'L']);
    p.push([x     ,y+my      ,'L']);
    ...
    var m = 6;
    p.push([x,     y+my,'L']);
    p.push([x,     y+my-m*hh,'L']);
    p.push([x+hw,  y+my-m*hh-hh,'L']);
    p.push([x+w-hw,y+my-m*hh-hh,'L']);
    p.push([x+w   ,y+my-m*hh   ,'L']);
    p.push([x+w   ,y+my      ,'L']);
    p.push([x+w-hw,y+my-hh   ,'L']);
    p.push([x+hw  ,y+my-hh   ,'L']);
    p.push([x     ,y+my      ,'L']);
