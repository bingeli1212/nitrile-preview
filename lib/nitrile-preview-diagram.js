...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  to_q_TERM(x,y,w,h){
    ...
    p.push([x+gap,y,'M']);
    p.push([x+w-gap,y,'L']);
    p.push([x+w,y+hh,'C',x+w-gap+cc,y,x+w,y+hh-cc]);
    p.push([x+w-gap,y+h,'C',x+w,y+hh+cc,x+w-gap+cc,y+h]);
    p.push([x+gap,y+h,'L']);
    p.push([x,y+hh,'C',x+gap-cc,y+h,x,y+hh+cc]);
    p.push([x+gap,y,'C',x,y+hh-cc,x+gap-cc,y]);
    p.push([0,0,'cycle']);
    return p;
  }
  ///////////////////////////////////////////////////////////////////////////////////
