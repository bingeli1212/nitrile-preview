...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  exec_command_line(line) {
    ...
    ///
      ...
      let s0 = this.coords_to_string(coords);
      this.do_comment(`***coords:${s0} ***refx:${this.refx} ***refy:${this.refy} ***refsx:${this.refsx} ***refsy:${this.refsy}`);
      this.offset_coords(coords,this.refx,this.refy,this.refsx,this.refsy,0);
      if(opt){
        ///is 'opt' a known path?
        let symbol = opt;
        let p = this.get_path_from_symbol(symbol);
    ...
    ///
      ...
      o.push(this.do_edge(opts,g,txt,data));///own method
    }
    ///
  ...
  move_pt(pt){
    var refx = this.refx;
    var refy = this.refy;
    var refsx = this.refsx;
    var refsy = this.refsy;
    var rotation = 0;
    if(rotation){
      var x = pt[0];
      var y = pt[1];
  ...
  read_coords(line) {
    ...
    var offset = [this.offset_x,this.offset_y];
    var dx = 0;
    var dy = 0;
    var x = 0;
    var y = 0;
  ...
  do_barchart(subcmd,opts,g,txt,floats) {
    ...
    switch( subcmd ) {
      ...
      case 'bbox'://BARCHART
        ...
        p.push([x1,y2,'L']);
        p.push([0,0,'cycle']);
        this.offset_coords(p,this.refx,this.refy,this.refsx,this.refsy,0); 
            ...
            for(var y=1; y <= max_y; y++) {
              ...
              if(A.all.has(key)){
                ...
                if(1){
                  ...
                  this.offset_coords(q,this.refx,this.refy,this.refsx,this.refsy,0);
