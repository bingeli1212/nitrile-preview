...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  do_image(opt,x,y,w,h,g,txts){
    ...
    o.push(this.p_image(x,y,w,h,ta,txts,g));
    return o.join('\n');
  }
  do_header(opt,x,y,w,h,g,txts){
    var o = [];
    o.push(this.p_header(opt,x,y,w,h,txts,g));
    return o.join('\n');
  }
  do_footer(opt,x,y,w,h,g,txts){
    var o = [];
    o.push(this.p_footer(opt,x,y,w,h,txts,g));
    return o.join('\n');
  }
  do_subtitle(opt,x,y,w,h,g,txts){
    var o = [];
    o.push(this.p_subtitle(opt,x,y,w,h,txts,g));
    return o.join('\n');
  }
