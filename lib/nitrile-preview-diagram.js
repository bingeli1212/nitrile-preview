    ...
    if ((v = this.re_set_command.exec(line)) !== null) {
      ...
      if (key === 'refx') {
        ...
        if (val[0] === '/') { /// '/3'
          ...
          val = this.assertFloat(val, this.def_refx, -this.config.width, this.config.width);
        }
        this.refx = val;
      } ///such as 12.5
      else if (key === 'refy') {
        ...
        if (val[0] === '/') { /// '/3'
          ...
          val = this.assertFloat(val, this.def_refy, -this.config.height, this.config.height);
        }
        this.refy = val;
      } ///such as 12.5
      else if (key === 'refs') { 
