...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  exec_body(body,env){
    ...
    while (lines.length) {
      ...
      if((v = this.re_config_command.exec(line)) !== null) {
        var key = v[1];
        var val = v[2];
        this.conf_to_stringig[key] = val;
        if(val=='0'){
          this.conf_to_stringig[key] = 0;
        }
        continue;
      }
  ...
  move_coords(coords){
    ...
    if(this.origin_x !== 0 || this.origin_y !== 0 || this.origin_s !== 1){
      let p = this.dup_coords(coords);
      this.offset_coords(p,this.origin_x,this.origin_y,this.origin_s,this.origin_s,0);
      return p;
    }else{
      return coords;
    }
  ...
  move_xy(x,y){
    var pt = [x,y];
    this.offset_pt(pt,this.origin_x,this.origin_y,this.origin_s,this.origin_s,0);
    return pt;
  }
  scale_dist(r){
  ...
  do_node(opts,g,txt,coords){
    ...
    for (var j = 0; j < coords.length; j++) {
      ...
      if(this.g_to_shadow_int(g)){
        ...
        let dd = 1/this.viewport_unit;
        let x1 = x+dd;
        let y1 = y-dd;
        o.push(this.p_circle(x1,y1,r,g1));
      }
  ...
  do_box(opts,g,txt,coords){
    ...
    var showid = this.g_to_showid_int(g);
    var multiline = this.g_to_multiline_int(g);
    ...
    for (var j = 0; j < coords.length; j++) {
      ...
      var v = [x,y,w,h,rdx,rdy,boxtype,cx,cy];
      if(id){
        this.my_box_map.set(id,v);
      }
      drawshadowflag = this.g_to_shadow_int(g);
      all.push(v);
    }
    if(coords.length==0){
    ...
    all.forEach((p,j,arr) => {
      ...
      if(boxtype=='hexgon'){
        if(g1){
          o.push(this.p_hexgon(x1,y1,w,h,g1));
        }
        o.push(this.p_hexgon(x,y,w,h,g));
      }else if(boxtype=='triangle'){
        if(g1){
          o.push(this.p_triangle(x1,y1,w,h,g1));
        }
        ...
        if(g1){
          o.push(this.p_parallelogram(x1,y1,w,h,g1));
        }
        o.push(this.p_parallelogram(x,y,w,h,g));
      }else if(boxtype=='rhombus'){
        if(g1){
          o.push(this.p_rhombus(x1,y1,w,h,g1));
        }
        o.push(this.p_rhombus(x,y,w,h,g));
      }else if(boxtype=='rrect'){
        if(g1){
          o.push(this.p_rrect(x1,y1,w,h,rdx,rdy,g1));
        }
        o.push(this.p_rrect(x,y,w,h,rdx,rdy,g));
      }else{
        if(g1){
          o.push(this.p_rect(x1,y1,w,h,g1));
        }
        o.push(this.p_rect(x,y,w,h,g));
      }
      if(showid){
      ...
      if(opts.length){
        ...
        for(var j=0; j<opts.length; ++j){
          ...
          if(this.my_box_map.has(id1)&&this.my_box_map.has(id2)){
            ...
            var [x1,y1,w1,h1,rdx1,rdy1,boxtype1,cx1,cy1] = v1;
            var [x2,y2,w2,h2,rdx2,rdy2,boxtype2,cx2,cy2] = v2;
  ...
  g_to_multiline_int(g){
    g = this.update_style_with_group(g);
    return this.get_int_prop(g,'multiline',0);
  }
  g_to_shift_float(g){
    g = this.update_style_with_group(g);
  ...
  do_comment(s) {
    ...
    if(this.conf_to_stringig.verbose){
      console.log(s);
    }
  }
  do_line(s) {
  ...
  to_trump_card(x,y,mypath,d,g,mycolor){
    ...
    var o = [];
    o.push(this.p_rrect(x,y,5*scaleX,6*scaleY,0.4*scaleX,0.4*scaleY,{...g,fillcolor:'white'}));
    g = {...g,fontcolor:mycolor,fillcolor:mycolor,fontsize:fontsize,linesize:0,hints:0}
    if(d==='10'){
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'10','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'9','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1*scaleX,1*scaleY);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'8','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1*scaleX,1*scaleY);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'7','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1*scaleX,1*scaleY);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+(0.5*scaleX),y+(0.5+5)*scaleX,'6','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1*scaleX,1*scaleY);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'5','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1*scaleX,1*scaleY);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'4','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1*scaleX,1*scaleY);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'3','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'2','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,2*scaleX,1*scaleY);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'A','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      o.push(this.p_fill(q2,g));
    }else if(d==='J'){
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'J','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      o.push(this.p_stroke(sq,{...g,linesize:0,linecolor:'lightgray'}));      
      ///
      ...
      o.push(this.p_draw(jack,g));
      o.push(this.p_label(x+2.5*scaleX,y+3*scaleY,"JACK",'bot',g)) 
    }else if(d==='Q'){
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'Q','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      o.push(this.p_stroke(sq,{...g,linesize:0,linecolor:'lightgray'}));      
      ///
      ...
      this.offset_coords(jack,0,2*scaleY);
      o.push(this.p_draw(jack,g));      
      o.push(this.p_label(x+2.5*scaleX,y+3*scaleY,"QUEEN",'bot',g)) 
    }else if(d==='K'){
      ///
      o.push(this.p_label(x+0.5*scaleX,y+(0.5+5)*scaleY,'K','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      o.push(this.p_stroke(sq,{...g,linesize:0,linecolor:'lightgray'}));      
      ///
      ...
      this.offset_coords(jack,0,2*scaleY);
      o.push(this.p_draw(jack,g));     
      o.push(this.p_label(x+2.5*scaleX,y+3*scaleY,"KING",'bot',g)) 
    }
    return o.join('\n');
  }
  ...
  to_animated_diagrams(style,ss){
    ...
    for(let env of env_array){
      style.env = env;
      var { text } = this.to_diagram(style,ss);
      o.push(text); 
    }
    var text = o.join('\n')
    return { text };    
