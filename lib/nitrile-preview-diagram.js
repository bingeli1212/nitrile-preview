...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  to_trump_card(x,y,mypath,d,g,mycolor){
    ...
    if(d==='10'){
      ...
      ///
      let myjack = '(0.5,0) [a:0.4,0.4,0,0,1,1.8,0] cycle (0.5,0) [l:1.2,-0.5] [q:0.5,0,0.8,0.2] [l:-0.2,0.3] cycle';
      ...
      o.push(this.p_stroke(sq,{...g,linesize:0,linecolor:'lightgray'}));      
      ///
      let myjack = '(0.75,0) [q:0.75,-0.5,1.5,0] [l:0.25,0.75] [l:-0.5,-0.4] [l:0,0.5] [l:-0.25,-0.5] [l:-0.25,0.75] [l:-0.25,-0.75] [l:-0.25,0.5] [l:0,-0.5] [l:-0.5,0.4] cycle &circle{(2.5,0.75),0.1} &circle{(2,0.85),0.1} &circle{(1.5,1.1),0.1} &circle{(1,0.85),0.1} &circle{(0.5,0.75),0.1}';
      let [jack] = this.read_coords(myjack);
      this.offset_coords(jack,x+1,y+1);
      this.offset_coords(jack,0,2);
      o.push(this.p_draw(jack,g));      
