...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  constructor(translator) {
    ...
    */
    ...
    this.re_number_is_array         = /^&([A-Za-z0-9_]+)$/;
    this.re_number_is_fn            = /^fn:([A-Za-z][A-Za-z0-9]*)$/;
    this.re_number_is_spread        = /^([^!]+)!([^!]+)!([^!]+)$/;
    this.re_number_is_range2        = /^([^~]+)~([^~]+)$/;
    this.re_number_is_range3        = /^([^~]+)~([^~]+)~([^~]+)$/;
    // path construction
    this.re_dashdot = /^(~|\.\.)\s*(.*)$/;
    this.re_coord = /^\((.*?)\)\s*(.*)$/;
  ...
  exec_command_line(line) {
    ...
    ///
      ...
      o.push(this.do_cartesian(subcmd,opts,g,txt,floats));///own method
    }
    ///
  ...
  move_coords(coords){
    this.offset_coords(coords,this.origin_x,this.origin_y,this.origin_s,this.origin_s,0);
  }
  move_xy(x,y){
    var pt = [x,y];
  ...
  read_numbers(line) {
    ...
    var fn;
    while(line.length) {
      if((v=this.re_nonblanks.exec(line))!==null){
        let expr = v[1];
        line = v[2];
        if((v=this.re_number_is_range2.exec(expr))!==null){
          ...
          for(let a of all){
            if(fn){
              let fn_args = [];
              fn_args.push(a);
              a = this.expr.exec_complex_func(fn,fn_args,this.my_var_g);
            }
            o.push(a);
          } 
        }else if((v=this.re_number_is_range3.exec(expr))!==null){
          let [a1]   = this.expr.extract_next_expr(v[1],this.my_var_g);//returns a 'Complex'
          let [a2] = this.expr.extract_next_expr(v[2],this.my_var_g);//If empty it returns (0,0*I)
        ...
        }else if((v=this.re_number_is_spread.exec(expr))!==null){
          let [a1] = this.expr.extract_next_expr(v[1],this.my_var_g);//returns a 'Complex'
          let [a2] = this.expr.extract_next_expr(v[2],this.my_var_g);//If empty it returns (0,0*I)
        ...
        }else if((v=this.re_number_is_fn.exec(expr))!==null){
          fn = v[1];
        }else if((v=this.re_number_is_array.exec(expr))!==null){
          let symbol = v[1];
  ...
  do_cartesian(subcmd,opts,g,txt,floats) {
    var o = [];
    var id = 0;
  ...
  to_trump_card(x,y,mypath,d,g,mycolor){
    ///this size is always 5x6
    ///'mycolor' is 'red' for diamond and heart, and 'black' for spade and club
    let mysquare = '(0,0) [h:3] [v:4] [h:-3] cycle';
    let [sq] = this.read_coords(mysquare);
    let [q] = this.read_coords(mypath);
    var q1 = this.dup_coords(q);
    var q2 = this.dup_coords(q);
    this.offset_coords(sq,x+1,y+1);
    this.offset_coords(q,x,y);
    this.offset_coords(q1,x+0.25,y+4.50,0.5,0.5);
    this.offset_coords(q2,x+1.5,y+2,2.0,2.0);
    var o = [];
    o.push(this.p_rrect(x,y,5,6,0.5,0.5,{...g,fillcolor:'white'}));
    g = {...g,fontcolor:mycolor,fillcolor:mycolor,fontsize:11}
    if(d==='10'){
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'10','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1,1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,2,0);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,-1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,-1);
      ...
      this.offset_coords(q,0,-1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,-1,0.5);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,2);
      o.push(this.p_fill(q,g));
    }else if(d==='9'){
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'9','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1,1);
      o.push(this.p_fill(q,g));
      ...
      this.offset_coords(q,0,-1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,-1,1.5);
      o.push(this.p_fill(q,g));
    }else if(d==='8'){
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'8','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1,1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,1.5);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,1.5);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,1,-0.75);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,-1.5);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,1,-0.75);
      ...
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'7','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1,1);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'6','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1,1);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'5','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1,1);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'4','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,1,1);
      o.push(this.p_fill(q,g));
      ...
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'3','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,2,1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,1.5);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,1.5);
      ...
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'2','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      this.offset_coords(q,2,1);
      o.push(this.p_fill(q,g));
      this.offset_coords(q,0,3);
      o.push(this.p_fill(q,g));
    }else if(d==='A'){
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'A','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      o.push(this.p_fill(q2,g));
    }else if(d==='J'){
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'J','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      ...
      this.offset_coords(jack,x+1,y+1);
      this.offset_coords(jack,0,2);
      o.push(this.p_draw(jack,g));
      o.push(this.p_label(x+2.5,y+3,"JACK",'bot',g)) 
    }else if(d==='Q'){
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'Q','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      o.push(this.p_stroke(sq,{...g,linesize:0,linecolor:'lightgray'}));      
      ///
      ...
      this.offset_coords(jack,0,2);
      o.push(this.p_draw(jack,g));      
      o.push(this.p_label(x+2.5,y+3,"QUEEN",'bot',g)) 
    }else if(d==='K'){
      ///
      o.push(this.p_label(x+0.5,y+0.5+5,'K','ctr',g))
      o.push(this.p_fill(q1,g));
      ///
      o.push(this.p_stroke(sq,{...g,linesize:0,linecolor:'lightgray'}));      
      ///
      let myjack = '(0.5,0) [h:2] [v:0.85] [l:-0.25,-0.25] [l:-0.25,0.35] [l:-0.25,-0.25] [l:-0.25,0.55] [l:-0.25,-0.55] [l:-0.25,0.25] [l:-0.25,-0.35] [l:-0.25,0.25] cycle &circle{(2.5,0.85),0.1} &circle{(2,0.95),0.1} &circle{(1.5,1.25),0.1} &circle{(1,0.95),0.1} &circle{(0.5,0.85),0.1}';
      let [jack] = this.read_coords(myjack);
      this.offset_coords(jack,x+1,y+1);
      this.offset_coords(jack,0,2);
      o.push(this.p_draw(jack,g));     
      o.push(this.p_label(x+2.5,y+3,"KING",'bot',g)) 
    }
    return o.join('\n');
  }
