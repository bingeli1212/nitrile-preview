...
class NitrilePreviewDiagram extends NitrilePreviewBase {
  ...
  */
    ...
    for(let i=1; i < opts.length; ++i){
      ...
      if(this.my_nodes.has(name1)&&this.my_nodes.has(name2)){
        ...
        if(name1==name2){
          ...
          let [p0,p1,p2,p3] = this.dir_to_cbezier_loop(abr,span,protrude, node1.pt[0],node1.pt[1],node1.r);
          ...
          let [p0,p1,p2] = this.dir_to_qbezier(abr, node1.pt[0],node1.pt[1],node1.r, node2.pt[0],node2.pt[1],node2.r);        
          if(abr){
  ...
  dir_to_cbezier_loop(abr,span,protrude,x1,y1,r1){
    var p0 = [0,0];
    var p1 = [0,0];
    var p2 = [0,0];
    var p3 = [0,0];
  ...
  dir_to_qbezier(abr, x1,y1,r1, x2,y2,r2){
    var p0 = [x1,y1];
    var p2 = [x2,y2];
    // 
    var dx = +x2-x1;
