  ...
  exec_line(line,env) {
    ...
    if ((v = this.re_draw_command.exec(line)) !== null) {
      ...
      if(opt){
        ...
        let mypath = this.string_to_builtin_path(opt);
        if(mypath){
          ///is 'opt' a known built-in path?
          this.commands.push(this.to_shape(mypath,g,coords,'draw'));///own method
        }else{
          ///is 'opt' a known path?
    ...
    if ((v = this.re_fill_command.exec(line)) !== null) {
      ...
      if(opt){
        ...
        if(mypath){
          ///is 'opt' a known built-in path?
          this.commands.push(this.to_shape(mypath,g,coords,'fill'));///own method
        }else{
          ///is 'opt' a known path?
          if(this.my_paths.has(opt)){
            let p = this.my_paths.get(opt);
    ...
    if ((v = this.re_stroke_command.exec(line)) !== null) {
      ...
      if(opt){
        ...
        if(mypath){
          ///is 'opt' a known built-in path?
          this.commands.push(this.to_shape(mypath,g,coords,'stroke'));///own method
        }else{
          ///is 'opt' a known path?
          if(this.my_paths.has(opt)){
            let p = this.my_paths.get(opt);
