  ...
  do_lego(opts,g,txt,ts,floats) {
    ...
    switch( opt ) {
      ...
      case 'show'://LEGO
        ...
        A.q = [[0,wh],[ww,wh,'L'],[ww-wx,wh-wy,'L'],[0-wx,wh-wy,'L'],[0,0,'cycle'],
               [ww,wh],[ww,0,'L'],[ww-wx,0-wy,'L'],[ww-wx,wh-wy,'L'],[0,0,'cycle'],
               [0-wx,0-wy],[0-wx,wh-wy,'L'],[ww-wx,wh-wy,'L'],[ww-wx,0-wy,'L'],[0,0,'cycle']];
        ///export commands for each cube
        for(var z=1; z <= max_z; z++) {
          for(var x=1; x <= max_x; x++) {
            for(var y=1; y <= max_y; y++) {
