    ...
    while (line.length) {
      ...
      if ((v = this.re_coords_is_aux.exec(line))!==null) {
        ...
        switch (key){
          ...
          case 'veer': {
            // 'veer:left' - set it such that it will veer to the left 
            // 'veer:right' - set it such that it will veer to the right 
            veer = val;
            break;
          }
          case 'at': {
      ...
      if((v=this.re_coords_is_point.exec(line))!==null){
        ...
        if (dashdot === '..') {
          ...
          if(dashdot.length==1){
            abr = 0;
          }else if(dashdot.length==2){
            abr = 30;
          }else if(dashdot.length==3){
            abr = 48;
          }else if(dashdot.length==4){
            abr = 60;
          }else if(dashdot.length==5){
            abr = 68;
          }else{
            abr = 73;
          }
