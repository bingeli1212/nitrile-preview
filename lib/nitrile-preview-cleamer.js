...
class NitrilePreviewCleamer extends NitrilePreviewContex {
...
`;
  ...
  write_frame(frame) {
    ...
    frame.solutions.forEach((o,i,arr) => {     
      ...
      all.push(`\\startsubsection[title={{\\it ${this.uncode(o.style,o.title)}}},bookmark={}]`);
      all.push('');
      all.push(this.untext(o.style,o.body).trim());
  ...
  to_preamble_core(){
    ...
    all.push(`\\definefallbackfamily [linux] [serif] [hiraginominchopro] [range={cjkunifiedideographs}]`);
    all.push(`\\definefallbackfamily [linux] [serif] [hiraginominchopro] [range={hiragana}]`);
    all.push(`\\definefallbackfamily [linux] [serif] [hiraginominchopro] [range={katakana}]`);
...
module.exports = { NitrilePreviewCleamer }
