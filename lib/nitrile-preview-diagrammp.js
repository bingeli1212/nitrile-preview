...
class NitrilePreviewDiagramMP extends NitrilePreviewDiagram {
  ...
  to_shadeonlys(g,isinherit) {
    ...
    if (shade=='linear') {
      ...
      if(ss.length==0){
        d.push(`withshadestep( withshadefraction 1 withshadecolors(black,black) )`)
      }else if(ss.length==1){
        d.push(`withshadestep( withshadefraction 1 withshadecolors(${ss[0]},${ss[0]}) )`)
      }else if(ss.length==1){
