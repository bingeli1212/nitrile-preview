...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_one_frame(style,ss,env) {
    ...
    if(1){
      ...
      let s_svg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${gw}" height="${gw}"><rect fill="none" stroke="${gridcolor}" x="0" y="0" width="${gw}" height="${gw}"/></svg>`;
