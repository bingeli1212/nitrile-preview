...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  p_label(x,y,txt,ta,g) {
    ...
    if (this.g_to_math_int(g)) {
      ...
      var [x,y] = this.adjust_xy_for_label(x,y,valign,anchor)
      if(this.has_texts(g)){
  ...
  p_arc(x1,y1,x2,y2,Rx,Ry,bigarcflag,g){
    ...
    if(this.has_strokes(g)){
      if(g.arrowhead==1){
        ...
        let id1 = this.create_arrowhead('end',g);
        d.push(`<path d='M${x1},${y1} A${Rx},${Ry},0,${bigarcflag},0,${x2},${y2}' ${this.g_to_svg_drawonly_str(g)} marker-end='url(#${id1})' />`);
      }else if(g.arrowhead==2){
        ///back-pointing-arrow-head
        let id2 = this.create_arrowhead('start',g);
        d.push(`<path d='M${x1},${y1} A${Rx},${Ry},0,${bigarcflag},0,${x2},${y2}' ${this.g_to_svg_drawonly_str(g)} marker-start='url(#${id2})' />`);
      }else if(g.arrowhead==3){
        ///front-and-back-pointing-arrow-heads
        let id1 = this.create_arrowhead('end',g);
        let id2 = this.create_arrowhead('start',g);
        d.push(`<path d='M${x1},${y1} A${Rx},${Ry},0,${bigarcflag},0,${x2},${y2}' ${this.g_to_svg_drawonly_str(g)} marker-end='url(#${id1})' marker-start='url(#${id2})' />`);
      }else{
        ///no-arrow-head
        d.push(`<path d='M${x1},${y1} A${Rx},${Ry},0,${bigarcflag},0,${x2},${y2}' ${this.g_to_svg_drawonly_str(g)} />`);
      }
    }
    return d.join('\n');
  }
  ...
  g_to_svg_fillonly_str(g,isinherit) {
    g = g||{};
    var d = [];
  ...
  g_to_svg_fontfamily_str(g) {
    var fontfamily = this.g_to_fontfamily_string(g);
    var ss = [];
  ...
  g_to_svg_fontstyle_str(g) {
    var fontstyle = this.g_to_fontstyle_string(g);
    var ss = [];
  ...
  adjust_xy_for_label(x,y,valign,anchor){
    if(1){
