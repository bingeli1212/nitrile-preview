...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  /// the input 'max_w' expresses the maximum width each line can go;
  /// the x/y represents the topleft position; all these are in SVG
  /// user coordinates; 
  ///
  cairo_segment_array_to_pp(segment_array,max_w,x,y){
    var text_h = this.tokenizer.fh*1.333;
    var gap_w = 4;
    var pp = [];
    var p_latin = {key:'latin',text:'',w:0,h:0,mid:0};
    var p_svg = {key:'svg',svg:'',w:0,h:0,mid:0};
    var p_symbol = {key:'symbol',text:'',w:0,h:0,mid:0}
    var p_glue = {key:'glue',w:0};
    var p = null;
