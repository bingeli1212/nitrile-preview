...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_finalize(s,style) {
    ...
    var s_svg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" viewBox="0 0 ${this.fix(vw)} ${this.fix(vh)}" >${text}</svg>`;
    var img = `<object style="${css}" width="${vw}" height="${vh}" data="data:image/svg+xml;charset=UTF-8,${encodeURIComponent(s_svg)}"></object>`;
