...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_finalize(s,style) {
    ...
    if(width && height){
      ...
      var css_width = `width:${width}mm;`;
      var css_height = `height:${this.fix(width/this.viewport_width*this.viewport_height)}mm;`;
    }else{
      var css_width = `width:${this.fix(this.viewport_width*this.viewport_unit)}mm;`;
      var css_height = `height:${this.fix(this.viewport_height*this.viewport_unit)}mm;`;
    }
    var css = '';
