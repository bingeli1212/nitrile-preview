  ...
  p_label(x,y,txt,ta,g) {
    ...
    if (this.g_to_math_int(g)) {
      ...
      if(this.has_texts(g)){
        ...
        d.push(`<text transform='translate(${x} ${y}) rotate(${-rotate}) scale(${factor})' font-family='${fontfamily}' font-style='${fontstyle}' font-size='${this.tokenizer.fs}pt' text-anchor='${anchor}' ${this.g_to_svg_textdraw_str(g)} dx='${text_dx_pt}pt' dy='${text_dy_pt}pt'>${txt}</text>`);
      }
    }
    return d.join('\n');
  }
