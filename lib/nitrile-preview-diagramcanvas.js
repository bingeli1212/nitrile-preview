...
class NitrilePreviewDiagramCanvas extends NitrilePreviewDiagram {
  ...
  to_canvas(style,ss) {
    ...
    */
    var img = `<canvas data-type='ball' width='${viewport_width*viewport_unit*MM_TO_PX}' height='${viewport_height*viewport_unit*MM_TO_PX}' style='${css}' json='${json}'></canvas>`;
    var subc = '';
    var o = [];
    o.push({img,subc,w});
    return o;
