...
`;
  ...
  to_setup_script(){
    ...
    function board_getstroke(ctx,canvas){
      return (ctx.note.action%2)?all_big_stroke:all_sml_stroke;
    }
    function board_getcolor(ctx,canvas){
    ...
    function board_draw_pencil(ctx,canvas,first){
      ...
      let posx2 = ctx.posx2;
      let posy2 = ctx.posy2;
      ctx.lineWidth = board_getstroke(ctx,canvas);
      ctx.strokeStyle = board_getcolor(ctx,canvas);           
      ctx.beginPath();
    ...
    function board_draw_smudge(ctx,canvas){
      ...
      let x2 = ctx.posx2;
      let y2 = ctx.posy2;
      let mystroke = board_getstroke(ctx,canvas);
      let mycolor = board_getcolor(ctx,canvas);        
    ...
    function note_changecolor(v,ctx,canvas){
      ...
      let n = ctx.note.myundo.length;
      let o = ctx.note.myundo[n-1];
      o.myfig.mycolor = board_getcolor(ctx,canvas);
    }
...
//console.log('val_real=',val_real,'val_imag=',val_imag,'which=',which);
      ...
      ctx.strokeStyle = board_getcolor(ctx,canvas);        
      ctx.fillStyle = board_getcolor(ctx,canvas);        
...
//console.log('x-intercept','y0=',y0,'yi=',yi,'x0=',x0,'xii=',xii,'sign0=',sign0,'sign=',sign);
    ...
    function ball_changecolor(v,ctx,canvas){
      ctx.note.mycolorid = v;
      if(ctx.note.hit_ball){
        ctx.note.hit_ball.color = board_getcolor(ctx,canvas);
      }
    }
