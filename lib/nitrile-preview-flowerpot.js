  ...
  to_tool_contents(boardid){
    return `\
         ...
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:374px;height:34px;z-index:10;' >
           ...
           <button class='ONE CL C0'                   name='${boardid}'  data='0'         onclick="board_oneclclicked(this.name,this)" > &#x2B24;                   </button>         
           ...
           <button class='ONE ST'                      name='${boardid}'  data='1'         onclick="board_onestclicked(this.name,this)" > ${all_st_icons[1        ]} </button>
           <button class='ONE ST'                      name='${boardid}'  data='2'         onclick="board_onestclicked(this.name,this)" > ${all_st_icons[2        ]} </button>

           <button class='ONE SH'                      name='${boardid}'  data='0'         onclick="board_oneshclicked(this.name,this)" > ${all_sh_icons[0        ]} </button>
           ...
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='fopen'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["fopen"  ]} </button>  
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='dload'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["dload"  ]} </button>         
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='uload'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["uload"  ]} </button>  
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='acton'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["acton"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='clear'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["clear"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='cropp'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["cropp"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='cutbd'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["cutbd"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='paste'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["paste"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='darkb'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["darkb"  ]} </button> 
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='zoomo'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["zoomo"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='zoomi'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["zoomi"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='rotcl'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["rotcl"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='rotcr'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["rotcr"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='flipv'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["flipv"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='fliph'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["fliph"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='fg2bg'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["fg2bg"  ]} </button>       
           <button class='ONE AT' disabled='disabled'  name='${boardid}'  data='bg2fg'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["bg2fg"  ]} </button>       
       </div>
