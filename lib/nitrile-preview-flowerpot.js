...
`;
  ...
  to_setup_script(){
    ...
    function board_setup_canvas(canvas){
      ...
      ctx.d.myundo.push({s});
      ctx.d.myselect = s;
      ctx.d.mybasis = {x:0,y:0,w:0,h:0,dx:0,dy:0,s:null};
    }
    ...
    function board_start(ctx,canvas){
      if(ctx.d.mymouseisdown){
        ...
        if(ctx.d.myop=='move' || ctx.d.myop=='copy'){
          if(board_inside_selection(ctx,canvas)){
            ///MOVE/COPY
            ctx.d.mybasis.s = ctx.d.myselect;
            ctx.d.mybasis.ismove = 1;
            ctx.d.mybasis.iscopy = (ctx.d.myop=='copy');
          }else{
            ///HILITE-ONLY
            ctx.d.mybasis.s = ctx.d.myselect;
            ctx.d.mybasis.ismove = 0;
          ...
          ctx.d.mycircle = {cx,cy,rx:0,ry:0,mystroke,mycolor};
          ...
          let x = ctx.d.myposx0;
          let y = ctx.d.myposy0;
          ctx.d.myrect = {x,y,w:0,h:0,mystroke,mycolor};
    ...
    function board_inside_selection(ctx,canvas){     
