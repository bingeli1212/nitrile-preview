...
console.log('x-intercept','y0=',y0,'yi=',yi,'x0=',x0,'xii=',xii,'sign0=',sign0,'sign=',sign);
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.myop=='pencil'){ //board_start      
        ...
        o.myfig.sh = ctx.mysh;
        if(o.myfig.altKey){
          ///if alt is pressed down, then we need to make permanent the shape
...
console.log('o.myfig.sh=',o.myfig.sh,'altKey=',o.myfig.altKey);
      if(o.myop=='pencil' && o.myfig.sh=='circle' && o.myfig.altKey){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='hexagon' && o.myfig.altKey){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='pentagon' && o.myfig.altKey){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='rect' && o.myfig.altKey){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='tri' && o.myfig.altKey){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='line' && o.myfig.altKey){//board_drag
        //DRAG  
        let x1 = ctx.posx0;
        let y1 = ctx.posy0;
        let x2 = ctx.posx2;
      ...
      if(o.myop=='pencil' && !o.myfig.altKey){//board_drag
