    ...
    function board_setup_canvas(canvas){
      ...
      if(1){
        ...
        if(1){
          ...
          points.push({op:'z'});
          let ball = {points,transform,corner,translate_x,translate_y};
...
//console.log('x-intercept','y0=',y0,'yi=',yi,'x0=',x0,'xii=',xii,'sign0=',sign0,'sign=',sign);
    ...
    function ball_start(ctx,canvas){
      ...
      if(hitball){
        console.log('ball_start','hitball=',hitball,'corner=',hitball.corner);
      }
      ///check for switching to a new ball
      if(ctx.shiftKey && hitball && hitball.corner>=0){
        ///SETUP rotate flag
        ctx.note.rotate_ang = 0;
        ctx.note.rotateflag = 1;
      } else if(ctx.shiftKey && hitball && (hitball.corner<0)){
        ///SETUP move flag
        ctx.note.translate_x = 0;
        ctx.note.translate_y = 0;
        ctx.note.moveflag = 1;
        ...
        console.log('corner=',hitball.corner);
      } else {
    ...
    function ball_drag(ctx,canvas){
      if(ctx.note.rotateflag){
        ...
        let [x,y] = ball_getcornerxy(ctx.note.hitball);
