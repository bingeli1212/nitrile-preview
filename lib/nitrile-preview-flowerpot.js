  ...
  to_edit_contents(boardid,buttonopid,buttonshid,buttonclid,buttonckid){
    return `\
       ...
       <div style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECK' name='${boardid}'  data-ck='0'  onclick="board_oncakeidchanged(this.name,0)">0</button>
             <button class='ONECK' name='${boardid}'  data-ck='1'  onclick="board_oncakeidchanged(this.name,1)">1</button>
             <button class='ONECK' name='${boardid}'  data-ck='2'  onclick="board_oncakeidchanged(this.name,2)">2</button>
             <button class='ONECK' name='${boardid}'  data-ck='3'  onclick="board_oncakeidchanged(this.name,3)">3</button>
           </div>
         </div>
       </div>
