...
`;
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','eraser':'&#x2B1A;','smudge':'&#x25A8;','select':'&#x26F6;','cplane':'&#x1D456;','ball':'&#x26CB;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;','fopen':'&#x1F4C2;','dload':'&#x2728;'};
...
console.log('o.myball.hitball',o.myball.hitball);
console.log('here1');
          //delete hit ball
          if(o.myball.hitball){
            //del this ball
        ...
        }else if(ctx.altKey && !o.myball.hitball){
console.log('here2');
          //create a new ball                                     
          var v = ctx.cake.mysh;
          var x = ctx.posx0; 
...
console.log('here3');
          ...
          ctx.restore();
console.log('board_start','corner_i',o.myball.hitball.corner_i,o.myball.hitball.corner_t);
        } 
        board_redraw(ctx,canvas);
      }
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){ //board_drag
        if(o.myball.hitball && !o.myball.isnewlyball && !o.myball.isnewlycorner){
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){ //board_end
        if(o.myball.hitball && o.myball.hitball.corner_t > 0){
console.log('board_end here1');
        }else if(ctx.mouseisdragged){
console.log('board_end here2');
        }else{
console.log('board_end here3');
