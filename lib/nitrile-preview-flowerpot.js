...
`;
  ...
  to_tool_contents(boardid){
    return `\
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:323px;height:34px;z-index:10;' >
...
*/
    ...
    function board_enter(ctx,canvas){
      var o = ctx.cake;          
console.log('board_enter',o.myop);
      o.myaction   = 0;
      o.myrotation = 0;
      o.myflipv    = 0;
      o.myfliph    = 0;
