...
`;
  ...
  to_edit_contents(boardid,buttonopid,buttonshid,buttonclid){
    return `\
       ...
       <button name='${boardid}' id=''            class="BUTTON" role="button" onclick='board_oncakeclicked(0,this.name)' >1</button>
       <button name='${boardid}' id=''            class="BUTTON" role="button" onclick='board_oncakeclicked(1,this.name)' >2</button>
       <button name='${boardid}' id=''            class="BUTTON" role="button" onclick='board_oncakeclicked(2,this.name)' >3</button>
       <button name='${boardid}' id=''            class="BUTTON" role="button" onclick='board_oncakeclicked(3,this.name)' >4</button>
