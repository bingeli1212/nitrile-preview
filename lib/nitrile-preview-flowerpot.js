...
`;
    ...
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <button class='ONEOP'          name='1-${boardid}'  data-op='line'                   onclick="board_oneopclicked(this.name,'line'    ,this)" />
       ...
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <button class='ONEOP'          name='2-${boardid}'  data-op='line'                   onclick="board_oneopclicked(this.name,'line'    ,this)" />
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','line':'&#x269E;','eraser':'&#x2B1A;','smudge':'&#x25A8;','select':'&#x26F6;','cplane':'x&#x1D456;','ball':'&#x26CB;','xyplane':'xy','hand':'&#x270B;','fopen':'&#x1F4C2;','dload':'&#x2728;'};
...
//console.log('board_redraw','op=',ctx.cake.myop,'id=',canvas.id);
      ...
      if(ctx.cake.myop=='line'){ //board_redraw
      }
...
//console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
      ...
      if(ctx.cake.myop=='line'){ //board_start
        o.myfig.x = ctx.posx0;
        o.myfig.y = ctx.posy0;
        o.myfig.w = 0;
        o.myfig.h = 0;
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='line'){ //board_drag
        //DRAG  
        let x1 = ctx.posx0;
        let y1 = ctx.posy0;
        let x2 = ctx.posx2;
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.cake.myop=='line'){ //board_end
      }
