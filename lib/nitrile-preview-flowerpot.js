    ...
    function board_paste(ctx,canvas){
      ...
      if(o.myop=='square'){
        if(o.mysquare.clipshape){
          ...
          Object.assign(o.mysquare, o.mysquare.clipshape);    
        }
      }
      if(o.myop=='ball'){
        ctx.resetTransform();
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.cake.myop=='square'){    //board_start square
        ...
        if(altKey && shiftKey){
          ...
          o.mysquare.istodo = 'move';
        }else if(o.mysquare.w && o.mysquare.h){
          //do nothing, just keep the existing shape
        }else{
          //create a new sketch
          o.mysquare.skewX = 0;
          o.mysquare.skewY = 0;
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='square'){   //board_drag square
        ...
        if(istodo=='move'){
          ...
          o.mysquare.x = o.mysquare.x0 + dx;
          o.mysquare.y = o.mysquare.y0 + dy;
        }else if(istodo=='size'){
          let dx = ctx.posx2 - ctx.posx0;
          let dy = ctx.posy2 - ctx.posy0;
          if(ctx.shiftKey){
