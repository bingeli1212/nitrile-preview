...
console.log('board_onsubmitclicked',name,e);
    ...
    function board_leave(ctx,canvas){
      ...
      || o.myop=='ellipse' ){ //board_leave
        if(o.mysquare.face){
          ...
          o.mysquare.face = null;
          board_addpolypt_square(o.mysquare, o.mypoly,ctx,canvas);
        }
        if(o.mysquare.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
    ...
    function board_redraw(ctx,canvas){
      ...
      if(ctx.cake.myop=='square'){    //board_redraw square
        ...
        if(o.mysquare.w && o.mysquare.h){
          ...
          ctx.save();
          ///
          let path2d = square_get_path2d(o.mysquare);
          let corners = square_get_corners(o.mysquare);
          let center_p = square_get_center_p(o.mysquare);
          ///transform
    ...
    function board_addpolypt_square(squa, mypoly, ctx,canvas){
      let corners = square_get_corners(squa);
      switch(squa.shape){
        case 0: {
          board_addpolypt_xy([corners[0].x+squa.x,corners[0].y+squa.y], mypoly, ctx,canvas);
          board_addpolypt_xy([corners[1].x+squa.x,corners[1].y+squa.y], mypoly, ctx,canvas);
          board_addpolypt_xy([corners[2].x+squa.x,corners[2].y+squa.y], mypoly, ctx,canvas);
          board_addpolypt_xy([corners[3].x+squa.x,corners[3].y+squa.y], mypoly, ctx,canvas);
          break;
        }
        case 1: {
          board_addpolypt_xy([corners[0].x+squa.x,corners[0].y+squa.y], mypoly, ctx,canvas);
...
console.log('skewX');
    ...
    ///////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////
    function square_get_path2d(squa){
      let path2d = new Path2D();
      switch(squa.shape){
        case 0: {
          path2d.moveTo(0,                  0);
    ...
    function square_get_corners(squa){
      let {w,h} = squa;
      var corners = [];
      switch(squa.shape){
        case 0: {
    ...
    function square_get_center_p(squa){
      let {w,h} = squa;
      let p1 = {x:0,                      y:0};
