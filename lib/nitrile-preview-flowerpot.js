...
//console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
      ...
      if(ctx.cake.myop=='ball'){ //board_start
        ...
        if(ctx.shiftKey && ctx.altKey){
          ...
          //resizing or rotating existing ball
        }else if(ctx.altKey && !o.myball.hitball){
          //create a new ball                                     
          var v = ctx.cake.mysh;
          var x = ctx.posx0; 
            ...
            o.myball.hitball.points.forEach((pt,i) => {
              ...
              if(ctx.isPointInStroke(path2d, ctx.posx0,ctx.posy0)){
                if(o.myball.hitball.corner_i == i){
                  o.myball.hitball.corner_t = (o.myball.hitball.corner_t + 1) % 2;
                }else{
        ...
        if(o.myball.hitball && !o.myball.isnewlyball && !o.myball.isnewlycorner){
          if(ctx.altKey){                 
            if(o.myball.hitball.corner_i == 0) {
              if(o.myball.hitball.corner_t == 1){
            ...
            }else if(o.myball.hitball.corner_i > 0) {
              //scaleY
              let dx = ctx.posx2 - ctx.posx1;
              if(o.myball.hitball.corner_t == 1){
                if(dx >= 1){ //expand
