    ...
    function board_start(ctx,canvas){
      if(ctx.d.myop=='object' && ctx.d.myobject){
        ...
        if(myarg=='circle'){
          ...
          ctx.restore();
          if(ctx.d.myobject.hit1 || ctx.d.myobject.hit2 || ctx.d.myobject.hit3 || ctx.d.myobject.hit4){
            //OK
          }else{
            ctx.d.myobject = null;
          }
        ...
        if(myarg=='tri'){
          let {x1,y1,x2,y2,x3,y3,tr} = ctx.d.myobject;
          ///TRANSFORM
          ctx.save();
          ctx.setTransform(...tr);
          ctx.beginPath();
          ...
          ctx.d.myobject.hit3 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
          ctx.restore();
          if(ctx.d.myobject.hit1 || ctx.d.myobject.hit2 || ctx.d.myobject.hit3){
            //OK
          }else{
            ctx.d.myobject = null;
          }
        ...
        for(let o of ctx.d.myundo){
          ...
          if(myop=='shape' && myarg=='circle'){
            ...
            if(hit){
              ...
              mybasis = {...mybasis};
              s = ctx.d.myface;
              ctx.d.myobject = {s,mybasis,myop,myarg,myfig,hit1:1,hit2:0,hit3:0,hit4:0,x1,y1,x2,y2,x3,y3,x4,y4,tr:[a,b,c,d,e,f]};
              break;
            }
          }
          if(myop=='shape' && myarg=='rect'){
            ...
            if(hit){
              ...
              mybasis = {...mybasis};
              s = ctx.d.myface;
              ctx.d.myobject = {s,mybasis,myop,myarg,myfig,hit1:1,hit2:0,hit3:0,x1,y1,x2,y2,x3,y3,x4,y4,tr:[a,b,c,d,e,f]};
              break;
            }
          }
          if(myop=='shape' && myarg=='tri'){
            ...
            if(hit){
              ...
              mybasis = {...mybasis};
              s = ctx.d.myface;
              ctx.d.myobject = {s,mybasis,myop,myarg,myfig,hit1:1,hit2:0,hit3:0,hit4:0,x1,y1,x2,y2,x3,y3,tr:[a,b,c,d,e,f]};
              break;
            }
          }
          if(myop=='shape' && myarg=='line'){
            ...
            ctx.moveTo(x1,y1);
            ctx.lineTo(x2,y2);
            let hit = ctx.isPointInStroke(ctx.d.myposx0,ctx.d.myposy0);
            let m = ctx.getTransform();
            let a = m.a;
            let b = m.b;
            let c = m.c;
            ...
            if(hit){
              ...
              mybasis = {...mybasis};
              s = ctx.d.myface;
              ctx.d.myobject = {s,mybasis,myop,myarg,myfig,hit1:1,hit2:0,hit3:0,hit4:0,x1,y1,x2,y2,tr:[a,b,c,d,e,f]};
              break;
            }
          }
        }
