  ...
  to_setup_script(){
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.cake.myop=='select'){ //board_start select
        ...
        let py = ctx.posy0;
        let {x,y,w,h} = o.mybasis;
        o.mybasis.inside = IsPointInRect(px,py, x,y,w,h);
        let {altKey,shiftKey,inside} = o.mybasis;
        if(altKey && shiftKey){
          if(o.mybasis.face){
            o.mybasis.s = o.mybasis.face;
          }
...
console.log('board_drag',isnewlycorner,istomove,corner_i);
