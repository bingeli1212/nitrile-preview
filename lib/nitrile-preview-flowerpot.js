...
class NitrilePreviewFlowerpot extends NitrilePreviewSlide {
  ...
  to_document() {
    ...
    :root {
      ...
      --onedot: url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxMDAgMTAwIj4NCiAgPGNpcmNsZSBjeD0iODAiIGN5PSIyMCIgcj0iMTAiLz4gDQo8L3N2Zz4NCg==");
    }
    :root {
${allsidesvgs.join('\n')}
    }
...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    let edit_contents = this.to_edit_contents(boardid,buttonopid,buttonclid);
    ...
    all.push(`</div>`);
    all.push(`<canvas class='EDITBOARD' id='${boardid}' data-type='board' data-imgid='${imgid}' data-boardname='${boardname}' data-frameid='${frameid}' data-buttonopid='${buttonopid}' data-buttonclid='${buttonclid}' width='441' height='320' ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
  ...
  to_edit_contents(boardid,buttonopid,buttonclid){
    return `\
       ...
       <div style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONEOP' data-boardid='${boardid}' data-op='pencil' data-arg='pencil'   onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='shape'  data-arg='line'     onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='shape'  data-arg='tri'      onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='shape'  data-arg='rect'     onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='shape'  data-arg='pentagon' onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='shape'  data-arg='hexagon'  onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='shape'  data-arg='circle'   onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='select' data-arg='select'   onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='smudge' data-arg='smudge'   onclick="board_oneopclicked(this)"></button>
             <button class='ONEOP' data-boardid='${boardid}' data-op='eraser' data-arg='eraser'   onclick="board_oneopclicked(this)"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL' data-boardid='${boardid}' data-colorid='0' onclick="board_onecolorclicked(this)"></button>
             <button class='ONECL' data-boardid='${boardid}' data-colorid='1' onclick="board_onecolorclicked(this)"></button>
             <button class='ONECL' data-boardid='${boardid}' data-colorid='2' onclick="board_onecolorclicked(this)"></button>
             <button class='ONECL' data-boardid='${boardid}' data-colorid='3' onclick="board_onecolorclicked(this)"></button>
             <button class='ONECL' data-boardid='${boardid}' data-colorid='4' onclick="board_onecolorclicked(this)"></button>
             <button class='ONECL' data-boardid='${boardid}' data-colorid='5' onclick="board_onecolorclicked(this)"></button>
             <button class='ONECL' data-boardid='${boardid}' data-colorid='6' onclick="board_onecolorclicked(this)"></button>
             <button class='ONEST' data-boardid='${boardid}'                  onclick="board_onestrokeclicked(this)"></button>
           </div>
         </div>
       </div>
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_icons = {'pencil':'&#x270E;','line':'&#x2216;','tri':'&#x25B3;','rect':'&#x25AD;','pentagon':'&#x2B20;','hexagon':'&#x2B21;','circle':'&#x2B2D;','select':'&#x2B1A;','smudge':'&#x271C;','eraser':'&#x232B;'};
    ...
    function setup(){
      ...
      for(var i=0; i < select.length; i++){
        ...
        if(op=='pencil'){
          var icon = all_icons[op];
        }else{
          var icon = all_icons[arg];
        }
      ...
      for(var i=0; i < select.length; i++){
        var button = select[i];
        var colorid = button.getAttribute('data-colorid');
        var colorid = parseInt(colorid);
        var color = all_colors[colorid];
        button.style.backgroundColor = color;
      }
    }
    function board_oneopclicked(btn){
      var op = btn.getAttribute('data-op'); 
      var arg = btn.getAttribute('data-arg'); 
      var canvas = document.getElementById(btn.getAttribute('data-boardid')); 
      var ctx = canvas.getContext('2d');
      if(op=='shape'){
        board_shape(arg,ctx,canvas);                   
      }else if(op=='select'){
    ...
    function board_onecolorclicked(btn){
      var colorid = btn.getAttribute('data-colorid'); 
      var canvas = document.getElementById(btn.getAttribute('data-boardid')); 
      var ctx = canvas.getContext('2d');
      board_setcolorid(parseInt(colorid),ctx,canvas);
    }
    function board_onestrokeclicked(btn){
      var canvas = document.getElementById(btn.getAttribute('data-boardid')); 
      var ctx = canvas.getContext('2d');
	...
	var mode = ctx.mode;
        ctx.note.myundo.push({s,mybasis,myop,myarg,myfig,mode});
        ///MISC
        ctx.note.zoom = 1;
        ctx.note.grid = 30;
    ...
    function board_setstrokeid(v,ctx,canvas){
      ...
      if(1){
        ...
        if(v==0){
          ...
          button_elem.style.backgroundImage = "";
        }else{
          //button_elem.innerHTML = "&#x2716;";
          button_elem.style.backgroundImage = "var(--onedot)";
        }
      }
    }
...
console.log('note_start','mode=',ctx.mode,'all_op=',ctx.note.all_op,'all_arg=',ctx.note.all_arg);
      if(ctx.note.all_op=='shape'){ //note_start
...
console.log('note_drag','mode=',ctx.mode,'all_op=',ctx.note.all_op,'all_arg=',ctx.note.all_arg);
      ...
      if(ctx.note.all_op=='shape' && ctx.note.all_arg=='hexagon' && ctx.note.myfig){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.all_op=='shape' && ctx.note.all_arg=='pentagon' && ctx.note.myfig){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
...
console.log('note_end','mode=',ctx.mode,'all_op=',ctx.note.all_op,'all_arg=',ctx.note.all_arg);
...
console.log('note_redraw');
      ...
      if(o.mode=='note' && o.myop=='shape' && o.myarg=='circle'){
        //REDRAW
        let myfig = o.myfig;
      ...
      if(o.mode=='note' && o.myop=='shape' && o.myarg=='hexagon'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.mystroke;
        ctx.strokeStyle = myfig.mycolor;
      ...
      if(o.mode=='note' && o.myop=='shape' && o.myarg=='pentagon'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.mystroke;
        ctx.strokeStyle = myfig.mycolor;
      ...
      if(o.mode=='note' && o.myop=='shape' && o.myarg=='rect'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.mystroke;
        ctx.strokeStyle = myfig.mycolor;
      ...
      if(o.mode=='note' && o.myop=='shape' && o.myarg=='tri'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.mystroke;
        ctx.strokeStyle = myfig.mycolor;
      ...
      if(o.mode=='note' && o.myop=='shape' && o.myarg=='line'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.mystroke;
        ctx.strokeStyle = myfig.mycolor;
