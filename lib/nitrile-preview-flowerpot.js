  ...
  to_tool_contents(boardid){
    return `\
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:136px;z-index:10;' >
             ...
             <button class='ONECL DOT'      name='${boardid}'  data-cl='0'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='1'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='2'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='3'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='4'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='5'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='6'                      onclick="board_oneclclicked(this.name,this)" />         

             <button class='ONEST'          name='${boardid}'  data-st='0'                      onclick="board_one_stclicked(this.name,this)" />        
             <button class='ONEST DOT'      name='${boardid}'  data-st='1'                      onclick="board_one_stclicked(this.name,this)" />        
             <button class='ONEST'          name='${boardid}'  data-st='2'                      onclick="board_one_stclicked(this.name,this)" />        
...
*/
    ...
    function board_oneclclicked(name,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      ctx.cake.mycolorid = e.getAttribute('data-cl');
    ...
    function board_one_stclicked(name,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      ctx.cake.mystrokeid = e.getAttribute('data-st');
