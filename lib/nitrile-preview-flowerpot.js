...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`<article class='SLIDE' id='${frameid}' row='${frame.style.row}' style='--boardimg:url("");background-image:var(--boardimg),var(--logosvg),var(--bgsvg);background-repeat:no-repeat;background-position:88px 40px,top left,top left;background-size:441px 320px,88px 40px,cover;' >`);
    pages.push(1);
    ...
    all.push(`<canvas class='EDITBOARD' id='${boardid}' data-type='board' data-imgid='${imgid}' data-boardname='${boardname}' data-frameid='${frameid}' width='441' height='320' tabindex='1' onkeypress='canvas_keypress()' ></canvas>`);
  ...
  to_setup_script(){
    ...
    function board_start(ctx,canvas){
      if(ctx.d.myop=='object'){
        ///OBJECT           
        if(ctx.d.myobject){
          ///check for hit on one of the handles 
          ...
          if(myarg=='rect'){
            ...
            ctx.d.myobject.myhit1 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
console.log('hit1',ctx.d.myobject.myhit1);
            ctx.beginPath();
            ctx.rect(x2-3,y2-3,6,6);
            ctx.d.myobject.myhit2 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
console.log('hit2',ctx.d.myobject.myhit2);
            ctx.beginPath();
            ctx.rect(x3-3,y3-3,6,6);
            ctx.d.myobject.myhit3 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
console.log('hit3',ctx.d.myobject.myhit3);
            ctx.beginPath();
            ctx.rect(x4-3,y4-3,6,6);
            ctx.d.myobject.myhit4 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
console.log('hit4',ctx.d.myobject.myhit4);
            ctx.translate(-myfig.x,-myfig.y);
            ctx.restore();
            if(ctx.d.myobject.myhit1 || ctx.d.myobject.myhit2 || ctx.d.myobject.myhit3 || ctx.d.myobject.myhit4){
              //OK
            }else{
              ctx.d.myobject = null;
            }
          ...
          if(myarg=='tri'){
            ...
            ctx.rect(x1-3,y1-3,6,6);
            ctx.translate(-myfig.x,-myfig.y);
            let hit1 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
            ctx.translate(myfig.x,myfig.y);
            ctx.translate(myfig.w/2,0);
            ctx.rotate(myfig.rotate/180*Math.PI);
            ctx.translate(-myfig.w/2,0);
            ...
            ctx.rect(x2-3,y2-3,6,6);
            ctx.translate(-myfig.x,-myfig.y);
            let hit2 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
            ctx.translate(myfig.x,myfig.y);
            ctx.translate(myfig.w/2,0);
            ctx.rotate(myfig.rotate/180*Math.PI);
            ctx.translate(-myfig.w/2,0);
            ...
            ctx.rect(x3-3,y3-3,6,6);
            ctx.translate(-myfig.x,-myfig.y);
            let hit3 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
            ctx.restore();
            ctx.d.myobject.myhit1 = hit1;
            ctx.d.myobject.myhit2 = hit2;
            ctx.d.myobject.myhit3 = hit3;
            ctx.d.myobject.myhit4 = 0;
            if(hit1 || hit2 || hit3){
              //OK
            }else{
              ctx.d.myobject = null;
          ...
          ctx.d.myobject = null;
          for(let p of ctx.d.myundo){
            let {s,mybasis,myop,myarg,myfig} = p;
            if(myop=='shape' && myarg=='rect'){
              ...
              ctx.closePath();
              ctx.translate(-myfig.x,-myfig.y);
              let hit = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
              ctx.restore();
              if(hit){
                myfig = {...myfig};
                myop = 'object';
                mybasis = {...mybasis};
                s = ctx.d.myface;
                ctx.d.myobject = {s,mybasis,myop,myarg,myfig,myhit1:1,myhit2:0,myhit3:0,myhit4:0,myrot:0};
                break;
              }
            }
    ...
    function board_redraw(o,ctx,canvas){
      ...
      if(o.myop=='object' && o.myarg=='rect'){
        ///REDRAW 
        let {myfig,myhit1,myhit2,myhit3,myhit4,myrot} = ctx.d.myobject;
        let w = myfig.w;
        let h = myfig.h;
        let x1 = 0;
        let y1 = 0; 
        ...
        if(myrot && myhit1){
          ...
          ctx.translate(-x1,-y1);
        }else if(myrot && myhit2){
          ctx.translate(x2,y2);
          ctx.rotate(myrot/180*Math.PI);
          ctx.translate(-x2,-y2);
        }else if(myrot && myhit3){
          ctx.translate(x3,y3);
          ctx.rotate(myrot/180*Math.PI);
          ctx.translate(-x3,-y3);
        }else if(myrot && myhit4){
          ctx.translate(x4,y4);
          ctx.rotate(myrot/180*Math.PI);
          ctx.translate(-x4,-y4);
        }
      ...
      if(o.myop=='object' && o.myarg=='tri'){
        ///REDRAW 
        let {myfig,myhit1,myhit2,myhit3,myhit4} = ctx.d.myobject;
        let w = myfig.w;
        let h = myfig.h;
        let x1 = w/2;
        let y1 = 0; 
