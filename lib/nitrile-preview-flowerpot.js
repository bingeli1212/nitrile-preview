...
console.log('board_redraw',o.myop);
      ...
      if(o.myop=='pencil' && o.myfig.sh=='circle'){
        //REDRAW
        let myfig = o.myfig;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='hexagon'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='pentagon'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='rect'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='tri'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.myop=='pencil' && o.myfig.sh=='line'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
...
console.log('REDRAW ball');
    ...
    function board_add(ctx,canvas){
      var n = ctx.myundo.length;
      var o = ctx.myundo[n-1];
console.log('board_add','all_op=',o.myop);
      if(o.myop=='ball'){   
        //////////////////////////////////////////////////////////////////
        ...
        if(o.hit_ball){
          o.hit_ball.points = points;//{points,transform,corner_i,pivot_x,pivot_y,color};
          o.hit_ball.corner_i = 0;
        }else{
...
console.log('note_start',ctx.myop);
...
console.log('note_start',ctx.myop);
      if(ctx.myop=='cplane'){ //note_start
        ...
        o.origin_x = Math.round(canvas.width/2);
        o.origin_y = Math.round(canvas.height/2);
      }
      if(ctx.myop=='ball'){ //note_start
        let o = board_last_cake(ctx,canvas);
        if(o != 'ball'){
          o = board_new_cake(ctx,canvas);
        }
