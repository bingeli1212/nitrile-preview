...
*/
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_drag pencil
        ...
        let {x1,y1,x2,y2,x,y,w,h} = o.mypencil;
        if(o.mywiggleid==0){
          ...
          ctx.lineTo(x2,y2);
          ctx.stroke();
        }else if(o.mywiggleid==2){ // smudge
          if(ctx.altKey){
            let stroke = board_curr_stroke(ctx,canvas);
            let color = board_curr_color(ctx,canvas);        
            let mysmear = all_smears[color];
            let {x,y,w,h} = o.mypencil;
            let limit = 0;
            smudgeRect(x,y,w,h,mysmear,limit,ctx,canvas);
          }else{
            let {posx1,posy1,posx2,posy2} = ctx;
    ...
    function board_end(ctx,canvas){
      ...
      if(o.myop=='pencil'){ //board_end pencil
        if(o.mywiggleid==1){ // poly
          let {x1,y1,x2,y2} = o.mypencil;
