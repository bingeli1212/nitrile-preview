...
`;
       ...
       <div style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
          <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
            <button class='ONEOP' data-boardid='${boardid}' data-op='pencil' data-arg=''         onclick="board_oneopclicked(this)"></button>
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_icons = {'pencil':'&#x270E;','line':'&#x2215;','tri':'&#x25B3;','rect':'&#x25AD;','pentagon':'&#x2B20;','hexagon':'&#x2B21;','circle':'&#x2B2D;'};
...
console.log('board_onshowdropmenu',name);
    ...
    function note_start(ctx,canvas){
      if(ctx.note.action==1){ //note_start
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape'){ //note_start
        board_clear_basis(ctx);
        let mystroke = board_curr_stroke(ctx,canvas);
        let mycolor = board_curr_color(ctx,canvas);        
        let x = ctx.posx0;
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='pencil'){ //note_start
        board_clear_basis(ctx);
        ctx.clearRect(0,0, canvas.getAttribute('width'),canvas.getAttribute('height'));
        ctx.putImageData(ctx.note.myface, 0,0);
        if(ctx.altKey){
    ...
    function note_drag(ctx,canvas){
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape' && ctx.note.all_arg=='circle' && ctx.note.myfig){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape' && ctx.note.all_arg=='hexagon' && ctx.note.myfig){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape' && ctx.note.all_arg=='pentagon' && ctx.note.myfig){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape' && ctx.note.all_arg=='rect' && ctx.note.myfig){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape' && ctx.note.all_arg=='tri' && ctx.note.myfig){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape' && ctx.note.all_arg=='line' && ctx.note.myfig){
        //DRAG  
        let x1 = ctx.posx0;
        let y1 = ctx.posy0;
        let x2 = ctx.posx2;
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='pencil'){
        //DRAG  
        if(ctx.altKey){
    ...
    function note_end(ctx,canvas){
      ...
      if(ctx.note.action==0 && ctx.note.all_op=='shape'){
        //BOARD_END   
        let s        = ctx.note.myface;
        let myfig    = ctx.note.myfig;
        let myop     = ctx.note.all_op;
