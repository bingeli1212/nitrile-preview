...
//console.log('x-intercept','y0=',y0,'yi=',yi,'x0=',x0,'xii=',xii,'sign0=',sign0,'sign=',sign);
    ...
    function ball_start(ctx,canvas){
      ...
      if(!ctx.shiftKey && ctx.note.hitball && ctx.note.hitball.corner_i>=0){
        ///ROTATE  
        ctx.note.rotate_ang = 0;
      } 
      if(!ctx.shiftKey && ctx.note.hitball && (ctx.note.hitball.corner_i<0)){
      ...
      if(ctx.shiftKey && !ctx.note.hitball){
        ///DETERMIND hitball
    ...
    function ball_drag(ctx,canvas){
      if(ctx.note.hitball && ctx.note.hitball.corner_i >= 0){
      ...
      }else if(ctx.note.hitball && ctx.note.hitball.corner_i < 0){
