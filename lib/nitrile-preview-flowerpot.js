  ...
  to_setup_script(){
    ...
    function board_setup_canvas(canvas){
      ...
      if(1){
        ...
        ctx.note.myfig = {x:0,y:0,w:0,h:0,rotate:0,skewX:0,skewY:0,stroke:0,color:'',sh:''};
	...
	var mode = ctx.mode;
        ctx.note.myundo.push({s,mybasis,myop,myfig,mode});
        ///MISC
        ctx.note.zoom = 1;
        ctx.note.grid = 30;
    ...
    function board_setcolorid(v,ctx,canvas){
      ...
      if(1){
        ...
        //button_elem.style.backgroundColor = color;
    ...
    function note_start(ctx,canvas){
      if(ctx.note.all_op=='pencil' && ctx.shiftKey){ //pencil draw shape
        board_clear_basis(ctx);
        let stroke = board_curr_stroke(ctx,canvas);
        let color = board_curr_color(ctx,canvas);        
        let sh = ctx.note.all_sh;
        let x = ctx.posx0;
        let y = ctx.posy0;
        let s = ctx.note.myface;
        ctx.note.myfig = {x,y,w:0,h:0,rotate:0,skewX:0,skewY:0,stroke,color,sh,s};
        ctx.clearRect(0,0, canvas.getAttribute('width'),canvas.getAttribute('height'));
        ctx.putImageData(s, 0,0);
      }
      if(ctx.note.all_op=='pencil' && !ctx.shiftKey){ //pencil free drawing
        board_clear_basis(ctx);
        let stroke = board_curr_stroke(ctx,canvas);
        let color = board_curr_color(ctx,canvas);        
        let sh = "";               
    ...
    function note_drag(ctx,canvas){
      if(ctx.note.all_op=='pencil' && ctx.note.myfig.sh=='circle'){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
        ...
        ctx.lineWidth   = ctx.note.myfig.stroke;         
        ctx.strokeStyle = ctx.note.myfig.color;   
        ///CIRCLE
        let s = ctx.note.myfig.s;
        ctx.clearRect(0,0, canvas.getAttribute('width'),canvas.getAttribute('height'));
        ctx.putImageData(s, 0,0);
        let cx,cy,rx,ry;
        cx = posx0;
      ...
      if(ctx.note.all_op=='pencil' && ctx.note.myfig.sh=='hexagon'){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.all_op=='pencil' && ctx.note.myfig.sh=='pentagon'){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.all_op=='pencil' && ctx.note.myfig.sh=='rect'){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.all_op=='pencil' && ctx.note.myfig.sh=='tri'){
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.note.all_op=='pencil' && ctx.note.myfig.sh=='line'){
        //DRAG  
	if(ctx.shiftKey){
          let x1 = ctx.posx0;
          let y1 = ctx.posy0;
          ...
          if(ctx.altKey && ddx > ddy){
            x2 = ctx.posx2;
            y2 = ctx.posy0;
          }else if(ctx.altKey && ddy > ddx){
            x2 = ctx.posx0;
            y2 = ctx.posy2;
          }
          let w = x2-x1;
      ...
      if(ctx.note.all_op=='pencil' && ctx.note.myfig.sh==''){
    ...
    function note_end(ctx,canvas){
      if(ctx.note.all_op=='pencil'){
        let s        = ctx.note.myfig.s;
        let mode     = ctx.mode;
        if(!ctx.note.myfig.sh){
          s = ctx.getImageData(0,0, canvas.getAttribute('width'),canvas.getAttribute('height'));
        }
        //'pencil with shape'
        ...
        console.log('undo count:',ctx.note.myundo.length);
      } 
      if(ctx.note.all_op=='select'){
    ...
    function note_setcolorid(v,ctx,canvas){
      ...
      //let n = ctx.note.myundo.length;
      //let o = ctx.note.myundo[n-1];
      //o.myfig.color = board_curr_color(ctx,canvas);
    }
    function note_setstrokeid(v,ctx,canvas){
      //let n = ctx.note.myundo.length;
      //let o = ctx.note.myundo[n-1];
      //o.myfig.stroke = board_curr_stroke(ctx,canvas);
    }
    ...
    function note_revundo(ctx,canvas){
      ...
      if(ctx.note.myredo.length>0){
        ...
        ///o.s = ctx.note.myface;//IMPORTANT: always update the base image in case the shape has been resized/shifted/rotated
    ...
    function note_redraw(ctx,canvas){
      ...
      if(o.mode=='note' && o.myop=='pencil' && o.myfig.sh=='circle'){
        //REDRAW
        let myfig = o.myfig;
      ...
      if(o.mode=='note' && o.myop=='pencil' && o.myfig.sh=='hexagon'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.mode=='note' && o.myop=='pencil' && o.myfig.sh=='pentagon'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.mode=='note' && o.myop=='pencil' && o.myfig.sh=='rect'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.mode=='note' && o.myop=='pencil' && o.myfig.sh=='tri'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
      ...
      if(o.mode=='note' && o.myop=='pencil' && o.myfig.sh=='line'){
        //REDRAW
        let myfig = o.myfig;
        ctx.lineWidth = myfig.stroke;
        ctx.strokeStyle = myfig.color;
