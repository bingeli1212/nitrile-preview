...
`;
  ...
  to_tool_contents(boardid){
    return `\
         <div id='tool-1-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:136px;z-index:10;' >
             ...
             <button class='ONEAT'          name='1-${boardid}'  data-at='darkb'                  onclick="board_one_atclicked(this.name,this)" />
  ...
  to_setup_script(){
    ...
    all_st_icons = ['&#x2758;','&#x2759;','&#x275A;'];
    all_at_icons = {'clear':'&#x2B1A;','cropp':'&#x26CB;','fopen':'&#x1F4C2;','dload':'&#x2728;','zoomo':'&#x2315;-','zoomi':'&#x2315;+','rotcl':'&#x2B6F;','rotcr':'&#x2B6E;','acton':'&#x2318;','cutbd':'&#x2702;','paste':'&#x26E8;','rsize':'&#x26DE;','echos':'&#x2BB8;','darkb':'&#x2B13;'};
