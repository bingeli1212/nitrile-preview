...
console.log('board_start',ctx.d.myop,ctx.d.myarg);
      if(ctx.d.myop=='object'){
        ///OBJECT           
        if(ctx.d.myobject){
          ...
          if(myarg=='rect'){
            ...
            ctx.translate(-myfig.x,-myfig.y);
            let hit4 = ctx.isPointInPath(ctx.d.myposx0,ctx.d.myposy0);
            ctx.restore();
            ctx.d.hit1 = hit1;
            ctx.d.hit2 = hit2;
            ctx.d.hit3 = hit3;
          ...
          for(let p of ctx.d.myundo){
            ...
            if(myop=='shape' && myarg=='rect'){
              ...
              if(hit){
                ...
                mybasis = {...mybasis};
                s = ctx.d.myface;
                ctx.d.myobject = {s,mybasis,myop,myarg,myfig};
                break;
              }
            }
...
console.log('here james',ctx.d.myop,ctx.d.myarg);
        //START
        board_reset_basis(ctx);
        let mystroke = ctx.d.mystroke;
        let mycolor  = ctx.d.mycolor;
...
console.log('board_move',ctx.d.myop,ctx.d.myarg);
      if(ctx.d.myop=='select'){
        //MOVE  
        if(ctx.d.mybasis.a){
...
console.log('board_end',ctx.d.myop,ctx.d.myarg);
      if(ctx.d.myop=='object'){
        if(ctx.d.myobject){
        ...
        if(s && myfig && myop && myarg && (myfig.w || myfig.h)){
          ...
          ctx.d.myredo = [];
          ctx.d.myface = ctx.getImageData(0,0, 441,320);
console.log('saved',ctx.d.myundo[ctx.d.myundo.length-1]);
        }
      }
      else {
...
console.log('board_redraw',o.myop,o.myarg);
      ctx.clearRect(0,0,441,320);
      if(o.s){
