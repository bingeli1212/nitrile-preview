    ...
    function board_start(ctx,canvas){
      if(ctx.d.mymouseisdown){
        if(ctx.d.myop=='basis'){
          ...
          let dy = 0;
          let dd = 0;
          let imagedata = ctx.d.myselect;
          ctx.d.mymove = {dx,dy,dd,imagedata};
    ...
    function board_move(ctx,canvas){
      if(ctx.d.myop=='basis'){
        ...
        if(ctx.d.mybasis && ctx.d.mymove){
          ...
          mymove.imagedata = ctx.getImageData(0,0, 441,320);
          ///draw hilite
          ctx.save();
          ctx.globalCompositeOperation = 'xor';
    ...
    function board_end(ctx,canvas){
      if(ctx.d.myop=='basis'){
        ...
        if(ctx.d.mybasis && ctx.d.mymove){
          ...
          let s        = ctx.d.myselect;
          let myop     = ctx.d.myop;
          if(s && mybasis && mymove && myop && (mybasis.w&&mybasis.h) && (mymove.dx||mymove.dy)){
            ctx.d.mysave.push({s,myop,mybasis,mymove});
            ctx.d.myredo = [];
            var n = ctx.d.mysave.length;
            var o = ctx.d.mysave[n-1];
            ctx.d.myselect = mymove.imagedata;
