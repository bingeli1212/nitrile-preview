...
console.log('hit1',ctx.d.myobject.hit1);
console.log('hit2',ctx.d.myobject.hit2);
console.log('hit3',ctx.d.myobject.hit3);
console.log('hit4',ctx.d.myobject.hit4);
              //OK
            }else{
              ctx.d.myobject = null;
            }
          ...
          for(let p of ctx.d.myundo){
            ...
            if(myop=='shape' && myarg=='tri'){
              ...
              if(hit){
                ...
                mybasis = {...mybasis};
                s = ctx.d.myface;
                ctx.d.myobject = {s,mybasis,myop,myarg,myfig,hit1:1,hit2:0,hit3:0,x1,y1,x2,y2,x3,y3,tr:[a,b,c,d,e,f]};
                break;
              }
            }
          }
