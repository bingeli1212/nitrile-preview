...
class NitrilePreviewFlowerpot extends NitrilePreviewHtml {
  ...
  constructor(parser) {
    ...
    let vw = 140*this.MM_to_PX;//529
    let vh = 106*this.MM_to_PX;//400
    console.log(vw,vh)
  ...
  to_peek_document() {
    ...
    var main_html = this.to_main_html();
  ...
  to_document() {
    ...
    var main_html = this.to_main_html();
    var main_html = this.replace_all_refs(main_html);
    var script_canvas = this.to_script_canvas();
    ...
    @media print {
      ...
      .SLIDE {
        background-image: url("image-slide.png"), url("data:image/svg+xml,${encodeURIComponent(this.bgsvg)}");
        background-repeat: no-repeat, no-repeat;
        background-position: top left, top left;
        background-size: 88px 40px, cover;
