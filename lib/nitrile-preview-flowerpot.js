...
`;
  ...
  to_setup_script(){
    ...
    all_st_icons = ['&#x2758;','&#x2759;','&#x275A;'];
    all_at_icons = {'clear':'&#x2613;','fopen':'&#x1F4C2;','dload':'&#x2728;','zoomo':'&#x2315;-','zoomi':'&#x2315;+','acton':'&#x2318;','cutbd':'&#x2702;','paste':'&#x2730;','rsize':'&#x26DE;'};
    ...
    function board_enter(ctx,canvas){
      ...
      || o.myop=='smudge'   //board_enter smudge
    ...
    function board_clear(ctx,canvas){
      ...
      if(o.myop=='select'){
        ...
        let {x,y,w,h} = o.mybasis;
console.log('board_clear',x,y,w,h);
        if(w && h){
          ctx.clearRect(x,y, w,h);
          o.mybasis.s = ctx.getImageData(0,0, canvas.width,canvas.height);
        }
...
console.log(o.mysquare.isnewlycorner,o.mysquare.corner_i,o.mysquare.face);
            //add to polypts
            let x0 = o.mysquare.x;
            let y0 = o.mysquare.y;
            if(o.myop=='square'){
