...
`;
    ...
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             <button class='ONEOP DOT'      name='1-${boardid}'  data-op='hand'         onclick="board_oneopclicked(this.name,'hand'   ,this)"></button>
             <button class='ONEOP'          name='1-${boardid}'  data-op='pencil'       onclick="board_oneopclicked(this.name,'pencil' ,this)"></button>
             <button class='ONEOP'          name='1-${boardid}'  data-op='line'         onclick="board_oneopclicked(this.name,'line'   ,this)"></button>
             ...
             <button class='ONEOP'          name='1-${boardid}'  data-op='fopen'        onclick="board_oneopclicked(this.name,'fopen'  ,this)"></button>
             <button class='ONEOP'          name='1-${boardid}'  data-op='dload'        onclick="board_oneopclicked(this.name,'dload'  ,this)"></button>
             <button class='ONESH DOT'      name='1-${boardid}'  data-sh='tri'          onclick="board_oneshclicked(this.name,'tri'     ,this)"></button>
             <button class='ONESH'          name='1-${boardid}'  data-sh='triur'        onclick="board_oneshclicked(this.name,'triur'   ,this)"></button>
             ...
             <input id='fopen-1-${boardid}' name='1-${boardid}'  type='file' style='display:none' onchange='board_one_fi_clicked(this.name,this)'/>
             <a     id='dload-1-${boardid}' name='1-${boardid}'  type='text' style='display:none' onclick="board_one_dd_clicked(this,this.name,'image.png')">&#x2B73;</a>
         </div>
       </div>
       <div class='DROPDOWNCONTAINER' style='position:static'>
         <button name='${boardid}' id='op-2-${boardid}' class="BUTTON" role="button" onclick="board_oncakeclicked(this.name,'2')" ></button>
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             <button class='ONEOP DOT'      name='2-${boardid}'  data-op='hand'         onclick="board_oneopclicked(this.name,'hand'   ,this)"></button>
             <button class='ONEOP'          name='2-${boardid}'  data-op='pencil'       onclick="board_oneopclicked(this.name,'pencil' ,this)"></button>
             <button class='ONEOP'          name='2-${boardid}'  data-op='line'         onclick="board_oneopclicked(this.name,'line'   ,this)"></button>
             ...
             <button class='ONEOP'          name='2-${boardid}'  data-op='fopen'        onclick="board_oneopclicked(this.name,'fopen'  ,this)"></button>
             <button class='ONEOP'          name='2-${boardid}'  data-op='dload'        onclick="board_oneopclicked(this.name,'dload'  ,this)"></button>
             <button class='ONESH DOT'      name='2-${boardid}'  data-sh='tri'          onclick="board_oneshclicked(this.name,'tri'     ,this)"></button>
             <button class='ONESH'          name='2-${boardid}'  data-sh='triur'        onclick="board_oneshclicked(this.name,'triur'   ,this)"></button>
             ...
             <input id='fopen-2-${boardid}' name='2-${boardid}'  type='file' style='display:none' onchange='board_one_fi_clicked(this.name,this)'/>
             <a     id='dload-2-${boardid}' name='2-${boardid}'  type='text' style='display:none' onclick="board_one_dd_clicked(this,this.name,'image.png')">&#x2B73;</a>
         </div>
       </div>
       `;
  }
  ...
  to_setup_script(){
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    function board_one_dd_clicked(a,name,fname){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      a.download = fname;
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    function board_one_fi_clicked(name,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      var img = new Image();
...
//console.log('board_enter','op=',ctx.cake.myop,'id=',canvas.id);
      var o = ctx.cake;          
      if(o.myop=='ball'){
        o.myball = {};
...
//console.log('board_leave','op=',ctx.cake.myop,'id=',canvas.id);
      var o = ctx.cake;          
      if(o.myop=='figure'){
        o.myfig.s = null;
        o.myfig.sh = '';
      ...
      if(o.myop=='ball'){
        o.balls = [];///remove all existing balls
      }
    }
    ////////////////////////////////////////////
    ////////////////////////////////////////////
...
//console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
      ...
      if(ctx.cake.myop=='ball'){ //board_start
        ...
        var hit_size = 8;
        if(ctx.shiftKey && ctx.altKey && !o.hit_ball){
          ///DETERMIND hit_ball
          ...
          if(o.hit_ball){
            ...
            let {pivot_x,pivot_y} = o.hit_ball;
            ctx.translate(pivot_x,pivot_y);
            ctx.transform(a,b,c,d,e,f);
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){ //board_drag
        if(o.hit_ball){
          if(ctx.shiftKey){               
            if(o.hit_ball.corner_i==0 && ctx.altKey) {
              //skewX
              let [x,y] = ball_getpivotxy(o.hit_ball);//grow/shrink vertical dimension only
            ...
            }else if(o.hit_ball.corner_i==0) {
              //rotate
              let [x,y] = ball_getpivotxy(o.hit_ball);//rotate
              let angle0 = Math.atan2(ctx.posy1-y, ctx.posx1-x);
              let angle1 = Math.atan2(ctx.posy2-y, ctx.posx2-x);
              let rotate_ang = (angle1-angle0)/Math.PI*180;
              board_rotate(rotate_ang, ctx,canvas);
            }else if(o.hit_ball.corner_i > 0 && ctx.altKey) {
              //scaleY
              let [x,y] = ball_getpivotxy(o.hit_ball);//grow/shrink vertical dimension only
              let angle0 = Math.atan2(ctx.posy1-y, ctx.posx1-x);
              let angle1 = Math.atan2(ctx.posy2-y, ctx.posx2-x);
              ...
              multiple = Math.min(multiple,1);
              if(multiple>0){//grow
                board_scale(1,1+multiple, ctx,canvas);
              }else{//shrink
                board_scale(1,1+0.5*multiple, ctx,canvas);
              }
            }else if(o.hit_ball.corner_i > 0) {
              //scaleXY
              let [x,y] = ball_getpivotxy(o.hit_ball);//resize uniformly
              let angle0 = Math.atan2(ctx.posy1-y, ctx.posx1-x);
              let angle1 = Math.atan2(ctx.posy2-y, ctx.posx2-x);
              let rotate_ang = (angle1-angle0)/Math.PI*180;
              if(rotate_ang > 180){
              ...
              multiple = Math.min(multiple,1);
              if(multiple>0){//grow
                board_scale(1+multiple,1+multiple, ctx,canvas);
              }else{//shrink
                board_scale(1+0.5*multiple,1+0.5*multiple, ctx,canvas);
              }
            }
          }else {
