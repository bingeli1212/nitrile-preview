...
`;
  ...
  to_tool_contents(boardid){
    return `\
         ...
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:340px;height:34px;z-index:10;' >
             ...
             <button class='ONEWG'          name='${boardid}'  data='4'                      onclick="board_onewgclicked(this.name,this)" />         
