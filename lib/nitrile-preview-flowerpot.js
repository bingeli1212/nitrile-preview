...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    let edit_contents = this.to_edit_contents(boardid,buttonid);
    ...
    all.push(`</div>`);
    all.push(`<canvas class='EDITBOARD' id='${boardid}' data-type='board' data-imgid='${imgid}' data-boardname='${boardname}' data-frameid='${frameid}' data-buttonid='${buttonid}' width='441' height='320' ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
  ...
  to_edit_contents(boardid,buttonid){
    return `\
       ...
       <div style='position:relative'>
         <button name='${boardid}' id='${buttonid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' ></button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
          ...
          <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
            <button class='ONECOLOR' data-boardid='${boardid}' data-colorid='0' onclick="board_onecolorclicked(this)"></button>
            <button class='ONECOLOR' data-boardid='${boardid}' data-colorid='1' onclick="board_onecolorclicked(this)"></button>
            <button class='ONECOLOR' data-boardid='${boardid}' data-colorid='2' onclick="board_onecolorclicked(this)"></button>
            <button class='ONECOLOR' data-boardid='${boardid}' data-colorid='3' onclick="board_onecolorclicked(this)"></button>
            <button class='ONECOLOR' data-boardid='${boardid}' data-colorid='4' onclick="board_onecolorclicked(this)"></button>
            <button class='ONECOLOR' data-boardid='${boardid}' data-colorid='5' onclick="board_onecolorclicked(this)"></button>
            <button class='ONECOLOR' data-boardid='${boardid}' data-colorid='6' onclick="board_onecolorclicked(this)"></button>
            <input type='range' class='ONESTROKE' name='${boardid}' list='tickmarks' min='0' max='1' value='0' onclick="board_onestrokechanged(this.value,this.name)">
  ...
  to_setup_script(){
    ...
    function setup(){
      ...
      var select = document.querySelectorAll('.ONECOLOR');
      for(var i=0; i < select.length; i++){
        var button = select[i];
...
console.log('board_onshowdropmenu',name);
    ...
    function board_setup_canvas(canvas){
      ...
      if(1){
        ...
        ///
        //let button_elem = document.getElementById(canvas.getAttribute('data-buttonid'));
        //button_elem.style.color = all_colors[ctx.note.mycolorid];
        //button_elem.style.borderColor = all_colors[ctx.note.mycolorid];
        //button_elem.innerHTML = all_icons[ctx.note.all_op];
        ///
    ...
    function board_setcolorid(v,ctx,canvas){
      ...
      if(1){
        ...
        //button_elem.style.borderColor = mycolor;
      }
    }
    function board_setstrokeid(v,ctx,canvas){
      ...
      if(1){
        ...
        //button_elem.style.borderWidth = ""+bordersize+"px";
        if(v==0){
          button_elem.style.fontWeight = "normal";
        }else{
          button_elem.style.fontWeight = "bolder";
        }
      }
    }
