  ...
  to_setup_script(){
        ...
        if(w && h){
          ...
          if(1){
            ...
            points.forEach((pt,i) => {
              ...
              let corner_size = 4;
              if(Number.isFinite(x)&&Number.isFinite(y)){
                //console.log('drawing corner at',i,x,y,corner_size);
                ctx.rect(x-corner_size/2,y-corner_size/2,corner_size,corner_size);
              }
              /*
              if(o.mysquare.corner_i==i){
                if(o.mysquare.corner_t == 1){
                  ctx.fillStyle = 'red';
                }else if(o.mysquare.corner_t == 2){
                  ctx.fillStyle = 'blue';
                }
              }
              */
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.cake.myop=='square'){ //board_end
        if(ctx.mouseisdragged){
        }
        else if(o.mysquare.altKey){
console.log('board_end,square',o.mysquare.w,o.mysquare.h);
          o.mysquare.showcorners = 0;
          board_redraw(ctx,canvas);
          o.mysquare.s = ctx.getImageData(0,0, canvas.width,canvas.height);
          /*
          o.mysquare.w = 0;
