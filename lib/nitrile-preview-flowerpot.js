  ...
  to_setup_script(){
    ...
    function board_onmousedown(evt){
      ...
      if(ctx.d.myop=='select'){
        ...
        if(evt.shiftKey && evt.altKey){
          board_draw_copy(evt,ctx,canvas,true,false);
        }else if(evt.altKey){
          board_draw_move(evt,ctx,canvas,true,false);
        }else{
          board_draw_select(evt,ctx,canvas,true,false);
        }
      }else{
        board_draw_dot(evt.shiftKey,evt.altKey,ctx,canvas,true);
      }
    }
    function board_onmousemove(evt){
      ...
      if(ctx.d.mymouseisdown){
        if(ctx.d.myop=='select'){
          if(evt.shiftKey && evt.altKey){
            board_draw_copy(evt,ctx,canvas,false,false);
          }else if(evt.altKey){
            board_draw_move(evt,ctx,canvas,false,false);
          }else{
            board_draw_select(evt,ctx,canvas,false,false);
          }
        }else{
          board_draw_dot(evt.shiftKey,evt.altKey,ctx,canvas,false);
        }
      }
    }
    function board_onmouseup(evt){
      ...
      if(ctx.d.mymouseisdown){
        if(ctx.d.myop=='select'){
          if(evt.shiftKey && evt.altKey){
            board_draw_copy(evt,ctx,canvas,false,true);
            if(ctx.d.mycopy){
              let p = ctx.d.mycopy;
              ctx.d.mysave.push(p);
              ctx.d.myredo = [];
            ...
            board_draw_move(evt,ctx,canvas,false,true);
            if(ctx.d.mymove){
              let p = ctx.d.mymove;
              ctx.d.mysave.push(p);
              ctx.d.myredo = [];
            ...
            board_draw_select(evt,ctx,canvas,false,true);
          }
        }else{
          if(1){
    ...
    ////////////////////////////////////////////
    ////////////////////////////////////////////
    function board_draw_copy(evt,ctx,canvas,isfirst,islast){
      ctx.globalAlpha = 1;
      ctx.lineWidth = 1;
    ...
    function board_draw_move(evt,ctx,canvas,isfirst,islast){
      ctx.globalAlpha = 1;
      ctx.lineWidth = 1;
      let myposx0 = ctx.d.myposx0;
      let myposy0 = ctx.d.myposy0;
    ...
    function board_draw_select(evt,ctx,canvas,isfirst,islast){
      ctx.globalAlpha = 1;
      ctx.lineWidth = 1;
      let myposx0 = ctx.d.myposx0;
      let myposy0 = ctx.d.myposy0;
    ...
    function board_ontouchstart(evt) {
      evt.preventDefault();
      console.log('board_ontouchstart',evt);
    ...
    function board_ontouchmove(evt) {
      evt.preventDefault();
      console.log('board_ontouchmove',evt);
      var touches = evt.changedTouches;
      for (var i = 0; i < touches.length; i++) {
        var touch = touches[i];
        var canvas = touch.target;                            
    ...
    function board_ontouchend(evt) {
      evt.preventDefault();
      console.log('board_ontouchend',evt);
      var touches = evt.changedTouches;
      for (var i = 0; i < touches.length; i++) {
        var touch = touches[i];
        var canvas = touch.target;                            
    ...
    function board_ontouchcancel(evt) {
      evt.preventDefault();
      console.log('board_ontouchcancel',evt);
      for (var i = 0; i < touches.length; i++) {
        var touch = touches[i];
        var canvas = touch.target;                            
        var ctx = canvas.getContext("2d");
