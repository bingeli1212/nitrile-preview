...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`<canvas class='EDITBOARD' id='${boardid}' data-type='board' data-imgid='${imgid}' data-boardname='${boardname}' width='441' height='320' tabindex='1'></canvas>`);
  ...
  to_setup_script(){
    ...
    function board_setup_canvas(canvas){
      ...
      ctx.d = {};
      canvas.addEventListener("keydown",    board_onkeydown,    false);
    ...
    function board_onkeydown(evt){
      console.log('board_onkeydown',evt);
...
console.log('board_onmousedown',ctx.d.mymouseisdown);
    }
...
console.log('board_onmousemove',ctx.d.mymouseisdown);
    }
...
console.log('board_onmouseup',ctx.d.mymouseisdown);
    }
    ...
    function board_draw_rect(ctx,canvas,isfirst){
      ...
      if(ctx.d.myselect){  
        ...
        ctx.clearRect(0,0, 441,320);
        ctx.putImageData(p, 0,0);
        ctx.strokeRect(myposx0,myposy0, myposx2-myposx0,myposy2-myposy0);
        ctx.d.myrect = ctx.getImageData(0,0, 441,320);
      }
    }
    ...
    function board_end(ctx,canvas){
      if(ctx.d.myop=='selection'){
        ...
        let myop     = ctx.d.myop;
        if(s && mycircle && myop){
          ctx.d.mysave.push({s,myop,mycircle});
          ctx.d.myredo = [];
          ctx.d.myselect = ctx.getImageData(0,0, 441,320);
        }
      }else if(ctx.d.myop=='rect'){
