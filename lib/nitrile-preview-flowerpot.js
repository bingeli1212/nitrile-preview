...
`;
  ...
  to_tool_contents(boardid){
    return `\
         ...
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:374px;height:34px;z-index:10;' >
             ...
             <button class='ONEAT'          name='${boardid}'  data='addto'                  onclick="board_oneatclicked(this.name,this)" />        
  ...
  to_setup_script(){
    ...
    all_at_icons = {'clear':'&#x26F6;','cropp':'&#x26BF;','fopen':'&#x1F4C2;','dload':'&#x2728;','zoomo':'&#x2315;&#x207B;','zoomi':'&#x2315;&#x207A;','rotcl':'&#x2B6F;','rotcr':'&#x2B6E;','flipv':'&#x2BFC;','fliph':'&#x2BFA;','acton':'&#x2318;','cutbd':'&#x2702;','paste':'&#x26E8;','rsize':'&#x26DE;','uload':'&#x26A1;','darkb':'&#x263E;','addto':'&#x2621;'};
...
*/
    ...
    function board_enter(ctx,canvas){
      ...
      if(o.myop=='poly'){  //board_enter pencil
        ctx.resetTransform();
        if(!o.mypoly){
          o.mypoly = {};
          o.mypoly.s = null;
    ...
    function board_redraw(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){ //board_redraw ball
        ...
        o.myball.balls.forEach((ball,j) => {
          ...
          ctx.stroke(path2d);
          ///draw corners
          if(o.myball.istodo!='create' && o.myball.hitball===ball){
    ...
    function board_addto(ctx,canvas){
      var o = ctx.cake;          
      var img = new Image();
      img.crossOrigin = 'anonymous';
      var dataURL = canvas.getAttribute("data-url");
      if(!dataURL){
        let data_s = canvas.toDataURL();
        canvas.style.backgroundImage = "url("+data_s+")";
        canvas.setAttribute("data-url",data_s);
        ctx.clearRect(0,0, canvas.width,canvas.height);
      }else{
        img.onload = function() {
          ...
          putImageData2(data, 0,0,ctx);//this will blend in with existing one 
          let data_s = canvas.toDataURL();
          canvas.style.backgroundImage = "url("+data_s+")";
          canvas.setAttribute("data-url",data_s);
          ctx.clearRect(0,0, canvas.width,canvas.height);
    ...
    ////////////////////////////////////////////
    ////////////////////////////////////////////
    function board_draw_smudge(x1,y1,x2,y2,ctx,canvas){
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_start pencil
        ...
        o.mypencil.x1 = ctx.posx0;
        o.mypencil.y1 = ctx.posy0;
        o.mypencil.x2 = ctx.posx0;
        o.mypencil.y2 = ctx.posy0;
        o.mypencil.w = 0;
        o.mypencil.h = 0;
        let {x,y,x1,y1,x2,y2,w,h} = o.mypencil;
      ...
      if(o.myop=='smudge'){
        ...
        o.mysmudge.x1 = ctx.posx0;
        o.mysmudge.y1 = ctx.posy0;
        o.mysmudge.x2 = ctx.posx0;
        o.mysmudge.y2 = ctx.posy0;
        o.mysmudge.w = 0;
        o.mysmudge.h = 0;
        ...
        if(ctx.shiftKey){
          ...
          board_draw_smudge(x1,y1,x2,y2,ctx,canvas);
        }
      }
      if(o.myop=='eraser'){
      }
      if(ctx.cake.myop=='poly'){ //board_start poly
        ...
        o.mypoly.x1 = ctx.posx0;
        o.mypoly.y1 = ctx.posy0;
        o.mypoly.x2 = ctx.posx0;
        o.mypoly.y2 = ctx.posy0;
        o.mypoly.w = 0;
        o.mypoly.h = 0;
        let {x1,y1,x2,y2} = o.mypoly;
        if(!ctx.altKey){
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_drag pencil
        o.mypencil.w = ctx.posx2 - o.mypencil.x;
        o.mypencil.h = ctx.posy2 - o.mypencil.y;
        o.mypencil.x2 = ctx.posx2;
        o.mypencil.y2 = ctx.posy2;
        let {posx1,posy1,posx2,posy2} = ctx;
        board_draw_pencil(posx1,posy1,posx2,posy2,ctx,canvas);
      }
      if(o.myop=='poly'){
        o.mypoly.w = ctx.posx2 - o.mypoly.x;
        o.mypoly.h = ctx.posy2 - o.mypoly.y;
        o.mypoly.x2 = ctx.posx2;
        o.mypoly.y2 = ctx.posy2;
        let {x1,y1,x2,y2,s} = o.mypoly;
        ctx.lineWidth   = board_curr_stroke(ctx,canvas);
        ctx.strokeStyle = board_curr_color(ctx,canvas);
        if(s){
      ...
      if(o.myop=='smudge'){ // smudge
        o.mysmudge.w = ctx.posx2 - o.mysmudge.x;
        o.mysmudge.h = ctx.posy2 - o.mysmudge.y;
        o.mysmudge.x2 = ctx.posx2;
        o.mysmudge.y2 = ctx.posy2;
        if(ctx.altKey){
          let stroke = board_curr_stroke(ctx,canvas);
          let color = board_curr_color(ctx,canvas);        
          let mysmear = all_smears[color];
          ...
          let {posx1,posy1,posx2,posy2} = ctx;
          board_draw_smudge(posx1,posy1,posx2,posy2,ctx,canvas);
        }
      }
      if(o.myop=='eraser'){ // eraser
        o.myeraser.w = ctx.posx2 - o.myeraser.x;
        o.myeraser.h = ctx.posy2 - o.myeraser.y;
        o.myeraser.x2 = ctx.posx2;
        o.myeraser.y2 = ctx.posy2;
        if(ctx.altKey){
          let {x,y,w,h} = o.myeraser;
          ctx.clearRect(x,y, w,h);
        }else{
          let {posx1,posy1,posx2,posy2} = ctx;
          board_draw_eraser(posx1,posy1,posx2,posy2, ctx,canvas);
        }
      }
    ...
    function board_end(ctx,canvas){
      ...
      if(o.myop=='poly'){ //board_end pencil
        let {x1,y1,x2,y2} = o.mypoly;
