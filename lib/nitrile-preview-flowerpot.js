...
`;
  ...
  to_setup_script(){
    ...
    function board_addpolypt(pt, ctx,canvas){
      var o = ctx.cake;
      ...
      || ctx.cake.myop=='ellipse' ){  //board_start
        ...
        if(o.mysquare.altKey && o.mysquare.shiftKey){
          if(o.mysquare.face){
            ...
            if(1){ //add to polypts
              if(o.myop=='square'){
                board_addpolypt(o.mysquare.points[0], ctx,canvas);
                board_addpolypt(o.mysquare.points[1], ctx,canvas);
                board_addpolypt(o.mysquare.points[2], ctx,canvas);
                board_addpolypt(o.mysquare.points[3], ctx,canvas);
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.cake.myop=='poly'){ //board_end
        if(ctx.mouseisdragged){
          ...
          let x2 = o.mypoly.x2;
          let y2 = o.mypoly.y2;
          board_addpolypt([x1,y1], ctx,canvas);
          board_addpolypt([x2,y2], ctx,canvas);
        }
      }
