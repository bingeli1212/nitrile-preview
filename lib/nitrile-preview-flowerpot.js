    ...
    function note_redraw(ctx,canvas){
      ...
      if(o.myop=='shape' && o.myarg=='hexagon'){
        ...
        if(1){
          ...
          let p1 = board_midpoint(c1,c2,0.25);
          let p2 = board_midpoint(c1,c2,0.75);
          let p3 = board_midpoint(c2,c3,0.50);
          let p4 = board_midpoint(c3,c4,0.25);
          let p5 = board_midpoint(c3,c4,0.75);
          let p6 = board_midpoint(c1,c4,0.50);
