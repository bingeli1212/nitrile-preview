...
${allsidesvgs.join('\n')}
    ...
    .DROPDOWNCONTAINER:hover .DROPMENU {
      visibility: visible;
    }
    .BUTTON {
...
`;
  ...
  to_edit_contents(boardid){
    return `\
       ...
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         <button name='${boardid}' id='op-1-${boardid}' class="BUTTON COLOR DOT" role="button" onclick="board_oneckclicked(this.name,'1')" >&#x270E;</button>
       ...
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         <button name='${boardid}' id='op-2-${boardid}' class="BUTTON COLOR" role="button" onclick="board_oneckclicked(this.name,'2')" >&#x270E;</button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:51px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
  ...
  to_setup_script(){
    ...
    function board_oneckclicked(name,v){
      ...
      if(v=='2'){
        button2.classList.add('DOT');
        button1.classList.remove('DOT');
      }else{
        button1.classList.add('DOT');
        button2.classList.remove('DOT');
      }
    }
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
