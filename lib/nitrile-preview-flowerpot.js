...
const all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','select':'&#x2B1A;','smudge':'&#x26C6;','eraser':'&#x26CA;','cplane':'&#x1D465;&#x1D456;','ball':'&#x26CB;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;'};
const all_st_icons = ['&#x2758;','&#x2759;','&#x275A;'];
const all_sh_icons = ['&#x25AD;','&#x25FA;','&#x2B2D;','&#x2216;'];
const all_wg_icons = ['&#x269D;','&#x269E;','&#x26C6;','&#x26CA;'];
const all_at_icons = {'clear':'&#x26F6;','cropp':'&#x26BF;','fopen':'&#x1F4C2;','dload':'&#x2728;','zoomo':'&#x2315;&#x207B;','zoomi':'&#x2315;&#x207A;','rotcl':'&#x2B6F;','rotcr':'&#x2B6E;','flipv':'&#x2BFC;','fliph':'&#x2BFA;','acton':'&#x2318;','cutbd':'&#x2702;','paste':'&#x26E8;','rsize':'&#x26DE;','uload':'&#x26A1;','darkb':'&#x263E;','addto':'&#x2621;'};
  ...
  to_tool_contents(boardid){
    return `\
         <div id='text-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:88px;height:34px;z-index:10;' >
             <input  class='ONE TE'      name='${boardid}'  type='text'      onchange="board_onetechanged(this.name,this)" />
         </div>
         ...
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:374px;height:34px;z-index:10;' >
             <button class='ONE OP DOT'  name='${boardid}'  data='pencil'    onclick="board_oneopclicked(this.name,this)" > ${all_op_icons["pencil" ]} </button>
             ...
             <button class='ONE C0 DOT'  name='${boardid}'  data='0'         onclick="board_oneclclicked(this.name,this)" >                            </button>         
             <button class='ONE C1'      name='${boardid}'  data='1'         onclick="board_oneclclicked(this.name,this)" >                            </button>        
             <button class='ONE C2'      name='${boardid}'  data='2'         onclick="board_oneclclicked(this.name,this)" >                            </button>        
             <button class='ONE C3'      name='${boardid}'  data='3'         onclick="board_oneclclicked(this.name,this)" >                            </button>        
             <button class='ONE C4'      name='${boardid}'  data='4'         onclick="board_oneclclicked(this.name,this)" >                            </button>        
             <button class='ONE C5'      name='${boardid}'  data='5'         onclick="board_oneclclicked(this.name,this)" >                            </button>        
             <button class='ONE C6'      name='${boardid}'  data='6'         onclick="board_oneclclicked(this.name,this)" >                            </button>        
             ...
             <button class='ONE SH DOT'  name='${boardid}'  data='0'         onclick="board_oneshclicked(this.name,this)" > ${all_sh_icons[0        ]} </button>
             <button class='ONE SH'      name='${boardid}'  data='1'         onclick="board_oneshclicked(this.name,this)" > ${all_sh_icons[1        ]} </button>
             <button class='ONE SH'      name='${boardid}'  data='2'         onclick="board_oneshclicked(this.name,this)" > ${all_sh_icons[2        ]} </button>
             <button class='ONE SH'      name='${boardid}'  data='3'         onclick="board_oneshclicked(this.name,this)" > ${all_sh_icons[3        ]} </button>
             ...
             <button class='ONE AT'      name='${boardid}'  data='addto'     onclick="board_oneatclicked(this.name,this)" > ${all_at_icons["addto"  ]} </button>       
