...
`;
    ...
    topframes.forEach((topframe,j,arr) => {
      ...
      if(n==0){
        ...
        all.push(`<div class='TOPCONTAINER'> 
                  <h1 class='SLIDETITLE'> <b>Table Of Contents</b> </h1>
                  <h2 class='SLIDESUBTITLE'> <b></b> </h2>
                  </div>`);
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`<article class='SLIDE' id='${frameid}' row='${frame.style.row}' style='var(--logosvg);background-repeat:no-repeat;background-position:top left;background-size:88px 40px;' >`);
    pages.push(1);
    all.push(`<div class='TOPCONTAINER'> 
              <h1 class='SLIDETITLE'> ${id} <b>${this.uncode(frame.style,frame.title)}</b> </h1>
              <h2 class='SLIDESUBTITLE'> <b></b> </h2>
              </div>`);
  ...
  write_one_frame(id,order,icon,frame,issub,parentid,toc,pages,topframe){
    ...
    if(issub){
      all.push(`<div class='TOPCONTAINER'> 
                <h1 class='SLIDETITLE'>${order} <b>${this.uncode(topframe.style,topframe.title)}</b> </h1>
                <h2 class='SLIDESUBTITLE'> <b>${icon} ${this.uncode(frame.style,frame.title)}</b> </h2>
                </div>`);
      order = '';
    }else{
      icon = '';
      all.push(`<div class='TOPCONTAINER'> 
                <h1 class='SLIDETITLE'>${order} <a href='#frame-${parentid}'></a> <b>${this.uncode(topframe.style,topframe.title)}</b> </h1>
                <h2 class='SLIDESUBTITLE'> <b></b> </h2>
                </div>`);
    }
    all.push(`<div class='SIDECONTAINER'><img width='88' height='360' style='content:var(--side${id})' usemap='#map${id}' /> </div>`);
  ...
  to_titlepage(pages){
    ...
    let data = `<article row='0' class='SLIDE' style='' >
  ...
  to_setup_script(){
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_drag pencil
        ...
        let {posx1,posy1,posx2,posy2} = ctx.cake;
