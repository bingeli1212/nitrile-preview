...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`</div>`);
    all.push(`<img class='IMG' id='img-1-${boardid}' style='display:none' src='${boardpng}' crossOrigin='Anonymous' />`);
    all.push(`<canvas class='CANVAS CAKE' id='1-${boardid}' data-frameid='${frameid}' width='441' height='320' data-imgid='img-1-${boardid}' ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
  ...
  write_one_frame(id,order,icon,frame,issub,parentid,toc,pages,topframe){
    ...
    let boardpng = boardname?boardname+'.png':'';
    let edit_contents = this.to_edit_contents(boardid);
    let form_contents = this.to_form_contents(boardid);
    all.push(`<article class='SLIDE' id='${frameid}' row='${frame.style.row}' style='--boardpng:url("");background-image:var(--boardpng),var(--logosvg),var(--bgsvg);background-repeat:no-repeat;background-position:88px 40px,top left,top left;background-size:441px 320px,88px 40px,cover;' >`);
    pages.push(1);
    all.push(`<div class='BOTTOMCONTAINER'>`);
    all.push(`<div class='EDITFORM' > ${edit_contents} ${form_contents} </div>`);
    all.push(`<div class='PAGENUM'> / </div>`);
    all.push(`</div>`);
    all.push(`<div class='SIDECONTAINER'><img width='88' height='360' style='content:var(--side${id})' usemap='#map${id}' /></div>`);
    if(issub){
    ...
    all.push(`<img class='IMG' id='img-1-${boardid}' style='display:none' src='${boardpng}' crossOrigin='Anonymous' />`);
    all.push(`<canvas class='CANVAS CAKE' id='1-${boardid}' data-frameid='${frameid}' width='441' height='320' data-boardname='${boardname}' data-imgid='img-1-${boardid}' ></canvas>`);
    all.push('</article>');
    all.push('');
    // 
  ...
  to_edit_contents(boardid){
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         <button name='1-${boardid}' id='op-1-${boardid}' class="BUTTON CAKE" role="button" onclick="board_oncakeclicked(this.name,this)" ></button>
         <div id='dropmenu-1-${boardid}' class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <button class='ONEST'          name='1-${boardid}'  data-st='0'                      onclick="board_one_stclicked(this.name,0,this)" />        
             <button class='ONEST DOT'      name='1-${boardid}'  data-st='1'                      onclick="board_one_stclicked(this.name,1,this)" />        
             <button class='ONEST'          name='1-${boardid}'  data-st='2'                      onclick="board_one_stclicked(this.name,2,this)" />        

             <button class='ONEAT'          name='1-${boardid}'  data-at='fopen'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='dload'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='zoomo'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='zoomi'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='acton'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='clear'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='cropp'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='cutbd'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='paste'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='rsize'                  onclick="board_one_atclicked(this.name,this)" />        
      ...
      <div class='DROPDOWNCONTAINER' style='position:static'>
         <button name='1-${boardid}' id='submit-1-${boardid}' form='form-1-${boardid}' class="BUTTON CAKE" role="button" >s</button>
         <form name='1-${boardid}' id='form-1-${boardid}' action='/echo' method='post' style='display:none' onsubmit='board_onsubmitclicked(this.name,this)' >
           <textarea style='display:none' id='boardname-1-${boardid}' name='boardname'></textarea>
           <textarea style='display:none' id='boardid-1-${boardid}'   name='boardid'></textarea>
           <textarea style='display:none' id='dataurl-1-${boardid}'   name='dataurl'></textarea>
        </form>
      </div>
       `;
  }
  to_form_contents(boardid){
    return `\
       `;
  }
  ////////////////////////////////////////////////////////////////////////
  ...
  to_setup_script(){
    ...
    all_st_icons = ['&#x2758;','&#x2759;','&#x275A;'];
    all_at_icons = {'clear':'&#x26CC;','cropp':'&#x26CB;','fopen':'&#x1F4C2;','dload':'&#x2728;','zoomo':'&#x2315;-','zoomi':'&#x2315;+','acton':'&#x2318;','cutbd':'&#x2702;','paste':'&#x26E8;','rsize':'&#x26DE;'};
    ...
    function board_one_atclicked(name,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      var v = e.getAttribute('data-at');
      switch(v){
        case 'clear': {
        ...
        case 'zoomo': {
          board_zoomOut(ctx,canvas);
          break;
        }
        case 'zoomi': {
          board_zoomIn(ctx,canvas);
          break;
        }
        case 'acton': {
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    function board_oncakeclicked(name,e){
      //var dropmenu = document.getElementById("dropmenu-"+name);
    ...
    function board_onsubmitclicked(name,e){
      //console.log('board_onsubmitclicked',name,e);
      //alert('board_onsubmitclicked'+' '+name);
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      var boardname = canvas.getAttribute('data-boardname');
      //alert('board_onsubmitclicked'+' '+imgid);
      //var img = document.getElementById(imgid);
      //var src = img.src;
      alert('board_onsubmitclicked'+' '+boardname);
      if(boardname){
        var boardname_elem = document.getElementById("boardname-"+name);
        var boardid_elem   = document.getElementById("boardid-"+name);
        var dataurl_elem   = document.getElementById("dataurl-"+name);
        console.log(boardname_elem);
        console.log(boardid_elem);
        console.log(dataurl_elem);
      }
    ...
    function board_enter(ctx,canvas){
      ...
      if(o.myop=='shape'    //board_enter shape
      || o.myop=='eraser'){ //board_enter eraser
        ctx.resetTransform();
      }
      ...
      if(o.myop=='square'     //board_enter square
      || o.myop=='triangle'   //board_enter triangle
      || o.myop=='ellipse' ){ //board_enter ellipse
        o.mysquare = {};
        ...
        o.mysquare.points = [[0,0],[0,0],[0,0],[0,0]];
        o.mysquare.isinside = 0;
        o.mysquare.corner_i = 0;
      }
      if(o.myop=='ball'){ //board_enter ball
        o.myball = {};
    ...
    function board_redraw(ctx,canvas){
      ...
      var o = ctx.cake;          
      ctx.resetTransform();
      if(ctx.cake.myop=='hand'){ //board_redraw hand
        ctx.clearRect(0,0, canvas.width,canvas.height);
      }
        ...
        if(w && h){
          if(o.mybasis.clipboard){
            if(o.mybasis.w == o.mybasis.clipboard.width && o.mybasis.h == o.mybasis.clipboard.height){
              putImageData2(o.mybasis.clipboard, x,y,ctx);
        ...
        if(o.mysquare.w && o.mysquare.h){
          ...
          switch(o.myop){
            ...
            case 'ellipse': {
              ...
              let p0 = [0, 0];
              let p1 = [o.mysquare.w,                 o.mysquare.skewY];
              let p2 = [o.mysquare.w+o.mysquare.skewX,o.mysquare.h+o.mysquare.skewY];
              let p3 = [o.mysquare.skewX,             o.mysquare.h];
              ...
              if(1){
                ...
                ctx.bezierCurveTo(cp1x,cp1y,cp2x,cp2y,x4,y4);
              }
              if(1){
      ...
      if(ctx.cake.myop=='cplane'){ //board_redraw cplane
        ctx.resetTransform();
        ctx.clearRect(0,0, canvas.width,canvas.height);
        ctx.fillStyle = 'black';
        ...
        if(1){
          ...
          let reduce_rate = 1;
          if(o.scale_factor > 1){
            reduce_rate = Math.log(o.scale_factor)+1;
          }
          ctx.lineWidth = 1*1.4*(1/reduce_rate);
          let arrow_x = (val_real)*o.grid ;
          let arrow_y = -(val_imag)*o.grid ;
          arrow_x = (val_real)*o.grid ;
          arrow_y = -(val_imag)*o.grid ;
    ...
    function board_action(ctx,canvas){
      ...
      o.myaction++; 
      if(o.myop=='cplane'){
        o.rotate_ang = 0;  // this one and the one below is for 'mul'
        o.scale_factor = 1;
        o.move_x = 0 ;    // this one is for 'add'
        o.move_y = 0 ;
      }
    }
    ...
    function board_addpolypt(polypts,pt, ctx,canvas){
      var o = ctx.cake;
    ...
    function board_findpolypt(polypts,pt, ctx,canvas){
      var o = ctx.cake;          
      var [sx,sy] = pt;
      var dist = Infinity;
      var tx = 0;
    ...
    function board_smudge_rect(x,y,w,h,ctx,canvas){
      let stroke= board_curr_stroke(ctx,canvas);
      let color = board_curr_color(ctx,canvas);        
      let mysmear = all_smears[color];
      let limit = 0; 
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_start pencil
        o.mypencil.shiftKey = ctx.shiftKey;
        o.mypencil.altKey = ctx.altKey;
        o.mypencil.x = ctx.posx0;
        o.mypencil.y = ctx.posy0;
        let {x,y} = o.mypencil;
        let w = board_curr_stroke(ctx,canvas);
        let h = board_curr_stroke(ctx,canvas);
        ctx.fillStyle = board_curr_color(ctx,canvas);           
      ...
      if(ctx.cake.myop=='poly'){ //board_start
        ...
        let y2 = ctx.posy0;
        if(ctx.altKey){
          [x1,y1] = board_findpolypt(o.mypoly.polypts,[x1,y1], ctx,canvas);
          [x2,y2] = board_findpolypt(o.mypoly.polypts,[x2,y2], ctx,canvas);
        }
        o.mypoly.x1 = x1;
        o.mypoly.y1 = y1;
        o.mypoly.x2 = x2;
      ...
      if(ctx.cake.myop=='square'      //board_start square
      || ctx.cake.myop=='triangle'    //board_start triangle
      || ctx.cake.myop=='ellipse' ){  //board_start ellipse
        ...
        if(1){ ///determine which corner index
          o.mysquare.isnewlycorner = 0;
          o.mysquare.isinside = 0;
          ctx.save();
          ctx.resetTransform();
          ctx.translate(o.mysquare.x,o.mysquare.y);
        ...
        if(o.mysquare.altKey && o.mysquare.shiftKey){
          ...
          o.mysquare.corner_i = 0;
          o.mysquare.isnewlycorner = 1;
          o.mysquare.istomove = 1;
          o.mysquare.isresize = 0;
        }else if(o.mysquare.altKey){ 
          //keep old sketch
          o.mysquare.istomove = 1;
          o.mysquare.isresize = 0;
        }else if(isnewlycorner){
          //keep old sketch - the exact move/resize depends on which corner is selected
          o.mysquare.istomove = 0;
          o.mysquare.isresize = 0;
        }else{
          if(o.mysquare.face){
            o.mysquare.s = o.mysquare.face;
          ...
          o.mysquare.h = 0;
          o.mysquare.istomove = 0;
          o.mysquare.isresize = 1;
          o.mysquare.isnewsketch = 1;
        }
        board_redraw(ctx,canvas);
      }
      if(ctx.cake.myop=='smudge'){ //board_start smudge
        o.mysmudge.x = ctx.posx0;
        o.mysmudge.y = ctx.posy0;
        o.mysmudge.w = 0;
        o.mysmudge.h = 0;
        o.mysmudge.shiftKey = ctx.shiftKey;
        o.mysmudge.altKey = ctx.altKey;
        if(ctx.altKey){
          let {x,y,w,h} = o.mysmudge;
          board_smudge_rect(x,y,w,h, ctx,canvas);                        
        }
        else if(ctx.shiftKey){
          let {x,y,w,h} = o.mysmudge;
          board_smudge_fill(x,y, ctx,canvas);
        }else{
          let x1 = ctx.posx0;
          let y1 = ctx.posy0;
          let x2 = ctx.posx0;
      ...
      if(ctx.cake.myop=='cplane'){ //board_start
        ...
        if(o.mycplane.path_handle){
          if(ctx.isPointInPath(o.mycplane.path_handle, ctx.posx0,ctx.posy0)){ 
            o.mycplane.pointisinhandle = true;
          }else if(ctx.isPointInStroke(o.mycplane.path_handle, ctx.posx0,ctx.posy0)){ 
            o.mycplane.pointisinhandle = true;
          }
        }
        ctx.restore();
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='select'){ //board_drag select
        let {rsize,istomove,istosize} = o.mybasis;
        if(rsize==1){
          ...
          let w = ctx.posx2 - ctx.posx0;
          let h = ctx.posy2 - ctx.posy0;
          o.mybasis.w = w;
          o.mybasis.h = h;
        }
        board_redraw(ctx,canvas);
        ...
        if(ctx.altKey){
          ...
          if(ctx.shiftKey){
            if(Math.abs(dx) > Math.abs(dy)){
              y1 = y0; //draw a horizontal line
              y2 = y0;
            }else{
              x1 = x0; //draw a vertical line
              x2 = x0;
            }
          }
          ctx.lineWidth = board_curr_stroke(ctx,canvas);
      ...
      if(ctx.cake.myop=='poly'){ //board_drag poly
        //DRAG  
        let x1 = o.mypoly.x1;
        let y1 = o.mypoly.y1;
        let x2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='square'     //board_drag square
      || ctx.cake.myop=='triangle'   //board_drag triangle
      || ctx.cake.myop=='ellipse' ){ //board_drag ellipse
        let {isnewlycorner,istomove,isresize,corner_i} = o.mysquare;
        if(isnewlycorner && o.mysquare.corner_i==0){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          if(ctx.shiftKey){
            if(Math.abs(ctx.posx2-ctx.posx0)==Math.abs(ctx.posy2-ctx.posy0)){
              dx = 0; 
              dy = 0; 
            }else if(Math.abs(ctx.posx2-ctx.posx0)>Math.abs(ctx.posy2-ctx.posy0)){
              dy = 0; 
            }else{
              dx = 0; 
            }
          ...
          o.mysquare.x += dx;
          o.mysquare.y += dy;
        }else if(isnewlycorner && o.mysquare.corner_i==2){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          if(ctx.shiftKey){
            if(Math.abs(ctx.posx2-ctx.posx0)==Math.abs(ctx.posy2-ctx.posy0)){
          ...
          o.mysquare.w += dx;
          o.mysquare.h += dy;
        }else if(isnewlycorner && o.mysquare.corner_i==3){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.skewX += dx;
        }else if(isnewlycorner && o.mysquare.corner_i==1){
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.skewY += dy;
        }else if(istomove){
          let dx = ctx.posx2-ctx.posx1;
      ...
      if(ctx.cake.myop=='smudge'){ //board_drag smudge
        if(ctx.altKey){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          o.mysmudge.w += dx;
      ...
      if(ctx.cake.myop=='eraser'){ //board_drag
        if(o.myfig.altKey){
          ...
          ctx.globalCompositeOperation = 'xor';
          ctx.setLineDash([3.0,3.0]);
          ctx.strokeRect(o.myfig.x,o.myfig.y, o.myfig.w,o.myfig.h);
          ctx.restore();
        }
        else if(o.myfig.shiftKey){
        }
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.cake.myop=='poly'){ //board_end
        if(ctx.mouseisdragged){
          ...
          let x2 = o.mypoly.x2;
          let y2 = o.mypoly.y2;
          board_addpolypt(o.mypoly.polypts, [x1,y1], ctx,canvas);
          board_addpolypt(o.mypoly.polypts, [x2,y2], ctx,canvas);
        }
      }
    ...
    ////////////////////////////////////////////
    ////////////////////////////////////////////
    function putImageData2(src,x,y,ctx) {
      var w = src.width;
      var h = src.height;
