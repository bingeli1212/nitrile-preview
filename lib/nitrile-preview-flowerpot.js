    ...
    function board_redraw(ctx,canvas){
      ...
      || ctx.cake.myop=='ellipse' ){  //board_redraw
        ...
        if(o.mysquare.w && o.mysquare.h){
          ...
          ctx.translate(o.mysquare.w/2,o.mysquare.h/2);
      ...
      if(ctx.cake.myop=='ball'){ //board_redraw ball
        ...
        o.myball.balls.forEach((ball,j) => {
          ...
          ctx.translate(ball.w/2,ball.h/2);
      ...
      if(ctx.cake.myop=='ball'){ //board_start ball
        ...
        if(altKey && shiftKey){
          if(o.myball.hitball){
            ...
            if(points.length){
              let ball = {points,corners,transform,corner_i,pivot_x,pivot_y,color,x,y,w:30,h:30,skewX:0,skewY:0};
              o.myball.balls.push(ball);
