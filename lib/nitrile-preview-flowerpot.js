       ...
       <div style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
          <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
            ...
            <input type='range' class='ONEST' name='${boardid}' list='tickmarks' min='0' max='1' value='0' onclick="board_onestrokechanged(this.value,this.name)">
              <datalist id='tickmarks'>
                <option valud='0'></option>
                <option valud='1'></option>
              </datalist>
            </input>
          </div>
         </div>
...
console.log('board_onshowdropmenu',name);
    ...
    function board_setstrokeid(v,ctx,canvas){
      ...
      if(1){
        ...
        let button_elem = document.getElementById(canvas.getAttribute('data-buttonclid'));
        if(v==0){
          button_elem.innerHTML = "S";
        }else{
          button_elem.innerHTML = "B";
        }
      }
    }
    ...
    function board_handle_keydown(shiftKey,keycode,ctx,canvas){
      ...
      case 'Minus':
        ...
        break;
      case 'Equal':
        board_setstrokeid(1,ctx,canvas);
        break;
      case 'Backslash':
        if(shiftKey){
...
console.log('all_op=',ctx.note.all_op);
    ...
    function note_changeaction(ctx,canvas){
      ///ACTION==1 is the 'select' mode
      ctx.note.action++;
      ctx.note.action = ctx.note.action % 2;
      if(ctx.note.action==0){
        canvas.style.cursor = 'crosshair';
      }else{
