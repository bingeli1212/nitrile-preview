...
`;
  ...
  to_edit_contents(boardid,buttonopid,buttonshid,buttonclid,buttonckid){
    return `\
       ...
       <button name='${boardid}' id=''            class="BUTTON" role="button" onclick='board_oncopyclicked(this.name)'   >&#x2BBA;</button>
       <button name='${boardid}' id=''            class="BUTTON" role="button" onclick='board_onpasteclicked(this.name)'  >&#x2BBB;</button>
       `;
  }
  ////////////////////////////////////////////////////////////////////////
  //
