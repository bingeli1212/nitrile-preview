...
`;
  ...
  to_setup_script(){
    ...
    function cplane_start(ctx,canvas){
      ...
      var flag = ctx.isPointInPath(ctx.cplane.myposx0,ctx.cplane.myposy0); 
    ...
    function cplane_drag(ctx,canvas){
      if(ctx.cplane.mypointisinhandle){
        ...
        var diff_x = ctx.cplane.myposx2 - ctx.cplane.myposx1;
        var diff_y = ctx.cplane.myposy2 - ctx.cplane.myposy1;
