...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`</div>`);
    all.push(`<img class='IMG' id='imgid-${boardid}' style='display:none' src='${boardpng}' crossOrigin='Anonymous' />`);
    all.push(`<canvas class='CANVAS CAKE' id='${boardid}' data-frameid='${frameid}' width='441' height='320' data-boardpng='${boardpng}' ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
  ...
  write_one_frame(id,order,icon,frame,issub,parentid,toc,pages,topframe){
    ...
    frame.solutions.forEach((o,i,arr) => {
      ...
      all.push(`<canvas class='CANVAS CAKE' id='${boardid}' data-frameid='${frameid}' width='441' height='320' ></canvas>`);
      all.push('</article>');
      all.push('');
    })
    //
  ...
  to_butt_contents(boardid){
    return `\
       <button name='${boardid}' id='op-${boardid}' class="BUTTON CAKE" role="button" onclick="board_oncakeclicked(this.name,this)" ></button>
       `;
  }
  to_tool_contents(boardid){
    return `\
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:136px;z-index:10;' >
             <input  class='ONETE'          name='${boardid}'  type='text'                      onchange="board_one_te_changed(this.value,this.name)" />

             <button class='ONEOP DOT'      name='${boardid}'  data-op='pencil'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='${boardid}'  data-op='poly'                   onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='${boardid}'  data-op='square'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='${boardid}'  data-op='smudge'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='${boardid}'  data-op='select'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='${boardid}'  data-op='cplane'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='${boardid}'  data-op='xyplane'                onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='${boardid}'  data-op='ball'                   onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP HIDE'     name='${boardid}'  data-op='hide'                   onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP HIDE'     name='${boardid}'  data-op='hide'                   onclick="board_oneopclicked(this.name             ,this)" />

             <button class='ONECL DOT'      name='${boardid}'  data-cl='0'                      onclick="board_oneclclicked(this.name,0,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='1'                      onclick="board_oneclclicked(this.name,1,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='2'                      onclick="board_oneclclicked(this.name,2,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='3'                      onclick="board_oneclclicked(this.name,3,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='4'                      onclick="board_oneclclicked(this.name,4,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='5'                      onclick="board_oneclclicked(this.name,5,this)" />         
             <button class='ONECL'          name='${boardid}'  data-cl='6'                      onclick="board_oneclclicked(this.name,6,this)" />         

             <button class='ONEST'          name='${boardid}'  data-st='0'                      onclick="board_one_stclicked(this.name,0,this)" />        
             <button class='ONEST DOT'      name='${boardid}'  data-st='1'                      onclick="board_one_stclicked(this.name,1,this)" />        
             <button class='ONEST'          name='${boardid}'  data-st='2'                      onclick="board_one_stclicked(this.name,2,this)" />        

             <button class='ONEAT'          name='${boardid}'  data-at='acton'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='clear'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='cropp'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='cutbd'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='paste'                  onclick="board_one_atclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data-at='zoomo'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='zoomi'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='rotcl'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='rotcr'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT HIDE'     name='${boardid}'  data-at='hide'                   onclick="board_one_atclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data-at='fopen'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='dload'                  onclick="board_one_atclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='uload'                  onclick="board_one_atclicked(this.name,this)" />
             <button class='ONEAT'          name='${boardid}'  data-at='darkb'                  onclick="board_one_atclicked(this.name,this)" />
             <button class='ONEAT HIDE'     name='${boardid}'  data-at='hide'                   onclick="board_one_atclicked(this.name,this)" />

       </div>
             <input id='fopen-${boardid}' name='${boardid}'  type='file' style='display:none' onchange='board_fopen_clicked(this.name,this)'/>
             <a     id='dload-${boardid}' name='${boardid}'  type='text' style='display:none' onclick="board_dload_clicked(this,this.name,'image.png')">&#x2B73;</a>
...
*/
    ...
    function board_fopen_clicked(name,e){
      ...
      if(e.files[0]){
        ...
        img.onload = function(){
          var str = ".ONEOP[name="+name+"]"+"[data-op=select]";
          var button_e = document.querySelector(str);
          board_oneopclicked(name,button_e);
          var o = ctx.cake;
