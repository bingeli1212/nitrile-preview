...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`<canvas class='CANVAS CAKE' id='${boardid}' data-frameid='${frameid}' width='441' height='320' data-boardpng='${boardpng}' onmouseenter="board_onmouseenter()" onmoueleave="board_onmouseleave()" onmousedown="board_onmousedown()" onmousemove="board_onmousemove()" onmouseup="board_onmouseup()" ontouchstart="board_ontouchstart()" ontouchmove="board_ontouchmove()" ontouchend="board_ontouchend()" ontouchcancel="board_ontouchcancel()" ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
...
console.log('board_onmouseenter')
      var evt = event;
      var canvas = evt.target;
      all_canvas = canvas;
      var ctx = canvas.getContext("2d");
