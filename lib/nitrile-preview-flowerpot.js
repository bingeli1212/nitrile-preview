...
`;
    ...
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <button class='ONEOP'          name='1-${boardid}'  data-op='rtriangle'              onclick="board_oneopclicked(this.name,'rtriangle' ,this)" />
       ...
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <button class='ONEOP'          name='2-${boardid}'  data-op='rtriangle'              onclick="board_oneopclicked(this.name,'rtriangle' ,this)" />
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','square':'&#x25B1;','triangle':'&#x25B3;','rtriangle':'&#x25FA;','eraser':'&#x2B1A;','smudge':'&#x25A8;','select':'&#x26F6;','cplane':'&#x1D456;','ball':'&#x26CB;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;','fopen':'&#x1F4C2;','dload':'&#x2728;'};
    ...
    function board_redraw(ctx,canvas){
      ...
      || ctx.cake.myop=='rtriangle'){ //board_redraw
        ctx.resetTransform();
        if(o.mysquare.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.mysquare.s,0,0);
        ...
        if(o.mysquare.w && o.mysquare.h){
          ...
          ctx.rotate(o.mysquare.rotate/180*Math.PI);
          ctx.translate(-o.mysquare.w/2,-o.mysquare.w/2);
          ///draw square itself
          switch(o.myop){
            case 'square':
...
console.log('triangle');
    ...
    function board_start(ctx,canvas){
      ...
      || ctx.cake.myop=='rtriangle'){ //board_start
        ...
        if(1){
          ...
          o.mysquare.points.forEach((pt,i) => {
            ...
            if(ctx.isPointInStroke(path2d, ctx.posx0,ctx.posy0)){
              if(o.mysquare.corner_i == i){
                o.mysquare.corner_t = (o.mysquare.corner_t + 1) % 3;
              }else{
                o.mysquare.corner_i = i;
                o.mysquare.corner_t = 1;
              }
        ...
        console.log('square corner',o.mysquare.corner_i,o.mysquare.corner_t);
    ...
    function board_drag(ctx,canvas){
      ...
      || ctx.cake.myop=='rtriangle'){//board_drag
        if(o.mysquare.altKey){
          let posx0 = ctx.posx0;
          let posy0 = ctx.posy0;
          let posx2 = ctx.posx2;
        ...
        var points = [];
        points.push([o.mysquare.w/2,               o.mysquare.h/2]);
        points.push([0,                            0]);
    ...
    function board_end(ctx,canvas){
      ...
      || ctx.cake.myop=='rtriangle'){ //board_end
