...
`;
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','select':'&#x2B1A;','smudge':'&#x271C;','eraser':'&#x232B;','cplane':'C','ball':'B'};
...
console.log('REDRAW ball');
    ...
    function board_text(v,ctx,canvas){
      var o = board_last_cake(ctx,canvas); 
      o.mytext = v;
    }
    ...
    function board_drag(ctx,canvas){
      ...
      if(o.myop=='cplane'){//board_drag
        ...
        if(o.pointisinhandle){
          ...
          o.origin_x += diff_x;
          o.origin_y += diff_y;
console.log('diff_x,diff_y',diff_x,diff_y,o.origin_x,o.origin_y);
        }
        board_redraw(ctx,canvas);
      }
      if(o.myop=='ball'){
