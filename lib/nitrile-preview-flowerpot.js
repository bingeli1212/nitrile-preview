...
`;
  ...
  to_setup_script(){
    ...
    function board_action(ctx,canvas){
      if(ctx.mode=='note'){
        note_action(ctx,canvas);
      }else if(ctx.mode=='cplane'){
        cplane_action(ctx,canvas);
      }else if(ctx.mode=='xyplane'){
        xyplane_action(ctx,canvas);
      }else if(ctx.mode=='ball'){
        ball_action(ctx,canvas);
      }
    }
    function board_changecolor(v,ctx,canvas){
      if(ctx.mode=='note'){
        note_changecolor(v,ctx,canvas);
      }else if(ctx.mode=='cplane'){
        cplane_changecolor(v,ctx,canvas);
      }else if(ctx.mode=='xyplane'){
        xyplane_changecolor(v,ctx,canvas);
      }else if(ctx.mode=='ball'){
        ball_changecolor(v,ctx,canvas);
      }
      if(1){
    ...
    function board_changestroke(v,ctx,canvas){
      if(ctx.mode=='note'){
        note_changestroke(v,ctx,canvas);
      }else if(ctx.mode=='cplane'){
        cplane_changestroke(v,ctx,canvas);
      }else if(ctx.mode=='xyplane'){
        xyplane_changestroke(v,ctx,canvas);
      }else if(ctx.mode=='ball'){
        ball_changestroke(v,ctx,canvas);
      }
      if(1){
    ...
    function board_handle_keydown(shiftKey,keycode,ctx,canvas){
      ...
      case 'KeyZ':
        board_changecolor(0,ctx,canvas);
        break;
      case 'KeyX':
        board_changecolor(1,ctx,canvas);
        break;
      case 'KeyC':
        board_changecolor(2,ctx,canvas);
        break;
      case 'KeyV':
        board_changecolor(3,ctx,canvas);
        break;
      case 'KeyB':
        board_changecolor(4,ctx,canvas);   
        break;
      case 'KeyN':
        board_changecolor(5,ctx,canvas);   
        break;
      case 'KeyM':
        board_changecolor(6,ctx,canvas);   
        break;
      ///STROKES
      case 'Minus':
        board_changestroke(0,ctx,canvas);
        break;
      case 'Equal':
        board_changestroke(1,ctx,canvas);
        break;
      case 'Backslash':
        ///ZOOM-RESET       
        ctx.note.zoom = 1;
      ...
      case 'Comma':
        if(shiftKey){
          ...
          id = id % all_colors.length;
          board_changecolor(id,ctx,canvas);
        }
        break;
      case 'Period':
        if(shiftKey){
    ...
    function note_changecolor(v,ctx,canvas){
      ctx.note.mycolorid = v;
      //let n = ctx.note.myundo.length;
      //let o = ctx.note.myundo[n-1];
      //o.myfig.mycolor = board_curr_color(ctx,canvas);
    }
    function note_changestroke(v,ctx,canvas){
    ...
    function note_action(ctx,canvas){
    }
...
//console.log('diff_y=',diff_y,'diff_x=',diff_x,'dy=',dy,'dx=',dx);
    ...
    function cplane_changecolor(v,ctx,canvas){
    }
    function cplane_changestroke(v,ctx,canvas){
    }
    ...
    function cplane_action(ctx,canvas){
      ctx.note.rotate_ang = 0;
      ctx.note.scale_factor = 1;
      ctx.note.move_x = 0;
      ctx.note.move_y = 0;
...
//console.log('val_real=',val_real,'val_imag=',val_imag,'which=',which);
    ...
    function xyplane_changecolor(v,ctx,canvas){
    }
    function xyplane_changestroke(v,ctx,canvas){
    }
    function xyplane_shape(v,ctx,canvas){
    }
    function xyplane_reset(ctx,canvas){
    }
    function xyplane_action(ctx,canvas){
    }
...
//console.log('x-intercept','y0=',y0,'yi=',yi,'x0=',x0,'xii=',xii,'sign0=',sign0,'sign=',sign);
    ...
    function ball_changecolor(v,ctx,canvas){
      ctx.note.mycolorid = v;
      if(ctx.note.hit_ball){
        ctx.note.hit_ball.color = board_curr_color(ctx,canvas);
      }
    }
    function ball_changestroke(v,ctx,canvas){
    }
    ...
    function ball_action(ctx,canvas){
    }
