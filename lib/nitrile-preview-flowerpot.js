...
`;
  ...
  to_setup_script(){
    ...
    all_shapes = ['square','triangle','ellipse','line'];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','square':'&#x26CB;','triangle':'&#x25B3;','ellipse':'&#x2B2D;','eraser':'&#x2B1A;','smudge':'&#x26C6;','select':'&#x26F6;','cplane':'&#x1D465;&#x1D456;','ball':'&#x2699;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;'};
...
console.log('board_onsubmitclicked',name,e);
    ...
    function board_redraw(ctx,canvas){
      ...
      if(ctx.cake.myop=='select'){ //board_redraw select
        ...
        if(w && h){
          ...
          ctx.globalAlpha = 1.0;   
          ctx.lineWidth = 1;   
          if(canvas.classList.contains('DARKB')){
      ...
      if(ctx.cake.myop=='poly'){ //board_redraw 'poly'
      }
      if(ctx.cake.myop=='square'){    //board_redraw square
        ...
        if(o.myrotation){
          o.mysquare.rotation += o.myrotation; 
          o.myrotation = 0; //reset it to zero
        }
        if(o.myaction){
          o.myaction = 0;
          o.mysquare.shape += 1;
          o.mysquare.shape %= all_shapes.length;
          o.mysquare.skewX = 0;
          o.mysquare.skewY = 0;
          o.mysquare.rotation = 0;
        }
        if(o.mysquare.w || o.mysquare.h){
          ...
          ctx.save();
          ///
          let path2d = ball_get_path2d(o.mysquare);
          let corners = ball_get_corners(o.mysquare);
          let center_p = ball_get_center_p(o.mysquare);
          ///transform
      ...
      if(ctx.cake.myop=='xyplane'){ //board_redraw xyplane
        ctx.resetTransform();
        ctx.clearRect(0,0, canvas.width,canvas.height);
        //ctx.fillStyle = 'black';
        //ctx.fillRect(0,0, canvas.width,canvas.height);
      ...
      if(ctx.cake.myop=='ball'){ //board_redraw ball
        ...
        if(o.myaction){
          ...
          if(o.myball.hitball){
            ...
            o.myball.hitball.shape %= all_shapes.length;
    ...
    function board_addpolypt_square(squa, mypoly, ctx,canvas){
      let corners = ball_get_corners(squa);
      switch(squa.shape){
        case 0: {
    ...
    function board_paste(ctx,canvas){
      ...
      if(o.myop=='square'){
        if(o.mysquare.clipshape){
          ...
          o.mysquare.x = canvas.width/2;
          o.mysquare.y = canvas.height/2;
          o.mysquare.w = 30;
          o.mysquare.h = 30;
          o.mysquare.skewX = 0;
          o.mysquare.skewY = 0;
      ...
      if(o.myop=='ball'){
        ...
        if(o.myball.clipball){
          ...
          let w = 30;
          let h = 30;
          let ball = ball_new_ball(o.mycolorid,x,y);
          o.myball.hitball = ball;
          o.myball.balls.push(ball);
        }
      }
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.cake.myop=='poly'){ //board_start poly
      ...
      if(ctx.cake.myop=='square'){    //board_start square
        ...
        if(1){ ///determine which corner index
          ...
          o.mysquare.isfringe = ctx.isPointInStroke(path2d, ctx.posx0,ctx.posy0);
          o.mysquare.corner_i = -1;
          corners.forEach((pt,i) => {
            let {x,y} = pt;
            let sx = ctx.posx0;
            let sy = ctx.posy0;
            if(Number.isFinite(x) && Number.isFinite(y)){
              let path2d_corner = new Path2D();
              let corner_size = 4;
              path2d_corner.arc(x,y,corner_size,0,2*Math.PI,0);
              path2d_corner.closePath();
              ctx.lineWidth=10;
              if(ctx.isPointInPath(path2d_corner, sx,sy)){
                o.mysquare.corner_i = i;
                success = 1;
              }else if(ctx.isPointInStroke(path2d_corner, sx,sy)){                     
                o.mysquare.corner_i = i;
                success = 1;
              }
            }
        ...
        let {altKey,shiftKey,isinside,isfringe,corner_i} = o.mysquare;
        if(altKey && shiftKey){
          if(o.mysquare.face){
            o.mysquare.s = o.mysquare.face;
            o.mysquare.face = null;
      ...
      if(ctx.cake.myop=='eraser'){ //board_start eraser
        o.myfig.x = ctx.posx0;
        o.myfig.y = ctx.posy0;
        o.myfig.w = 0;
        o.myfig.h = 0;
      ...
      if(ctx.cake.myop=='ball'){ //board_start ball
        ...
        if(altKey && shiftKey){
          if(o.myball.hitball){
            ...
            var corner_i = 0;
            var colorid = o.mycolorid;
            var m = Math.PI/180;
            if(1){                  
              let ball = {shape:0,corner_i,colorid,x,y,w:30,h:30,skewX:0,skewY:0,rotation:0};
              o.myball.balls.push(ball);
          ...
          o.myball.x = ctx.posx0;
          o.myball.y = ctx.posy0;
          o.myball.w = 0;
          o.myball.h = 0;
console.log('istodo is select',o.myball.istodo);
        }else{
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){ //board_drag ball
        ...
        if(o.myball.istodo=='move'){
          ...
          o.myball.w = ctx.posx2 - ctx.posx0;
          o.myball.h = ctx.posy2 - ctx.posy0;
    ...
    function ball_new_ball(colorid,x,y){
      let ball = {shape:0,corner_i:-1,colorid,x,y,w:30,h:30,skewX:0,skewY:0,rotation:0};
      return ball;
    }
    ///////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////
