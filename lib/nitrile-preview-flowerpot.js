    ...
    function board_redraw(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){ //board_redraw ball
        ...
        if(o.myaction){
          o.myaction = 0;
          if(o.myball.hitball){
            o.myball.hitball.shape += 1;
            o.myball.hitball.shape %= 4;
            o.myball.hitball.skewX = 0;
            o.myball.hitball.skewY = 0;
            o.myball.hitball.rotation = 0;
            o.myball.hitball.w = 30;
            o.myball.hitball.h = 30;
          }
        }
        if(o.myball.hitball){
...
console.log('pointisinhandle',o.mycplane.pointisinhandle);
      ...
      if(ctx.cake.myop=='xyplane'){ //board_start xyplane
        ...
        ///////////////////////////////
        o.myxyplane.info_tt = '';
        for(var j=0; j < o.myxyplane.y_intercepts.length; ++j){
          var p = o.myxyplane.y_intercepts[j];
          ctx.lineWidth=10;
        ...
        for(var j=0; j < o.myxyplane.x_intercepts.length; ++j){
          var p = o.myxyplane.x_intercepts[j];
          ctx.lineWidth=10;
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='cplane'){ //board_drag cplane
        ...
        if(o.mycplane.pointisinhandle){
          ...
          var diff_x = ctx.posx2 - o.mycplane.origin_x;
          var diff_y = ctx.posy2 - o.mycplane.origin_y;
      ...
      if(ctx.cake.myop=='ball'){ //board_drag ball
        ...
        if(ball){
          if((ball.corner_i == 0) && (ball.corner_t == 2)){
            ...
            let rot_ang = (angle1-angle0)/Math.PI*180;
            let rot_rad = (angle1-angle0);
            board_rotate(rot_ang, ctx,canvas);
