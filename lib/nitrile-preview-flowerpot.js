    ...
    return `\
       ...
       <select name='${canvasid}' onchange='select_change_line(this.value,this.name)'>
          <optgroup label='Lines'>
           <option value='line/1.5'>Thin line</option>
           <option value='line/2.5'>Med line</option>
           <option value='line/4'>Thick line</option>
          </optgroup>
          <optgroup label='Areas'>
           <option value='area/1.5'>Thin line</option>
           <option value='area/2.5'>Med line</option>
           <option value='area/4'>Thick line</option>
          </optgroup>
          <optgroup label='Erasers'>
            <option value='eraser/1.5'>Thin eraser</option>
            <option value='eraser/2.5'>Med eraser</option>
            <option value='eraser/4'>Thick eraser</option>
            <option value='eraser/0'>Erase All</option>
         </optgroup>
       </select>
       `;
  }
