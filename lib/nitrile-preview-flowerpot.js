...
`;
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','square':'&#x25B1;','eraser':'&#x2B1A;','smudge':'&#x25A8;','select':'&#x26F6;','cplane':'&#x1D456;','ball':'&#x26CB;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;','fopen':'&#x1F4C2;','dload':'&#x2728;'};
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.cake.myop=='square'){ //board_start
        ...
        if(o.mysquare.shiftKey && o.mysquare.face && o.mysquare.corner_i == 0){
          o.mysquare.s = o.mysquare.face;
          o.mysquare.face = null;
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.mysquare.s, 0,0);
          o.mysquare.x = ctx.posx0 - o.mysquare.w/2;
          o.mysquare.y = ctx.posy0 - o.mysquare.h/2;
        }
      }
