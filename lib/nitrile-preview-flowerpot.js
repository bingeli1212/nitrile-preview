...
`;
  ...
  to_setup_script(){
    ...
    function board_enter(ctx,canvas){
      ...
      || o.myop=='select'   //board_enter select
    ...
    function board_start(ctx,canvas){
      ...
      || ctx.cake.myop=='ellipse' ){  //board_start ellipse
        ...
        if(o.mysquare.altKey && o.mysquare.shiftKey && o.mysquare.face){
          if(o.mysquare.isnewlycorner && o.mysquare.corner_i == 0){
            //add to polypts
            let x0 = o.mysquare.x;
            let y0 = o.mysquare.y;
            if(o.myop=='square'){
            ...
            o.mysquare.face = null;
            o.mysquare.keepold = 1;
            o.mysquare.w = 0;//completely elliminate the sketch
            o.mysquare.h = 0;
          }
