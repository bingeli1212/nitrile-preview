...
`;
  ...
  write_one_frame(id,order,icon,frame,issub,parentid,toc,pages,topframe){
    ...
    let buttonckid= `buttonck${id}`;
    let imgid   = `img${id}`;
    let boardname = frame.boardname;
    let boardpng = boardname?boardname+'.png':'';
    let edit_contents = this.to_edit_contents(boardid,buttonopid,buttonshid,buttonclid,buttonckid);
    all.push(`<article class='SLIDE' id='${frameid}' row='${frame.style.row}' style='--boardpng:url("${boardpng}");background-image:var(--boardpng),var(--logosvg),var(--bgsvg);background-repeat:no-repeat;background-position:88px 40px,top left,top left;background-size:441px 320px,88px 40px,cover;' >`);
    pages.push(1);
    all.push(`<div class='BOTTOMCONTAINER'>`);
    all.push(`<div class='EDITFORM' > ${edit_contents} </div>`);
    ...
    all.push(`<canvas class='EDITBOARD' id='${boardid}' data-type='board' data-imgid='${imgid}' data-boardname='${boardname}' data-frameid='${frameid}' data-buttonopid='${buttonopid}' data-buttonshid='${buttonshid}' data-buttonclid='${buttonclid}' data-buttonckid='${buttonckid}' width='441' height='320' ></canvas>`);
    all.push('</article>');
    all.push('');
    // 
    ...
    frame.solutions.forEach((o,i,arr) => {
      ...
      let buttonckid= `buttonck${id}a${i}`;
  ...
  to_edit_contents(boardid){
    return `\
       ...
       <div style='position:relative'>
         <button name='1-${boardid}' id='op-1-${boardid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' ></button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONESH' name='1-${boardid}'  data-sh='line'     onclick="board_oneshclicked(this.name,'line')">    &#x2216;</button>
             <button class='ONESH' name='1-${boardid}'  data-sh='tri'      onclick="board_oneshclicked(this.name,'tri')">      </button>
             <button class='ONESH' name='1-${boardid}'  data-sh='rect'     onclick="board_oneshclicked(this.name,'rect')">     </button>
             <button class='ONESH' name='1-${boardid}'  data-sh='pentagon' onclick="board_oneshclicked(this.name,'pentagon')"> </button>
             <button class='ONESH' name='1-${boardid}'  data-sh='hexagon'  onclick="board_oneshclicked(this.name,'hexagon')">  </button>
             <button class='ONESH' name='1-${boardid}'  data-sh='circle'   onclick="board_oneshclicked(this.name,'circle')">   </button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL' name='1-${boardid}'  data-cl='0'        onclick="board_oncoloridclicked(this.name,0)"></button>
             <button class='ONECL' name='1-${boardid}'  data-cl='1'        onclick="board_oncoloridclicked(this.name,1)"></button>
             <button class='ONECL' name='1-${boardid}'  data-cl='2'        onclick="board_oncoloridclicked(this.name,2)"></button>
             <button class='ONECL' name='1-${boardid}'  data-cl='3'        onclick="board_oncoloridclicked(this.name,3)"></button>
             <button class='ONECL' name='1-${boardid}'  data-cl='4'        onclick="board_oncoloridclicked(this.name,4)"></button>
             <button class='ONECL' name='1-${boardid}'  data-cl='5'        onclick="board_oncoloridclicked(this.name,5)"></button>
             <button class='ONECL' name='1-${boardid}'  data-cl='6'        onclick="board_oncoloridclicked(this.name,6)"></button>
             <button class='ONEST' name='1-${boardid}'  data-st='0'        onclick="board_onestrokeclicked(this.name,0)"></button>
             <button class='ONEST' name='1-${boardid}'  data-st='1'        onclick="board_onestrokeclicked(this.name,1)"></button>
           </div>
         </div>
         <button name='2-${boardid}' id='op-2-${boardid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' ></button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONESH' name='2-${boardid}'  data-sh='line'     onclick="board_oneshclicked(this.name,'line')">    &#x2216;</button>
             <button class='ONESH' name='2-${boardid}'  data-sh='tri'      onclick="board_oneshclicked(this.name,'tri')">      </button>
             <button class='ONESH' name='2-${boardid}'  data-sh='rect'     onclick="board_oneshclicked(this.name,'rect')">     </button>
             <button class='ONESH' name='2-${boardid}'  data-sh='pentagon' onclick="board_oneshclicked(this.name,'pentagon')"> </button>
             <button class='ONESH' name='2-${boardid}'  data-sh='hexagon'  onclick="board_oneshclicked(this.name,'hexagon')">  </button>
             <button class='ONESH' name='2-${boardid}'  data-sh='circle'   onclick="board_oneshclicked(this.name,'circle')">   </button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL' name='2-${boardid}'  data-cl='0'        onclick="board_oncoloridchanded(this.name,0)"></button>
             <button class='ONECL' name='2-${boardid}'  data-cl='1'        onclick="board_oncoloridclicked(this.name,1)"></button>
             <button class='ONECL' name='2-${boardid}'  data-cl='2'        onclick="board_oncoloridclicked(this.name,2)"></button>
             <button class='ONECL' name='2-${boardid}'  data-cl='3'        onclick="board_oncoloridclicked(this.name,3)"></button>
             <button class='ONECL' name='2-${boardid}'  data-cl='4'        onclick="board_oncoloridclicked(this.name,4)"></button>
             <button class='ONECL' name='2-${boardid}'  data-cl='5'        onclick="board_oncoloridclicked(this.name,5)"></button>
             <button class='ONECL' name='2-${boardid}'  data-cl='6'        onclick="board_oncoloridclicked(this.name,6)"></button>
             <button class='ONEST' name='2-${boardid}'  data-st='0'        onclick="board_onestrokeclicked(this.name,0)"></button>
             <button class='ONEST' name='2-${boardid}'  data-st='1'        onclick="board_onestrokeclicked(this.name,1)"></button>
           </div>
         </div>
       </div>
       `;
  ...
  to_setup_script(){
    ...
    function board_oncoloridclicked(name,v){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
    ...
    function board_oncakeclicked(i,name){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      ctx.cake = ctx.cakes[i];
      ctx.cake_i = i;
      board_redraw(ctx,canvas);
    }
...
console.log('board_redraw',ctx.myop,'id=',canvas.id);
      var o = ctx.cake;          
      ctx.resetTransform();
      ctx.clearRect(0,0, canvas.width,canvas.height);
      if(ctx.myop=='select'){//board_redraw
        if(o.s){
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='circle'){//board_redraw
        if(o.myfig.s){
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='hexagon'){//board_redraw
        if(o.myfig.s){
          ctx.putImageData(o.myfig.s,0,0);
        }
        //REDRAW
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='pentagon'){//board_redraw
        if(o.myfig.s){
          ctx.putImageData(o.myfig.s,0,0);
        }
        //REDRAW
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='rect'){//board_redraw
        if(o.myfig.s){
          ctx.putImageData(o.myfig.s,0,0);
        }
        //REDRAW
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='tri'){//board_redraw
        if(o.myfig.s){
          ctx.putImageData(o.myfig.s,0,0);
        }
        //REDRAW
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='line'){//board_redraw
        if(o.myfig.s){
          ctx.putImageData(o.myfig.s,0,0);
        }
        //REDRAW
      ...
      if(ctx.myop=='pencil' && o.myfig.sh==''){//board_redraw
        if(o.s){
          ctx.putImageData(o.s,0,0);
        }
      }
      if(ctx.myop=='smudge' ){//board_redraw
        if(o.s){
          ctx.putImageData(o.s,0,0);
        }
      }
      if(ctx.myop=='eraser' ){//board_redraw
        if(o.s){
          ctx.putImageData(o.s,0,0);
        }
      }
      if(ctx.myop=='cplane'){//board_redraw
        if(o.s){
          ctx.putImageData(o.s,0,0);
        }
        //REDRAW
...
console.log('3',a,b,c,d,e,f);
      ...
      if(ctx.myop=='xyplane'){//board_redraw
        if(o.s){
          ctx.putImageData(o.s,0,0);
        }
        ctx.resetTransform();
    ...
    function board_cakeid(ctx,canvas){
      if(1){
        let button_elem = document.getElementById(canvas.getAttribute('data-buttonckid'));
        let icon = ctx.cake_i+1;
        button_elem.innerHTML = ""+icon;
      }
    }
    ...
    function board_start(ctx,canvas){
      let o = ctx.cake;
      console.log('board_start',ctx.myop,'id=',canvas.id);
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='circle'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='hexagon'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='pentagon'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='rect'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='tri'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.myop=='pencil' && o.myfig.sh=='line'){//board_drag
        //DRAG  
        let x1 = ctx.posx0;
        let y1 = ctx.posy0;
        let x2 = ctx.posx2;
      ...
      if(ctx.myop=='pencil' && !o.myfig.sh){//board_drag
        if(ctx.shiftKey){
      ...
      if(ctx.myop=='xyplane'){//board_drag
        var diff_x = ctx.posx2 - ctx.posx1;
        var diff_y = ctx.posy2 - ctx.posy1;
        o.origin_x += diff_x;
        o.origin_y += diff_y;
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.myop=='cplane'){//board_end
      }
      if(ctx.myop=='ball'){//board_end
      }
      if(ctx.myop=='xyplane'){//board_end
      }
    }
    ////////////////////////////////////////////
    ////////////////////////////////////////////
