...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    pages.push(1);
    all.push(`<div class='TOPCONTAINER'> 
              <h1 class='SLIDETITLE'> <b>${id} ${this.uncode(frame.style,frame.title)}</b> </h1>
              <h2 class='SLIDESUBTITLE'> <b></b> </h2>
              </div>`);
  ...
  write_one_frame(id,order,icon,frame,issub,parentid,toc,pages,topframe){
    ...
    if(issub){
      all.push(`<div class='TOPCONTAINER'> 
                <h1 class='SLIDETITLE'><b> ${order} ${this.uncode(topframe.style,topframe.title)}</b> </h1>
