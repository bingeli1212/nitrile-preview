...
console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
      ...
      if(ctx.cake.myop=='select'){ //board_start
        if(o.mybasis.clipboard==null){
          ...
          if(ctx.altKey || isPointInRect(ctx.posx0,ctx.posy0, o.mybasis.x,o.mybasis.y,o.mybasis.w,o.mybasis.h)){
            //drag the hilited area around
            ctx.clearRect(0,0, canvas.width,canvas.height);
            if(o.mybasis.s){
            ...
            //make permanent and start another hilite
            ctx.clearRect(0,0, canvas.width,canvas.height);
            if(o.mybasis.s){
              ctx.putImageData(o.mybasis.s, 0,0);
            }
