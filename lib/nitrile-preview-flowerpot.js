...
`;
  ...
  to_edit_contents(boardid){
    return `\
       ...
       <div style='position:relative'>
         <button name='${boardid}' id='ck-${boardid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' >1</button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:17px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECK' name='${boardid}'    onclick="board_oneckclicked(this.name,'1' )">1</button>
             <button class='ONECK' name='${boardid}'    onclick="board_oneckclicked(this.name,'2' )">2</button>
           </div>
         </div>
       </div>
       <div style='position:relative'>
         <button name='${boardid}' id='op-${boardid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' >&#x270E;</button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:51px;z-index:10;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL' name='${boardid}'  data-cl='0'        onclick="board_oncoloridclicked(this.name,0)"></button>
             <button class='ONECL' name='${boardid}'  data-cl='1'        onclick="board_oncoloridclicked(this.name,1)"></button>
             <button class='ONECL' name='${boardid}'  data-cl='2'        onclick="board_oncoloridclicked(this.name,2)"></button>
             <button class='ONECL' name='${boardid}'  data-cl='3'        onclick="board_oncoloridclicked(this.name,3)"></button>
             <button class='ONECL' name='${boardid}'  data-cl='4'        onclick="board_oncoloridclicked(this.name,4)"></button>
             <button class='ONECL' name='${boardid}'  data-cl='5'        onclick="board_oncoloridclicked(this.name,5)"></button>
             <button class='ONECL' name='${boardid}'  data-cl='6'        onclick="board_oncoloridclicked(this.name,6)"></button>
  ...
  to_setup_script(){
    ...
    function board_oneckclicked(name,v){
      ...
      let button_elem = document.getElementById("ck-"+name);
      let icon = ""+v;
      button_elem.innerHTML = icon;
      if(1){
