...
class NitrilePreviewFlowerpot extends NitrilePreviewSlide {
  ...
  to_document() {
    ...
    :root {
      ...
      --buttoncopy: url("data:image/svg+xml;base64,");
      --buttonpaste: url("data:image/svg+xml;base64,");
    }
    :root {
${allsidesvgs.join('\n')}
    }
...
`;
  ...
  to_edit_contents(boardid,buttonopid,buttonshid,buttonclid,buttonckid){
    return `\
       ...
       <div style='position:relative'>
         <button name='${boardid}' id='${buttonckid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' ></button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECK' name='${boardid}'  data-ck='0'  onclick="board_oncakeidchanged(this.name,1)">1</button>
             <button class='ONECK' name='${boardid}'  data-ck='1'  onclick="board_oncakeidchanged(this.name,2)">2</button>
             <button class='ONECK' name='${boardid}'  data-ck='2'  onclick="board_oncakeidchanged(this.name,3)">3</button>
             <button class='ONECK' name='${boardid}'  data-ck='3'  onclick="board_oncakeidchanged(this.name,4)">4</button>
           </div>
         </div>
       </div>
       <button name='${boardid}' class="BUTTON COPY" role="button" onclick='board_oncopyclicked(this.name)'   ></button>
       <button name='${boardid}' class="BUTTON PASTE" role="button" onclick='board_onpasteclicked(this.name)'  ></button>
       `;
  }
  ////////////////////////////////////////////////////////////////////////
  //
  ...
  to_setup_script(){
    ...
    function board_setup_canvas(canvas){
      ...
      if(1){
        ...
        board_shapeid(ctx,canvas);
        board_cakeid(ctx,canvas);
      }
    }
    ...
    function board_oncakeidchanged(name,v){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      ctx.cake_i = parseInt(v)-1;
...
console.log('board_redraw',ctx.cake_i);
      var o = ctx.cake;          
      ctx.resetTransform();
...
console.log('3',a,b,c,d,e,f);
    ...
    function board_shapeid(ctx,canvas){
      if(1){
    ...
    function board_start(ctx,canvas){
      let o = ctx.cake;
      console.log('board_start',ctx.myop);
