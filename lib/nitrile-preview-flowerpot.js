...
`;
       ...
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:51px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONEOP' name='1-${boardid}'  data-op='pencil'   onclick="board_oneopclicked(this.name,'pencil' )"></button>
             <button class='ONEOP' name='1-${boardid}'  data-op='select'   onclick="board_oneopclicked(this.name,'select' )"></button>
             <button class='ONEOP' name='1-${boardid}'  data-op='smudge'   onclick="board_oneopclicked(this.name,'smudge' )"></button>
             <button class='ONEOP' name='1-${boardid}'  data-op='eraser'   onclick="board_oneopclicked(this.name,'eraser' )"></button>
             <button class='ONEOP' name='1-${boardid}'  data-op='cplane'   onclick="board_oneopclicked(this.name,'cplane' )"></button>
             <button class='ONEOP' name='1-${boardid}'  data-op='ball'     onclick="board_oneopclicked(this.name,'ball'   )"></button>
             <button class='ONEOP' name='1-${boardid}'  data-op='xyplane'  onclick="board_oneopclicked(this.name,'xyplane')"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL DOT' name='1-${boardid}'  data-cl='0'        onclick="board_oncoloridclicked(this.name,0,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='1'        onclick="board_oncoloridclicked(this.name,1,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='2'        onclick="board_oncoloridclicked(this.name,2,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='3'        onclick="board_oncoloridclicked(this.name,3,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='4'        onclick="board_oncoloridclicked(this.name,4,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='5'        onclick="board_oncoloridclicked(this.name,5,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='6'        onclick="board_oncoloridclicked(this.name,6,this)"></button>
             <button class='ONEST DOT' name='1-${boardid}'  data-st='0'        onclick="board_onestrokeclicked(this.name,0,this)"></button>
             <button class='ONEST'     name='1-${boardid}'  data-st='1'        onclick="board_onestrokeclicked(this.name,1,this)"></button>
           </div>
         </div>
       </div>
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:51px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONEOP' name='2-${boardid}'  data-op='pencil'   onclick="board_oneopclicked(this.name,'pencil' )"></button>
             <button class='ONEOP' name='2-${boardid}'  data-op='select'   onclick="board_oneopclicked(this.name,'select' )"></button>
             <button class='ONEOP' name='2-${boardid}'  data-op='smudge'   onclick="board_oneopclicked(this.name,'smudge' )"></button>
             <button class='ONEOP' name='2-${boardid}'  data-op='eraser'   onclick="board_oneopclicked(this.name,'eraser' )"></button>
             <button class='ONEOP' name='2-${boardid}'  data-op='cplane'   onclick="board_oneopclicked(this.name,'cplane' )"></button>
             <button class='ONEOP' name='2-${boardid}'  data-op='ball'     onclick="board_oneopclicked(this.name,'ball'   )"></button>
             <button class='ONEOP' name='2-${boardid}'  data-op='xyplane'  onclick="board_oneopclicked(this.name,'xyplane')"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL DOT' name='2-${boardid}'  data-cl='0'        onclick="board_oncoloridclicked(this.name,0,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='1'        onclick="board_oncoloridclicked(this.name,1,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='2'        onclick="board_oncoloridclicked(this.name,2,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='3'        onclick="board_oncoloridclicked(this.name,3,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='4'        onclick="board_oncoloridclicked(this.name,4,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='5'        onclick="board_oncoloridclicked(this.name,5,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='6'        onclick="board_oncoloridclicked(this.name,6,this)"></button>
             <button class='ONEST DOT' name='2-${boardid}'  data-st='0'        onclick="board_onestrokeclicked(this.name,0,this)"></button>
             <button class='ONEST'     name='2-${boardid}'  data-st='1'        onclick="board_onestrokeclicked(this.name,1,this)"></button>
           </div>
         </div>
       </div>
       `;
  ...
  to_setup_script(){
    ...
    function board_oncoloridclicked(name,v,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
    ...
    function board_onestrokeclicked(name,v,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
