...
console.log('board_onsubmitclicked',name,e);
    ...
    function board_get_ball_points(v,ctx,canvas){
      let points = [];
      let m = Math.PI/180;
      switch(v){
      case 'line':
      ...
      if(ctx.cake.myop=='ball'){ //board_start ball
        ...
        if(altKey && shiftKey){
          if(o.myball.hitball){
            ...
            var color = 'gray';
            var m = Math.PI/180;
            var points = board_get_ball_points('tri',ctx,canvas);
            if(points.length){
          ...
          if(o.myball.hitball){
            //this allows for searching for the middle pivot point
            o.myball.hitball.corner_i = ball_findcorner(ctx.posx0,ctx.posy0, o.myball.hitball,ctx);
          }
          if(!o.myball.hitball || o.myball.hitball.corner_i == -1){
            o.myball.hitball = ball_findhitball(ctx.posx0,ctx.posy0, o.myball.balls,ctx);
            if(o.myball.hitball){
              o.myball.hitball.corner_i = ball_findcorner(ctx.posx0,ctx.posy0, o.myball.hitball,ctx);
            }
          }
    ...
    function ball_findcorner(sx,sy, hitball,ctx){
    ...
    function ball_findhitball(sx,sy, balls,ctx){
