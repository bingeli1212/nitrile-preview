...
${allsidesvgs.join('\n')}
    ...
    .DROPDOWNCONTAINER:hover .BUTTON.CAKE + .DROPMENU {
      visibility: visible;
    }
    .BUTTON {
      background-color: black;
    ...
    .BUTTON.COPY {
      background-image: var(--buttoncopy);
    }
    .BUTTON.PASTE {
      background-image: var(--buttonpaste);
    }
    .BUTTON.CAKE {
      background-image: var(--onedotwhite);
    }
...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`</div>`);
    all.push(`<canvas class='CANVAS'      id='2-${boardid}' data-frameid='${frameid}' width='441' height='320' ></canvas>`);
    all.push(`<canvas class='CANVAS CAKE' id='1-${boardid}' data-frameid='${frameid}' width='441' height='320' ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
  ...
  to_edit_contents(boardid){
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         <button name='${boardid}' id='op-1-${boardid}' class="BUTTON CAKE" role="button" onclick="board_oncakeclicked(this.name,'1')" ></button>
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             <button class='ONEOP DOT'      name='1-${boardid}'  data-op='hand'                   onclick="board_oneopclicked(this.name,'hand'      ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='pencil'                 onclick="board_oneopclicked(this.name,'pencil'    ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='poly'                   onclick="board_oneopclicked(this.name,'poly'      ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='square'                 onclick="board_oneopclicked(this.name,'square'    ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='triangle'               onclick="board_oneopclicked(this.name,'triangle'  ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='ellipse'                onclick="board_oneopclicked(this.name,'ellipse'   ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='smudge'                 onclick="board_oneopclicked(this.name,'smudge'    ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='eraser'                 onclick="board_oneopclicked(this.name,'eraser'    ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='select'                 onclick="board_oneopclicked(this.name,'select'    ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='ball'                   onclick="board_oneopclicked(this.name,'ball'      ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='cplane'                 onclick="board_oneopclicked(this.name,'cplane'    ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='xyplane'                onclick="board_oneopclicked(this.name,'xyplane'   ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='fopen'                  onclick="board_oneopclicked(this.name,'fopen'     ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='dload'                  onclick="board_oneopclicked(this.name,'dload'     ,this)" />
             <button class='ONESH DOT'      name='1-${boardid}'  data-sh='tri'                    onclick="board_oneshclicked(this.name,'tri'       ,this)" />
             <button class='ONESH'          name='1-${boardid}'  data-sh='triur'                  onclick="board_oneshclicked(this.name,'triur'     ,this)" />
             <button class='ONESH'          name='1-${boardid}'  data-sh='rect'                   onclick="board_oneshclicked(this.name,'rect'      ,this)" />
             <button class='ONESH'          name='1-${boardid}'  data-sh='pentagon'               onclick="board_oneshclicked(this.name,'pentagon'  ,this)" />
             <button class='ONESH'          name='1-${boardid}'  data-sh='hexagon'                onclick="board_oneshclicked(this.name,'hexagon'   ,this)" />
             <button class='ONESH'          name='1-${boardid}'  data-sh='circle'                 onclick="board_oneshclicked(this.name,'circle'    ,this)" />
             <button class='ONECL DOT'      name='1-${boardid}'  data-cl='0'                      onclick="board_oneclclicked(this.name,0,this)" />         
             <button class='ONECL'          name='1-${boardid}'  data-cl='1'                      onclick="board_oneclclicked(this.name,1,this)" />         
             <button class='ONECL'          name='1-${boardid}'  data-cl='2'                      onclick="board_oneclclicked(this.name,2,this)" />         
             <button class='ONECL'          name='1-${boardid}'  data-cl='3'                      onclick="board_oneclclicked(this.name,3,this)" />         
             <button class='ONECL'          name='1-${boardid}'  data-cl='4'                      onclick="board_oneclclicked(this.name,4,this)" />         
             <button class='ONECL'          name='1-${boardid}'  data-cl='5'                      onclick="board_oneclclicked(this.name,5,this)" />         
             <button class='ONECL'          name='1-${boardid}'  data-cl='6'                      onclick="board_oneclclicked(this.name,6,this)" />         
             <button class='ONEST DOT'      name='1-${boardid}'  data-st='0'                      onclick="board_one_stclicked(this.name,0,this)" />        
             <button class='ONEST'          name='1-${boardid}'  data-st='1'                      onclick="board_one_stclicked(this.name,1,this)" />        
             <button class='ONEAT'          name='1-${boardid}'  data-at='0'                      onclick="board_one_atclicked(this.name,0,this)" />        
             <input  class='ONETE'          name='1-${boardid}'  type='text'                      onchange='board_one_te_changed(this.value,this.name)' />

             <input id='fopen-1-${boardid}' name='1-${boardid}'  type='file' style='display:none' onchange='board_fopen_clicked(this.name,this)'/>
             <a     id='dload-1-${boardid}' name='1-${boardid}'  type='text' style='display:none' onclick="board_dload_clicked(this,this.name,'image.png')">&#x2B73;</a>
         </div>
       </div>
       <div class='DROPDOWNCONTAINER' style='position:static'>
         <button name='${boardid}' id='op-2-${boardid}' class="BUTTON" role="button" onclick="board_oncakeclicked(this.name,'2')" ></button>
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             <button class='ONEOP DOT'      name='2-${boardid}'  data-op='hand'                   onclick="board_oneopclicked(this.name,'hand'      ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='pencil'                 onclick="board_oneopclicked(this.name,'pencil'    ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='poly'                   onclick="board_oneopclicked(this.name,'poly'      ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='square'                 onclick="board_oneopclicked(this.name,'square'    ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='triangle'               onclick="board_oneopclicked(this.name,'triangle'  ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='ellipse'                onclick="board_oneopclicked(this.name,'ellipse'   ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='smudge'                 onclick="board_oneopclicked(this.name,'smudge'    ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='eraser'                 onclick="board_oneopclicked(this.name,'eraser'    ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='select'                 onclick="board_oneopclicked(this.name,'select'    ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='ball'                   onclick="board_oneopclicked(this.name,'ball'      ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='cplane'                 onclick="board_oneopclicked(this.name,'cplane'    ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='xyplane'                onclick="board_oneopclicked(this.name,'xyplane'   ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='fopen'                  onclick="board_oneopclicked(this.name,'fopen'     ,this)" />
             <button class='ONEOP'          name='2-${boardid}'  data-op='dload'                  onclick="board_oneopclicked(this.name,'dload'     ,this)" />
             <button class='ONESH DOT'      name='2-${boardid}'  data-sh='tri'                    onclick="board_oneshclicked(this.name,'tri'       ,this)" />
             <button class='ONESH'          name='2-${boardid}'  data-sh='triur'                  onclick="board_oneshclicked(this.name,'triur'     ,this)" />
             <button class='ONESH'          name='2-${boardid}'  data-sh='rect'                   onclick="board_oneshclicked(this.name,'rect'      ,this)" />
             <button class='ONESH'          name='2-${boardid}'  data-sh='pentagon'               onclick="board_oneshclicked(this.name,'pentagon'  ,this)" />
             <button class='ONESH'          name='2-${boardid}'  data-sh='hexagon'                onclick="board_oneshclicked(this.name,'hexagon'   ,this)" />
             <button class='ONESH'          name='2-${boardid}'  data-sh='circle'                 onclick="board_oneshclicked(this.name,'circle'    ,this)" />
             <button class='ONECL DOT'      name='2-${boardid}'  data-cl='0'                      onclick="board_oneclclicked(this.name,0,this)" />         
             <button class='ONECL'          name='2-${boardid}'  data-cl='1'                      onclick="board_oneclclicked(this.name,1,this)" />         
             <button class='ONECL'          name='2-${boardid}'  data-cl='2'                      onclick="board_oneclclicked(this.name,2,this)" />         
             <button class='ONECL'          name='2-${boardid}'  data-cl='3'                      onclick="board_oneclclicked(this.name,3,this)" />         
             <button class='ONECL'          name='2-${boardid}'  data-cl='4'                      onclick="board_oneclclicked(this.name,4,this)" />         
             <button class='ONECL'          name='2-${boardid}'  data-cl='5'                      onclick="board_oneclclicked(this.name,5,this)" />         
             <button class='ONECL'          name='2-${boardid}'  data-cl='6'                      onclick="board_oneclclicked(this.name,6,this)" />         
             <button class='ONEST DOT'      name='2-${boardid}'  data-st='0'                      onclick="board_one_stclicked(this.name,0,this)" />        
             <button class='ONEST'          name='2-${boardid}'  data-st='1'                      onclick="board_one_stclicked(this.name,1,this)" />        
             <button class='ONEAT'          name='2-${boardid}'  data-at='0'                      onclick="board_one_atclicked(this.name,0,this)" />        
             <input  class='ONETE'          name='2-${boardid}'  type='text'                      onchange='board_one_te_changed(this.value,this.name)' />

             <input id='fopen-2-${boardid}' name='2-${boardid}'  type='file' style='display:none' onchange='board_fopen_clicked(this.name,this)'/>
             <a     id='dload-2-${boardid}' name='2-${boardid}'  type='text' style='display:none' onclick="board_dload_clicked(this,this.name,'image.png')">&#x2B73;</a>
         </div>
       </div>
       `;
  }
  ...
  to_setup_script(){
    ...
    all_smears = {};
    all_colors = ['SlateGray', 'RoyalBlue', 'Green', 'Olive', 'DarkOrchid', 'DarkOrange', 'Red'];
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','square':'&#x25B1;','triangle':'&#x25B3;','ellipse':'&#x25EF;','eraser':'&#x2B1A;','smudge':'&#x25C9;','select':'&#x26F6;','cplane':'&#x1D456;','ball':'&#x26CB;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;','fopen':'&#x1F4C2;','dload':'&#x2728;'};
    all_sh_icons = {'line':'&#x2216;','tri':'&#x25B3;','triur':'&#x25FA;','rect':'&#x25AD;','pentagon':'&#x2B20;','hexagon':'&#x2B21;','circle':'&#x2B2D;'};
    all_st_icons = ['&#x2759;','&#x275A;'];
    all_at_icons = ['D','&#x275A;'];
    ...
    function setup(){
      ...
      var select = document.querySelectorAll('.ONEAT');
      for(var i=0; i < select.length; i++){
        var button = select[i];
        var st = button.getAttribute('data-at');
        var st = parseInt(st);
        var icon = all_at_icons[st];
        button.innerHTML = icon;
      }
    }
    ...
    function board_create_cake(ctx,canvas){ 
      let myfig = {x:0,y:0,w:0,h:0,rotate:0,skewX:0,skewY:0,sh:'',shiftKey:0,altKey:0};
      let mybasis = {x:0,y:0,w:0,h:0,dx:0,dy:0,dw:0,dh:0,s:null,a:null};
      ///CORE
      let cake = {};
      cake.disabled = 0;
      cake.s = null;
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    function board_oneopclicked(name,v,e){
      ...
      if(1){
        let button_elem = document.getElementById("op-"+name);
        let icon = all_op_icons[ctx.cake.myop];
        button_elem.innerHTML = icon;
        //board_redraw(ctx,canvas);
        var sibs = getSiblings(e);
        sibs.forEach((v)=>{
          if(v.classList.contains('ONEOP')){
    ...
    function board_oneshclicked(name,v,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      ctx.cake.mysh = v;
      if(ctx.cake.hit_ball){
        ctx.cake.hit_ball.points = board_curr_shape_points(ctx,canvas);
      }
      board_redraw(ctx,canvas);
      var sibs = getSiblings(e);
      sibs.forEach((v)=>{
        if(v.classList.contains('ONESH')){
          v.classList.remove('DOT');
        }
      });
      e.classList.add('DOT');
    }
    function board_oneclclicked(name,v,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      ctx.cake.mycolorid = parseInt(v);
      if(ctx.cake.hit_ball){
      ...
      var sibs = getSiblings(e);
      sibs.forEach((v)=>{
        if(v.classList.contains('ONECL')){
          v.classList.remove('DOT');
        }
      });
      e.classList.add('DOT');
    }
    function board_one_stclicked(name,v,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      ctx.cake.mystrokeid = parseInt(v);
      board_redraw(ctx,canvas);
      var sibs = getSiblings(e);
      sibs.forEach((v)=>{
        if(v.classList.contains('ONEST')){
          v.classList.remove('DOT');
        }
      });
      e.classList.add('DOT');
    }
    function board_one_atclicked(name,v,e){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      switch(v){
        ///
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    function board_one_te_changed(value,name){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    function board_dload_clicked(a,name,fname){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      a.download = fname;
    ...
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    function board_oncakeclicked(name,v){
      var canvas1 = document.getElementById("1-"+name);
      var canvas2 = document.getElementById("2-"+name);
      if(v=='2'){
        canvas2.classList.add('CAKE');
        canvas1.classList.remove('CAKE');
      }else{
        canvas1.classList.add('CAKE');
        canvas2.classList.remove('CAKE');
      }
      var button1 = document.getElementById("op-1-"+name);
      var button2 = document.getElementById("op-2-"+name);
      if(v=='2'){
        button2.classList.add('CAKE');
        button1.classList.remove('CAKE');
      }else{
        button1.classList.add('CAKE');
        button2.classList.remove('CAKE');
      }
    }
    /////////////////////////////////////////////////////
    /////////////////////////////////////////////////////
    ...
    function board_curr_shape_points(ctx,canvas){
      let v = ctx.cake.mysh;
      let points = [];
      let m = Math.PI/180;
      switch(v){
    ...
    function board_enter(ctx,canvas){
      var o = ctx.cake;          
      if(o.myop=='hand'){ //board_enter
        o.myhand = {};
        o.myhand.s = ctx.getImageData(0,0, canvas.width,canvas.height);
        ctx.resetTransform();
        ctx.clearRect(0,0, canvas.width,canvas.height);
      }
      if(o.myop=='pencil' || //board_enter
         o.myop=='shape' ||
         o.myop=='smudge' ||
         o.myop=='select' ||
         o.myop=='eraser'){
      ...
      if( o.myop=='poly' ){ //board_enter
        ctx.resetTransform();
        o.mypoly = {};
        o.mypoly.pts = [];
      }
      if(o.myop=='square'     //board_enter
      || o.myop=='triangle'   //board_enter
      || o.myop=='ellipse' ){ //board_enter
        o.mysquare = {};
        o.mysquare.s = ctx.getImageData(0,0, canvas.width,canvas.height);
        o.mysquare.x = 0;
        o.mysquare.y = 0;
        o.mysquare.w = 0;
        o.mysquare.h = 0;
        o.mysquare.skewX = 0;
        o.mysquare.skewY = 0;
        o.mysquare.rotation = 0;
        o.mysquare.face = null;
        o.mysquare.points = [];
      }
      if(o.myop=='ball'){ //board_enter
        o.myball = {};
        o.myball.s = ctx.getImageData(0,0, canvas.width,canvas.height);
        o.myball.balls = [];
        o.myball.hitball = null;
      }
      if(o.myop=='cplane'){ //board_enter
        if(!o.mycplane){
          o.mycplane = {};
          ...
          o.mycplane.ctx_transform = [1,0,0,1,0,0];
        }
      }
      if(o.myop=='xyplane'){ //board_enter
        if(!o.myxyplane){
          o.myxyplane = {};
          o.myxyplane.path_handle = null;
          o.myxyplane.pointisinhandle = false;
          o.myxyplane.action = 0;
          o.myxyplane.ishandledragged = 0;
          o.myxyplane.ctx_transform = [1,0,0,1,0,0];
        }
      }
      if(o.myop=='dload'){ //board_enter
        o.mydload = {};
      }
    }
    function board_leave(ctx,canvas){
      var o = ctx.cake;          
      if(o.myop=='hand'){ //board_leave
        if(o.myhand && o.myhand.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myhand.s, 0,0);
        }
      }
      if(o.myop=='poly'){ //board_leave
        if(o.myfig){
          o.myfig.s = null;
          o.myfig.sh = '';
        }
      }
      if(o.myop=='square'     //board_leave
      || o.myop=='triangle'   //board_leave
      || o.myop=='ellipse' ){ //board_leave
        if(o.mysquare){
          if(o.mysquare.s){
            ctx.clearRect(0,0, canvas.width,canvas.height);
            ctx.putImageData(o.mysquare.s, 0,0);
          }
        }
      }
      if(o.myop=='ball'){ //board_leave
        if(o.myball){
        }
      }
      if(o.myop=='cplane'){ //board_leave
        if(o.mycplane){
          ...
          o.mycplane.ctx_transform = [a,b,c,d,e.f];
        }
        ctx.resetTransform();
      }
      if(o.myop=='xyplane'){ //board_leave
        if(o.myxyplane){
          let {a,b,c,d,e,f} = ctx.getTransform();
          o.myxyplane.ctx_transform = [a,b,c,d,e.f];
        }
        ctx.resetTransform();
      }
    }
    ...
    function board_redraw(ctx,canvas){
      ...
      var o = ctx.cake;          
      ctx.resetTransform();
      if(ctx.cake.myop=='hand'){ //board_redraw
        ctx.clearRect(0,0, canvas.width,canvas.height);
      }
      if(ctx.cake.myop=='select'){ //board_redraw
        o.mybasis.x = 0;
        o.mybasis.y = 0;
        o.mybasis.w = 0;
        o.mybasis.h = 0;
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='circle'){ //board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='hexagon'){ //board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='pentagon'){ //board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='rect'){ //board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='tri'){ //board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='triur'){ //board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='line'){ //board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='pencil' ){ //board_redraw
      }
      if(ctx.cake.myop=='poly'){ //board_redraw
      }
      if(ctx.cake.myop=='square'      //board_redraw
      || ctx.cake.myop=='triangle'    //board_redraw
      || ctx.cake.myop=='ellipse' ){  //board_redraw
        ctx.resetTransform();
        if(o.mysquare.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.mysquare.s,0,0);
        }
        if(o.mysquare.w && o.mysquare.h){
          ctx.lineWidth = board_curr_stroke(ctx,canvas);
          ctx.strokeStyle = board_curr_color(ctx,canvas);
          ctx.save();
          ///transform
          ctx.translate(o.mysquare.x,o.mysquare.y);
          ctx.translate(o.mysquare.w/2,o.mysquare.w/2);
          ctx.rotate(o.mysquare.rotation/180*Math.PI);
          ctx.translate(-o.mysquare.w/2,-o.mysquare.w/2);
          ///draw square itself
          switch(o.myop){
            case 'square': {
              ctx.beginPath();
              ctx.moveTo(0, 0);
              ctx.lineTo(o.mysquare.w,                 o.mysquare.skewY);
              ctx.lineTo(o.mysquare.w+o.mysquare.skewX,o.mysquare.h+o.mysquare.skewY);
              ctx.lineTo(o.mysquare.skewX,             o.mysquare.h);
              ctx.closePath();
              ctx.stroke();
              break;
            }
            ...
            case 'ellipse': {
              ctx.beginPath();
              let cx = o.mysquare.w/2;
              let cy = o.mysquare.h/2;
              let rx = Math.abs(o.mysquare.w/2);
              let ry = Math.abs(o.mysquare.h/2);
              let rotation = 0;
              let sAngle = 0;
              let eAngle = 2*Math.PI;
              ctx.ellipse(cx,cy,rx,ry,rotation,sAngle,eAngle);
              ctx.closePath();
              ctx.stroke();
              break;
            }
          ...
          ///save to face
          o.mysquare.face = ctx.getImageData(0,0, canvas.width,canvas.height);
          ///draw control points including corner
          o.mysquare.points.forEach((pt,i) => {
      ...
      if(ctx.cake.myop=='smudge' ){ //board_redraw
      }
      if(ctx.cake.myop=='eraser' ){ //board_redraw
      }
      if(ctx.cake.myop=='cplane'){ //board_redraw
        ctx.clearRect(0,0, canvas.width,canvas.height);
        var double_flag = 0;
        ...
        //colored arrow
        //
        ctx.lineWidth = board_curr_stroke(ctx,canvas)*1.4;
        ...
        var r = board_curr_stroke(ctx,canvas)*2;
        if((o.mycplane.action%2)==0){
          path_handle.arc(0,0,r,0,Math.PI*2);
        }else if((o.mycplane.action%2)==1){
          path_handle.arc(o.grid,0,r,0,Math.PI*2);
        }
      ...
      if(ctx.cake.myop=='ball'){ //board_redraw
        ctx.clearRect(0,0, canvas.width,canvas.height);
        if(o.myball.s){
          ctx.putImageData(o.myball.s, 0,0);
        }
        var corner_size = 4;
        ctx.resetTransform();
        ctx.globalAlpha = 1.0;
        ...
        o.myball.balls.forEach((ball,j) => {
          ctx.save();
          if(ball == o.myball.hitball){
            ctx.translate(ball.pivot_x,ball.pivot_y); ///IMPORTANT: the translate operation has to happen before rotation 
      ...
      if(ctx.cake.myop=='xyplane'){ //board_redraw
        ctx.clearRect(0,0, canvas.width,canvas.height);
        ctx.resetTransform();
        ctx.globalAlpha = 1.0;
        ctx.strokeStyle = 'gray';
      ...
      if(ctx.cake.myop=='fopen'){ //board_redraw
      }
      if(ctx.cake.myop=='dload'){ //board_redraw
      }
    }
    ...
    function board_zoomOut(ctx,canvas){
      ///ZOOM_OUT (become smaller)
      let o = ctx.cake;                
      o.zoom /= 1.05;
    }
    function board_zoomIn(ctx,canvas){
    ...
    function board_move(vx,vy,ctx,canvas){
      var o = ctx.cake;          
      if(ctx.cake.myop=='figure'){
        o.myfig.x += (vx);
        o.myfig.y += (vy);
      } 
      if(ctx.cake.myop=='ball'){
        if(o.myball.hitball){
          o.myball.hitball.pivot_x += vx;
          o.myball.hitball.pivot_y += vy;
        }
      }
    }
    function board_skewX(v,ctx,canvas){
      ...
      if(o.myop=='ball'){
        if(o.myball.hitball){
          ...
          o.myball.hitball.points.forEach((pt) => {
            //let {op,x,y,cp1x,cp1y,cp2x,cp2y,x1,y1,x2,y2,rx,ry,sAngle,eAngle,anticlockflag} = pt;
            [pt.x,    pt.y]       = SkewXPoint(pt.x,    pt.y,    v);
            [pt.cp1x, pt.cp1y]    = SkewXPoint(pt.cp1x, pt.cp1y, v);
            [pt.cp2x, pt.cp2y]    = SkewXPoint(pt.cp2x, pt.cp2y, v);
            [pt.x1,   pt.y1]      = SkewXPoint(pt.x1,   pt.y1,   v);
            [pt.x2,   pt.y2]      = SkewXPoint(pt.x2,   pt.y2,   v);
          });
        }
      }
    }
    function SkewXPoint(x,y,v){ 
      let x1 = (x) + (y)*(v);
      let y1 = (y);
      return [x1,y1];
    }
    function board_skewY(v,ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){
        if(o.myball.hitball){
          var [a,b,c,d,e,f] = o.myball.hitball.transform;
          var matrix = new DOMMatrix([a,b,c,d,e,f]);
          matrix.skewYSelf(v);//in DEGREES
          var {a,b,c,d,e,f} = matrix;
          o.myball.hitball.transform = [a,b,c,d,e,f];
        }
      }
    }
    function board_flip_h(ctx,canvas){
      let o = ctx.cake;
      if(o.myop=='figure'){
        o.myfig.w *= -1;
      }
      if(o.myop=='ball'){
        if(o.myball.hitball){
          var [cornerx,cornery] = ball_getcornerxy(o.myball.hitball);
          var [a,b,c,d,e,f] = o.myball.hitball.transform;
          var matrix = new DOMMatrix([a,b,c,d,e,f]);
          var matrix = matrix.flipX();
          var {a,b,c,d,e,f} = matrix;
          o.myball.hitball.transform = [a,b,c,d,e,f];
        }
      }
    }
    function board_flip_v(ctx,canvas){
      let o = ctx.cake;
      if(o.myop=='figure'){
        o.myfig.h *= -1;
      }
    ...
    function board_remove(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){
        if(o.myball.hitball){
          let i = o.myball.balls.indexOf(o.myball.hitball);
          if(i>=0){
            o.myball.balls.splice(i,1);
            console.log('ball remove',o.myball.balls.length);
          }
          o.myball.hitball = null;
        }
      }
    ...
    function board_dup(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){
        if(o.myball.hitball){
          ...
          let dup = {points,transform,corner_i,corner_t,pivot_x,pivot_y,color,w,h};
          o.myball.balls.push(dup);
        }
      }
    }
    function getAllCanvases(name){
      let v = [];
      for(let i=1; i <= 2; ++i){
        canvas = document.getElementById(""+i+"-"+name);//name attribute of Input field holds the 'boardid' of the canvas
        v.push(canvas);
      }
      return v;
    }
    function board_ontextchanged(value,name){
      ...
      var canvases = getAllCanvases(name);
    ...
    function board_handle_keydown(shiftKey,keycode,ctx,canvas){
      ...
      case 'KeyF':
        if(shiftKey){
          board_flip_v(ctx,canvas);
        }else{
          board_flip_h(ctx,canvas);
        }
        break;
      case 'KeyD':
        if(shiftKey){
    ...
    ////////////////////////////////////////////
    ////////////////////////////////////////////
    function board_draw_hilite(o,ctx,canvas){
      ctx.save();
      ctx.fillStyle = 'black';
    ...
    function board_start(ctx,canvas){
      //console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
      let o = ctx.cake;
      if(ctx.cake.myop=='select'){ //board_start
        if(o.mybasis.w > 0 && o.mybasis.h > 0 && isPointInRect(ctx.posx0,ctx.posy0, o.mybasis.x,o.mybasis.y,o.mybasis.w,o.mybasis.h)){
          o.mybasis.a = 'drag';
          o.mybasis.shiftKey = ctx.shiftKey;
          o.mybasis.altKey = ctx.altKey;
        }else{
          o.mybasis.a = 'hilite';
          if(o.mybasis.s){
            ctx.clearRect(0,0, canvas.width,canvas.height);
      ...
      if(ctx.cake.myop=='figure'){ //board_start      
        o.myfig.x = ctx.posx0;
        o.myfig.y = ctx.posy0;
        o.myfig.w = 0;
        o.myfig.h = 0;
        ...
        o.myfig.s = ctx.getImageData(0,0, canvas.width,canvas.height);
        o.myfig.sh = ctx.cake.mysh;
      }
      if(ctx.cake.myop=='pencil'){ //board_start
      }
      if(ctx.cake.myop=='poly'){ //board_start
        o.mypoly.shiftKey = ctx.shiftKey;
        o.mypoly.altKey = ctx.altKey;
        o.mypoly.s = ctx.getImageData(0,0, canvas.width,canvas.height);
        o.mypoly.sh = 'line';
      }
      if(ctx.cake.myop=='square'      //board_start
      || ctx.cake.myop=='triangle'    //board_start
      || ctx.cake.myop=='ellipse' ){  //board_start
        o.mysquare.shiftKey = ctx.shiftKey;
        o.mysquare.altKey = ctx.altKey;
        // always re-discover corners , the result of which will be used by lines afterwards
        let success = 0;
        if(1){
          ///looking for square corner
          ctx.save();
          ctx.resetTransform();
          ctx.translate(o.mysquare.x,o.mysquare.y);
          ctx.translate(o.mysquare.w/2,o.mysquare.w/2);
          ...
          o.mysquare.points.forEach((pt,i) => {
            ...
            if(Number.isFinite(x) && Number.isFinite(y)){
              ...
              ctx.lineWidth=10;
              if(ctx.isPointInStroke(path2d, ctx.posx0,ctx.posy0)){
                o.mysquare.corner_i = i;
                ///console.log('square corner',o.mysquare.corner_i);
                o.mysquare.isnewlycorner = 1;
              }
            }
          });
          ctx.restore();
        }
        if(o.mysquare.altKey && o.mysquare.shiftKey){
          if(o.mysquare.face){
            o.mysquare.s = o.mysquare.face;
            o.mysquare.face = null;
            o.mysquare.skewX = 0;
            o.mysquare.skewY = 0;
            o.mysquare.rotation = 0;
            o.mysquare.x = ctx.posx0;
            o.mysquare.y = ctx.posy0;
            o.mysquare.w = 0;
            o.mysquare.h = 0;
          }
        }else if(o.mysquare.altKey){
          o.mysquare.skewX = 0;
          o.mysquare.skewY = 0;
          o.mysquare.rotation = 0;
          o.mysquare.face = null;
          ...
          o.mysquare.w = 0;
          o.mysquare.h = 0;
        }else if(o.mysquare.shiftKey){
          if(o.mysquare.face && o.mysquare.corner_i == 0){
            o.mysquare.s = o.mysquare.face;
            o.mysquare.face = null;
          }
        }
      ...
      if(ctx.cake.myop=='smudge'){ //board_start
        o.myfig.x = ctx.posx0;
        o.myfig.y = ctx.posy0;
        o.myfig.w = 0;
        o.myfig.h = 0;
        ...
        else if(o.myfig.shiftKey){
          board_smudge_fill(o.myfig.x,o.myfig.y,o.myfig.x,o.myfig.y,ctx,canvas);
        }
        else{
        }
      }
      if(ctx.cake.myop=='eraser'){ //board_start
        o.myfig.x = ctx.posx0;
        o.myfig.y = ctx.posy0;
        o.myfig.w = 0;
        o.myfig.h = 0;
      ...
      if(ctx.cake.myop=='cplane'){ //board_start
        ///check to see if mouse click is directly on top of the handle dot
        if(ctx.altKey){
          if(o.mycplane.ishandledragged){
            o.mycplane.ishandledragged = 0;
          }else{
            o.mycplane.action = (o.mycplane.action+1)%2;
          }
          o.rotate_ang = 0;
          o.scale_factor = 1;
          o.move_x = 0 ;
          ...
          ctx.save();
          ctx.lineWidth=10; 
          if(o.mycplane.path_handle && ctx.isPointInStroke(o.mycplane.path_handle, ctx.posx0,ctx.posy0)){ 
      ...
      if(ctx.cake.myop=='ball'){ //board_start
        var corner_size = board_curr_stroke(ctx,canvas);
        if(o.myball.hitball){
          o.myball.start_pivot_x = o.myball.hitball.pivot_x;
          o.myball.start_pivot_y = o.myball.hitball.pivot_y;
          // re-discover corners only -- no rediscovering of new hit balls
          var success = 0;
          ctx.save();
          let [a,b,c,d,e,f] = o.myball.hitball.transform;
          let {pivot_x,pivot_y} = o.myball.hitball;
          ctx.resetTransform();
          ctx.translate(pivot_x,pivot_y);
          ctx.transform(a,b,c,d,e,f);
          o.myball.hitball.points.forEach((pt,i) => {
            let {op,x,y,cp1x,cp1y,cp2x,cp2y,x1,y1,x2,y2,r} = pt;
            let path2d = new Path2D();
            switch(op){
              case 'z':
            ...
            ctx.lineWidth=10;
            if(ctx.isPointInStroke(path2d, ctx.posx0,ctx.posy0)){
              if(o.myball.hitball.corner_i == i){
                o.myball.hitball.corner_t = (o.myball.hitball.corner_t + 1) % 3;
              }else{
                o.myball.hitball.corner_i = i;
                o.myball.hitball.corner_t = 1;
              }
              success = 1;
              o.myball.washitball = 1;
              o.myball.isnewlycorner = 1;
            }
          });
          ctx.restore();
        } 
      ...
      if(ctx.cake.myop=='xyplane'){ //board_start
        var x = ctx.posx2;
        var y = ctx.posy2;
        o.info_text = '';
      ...
      if(ctx.cake.myop=='fopen'){ //board_start
      }
      if(ctx.cake.myop=='dload'){ //board_start
      }
    }
    ...
    function board_drag(ctx,canvas){
      let o = ctx.cake;                
      if(ctx.cake.myop=='select'){ //board_drag
        //DRAG  
        if(o.mybasis.a=='hilite'){
          o.mybasis.w = ctx.posx2 - ctx.posx0;
          o.mybasis.h = ctx.posy2 - ctx.posy0;
          if(o.mybasis.w < 0){
            o.mybasis.x = ctx.posx2;
            o.mybasis.w = ctx.posx0 - ctx.posx2;
          }
          if(o.mybasis.h < 0){
            o.mybasis.y = ctx.posy2;
            o.mybasis.h = ctx.posy0 - ctx.posy2;
          }
          ctx.clearRect(0,0, canvas.width,canvas.height);
          if(o.mybasis.s){
            ctx.putImageData(o.mybasis.s, 0,0);
          }
          board_draw_hilite(o,ctx,canvas);
        }
        if(o.mybasis.a=='drag'){
          ...
          let s1 = ctx.getImageData(o.mybasis.x,o.mybasis.y, o.mybasis.w,o.mybasis.h);
          if(o.mybasis.shiftKey){
          }else{
            ctx.clearRect(o.mybasis.x,o.mybasis.y, o.mybasis.w,o.mybasis.h);
          }
          ctx.putImageData(s1, o.mybasis.x+o.mybasis.dx,o.mybasis.y+o.mybasis.dy);
          board_draw_hilite(o,ctx,canvas);
        }
      }
      if(ctx.cake.myop=='figure' && o.myfig.sh=='circle'){ //board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='hexagon'){ //board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='pentagon'){ //board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='rect'){ //board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='tri'){ //board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='triur'){ //board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='figure' && o.myfig.sh=='line'){ //board_drag
        //DRAG  
        let x1 = ctx.posx0;
        let y1 = ctx.posy0;
        let x2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='pencil'){ //board_drag
        if(ctx.shiftKey){
          board_draw_eraser(ctx,canvas,false);
        }else if(ctx.altKey){
          board_draw_smudge(ctx,canvas);
        }else{
          board_draw_pencil(ctx,canvas,false);
        }
      }
      if(ctx.cake.myop=='poly'){ //board_drag
        //DRAG  
        let x1 = ctx.posx0;
        let y1 = ctx.posy0;
        let x2 = ctx.posx2;
        let y2 = ctx.posy2;
        if(o.mypoly.altKey && o.mypoly.pts.length){
          o.mypoly.pts.forEach(([X1,Y1,X2,Y2])=>{
            if(Math.abs(X1-x1) < 10 && Math.abs(Y1-y1) < 10){
              x1 = X1;
              y1 = Y1;
            }
        ...
        if(o.mypoly.altKey && o.mypoly.pts.length){
          //check to see if the end point is sufficiently close to any one of the points
          o.mypoly.pts.forEach(([X1,Y1,X2,Y2])=>{
            if(Math.abs(X1-x2) < 10 && Math.abs(Y1-y2) < 10){
              x2 = X1;
              y2 = Y1;
            }
            if(Math.abs(X2-x2) < 10 && Math.abs(Y2-y2) < 10){
              x2 = X2;
              y2 = Y2;
            }
          });
        ...
        ctx.clearRect(0,0, canvas.getAttribute('width'),canvas.getAttribute('height'));
        if(o.mypoly.s){
          ctx.putImageData(o.mypoly.s, 0,0);
        }
        let ddx = Math.abs(x2-x1);
        let ddy = Math.abs(y2-y1);
        let dd = Math.sqrt(ddx*ddx + ddy*ddy);
      ...
      if(ctx.cake.myop=='square'     //board_drag
      || ctx.cake.myop=='triangle'   //board_drag
      || ctx.cake.myop=='ellipse' ){ //board_drag
        if(o.mysquare.altKey && o.mysquare.shiftKey){
        }else if(o.mysquare.altKey){
          let posx0 = ctx.posx0;
          let posy0 = ctx.posy0;
          ...
          o.mysquare.w = w;
          o.mysquare.h = h;
        }else if(o.mysquare.corner_i==0){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.x += dx;
          o.mysquare.y += dy;
        }else if(o.mysquare.corner_i==2){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.w += dx;
          o.mysquare.h += dy;
        }else if(o.mysquare.corner_i==3){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.skewX += dx;
        }else if(o.mysquare.corner_i==1){
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.skewY += dy;
        }
        ...
        switch(o.myop){
          case 'square': {
            points.push([0,                            0                            ]);
            points.push([o.mysquare.w,                 o.mysquare.skewY             ]);
            points.push([o.mysquare.w+o.mysquare.skewX,o.mysquare.h+o.mysquare.skewY]);
            points.push([o.mysquare.skewX,             o.mysquare.h                 ]);
            break;
          }
          case 'triangle': {
            points.push([0,                            0                            ]);
          ...
          case 'ellipse': {
            points.push([0,                            0                            ]);
            points.push([o.mysquare.w,                 0                            ]);
            points.push([o.mysquare.w,                 o.mysquare.h                 ]);
            points.push([0,                            o.mysquare.h                 ]);
            break;
          }
        }
        o.mysquare.points = points;
        ///start draw             
        board_redraw(ctx,canvas);
      }
      if(ctx.cake.myop=='smudge'){ //board_drag
        if(o.myfig.altKey){
      ...
      if(ctx.cake.myop=='eraser'){ //board_drag
        if(o.myfig.altKey){
          o.myfig.w = ctx.posx2 - o.myfig.x;
          o.myfig.h = ctx.posy2 - o.myfig.y;
          ctx.clearRect(0,0, canvas.width,canvas.height);
      ...
      if(ctx.cake.myop=='cplane'){ //board_drag
        var grid = o.grid;
      ...
      if(ctx.cake.myop=='ball'){ //board_drag
        if(o.myball.hitball && !o.myball.isnewlycorner){
          if((o.myball.hitball.corner_i == 0) && (o.myball.hitball.corner_t == 2)){
            let w = o.myball.hitball.w;
            let h = o.myball.hitball.h;
            //skewX
            let dx = ctx.posx2 - ctx.posx1;
            if(dx >= 1){ //expand
              let multip_x = dx/(h+h+h+h);
              board_skewX(multip_x, ctx,canvas);//multip_x is Rhanda
            }else if(dx <= -1){ //shrink
              let multip_x = dx/(h+h+h+h);
              board_skewX(multip_x, ctx,canvas);
            }
          }else if((o.myball.hitball.corner_i == 0) && (o.myball.hitball.corner_t == 1)){
            //rotate
            let [x,y] = ball_getpivotxy(o.myball.hitball);//rotate
            ...
            let rotate_rad = (angle1-angle0);
            board_rotate(rotate_ang, ctx,canvas);
          }else if((o.myball.hitball.corner_i > 0) && (o.myball.hitball.corner_t == 2)){
            //scaleY
            let dx = ctx.posx2 - ctx.posx1;
            if(dx >= 1){ //expand
              let multip_x = Math.pow(1.01,dx);
              board_scale(multip_x,1, ctx,canvas);
            }else if(dx <= -1){ //shrink
              let multip_x = Math.pow(1/1.01,-dx);
              board_scale(multip_x,1, ctx,canvas);
            }
          }else if((o.myball.hitball.corner_i > 0) && (o.myball.hitball.corner_t == 1)){
            let dx = ctx.posx2 - ctx.posx1;
            if(dx >= 1){ //expand
              let multip_x = Math.pow(1.01,dx);
              board_scale(multip_x,multip_x, ctx,canvas);
            }else if(dx <= -1){ //shrink
              let multip_x = Math.pow(1/1.01,-dx);
              board_scale(multip_x,multip_x, ctx,canvas);
            }
          }else if(o.myball.hitball.corner_t == 0){
            let move_x = ctx.posx2 - ctx.posx0;
            let move_y = ctx.posy2 - ctx.posy0;
            if(ctx.shiftKey){
            ...
            o.myball.hitball.pivot_x = o.myball.start_pivot_x + move_x;
            o.myball.hitball.pivot_y = o.myball.start_pivot_y + move_y;
          }
        }
        board_redraw(ctx,canvas);
      }
      ...
      if(ctx.cake.myop=='fopen'){ //board_drag
      }
      if(ctx.cake.myop=='dload'){ //board_drag
      }
    }
    function board_end(ctx,canvas){
      let o = ctx.cake;                
      if(ctx.cake.myop=='select'){ //board_end
        if(o.mybasis.a=='hilite'){
          if(o.mybasis.w==0 || o.mybasis.h==0){
            o.mybasis.s = null;//set it to null so that it can be retake to the latest screenshot
          }
        }
        if(o.mybasis.a=='drag'){
          ctx.clearRect(0,0, canvas.width,canvas.height);
      ...
      if(ctx.cake.myop=='figure'){ //board_end
        o.myfig.shiftKey = 0;
        o.myfig.altKey = 0;
      } 
      if(ctx.cake.myop=='pencil'){ //board_end
      }
      if(ctx.cake.myop=='poly'){ //board_end
        if(o.mypoly && o.mypoly.pts && ctx.mouseisdragged){
          var      x1 = o.mypoly.x1;
          var      y1 = o.mypoly.y1;
          var      x2 = o.mypoly.x2;
          var      y2 = o.mypoly.y2;
          o.mypoly.pts.push([x1,y1,x2,y2]);
        }
      }
      if(ctx.cake.myop=='square'      //board_end
      || ctx.cake.myop=='triangle'    //board_end
      || ctx.cake.myop=='ellipse' ){  //board_end
        o.mysquare.shiftKey = 0;
        o.mysquare.altKey = 0;
      }
      if(ctx.cake.myop=='smudge'){ //board_end
        if(o.myfig.altKey){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          if(o.myfig.s){
            ctx.putImageData(o.myfig.s, 0,0);
      ...
      if(ctx.cake.myop=='eraser'){ //board_end
        if(o.myfig.altKey && o.myfig.shiftKey){
          ctx.clearRect(0,0, canvas.width,canvas.height);
        }
      ...
      if(ctx.cake.myop=='cplane'){ //board_end
      }
      if(ctx.cake.myop=='ball'){ //board_end
        if(ctx.shiftKey && ctx.altKey){
          ...
          var pivot_x = x;
          var pivot_y = y;
          var color = board_curr_color(ctx,canvas);
          var m = Math.PI/180;
          var points = board_curr_shape_points(ctx,canvas);
          if(points.length){
            var ball = {points,transform,corner_i,corner_t,pivot_x,pivot_y,color,w:30,h:30};
            o.myball.balls.push(ball);
            o.myball.hitball = ball;//making it the latest hit ball
            o.myball.hitball.corner_i = 0;
            o.myball.hitball.corner_t = 0;
          }
          o.myball.washitball = 0;
        }else if(o.myball.hitball && o.myball.hitball.corner_t > 0){
        }else if(ctx.mouseisdragged){
        }else{
          //not on top of an existing corner of the current hit ball, need to find out if we need to switch to a different hit ball
          let old_hit_ball = o.myball.hitball;//check to see if we have switched to a different hit ball
          o.myball.hitball = null;
          o.myball.balls.forEach((ball) => {
            ctx.save();
            let [a,b,c,d,e,f] = ball.transform;
            let {pivot_x,pivot_y} = ball;
            ctx.translate(pivot_x,pivot_y);
            ctx.transform(a,b,c,d,e,f);
            ctx.lineWidth = 10;          
            ctx.beginPath();
            ...
            if(ctx.isPointInStroke(ctx.posx0,ctx.posy0)){
              ...
              o.myball.hitball.corner_i = -1;//no active corner
          ...
          o.myball.washitball = (old_hit_ball && o.myball.hitball && old_hit_ball === o.myball.hitball);
        }
        o.myball.washitball = 0;
        o.myball.isnewlycorner = 0;
        board_redraw(ctx,canvas);
      }
      if(ctx.cake.myop=='xyplane'){ //board_end
      }
      if(ctx.cake.myop=='fopen'){ //board_end
        var input = document.getElementById('fopen-'+canvas.id);
        input.click();
      }
      if(ctx.cake.myop=='dload'){ //board_end
        var a = document.getElementById('dload-'+canvas.id);
        a.click();
      }
    }
    ////////////////////////////////////////////
