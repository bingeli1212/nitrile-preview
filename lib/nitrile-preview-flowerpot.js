...
`;
  ...
  to_setup_script(){
    ...
    function board_setup_canvas(canvas){
      ...
      ctx.d.myundo.push({s});
      ctx.d.myface = s;
      ctx.d.mybasis = {x:0,y:0,w:0,h:0,dx:0,dy:0,s:null,a:null};
    }
    ...
    function board_handle_keydown(shiftKey,altKey,keycode,ctx,canvas){
      ...
      case 'KeyR':
        if(o.myop=='circle'){
          o.mycircle.rotate += (shiftKey)?(-1):(+1);
          board_redraw(o,ctx,canvas);
        }else if(o.myop=='rect'){
          o.myrect.rotate += (shiftKey)?(-1):(+1);
          board_redraw(o,ctx,canvas);
        }else if(o.myop=='line'){
          o.myline.rotate += (shiftKey)?(-1):(+1);
          board_redraw(o,ctx,canvas);
        }
        break;
      ///SCALE-X
      case 'KeyX':
        if(o.myop=='circle'){
          o.mycircle.rx += (shiftKey)?(-1):(+1);
          o.mycircle.rx = Math.max(1,o.mycircle.rx);
          board_redraw(o,ctx,canvas);
        }else if(o.myop=='rect'){
          o.myrect.w += (shiftKey)?(-1):(+1);
          o.myrect.w = Math.max(1,o.myrect.w);
          board_redraw(o,ctx,canvas);
        }else if(o.myop=='line'){
          o.myline.x2 += (shiftKey)?(-1):(+1);
          board_redraw(o,ctx,canvas);
        }
        break;
      ///SCALE-Y
      case 'KeyY':
        if(o.myop=='circle'){
          o.mycircle.ry += (shiftKey)?(-1):(+1);
          o.mycircle.ry = Math.max(1,o.mycircle.ry);
          board_redraw(o,ctx,canvas);
        }else if(o.myop=='rect'){
          o.myrect.h += (shiftKey)?(-1):(+1);
          o.myrect.h = Math.max(1,o.myrect.h);
          board_redraw(o,ctx,canvas);
        }else if(o.myop=='line'){
          o.myline.y2 += (shiftKey)?(-1):(+1);
          board_redraw(o,ctx,canvas);
        }
        break;
      ///SCALE-S
      ...
      case 'KeyD':
        if(shiftKey){
          if(o.myop=='circle'){
            ...
            mybasis = {...mybasis};
            ///save 
            ctx.d.myundo.push({s,mybasis,myop,mycircle});
            ctx.d.myredo = [];
            ...
            mybasis = {...mybasis};
            ///save 
            ctx.d.myundo.push({s,mybasis,myop,myrect});
            ctx.d.myredo = [];
            ctx.d.myface = ctx.getImageData(0,0, 441,320);
            board_redraw_last(ctx,canvas);
          }
            ...
            mybasis = {...mybasis};
            ///save 
            ctx.d.myundo.push({s,mybasis,myop,myline});
            ctx.d.myredo = [];
            ctx.d.myface = ctx.getImageData(0,0, 441,320);
            board_redraw_last(ctx,canvas);
          }
      ...
      if(ctx.d.mymouseisdown){
        ...
        if(ctx.d.myop=='select'){
          if( (ctx.d.myposx0 > ctx.d.mybasis.x) &&
              (ctx.d.myposx0 < ctx.d.mybasis.x+ctx.d.mybasis.w) &&
              (ctx.d.myposy0 > ctx.d.mybasis.y) &&
              (ctx.d.myposy0 < ctx.d.mybasis.y+ctx.d.mybasis.h) ){
            ///MOVE/COPY
          ...
          ctx.d.mycircle = {cx,cy,rx:0,ry:0,rotate:0,mystroke,mycolor};
          ...
          let x = ctx.d.myposx0;
          let y = ctx.d.myposy0;
          ctx.d.myrect = {x,y,w:0,h:0,s:0,rotate:0,mystroke,mycolor};
          ...
          let x3 = x;
          let y3 = y;
          ctx.d.mytri = {x,y,w:0,h:0,x1,y1,x2,y2,x3,y3,rotate:0,mystroke,mycolor};
          ...
          let x2 = ctx.d.myposx0;
          let y2 = ctx.d.myposy0;
          let ddx = Math.abs(x2-x1);
          let ddy = Math.abs(y2-y1);
          let dd = Math.sqrt(ddx*ddx + ddy*ddy);
          ctx.d.myline = {x1,y1,x2,y2,dd,rotate:0,mystroke,mycolor};
    ...
    function board_move(ctx,canvas){
      ...
      if(ctx.d.myop=='select'){
        ...
        if(ctx.d.mycircle){
          ...
          let myposy2 = ctx.d.myposy2;
          let [sx,sy] = board_calc_sx_and_sy(canvas);
          ctx.lineWidth   = ctx.d.mycircle.mystroke*sx;         
          ctx.strokeStyle = ctx.d.mycircle.mycolor;   
          ///CIRCLE
          let s = ctx.d.myface;
          ctx.clearRect(0,0, 441,320);
          ...
          if(ctx.d.altKey){
            ...
            ctx.d.mycircle.cx = cx;
            ctx.d.mycircle.cy = cy;
            ctx.d.mycircle.rx = rx;
            ctx.d.mycircle.ry = ry;
            ctx.stroke();
          }else{
            ctx.beginPath();
        ...
        if(ctx.d.myrect){
          ...
          let [sx,sy] = board_calc_sx_and_sy(canvas);
          ctx.lineWidth   = ctx.d.myrect.mystroke*sx;         
          ctx.strokeStyle = ctx.d.myrect.mycolor;   
          ///RECT  
          let s = ctx.d.myface;
          ctx.clearRect(0,0, 441,320);
          ctx.putImageData(s, 0,0);
        ...
        if(ctx.d.mytri){
          ...
          let h = myposy2-myposy0;
          let [sx,sy] = board_calc_sx_and_sy(canvas);
          ctx.lineWidth   = ctx.d.mytri.mystroke*sx;         
          ctx.strokeStyle = ctx.d.mytri.mycolor;   
          ///TRI   
          let s = ctx.d.myface;
          ctx.clearRect(0,0, 441,320);
          ctx.putImageData(s, 0,0);
        ...
        if(ctx.d.myline){
          ...
          let [sx,sy] = board_calc_sx_and_sy(canvas);
          ctx.lineWidth   = ctx.d.myline.mystroke*sx;
          ctx.strokeStyle = ctx.d.myline.mycolor;
          ///LINE  
          let s = ctx.d.myface;
          ctx.clearRect(0,0, 441,320);
          ctx.putImageData(s, 0,0);
        ...
        board_draw_smudge_fill(ctx,canvas,false);
      }else if(ctx.d.myop=='pencil'){
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.d.myop=='select'){
        ...
        let s        = ctx.d.myface;
        let mytri    = ctx.d.mytri ;  
        let myop     = ctx.d.myop;
        if(s && mytri && myop && mytri.w && mytri.h){
          ///normalize ctx.d.mybasis
          ctx.d.mybasis.x += ctx.d.mybasis.dx;
          ctx.d.mybasis.y += ctx.d.mybasis.dy;
          ctx.d.mybasis.dx = 0;
          ...
          mybasis = {...mybasis};
          ///save 
          ctx.d.myundo.push({s,mybasis,myop,mytri});
          ctx.d.myredo = [];
          ctx.d.myface = ctx.getImageData(0,0, 441,320);
        }
      }else if(ctx.d.myop=='line'){
    ...
    function board_redraw(o,ctx,canvas){
      ...
      if(o.myop=='circle'){
        ...
        if(1){
          ctx.beginPath();
          ctx.ellipse(mycircle.cx,mycircle.cy,mycircle.rx,mycircle.ry,mycircle.rotate/180*Math.PI,0,Math.PI*2);
          ctx.stroke();
        }
        ctx.d.myface = ctx.getImageData(0,0, 441,320);
      } else if(o.myop=='rect'){
        ...
        if(1){
          ...
          ctx.rotate(myrect.rotate/180*Math.PI);
          ctx.beginPath();
          ctx.moveTo(0,0);
          ctx.lineTo(myrect.w,0);
          ctx.lineTo(myrect.w+myrect.s,myrect.h);
          ctx.lineTo(myrect.s,myrect.h);
          ctx.closePath();
          ctx.translate(-myrect.x,-myrect.y);
          ctx.stroke();
          ctx.restore();
        ...
        let mytri = o.mytri;
        ctx.lineWidth = mytri.mystroke*sx;
        ctx.strokeStyle = mytri.mycolor;
        if(1){
          ///TRANSFORM
          ctx.save();
          ctx.translate(mytri.x,mytri.y);
          ctx.rotate(mytri.rotate/180*Math.PI);
          ctx.beginPath();
          ctx.moveTo(mytri.x1-mytri.x,mytri.y1-mytri.y);
          ctx.lineTo(mytri.x2-mytri.x,mytri.y2-mytri.y);
          ctx.lineTo(mytri.x3-mytri.x,mytri.y3-mytri.y);
          ctx.closePath();
          ctx.translate(-mytri.x,-mytri.y);
          ctx.stroke();
          ctx.restore();
        ...
        if(1){
          ...
          ctx.save();
          ctx.beginPath();
          ctx.translate(myline.x1,myline.y1);
          ctx.rotate(myline.rotate/180*Math.PI);
          ctx.moveTo(0,0);
          ctx.lineTo(myline.x2-myline.x1,myline.y2-myline.y1);
          ctx.translate(-myline.x1,-myline.y1);
          ctx.stroke();
          ctx.restore();
        }
