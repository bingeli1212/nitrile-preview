  ...
  to_tool_contents(boardid){
    return `\
         <div id='tool-1-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:136px;z-index:10;' >
             ...
             <button class='ONEOP DOT'      name='1-${boardid}'  data-op='pencil'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='poly'                   onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='square'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='smudge'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='select'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='cplane'                 onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='xyplane'                onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP'          name='1-${boardid}'  data-op='ball'                   onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP HIDE'     name='1-${boardid}'  data-op='hide'                   onclick="board_oneopclicked(this.name             ,this)" />
             <button class='ONEOP HIDE'     name='1-${boardid}'  data-op='hide'                   onclick="board_oneopclicked(this.name             ,this)" />
...
*/
    ...
    function board_oneopclicked(name,e){
      ...
      ctx.cake.myop = e.getAttribute('data-op');
