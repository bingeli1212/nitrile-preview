  ...
  to_tool_contents(boardid){
    return `\
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:136px;z-index:10;' >
             ...
             <button class='ONEST'          name='${boardid}'  data-st='0'                      onclick="board_onestclicked(this.name,this)" />        
             <button class='ONEST DOT'      name='${boardid}'  data-st='1'                      onclick="board_onestclicked(this.name,this)" />        
             <button class='ONEST'          name='${boardid}'  data-st='2'                      onclick="board_onestclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data-at='acton'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='clear'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='cropp'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='cutbd'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='paste'                  onclick="board_oneatclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data-at='zoomo'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='zoomi'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='rotcl'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='rotcr'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT HIDE'     name='${boardid}'  data-at='hide'                   onclick="board_oneatclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data-at='fopen'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='dload'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data-at='uload'                  onclick="board_oneatclicked(this.name,this)" />
             <button class='ONEAT'          name='${boardid}'  data-at='darkb'                  onclick="board_oneatclicked(this.name,this)" />
             <button class='ONEAT HIDE'     name='${boardid}'  data-at='hide'                   onclick="board_oneatclicked(this.name,this)" />
