...
`;
    ...
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:102px;z-index:10;' >
             ...
             <button class='ONEOP'     name='1-${boardid}'  data-op='figure'       onclick="board_oneopclicked(this.name,'figure' ,this)"></button>
             ...
             <button class='ONEOP'     name='1-${boardid}'  data-op=''             onclick="board_oneopclicked(this.name,''       ,this)"></button>
       ...
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:68px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             ...
             <button class='ONEOP'     name='2-${boardid}'  data-op='figure'       onclick="board_oneopclicked(this.name,'figure' ,this)"></button>
             ...
             <button class='ONEOP'     name='2-${boardid}'  data-op=''             onclick="board_oneopclicked(this.name,''       ,this)"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:initial;align-self:stretch;' >
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','figure':'&#x269E;','eraser':'&#x2B1A;','smudge':'&#x25A8;','select':'&#x26F6;','cplane':'C','ball':'B','xyplane':'xy','':'&#x270B;'};
...
//console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){//board_drag
        if(ctx.shiftKey && ctx.altKey && o.hit_ball && o.hit_ball.corner_i==0){
        ...
        }else if(ctx.shiftKey && o.hit_ball && o.hit_ball.corner_i==0){
        ...
        }else if(ctx.shiftKey && ctx.altKey && o.hit_ball && o.hit_ball.corner_i>0){
