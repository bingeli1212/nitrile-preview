...
`;
       ...
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:68px;z-index:10;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             ...
             <button class='ONESH'     name='1-${boardid}'  data-sh='trilr'    onclick="board_oneshclicked(this.name,'trilr'   ,this)"></button>
       ...
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:68px;z-index:10;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             ...
             <button class='ONESH'     name='2-${boardid}'  data-sh='trilr'    onclick="board_oneshclicked(this.name,'trilr'   ,this)"></button>
  ...
  to_setup_script(){
    ...
    all_sh_icons = {'line':'&#x2216;','tri':'&#x25B3;','trilr':'&#x25FF;','rect':'&#x25AD;','pentagon':'&#x2B20;','hexagon':'&#x2B21;','circle':'&#x2B2D;'};
    all_st_icons = ['&#x2759;','&#x275A;'];
...
//console.log('board_redraw','op=',ctx.cake.myop,'id=',canvas.id);
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='trilr'){//board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
...
//console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='trilr'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
