...
`;
    ...
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <a      class='ONEDD'     name='1-${boardid}'  type='text'            onclick="board_one_dd_clicked(this,this.name,'image.png')">&#x2B73;</a>
             <input id='file-1-${boardid}' name='2-${boardid}' type='file' style='display:none' onchange='board_one_fi_clicked(this.name,this)'/>
       ...
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <button class='ONEFI' type='button'><label for='file-2-${boardid}'>O</label></button>
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','line':'&#x269E;','eraser':'&#x2B1A;','smudge':'&#x25A8;','select':'&#x26F6;','cplane':'x&#x1D456;','ball':'&#x26CB;','xyplane':'xy','hand':'&#x270B;','fopen':'&#x1F4C2;'};
...
console.log('board_one_fi_clicked',name,e);
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
