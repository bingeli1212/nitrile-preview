...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    pages.push(1);
    all.push(`<div class='BOTTOMCONTAINER'>`);
    all.push(`<div class='EDITFORM' > ${tool_contents} </div>`);
    all.push(`<div class='PAGENUM'> / </div>`);
    all.push(`</div>`);
  ...
  to_tool_contents(boardid){
    return `\
         <div id='text-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:88px;height:34px;z-index:10;' >
             <input  class='ONETE'          name='${boardid}'  type='text'                      onchange="board_onetechanged(this.name,this)" />
         </div>

         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:374px;height:34px;z-index:10;' >
             <button class='ONEOP DOT'      name='${boardid}'  data='pencil'                 onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP'          name='${boardid}'  data='poly'                   onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP'          name='${boardid}'  data='eraser'                 onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP'          name='${boardid}'  data='smudge'                 onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP'          name='${boardid}'  data='select'                 onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP'          name='${boardid}'  data='ball'                   onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP'          name='${boardid}'  data='cplane'                 onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP'          name='${boardid}'  data='xyplane'                onclick="board_oneopclicked(this.name,this)" />

             <button class='ONECL DOT'      name='${boardid}'  data='0'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data='1'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data='2'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data='3'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data='4'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data='5'                      onclick="board_oneclclicked(this.name,this)" />         
             <button class='ONECL'          name='${boardid}'  data='6'                      onclick="board_oneclclicked(this.name,this)" />         

             <button class='ONEST'          name='${boardid}'  data='0'                      onclick="board_onestclicked(this.name,this)" />        
             <button class='ONEST DOT'      name='${boardid}'  data='1'                      onclick="board_onestclicked(this.name,this)" />        
             <button class='ONEST'          name='${boardid}'  data='2'                      onclick="board_onestclicked(this.name,this)" />        

             <button class='ONESH DOT'      name='${boardid}'  data='0'                      onclick="board_oneshclicked(this.name,this)" />        
             <button class='ONESH'          name='${boardid}'  data='1'                      onclick="board_oneshclicked(this.name,this)" />        
             <button class='ONESH'          name='${boardid}'  data='2'                      onclick="board_oneshclicked(this.name,this)" />        
             <button class='ONESH'          name='${boardid}'  data='3'                      onclick="board_oneshclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data='fopen'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='dload'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='uload'                  onclick="board_oneatclicked(this.name,this)" />

             <button class='ONEAT'          name='${boardid}'  data='acton'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='clear'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='cropp'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='cutbd'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='paste'                  onclick="board_oneatclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data='darkb'                  onclick="board_oneatclicked(this.name,this)" />
             <button class='ONEAT'          name='${boardid}'  data='zoomo'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='zoomi'                  onclick="board_oneatclicked(this.name,this)" />        

             <button class='ONEAT'          name='${boardid}'  data='rotcl'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='rotcr'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='flipv'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='fliph'                  onclick="board_oneatclicked(this.name,this)" />        
             <button class='ONEAT'          name='${boardid}'  data='undol'                  onclick="board_oneatclicked(this.name,this)" />        
  ...
  to_setup_script(){
    ...
    all_shapes = ['rect','triangle','ellipse','line'];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','square':'&#x26CB;','select':'&#x2B1A;','smudge':'&#x26C6;','eraser':'&#x26CA;','cplane':'&#x1D465;&#x1D456;','ball':'&#x26CB;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;'};
    all_st_icons = ['&#x2758;','&#x2759;','&#x275A;'];
    all_sh_icons = ['&#x25AD;','&#x25FA;','&#x2B2D;','&#x2216;'];
    //all_sh_icons = {'line':'&#x2216;','tri':'&#x25B3;','triur':'&#x25FA;','rect':'&#x25AD;','pentagon':'&#x2B20;','hexagon':'&#x2B21;','circle':'&#x2B2D;'};
    all_at_icons = {'clear':'&#x26F6;','cropp':'&#x26BF;','fopen':'&#x1F4C2;','dload':'&#x2728;','zoomo':'&#x2315;&#x207B;','zoomi':'&#x2315;&#x207A;','rotcl':'&#x2B6F;','rotcr':'&#x2B6E;','flipv':'&#x2BFC;','fliph':'&#x2BFA;','acton':'&#x2318;','cutbd':'&#x2702;','paste':'&#x26E8;','rsize':'&#x26DE;','uload':'&#x26A1;','darkb':'&#x263E;','undol':'&#x2621;'};
    ...
    function setup(){
      ...
      for(var i=0; i < select.length; i++){
        var button = select[i];
        var op = button.getAttribute('data');
      ...
      for(var i=0; i < select.length; i++){
        var button = select[i];
        var cl = button.getAttribute('data');
        var cl = parseInt(cl);
      ...
      for(var i=0; i < select.length; i++){
        var button = select[i];
        var st = button.getAttribute('data');
        var st = parseInt(st);
...
*/
    ...
    function board_fopen_clicked(name,e){
      ...
      if(e.files[0]){
        ...
        img.onload = function(){
          var str = ".ONEOP[name="+name+"]"+"[data=select]";
    ...
    function board_enter(ctx,canvas){
      ...
      if(o.myop=='pencil'){  //board_enter pencil
        ...
        o.mypencil.s0 = [];
        o.mypencil.iseraser = 0;
        o.mypencil.polypts = [];
      }
      if( o.myop=='poly' ){ //board_enter poly
        if(!o.mypoly){
          o.mypoly = {};
        }
        ctx.resetTransform();
      ...
      if(o.myop=='eraser'){ //board_enter eraser
        ctx.resetTransform();
      }
      ...
      if(o.myop=='cplane'){ //board_enter cplane
        ...
        o.mycplane.s = ctx.getImageData(0,0, canvas.width,canvas.height);
      }
      if(o.myop=='xyplane'){ //board_enter xyplane
        ...
        o.myxyplane.s = ctx.getImageData(0,0, canvas.width,canvas.height);
      }
    ...
    function board_leave(ctx,canvas){
      ...
      if(o.myop=='ball'){ //board_leave ball
        o.myball.hitball = null;
        o.myball.selection = [];  
        board_redraw(ctx,canvas);
        o.myball.s = null;
    ...
    function board_redraw(ctx,canvas){
      ...
      if(ctx.cake.myop=='square'){    //board_redraw square
        ...
        if(o.myaction){
          o.myaction = 0;
          o.mysquare.shapeid += 1;
          o.mysquare.shapeid %= all_shapes.length;
          o.mysquare.skewX = 0;
          o.mysquare.skewY = 0;
          o.mysquare.rotation = 0;
        }
    ...
    function polypts_add_square(squa, polypts){
      let corners = ball_get_corners(squa);
      switch(squa.shape){
        case 0: {
          polypts_add_xy(corners[0].x+squa.x,corners[0].y+squa.y, polypts);
          polypts_add_xy(corners[1].x+squa.x,corners[1].y+squa.y, polypts);
          polypts_add_xy(corners[2].x+squa.x,corners[2].y+squa.y, polypts);
          polypts_add_xy(corners[3].x+squa.x,corners[3].y+squa.y, polypts);
          break;
        }
        case 1: {
          polypts_add_xy(corners[0].x+squa.x,corners[0].y+squa.y, polypts);
      ...
      if(o.myop=='square'){
        if(o.mysquare.clipshape){
          if(o.mysquare.face){
            o.mysquare.s = o.mysquare.face;
            o.mysquare.face = null;
            polypts_add_square(o.mysquare, o.mypoly,ctx,canvas);
          }
    ...
    function board_undol(ctx,canvas){
      var o = ctx.cake;          
      if(o.myop=='pencil'){
        if(o.mypencil.s0.length){
          let s0 = o.mypencil.s0.pop();
          ctx.putImageData(s0, 0,0);
        }
      }
    }
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_start pencil
        if(1){
          ...
          o.mypencil.s0.push(s0);
          if(o.mypencil.s0.length > 10){
            o.mypencil.s0.shift();
          }
        }
        ...
        if(o.myaction){
          o.myaction = 0;
          o.mypencil.iseraser += 1;
          o.mypencil.iseraser %= 2;
        }
        let {x,y} = o.mypencil;
        if(o.mypencil.altKey){
          o.mypencil.s = ctx.getImageData(0,0, canvas.width,canvas.height);
          o.mypencil.sh = 'line';
          let x1 = ctx.posx0;
          let y1 = ctx.posy0;
          let x2 = ctx.posx0;
          let y2 = ctx.posy0;
          if(o.mypencil.shiftKey){
            [x1,y1] = polypts_find_xy(x1,y1, o.mypencil.polypts);
            [x2,y2] = polypts_find_xy(x2,y2, o.mypencil.polypts);
          }
          o.mypencil.x1 = x1;
          o.mypencil.y1 = y1;
          o.mypencil.x2 = x2;
      ...
      if(ctx.cake.myop=='poly'){ //board_start poly
        ...
        o.mypoly.x = ctx.posx0;
        o.mypoly.y = ctx.posy0;
        if(o.myaction){
          o.myaction = 0;
          o.mypoly.iseraser += 1;
          o.mypoly.iseraser %= 2;
        ...
        let x2 = ctx.posx0;
        let y2 = ctx.posy0;
        if(o.mypoly.shiftKey){
          [x1,y1] = polypts_find_xy(x1,y1, o.mypoly.polypts);
      ...
      if(ctx.cake.myop=='ball'){ //board_start ball
        ...
        if(altKey && shiftKey){
          if(o.myball.hitball){
            ...
            //create new ball                                     
            let ball = ball_new_ball(o.myshapeid,o.mycolorid,o.mystrokeid,ctx.posx0,ctx.posy0);
            o.myball.balls.push(ball);
    ...
    function board_drag(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_drag pencil
        if(o.mypencil.altKey){
          let x1 = o.mypencil.x1;
          let y1 = o.mypencil.y1;
          let x2 = ctx.posx2;
          let y2 = ctx.posy2;
          let x0 = ctx.posx0;
          let y0 = ctx.posy0;
          ...
          ctx.strokeStyle = board_curr_color(ctx,canvas);
          if(o.mypencil.s){
            ctx.putImageData(o.mypencil.s, 0,0);
          }
          let w = x2-x1;
          let h = y2-y1;
          if(w || h){
      ...
      if(ctx.cake.myop=='cplane'){ //board_drag cplane
        ...
        if(o.mycplane.pointisinhandle){
          ...
          let diff_x = ctx.posx2 - o.mycplane.origin_x;
          let diff_y = ctx.posy2 - o.mycplane.origin_y;
          ...
          let diff_x = ctx.posx2 - ctx.posx1;
          let diff_y = ctx.posy2 - ctx.posy1;
        ...
        if(o.myball.istodo=='move'){
          ...
          if(o.myball.hitball){
            ...
            if(Math.abs(dx)>10 || Math.abs(dy)>10){
              ...
              let ball = ball_new_ball(o.myshapeid,o.mycolorid,o.mystrokeid,x,y);
              ball.w = dx;
              ball.h = dy;
              o.myball.balls.push(ball);
              o.myball.hitball = ball;
    ...
    function board_end(ctx,canvas){
      ...
      if(ctx.cake.myop=='pencil'){ //board_end pencil
        if(o.mypencil.altKey){
          let x1 = o.mypencil.x1;
          let y1 = o.mypencil.y1;
          let x2 = o.mypencil.x2;
          let y2 = o.mypencil.y2;
          polypts_add_xy(x1,y1, o.mypencil.polypts);
          polypts_add_xy(x2,y2, o.mypencil.polypts);
          o.mypencil.s = null; 
        }else{
          o.mypencil.s = null; 
        }
      }
      if(ctx.cake.myop=='poly'){ //board_end poly
        let x1 = o.mypencil.x1;
        let y1 = o.mypencil.y1;
        let x2 = o.mypencil.x2;
        let y2 = o.mypencil.y2;
        polypts_add_xy(x1,y1, o.mypoly.polypts);
