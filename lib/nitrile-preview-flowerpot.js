  ...
  to_edit_contents(boardid){
    return `\
       ...
       <div style='position:relative'>
         <button name='${boardid}' id='op-1-${boardid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' >&#x270E;</button>
       ...
       <div style='position:relative'>
         <button name='${boardid}' id='op-2-${boardid}' class="BUTTON COLOR" role="button" onclick='board_onshowdropmenu()' >&#x270E;</button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:51px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
           ...
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL' name='2-${boardid}'  data-cl='0'        onclick="board_oncoloridclicked(this.name,0)"></button>
       ...
       <input type='range' min="1" max="2" value="1" name='${boardid}' style='margin-left:1px;margin-right:1px;width:30px;' onchange='board_oneckclicked(this.name,this.value)'/>
       `;
  }
  ////////////////////////////////////////////////////////////////////////
  //
