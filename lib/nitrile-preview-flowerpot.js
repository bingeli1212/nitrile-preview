  ...
  to_setup_script(){
    ...
    function smudge_fill(x,y,stacksize,n,sx,sy,dir,mysmear,ctx){
      ...
      if(stacksize<2000 && n < 5000){
        ...
        n += count;
        if(count){
          n = smudge_fill(x+1,y,  stacksize+1,n,sx,sy,dir,mysmear,ctx);
          n = smudge_fill(x+1,y+1,stacksize+1,n,sx,sy,dir,mysmear,ctx);
          n = smudge_fill(x,  y+1,stacksize+1,n,sx,sy,dir,mysmear,ctx);
          n = smudge_fill(x-1,y+1,stacksize+1,n,sx,sy,dir,mysmear,ctx);
          n = smudge_fill(x-1,y,  stacksize+1,n,sx,sy,dir,mysmear,ctx);
          n = smudge_fill(x-1,y-1,stacksize+1,n,sx,sy,dir,mysmear,ctx);
          n = smudge_fill(x,  y-1,stacksize+1,n,sx,sy,dir,mysmear,ctx);
