  ...
  to_setup_script(){
    ...
    function board_setup_canvas(canvas){
      ...
      if(1){
        ...
        ctx.note.myfig = {x:0,y:0,w:0,h:0,rotate:0,skewX:0,skewY:0,mystroke:all_sml_stroke,mycolor:'Black'};
    ...
    function board_curr_color(ctx,canvas){
      var mycolorid = Math.abs(ctx.note.mycolorid);
      mycolorid = mycolorid % all_colors.length;
      return all_colors[mycolorid]; 
    }
    function board_curr_stroke(ctx,canvas){
      return (ctx.note.mystrokeid)?all_big_stroke:all_sml_stroke;
    }
    ...
    function note_redraw(ctx,canvas){
      ...
      if(o.myop=='shape' && o.myarg=='pentagon'){
        ...
        if(1){
          ...
          ctx.stroke();
          ctx.restore();
console.log('note_redraw','pentagon');
        }
        ctx.note.myface = ctx.getImageData(0,0, canvas.getAttribute('width'),canvas.getAttribute('height'));
      } 
