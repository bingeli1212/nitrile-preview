    ...
    return `\
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:68px;z-index:10;' >
           ...
           <input type='text' 
                     class='ONETE'     name='1-${boardid}'                     onchange='board_one_te_changed(this.value,this.name)'/>
         </div>
       </div>
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:68px;z-index:10;' >
           ...
           <input type='text' 
                     class='ONETE'     name='2-${boardid}'                     onchange='board_one_te_changed(this.value,this.name)'/>
         </div>
       </div>
       `;
  }
