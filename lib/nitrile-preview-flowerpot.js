...
`;
  ...
  to_edit_contents(boardid,buttonid){
    return `\
       ...
       <div style='margin-left:1px;margin-right:1px;' class='DROPDOWN'>
         <div class='DROPMENU'>
         ...
         <button name='${boardid}' id='${buttonid}' class="COLORBUTTON" role="button"></button>
       </div>
       <button name='${boardid}' id=''            class="COLORBUTTON" role="button" onclick='board_onundoclicked(this.name)' >&#x2B6E;</button>
       <button name='${boardid}' id=''            class="COLORBUTTON" role="button" onclick='board_onrevundoclicked(this.name)' >&#x2B6F;</button>
       `;
  }
  ////////////////////////////////////////////////////////////////////////
  //
