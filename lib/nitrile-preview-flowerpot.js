  ...
  to_setup_script(){
    ...
    function board_handle_keydown(shiftKey,altKey,keycode,ctx,canvas){
      ...
      case 'KeyX':
        ...
        o.myfig.w   = Math.max(1,o.myfig.w);
        board_redraw(o,ctx,canvas);
        break;
      ///SCALE-Y
      case 'KeyY':
        ...
        o.myfig.h   = Math.max(1,o.myfig.h);
        board_redraw(o,ctx,canvas);
        break;
      ///SCALE-S
      case 'KeyS':
        o.myfig.skew += (shiftKey)?(-1):(+1);
        board_redraw(o,ctx,canvas);
        break;
      ///DUPLICATE
      case 'KeyD':
    ...
    function board_start(ctx,canvas){
      if(ctx.d.mymouseisdown){
        ...
        if(ctx.d.myop=='select'){
          ...
          let x = cx;
          let y = cy;
          ctx.d.myfig = {cx,cy,rx:0,ry:0,x,y,w:0,y:0,rotate:0,skew:0,mystroke,mycolor};
          ...
          let x = ctx.d.myposx0;
          let y = ctx.d.myposy0;
          ctx.d.myfig = {x,y,w:0,h:0,s:0,rotate:0,skew:0,mystroke,mycolor};
          ...
          let x3 = x;
          let y3 = y;
          ctx.d.myfig = {x,y,w:0,h:0,x1,y1,x2,y2,x3,y3,rotate:0,skew:0,mystroke,mycolor};
          ...
          let x = ctx.d.myposx0;
          let y = ctx.d.myposy0;
          ctx.d.myfig = {x,y,w:0,h:0,rotate:0,skew:0,mystroke,mycolor};
    ...
    function board_redraw(o,ctx,canvas){
      ...
      if(o.myop=='circle'){
        ...
        if(1){
          ...
          ctx.beginPath();
          ctx.moveTo(0,0);
          ctx.lineTo(myfig.w,0);
          ctx.lineTo(myfig.w+myfig.skew,myfig.h);
          ctx.lineTo(myfig.skew,myfig.h);
          ctx.closePath();
          ctx.translate(-myfig.x,-myfig.y);
          ctx.stroke();
          ctx.restore();
        ...
        if(1){
          ...
          ctx.rotate(myfig.rotate/180*Math.PI);
          ctx.beginPath();
          ctx.moveTo(myfig.x1-myfig.x,myfig.y1-myfig.y);
          ctx.lineTo(myfig.x2-myfig.x,myfig.y2-myfig.y);
          ctx.lineTo(myfig.x3-myfig.x,myfig.y3-myfig.y);
          ctx.closePath();
          ctx.translate(-myfig.x,-myfig.y);
          ctx.stroke();
          ctx.restore();
