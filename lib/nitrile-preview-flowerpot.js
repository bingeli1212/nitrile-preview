...
`;
  ...
  to_butt_contents(boardid){
    return `\
       <button name='${boardid}' id='butt-${boardid}' class="BUTTON CAKE" role="button" onclick="board_onebuttclicked(this.name,this)" ></button>
       `;
  }
  to_tool_contents(boardid){
    return `\
         <div id='tool-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:136px;z-index:10;' >
             ...
             <button class='ONEOP'          name='${boardid}'  data='square'                 onclick="board_oneopclicked(this.name,this)" />
             ...
             <button class='ONEOP HIDE'     name='${boardid}'  data='hide'                   onclick="board_oneopclicked(this.name,this)" />
             <button class='ONEOP HIDE'     name='${boardid}'  data='hide'                   onclick="board_oneopclicked(this.name,this)" />
             ...
             <button class='ONEAT HIDE'     name='${boardid}'  data='hide'                   onclick="board_oneatclicked(this.name,this)" />        
             <!------->
  ...
  to_setup_script(){
    ...
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','poly':'&#x269E;','square':'&#x26CB;','eraser':'&#x2B1A;','smudge':'&#x26C6;','select':'&#x26F6;','cplane':'&#x1D465;&#x1D456;','ball':'&#x2699;','xyplane':'&#x1D465;&#x1D466;','hand':'&#x270B;'};
...
*/
    ...
    function board_oneopclicked(name,e){
      ...
      if(1){
        let button_elem = document.getElementById("butt-"+name);
...
console.log('board_onsubmitclicked',name,e);
    ...
    function board_redraw(ctx,canvas){
      ...
      if(ctx.cake.myop=='ball'){ //board_redraw ball
        ...
        if(o.myaction){
          o.myaction = 0;
          if(o.myball.hitball){
            o.myball.hitball.shapeid += 1;
            o.myball.hitball.shapeid %= all_shapes.length;
    ...
    function board_paste(ctx,canvas){
      ...
      if(o.myop=='ball'){
        ...
        if(o.myball.clipball){
          ...
          let w = 30;
          let h = 30;
          let ball = ball_new_ball(o.mycolorid,o.mystrokeid,x,y);
          o.myball.hitball = ball;
          o.myball.balls.push(ball);
        }
      }
      ...
      if(ctx.cake.myop=='ball'){ //board_start ball
        ...
        if(altKey && shiftKey){
          if(o.myball.hitball){
            ...
            //create new ball                                     
            let ball = ball_new_ball(o.mycolorid,o.mystrokeid,ctx.posx0,ctx.posy0);
            o.myball.balls.push(ball);
    ...
    function ball_new_ball(colorid,strokeid,x,y){
      let ball = {shapeid:0,corner_i:-1,colorid,strokeid,x,y,w:30,h:30,skewX:0,skewY:0,rotation:0};
      return ball;
    }
    ///////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////
