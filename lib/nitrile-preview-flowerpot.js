    ...
    return `\
       <div class='DROPDOWNCONTAINER' style='position:static'>
         ...
         <div class='DROPMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:119px;z-index:10;' >
             ...
             <button class='ONEAT'          name='1-${boardid}'  data-at='5'                      onclick="board_one_atclicked(this.name,5,this)" />        
    ...
    function board_cut(ctx,canvas){
      ...
      if(o.myop=='select'){
        ...
        if(w && h){
          ...
          o.mybasis.s = ctx.getImageData(0,0, canvas.width,canvas.height);
console.log('clipboard',o.mybasis.clipboard.width,o.mybasis.clipboard.height);
console.log('w,h',w,h);
        }
      }
    }
