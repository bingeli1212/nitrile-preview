  ...
  to_setup_script(){
    ...
    function board_start(ctx,canvas){
      ...
      if(ctx.d.myop=='object'){
        ...
        if(ctx.d.myobject){
          ...
          let {s,mybasis,myop,myfig} = ctx.d.myobject;
          if(myop=='tri'){
            let w = myfig.w;
            let h = myfig.h;
            let x1 = w/2;
    ...
    function board_redo(boardid){
      ...
      if(ctx.d.myredo.length>0){
        ...
        if(o.myop=='circle' || // need to update the 'o.s' field as the previous undo might have changed it
           o.myop=='rect' ||
           o.myop=='tri' ||
           o.myop=='line' ){
          o.s = ctx.d.myface;
