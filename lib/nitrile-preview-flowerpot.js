...
`;
  ...
  to_tool_contents(boardid){
    return `\
         <div id='tool-1-${boardid}' class='TOOLMENU' style='display:flex;flex-direction:row;align-items:flex-start;justify-content:flex-start;flex-wrap:wrap;width:85px;height:136px;z-index:10;' >
             ...
             <button class='ONEAT HIDE'     name='1-${boardid}'  data-at='hide'                   onclick="board_one_atclicked(this.name,this)" />        
             ...
             <button class='ONEAT'          name='1-${boardid}'  data-at='uload'                  onclick="board_one_atclicked(this.name,this)" />
  ...
  to_setup_script(){
    ...
    all_st_icons = ['&#x2758;','&#x2759;','&#x275A;'];
    all_at_icons = {'clear':'&#x2B1A;','cropp':'&#x26CB;','fopen':'&#x1F4C2;','dload':'&#x2728;','zoomo':'&#x2315;-','zoomi':'&#x2315;+','rotcl':'&#x2B6F;','rotcr':'&#x2B6E;','acton':'&#x2318;','cutbd':'&#x2702;','paste':'&#x26E8;','rsize':'&#x26DE;','uload':'&#x26A1;','darkb':'&#x26C5;'};
...
console.log('board_onsubmitclicked',name,e);
    ...
    function board_coloridchanged(ctx,canvas){
      ...
      if(o.myop=='ball'){
        if(o.myball.hitball){
          o.myball.hitball.color = board_get_color(o.mycolorid,ctx,canvas);
        }
      } 
    }
    ...
    function board_redraw(ctx,canvas){
      ...
      if(ctx.cake.myop=='square'      //board_redraw square
      || ctx.cake.myop=='triangle'    //board_redraw triangle
      || ctx.cake.myop=='ellipse' ){  //board_redraw ellipse
        ctx.resetTransform();
        if(o.mysquare.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.mysquare.s,0,0);
        ...
        if(o.mysquare.w && o.mysquare.h){
          ...
          ctx.save();
          ///
          let path2d = square_get_path2d(o.myop,o.mysquare);
          let corners = square_get_corners(o.myop,o.mysquare);
          let center_p = square_get_center_p(o.myop,o.mysquare);
          ///transform
    ...
    function board_addpolypt_square(myop,mysquare, mypoly, ctx,canvas){
      let corners = square_get_corners(myop,mysquare);
      switch(myop){
        case 'square': {
          board_addpolypt_xy([corners[0].x+mysquare.x,corners[0].y+mysquare.y], mypoly, ctx,canvas);
          board_addpolypt_xy([corners[1].x+mysquare.x,corners[1].y+mysquare.y], mypoly, ctx,canvas);
          board_addpolypt_xy([corners[2].x+mysquare.x,corners[2].y+mysquare.y], mypoly, ctx,canvas);
          board_addpolypt_xy([corners[3].x+mysquare.x,corners[3].y+mysquare.y], mypoly, ctx,canvas);
          break;
        }
        case 'triangle': {
          board_addpolypt_xy([corners[0].x+mysquare.x,corners[0].y+mysquare.y], mypoly, ctx,canvas);
    ...
    function board_cutbd(ctx,canvas){
      ...
      || o.myop=='ellipse'){
        ctx.resetTransform();
        if(o.mysquare.w && o.mysquare.h){
          let {x,y,w,h,skewX,skewY} = o.mysquare;
          o.mysquare.clipshape = {x,y,w,h,skewX,skewY};
        }
        o.mysquare.w = 0;
        o.mysquare.h = 0;
        o.mysquare.face = null;
    ...
    function board_paste(ctx,canvas){
      ...
      || o.myop=='triangle'  
      || o.myop=='ellipse'){
        if(o.mysquare.clipshape){
          let {x,y,w,h,skewX,skewY} = o.mysquare.clipshape;
          ...
          && Number.isFinite(skewY)   ){
            ...
            o.mysquare.w = w; 
            o.mysquare.h = h; 
            o.mysquare.skewX = skewX; 
            o.mysquare.skewY = skewY; 
          }
        }
      }
      if(o.myop=='ball'){
    ...
    function board_start(ctx,canvas){
      ...
      || ctx.cake.myop=='ellipse' ){  //board_start ellipse
        ...
        if(1){ ///determine which corner index
          ...
          ctx.translate(-center_p.x,-center_p.y);             
          ctx.lineWidth=10;
          o.mysquare.isinside = ctx.isPointInPath(path2d, ctx.posx0,ctx.posy0);
          o.mysquare.corner_i = -1;
          corners.forEach((pt,i) => {
            let {x,y} = pt;
            if(Number.isFinite(x) && Number.isFinite(y)){
        ...
        let {altKey,shiftKey,isinside,corner_i} = o.mysquare;
        if(altKey && shiftKey){
          if(o.mysquare.face){
            o.mysquare.s = o.mysquare.face;
            o.mysquare.face = null;
          ...
          o.mysquare.istodo = 'size';
        }else if(corner_i==1){ 
          o.mysquare.istodo = 'skewY';
        }else if(corner_i==3){ 
          o.mysquare.istodo = 'skewX';
        }else if(isinside){ 
          o.mysquare.istodo = 'move';
        }else{
          if(o.mysquare.face){
        ...
        o.mysquare.x0 = o.mysquare.x;
        o.mysquare.y0 = o.mysquare.y;
        o.mysquare.w0 = o.mysquare.w;
        o.mysquare.h0 = o.mysquare.h;
        board_redraw(ctx,canvas);
      }
...
console.log('pointisinhandle',o.mycplane.pointisinhandle);
      ...
      if(ctx.cake.myop=='ball'){ //board_start ball
        ...
        if(altKey && shiftKey){
          ...
          var old_hitball = o.myball.hitball;
          if(o.myball.hitball){
          ...
          if(!old_hitball){
            o.myball.istodo = '';
          }else if(old_hitball !== o.myball.hitball){
            o.myball.istodo = '';
    ...
    function board_drag(ctx,canvas){
      ...
      || ctx.cake.myop=='ellipse' ){ //board_drag ellipse
        let {isnewsketch,istodo,corner_i,w,h} = o.mysquare;
        ...
        if(istodo=='move'){
          ...
          o.mysquare.w = o.mysquare.w0 + dx;
          o.mysquare.h = o.mysquare.h0 + dy;
        }else if(istodo=='skewX'){
          let dx = ctx.posx2 - ctx.posx1;
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.skewX += dx;
        }else if(istodo=='skewY'){
          let dy = ctx.posy2 - ctx.posy1;
          o.mysquare.skewY += dy;
        }
        board_redraw(ctx,canvas);
...
console.log('skewX');
    ...
    ///////////////////////////////////////////////////////
    ///////////////////////////////////////////////////////
    function square_get_path2d(myop,squa){
      let path2d = new Path2D();
      switch(myop){
        case 'square': {
          path2d.moveTo(0,                  0);
          path2d.lineTo(squa.w,             squa.skewY);
          path2d.lineTo(squa.w+squa.skewX,  squa.h+squa.skewY);
          path2d.lineTo(squa.skewX,         squa.h);
          path2d.closePath();
          break;
        }
        case 'triangle': {
        ...
        case 'ellipse': {
          let cx = squa.w/2;
          let cy = squa.h/2;
          let rx = Math.abs(squa.w/2);
          let ry = Math.abs(squa.h/2);
          let rotation = 0;
          let sAngle = 0;
          let eAngle = 2*Math.PI;
          //path2d.ellipse(cx,cy,rx,ry,rotation,sAngle,eAngle);
          let p0 = [0,                      0];
          let p1 = [squa.w,                 squa.skewY];
          let p2 = [squa.w+squa.skewX,      squa.h+squa.skewY];
          let p3 = [squa.skewX,             squa.h];
          let [x1,y1] = MidPoint(p3,p0,0.5);
          let [x2,y2] = MidPoint(p0,p1,0.5);
          let [x3,y3] = MidPoint(p1,p2,0.5);
          let [x4,y4] = MidPoint(p2,p3,0.5);
    ...
    function square_get_corners(myop,squa){
      let {w,h} = squa;
      var corners = [];
      switch(myop){
        case 'square': {
          corners.push({x:0,                      y:0});
          corners.push({x:squa.w,                 y:squa.skewY});
          corners.push({x:squa.w+squa.skewX,      y:squa.h+squa.skewY});
          corners.push({x:squa.skewX,             y:squa.h});
          break;
        }
        case 'triangle': {
          corners.push({x:0,                      y:0});
    ...
    function square_get_center_p(myop,squa){
      let {w,h} = squa;
      let p1 = {x:0,                      y:0};
      let p2 = {x:squa.w+squa.skewX,      y:squa.h+squa.skewY};
      let x = (p1.x + p2.x)/2;
      let y = (p1.y + p2.y)/2;
      return {x,y};   
    }
