    ...
    return `\
       ...
       <select name='${canvasid}' onchange='select_change_line(this.value,this.name)'>
          <optgroup label='Lines'>
           <option value='1.5'>Thin line</option>
           <option value='2.5'>Med line</option>
           <option value='4'>Thick line</option>
          </optgroup>
          <optgroup label='Erasers'>
            <option value='-1.5'>Thin eraser</option>
            <option value='-2.5'>Med eraser</option>
            <option value='-4'>Thick eraser</option>
            <option value='0'>Erase All</option>
         </optgroup>
       </select>
       `;
  }
  to_setup_script(){
    ...
    function setup(){
      ...
      document.onkeypress=function(evt){
        if(myslide){
          var mycanvas = myslide.querySelector('canvas.EDITBOARD');
