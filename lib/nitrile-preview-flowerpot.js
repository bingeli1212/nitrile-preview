...
`;
  ...
  write_frame_folder(id,frame,subframes,toc,pages){
    ...
    all.push(`</div>`);
    all.push(`<canvas class='EDITBOARD' id='2-${boardid}' data-frameid='${frameid}' width='441' height='320' ></canvas>`);
    all.push(`<canvas class='EDITBOARD' id='1-${boardid}' data-frameid='${frameid}' width='441' height='320' ></canvas>`);
    all.push('</article>');
    all.push('');
    //
    //NOTE: end
  ...
  to_edit_contents(boardid){
    return `\
       ...
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         <button name='${boardid}' id='op-1-${boardid}' class="BUTTON CAKE" role="button" onclick="board_oneckclicked(this.name,'1')" >&#x270E;</button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:51px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONEOP DOT' name='1-${boardid}'  data-op='pencil'       onclick="board_oneopclicked(this.name,'pencil' ,this)"></button>
             <button class='ONEOP'     name='1-${boardid}'  data-op='smudge'       onclick="board_oneopclicked(this.name,'smudge' ,this)"></button>
             <button class='ONEOP'     name='1-${boardid}'  data-op='eraser'       onclick="board_oneopclicked(this.name,'eraser' ,this)"></button>
             <button class='ONEOP'     name='1-${boardid}'  data-op='select'       onclick="board_oneopclicked(this.name,'select' ,this)"></button>
             <button class='ONEOP'     name='1-${boardid}'  data-op='cplane'       onclick="board_oneopclicked(this.name,'cplane' ,this)"></button>
             <button class='ONEOP'     name='1-${boardid}'  data-op='ball'         onclick="board_oneopclicked(this.name,'ball'   ,this)"></button>
             <button class='ONEOP'     name='1-${boardid}'  data-op='xyplane'      onclick="board_oneopclicked(this.name,'xyplane',this)"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONESH DOT' name='1-${boardid}'  data-sh='line'     onclick="board_oneshclicked(this.name,'line'    ,this)">&#x2216;</button>
             <button class='ONESH'     name='1-${boardid}'  data-sh='tri'      onclick="board_oneshclicked(this.name,'tri'     ,this)"></button>
             <button class='ONESH'     name='1-${boardid}'  data-sh='rect'     onclick="board_oneshclicked(this.name,'rect'    ,this)"></button>
             <button class='ONESH'     name='1-${boardid}'  data-sh='pentagon' onclick="board_oneshclicked(this.name,'pentagon',this)"></button>
             <button class='ONESH'     name='1-${boardid}'  data-sh='hexagon'  onclick="board_oneshclicked(this.name,'hexagon' ,this)"></button>
             <button class='ONESH'     name='1-${boardid}'  data-sh='circle'   onclick="board_oneshclicked(this.name,'circle'  ,this)"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL DOT' name='1-${boardid}'  data-cl='0'        onclick="board_oneclclicked(this.name,0,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='1'        onclick="board_oneclclicked(this.name,1,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='2'        onclick="board_oneclclicked(this.name,2,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='3'        onclick="board_oneclclicked(this.name,3,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='4'        onclick="board_oneclclicked(this.name,4,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='5'        onclick="board_oneclclicked(this.name,5,this)"></button>
             <button class='ONECL'     name='1-${boardid}'  data-cl='6'        onclick="board_oneclclicked(this.name,6,this)"></button>
             <button class='ONEST DOT' name='1-${boardid}'  data-st='0'        onclick="board_one_stclicked(this.name,0,this)"></button>
             <button class='ONEST'     name='1-${boardid}'  data-st='1'        onclick="board_one_stclicked(this.name,1,this)"></button>
           </div>
         </div>
       </div>
       <div class='DROPDOWNCONTAINER' style='position:relative'>
         <button name='${boardid}' id='op-2-${boardid}' class="BUTTON" role="button" onclick="board_oneckclicked(this.name,'2')" >&#x270E;</button>
         <div class='DROPMENU' style='display:flex;flex-direction:column;align-items:flex-start;justify-content:center;height:51px;z-index:10;' >
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONEOP DOT' name='2-${boardid}'  data-op='pencil'       onclick="board_oneopclicked(this.name,'pencil' ,this)"></button>
             <button class='ONEOP'     name='2-${boardid}'  data-op='select'       onclick="board_oneopclicked(this.name,'select' ,this)"></button>
             <button class='ONEOP'     name='2-${boardid}'  data-op='smudge'       onclick="board_oneopclicked(this.name,'smudge' ,this)"></button>
             <button class='ONEOP'     name='2-${boardid}'  data-op='eraser'       onclick="board_oneopclicked(this.name,'eraser' ,this)"></button>
             <button class='ONEOP'     name='2-${boardid}'  data-op='cplane'       onclick="board_oneopclicked(this.name,'cplane' ,this)"></button>
             <button class='ONEOP'     name='2-${boardid}'  data-op='ball'         onclick="board_oneopclicked(this.name,'ball'   ,this)"></button>
             <button class='ONEOP'     name='2-${boardid}'  data-op='xyplane'      onclick="board_oneopclicked(this.name,'xyplane',this)"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONESH DOT' name='2-${boardid}'  data-sh='line'     onclick="board_oneshclicked(this.name,'line'    ,this)">&#x2216;</button>
             <button class='ONESH'     name='2-${boardid}'  data-sh='tri'      onclick="board_oneshclicked(this.name,'tri'     ,this)"></button>
             <button class='ONESH'     name='2-${boardid}'  data-sh='rect'     onclick="board_oneshclicked(this.name,'rect'    ,this)"></button>
             <button class='ONESH'     name='2-${boardid}'  data-sh='pentagon' onclick="board_oneshclicked(this.name,'pentagon',this)"></button>
             <button class='ONESH'     name='2-${boardid}'  data-sh='hexagon'  onclick="board_oneshclicked(this.name,'hexagon' ,this)"></button>
             <button class='ONESH'     name='2-${boardid}'  data-sh='circle'   onclick="board_oneshclicked(this.name,'circle'  ,this)"></button>
           </div>
           <div style='display:flex;flex-direction:row;align-items:center;justify-content:flex-start;' >
             <button class='ONECL DOT' name='2-${boardid}'  data-cl='0'        onclick="board_oneclclicked(this.name,0,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='1'        onclick="board_oneclclicked(this.name,1,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='2'        onclick="board_oneclclicked(this.name,2,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='3'        onclick="board_oneclclicked(this.name,3,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='4'        onclick="board_oneclclicked(this.name,4,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='5'        onclick="board_oneclclicked(this.name,5,this)"></button>
             <button class='ONECL'     name='2-${boardid}'  data-cl='6'        onclick="board_oneclclicked(this.name,6,this)"></button>
             <button class='ONEST DOT' name='2-${boardid}'  data-st='0'        onclick="board_one_stclicked(this.name,0,this)"></button>
             <button class='ONEST'     name='2-${boardid}'  data-st='1'        onclick="board_one_stclicked(this.name,1,this)"></button>
           </div>
         </div>
       </div>
       `;
  ...
  to_setup_script(){
    ...
    all_strokes = [1.6,3.0];
    all_canvas = null;
    all_op_icons = {'pencil':'&#x270E;','eraser':'&#x2B1A;','smudge':'&#x271C;','select':'&#x2750;','cplane':'C','ball':'B','xyplane':'xy'};
    ...
    function board_create_cake(ctx,canvas){ 
      ...
      let x = ctx.posx0;
      let y = ctx.posy0;
      let myfig = {x,y,w:0,h:0,rotate:0,skewX:0,skewY:0,sh,shiftKey:0,altKey:0};
    ...
    function board_oneckclicked(name,v){
    ...
    function board_oncopyclicked(name){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      if(ctx.cake.myop=='select'){
        if(ctx.cake.mybasis.clipboard){
          ctx.clipboard_s = ctx.cake.mybasis.clipboard;
          ctx.clipboard_x = ctx.cake.mybasis.x;
          ctx.clipboard_y = ctx.cake.mybasis.y;
          ctx.clipboard_w = ctx.cake.mybasis.w;
          ctx.clipboard_h = ctx.cake.mybasis.h;
        }
      }else{
        ctx.clipboard_s = ctx.getImageData(0,0, canvas.width,canvas.height);
        ctx.clipboard_x = 0;
        ctx.clipboard_y = 0;
        ctx.clipboard_w = canvas.width;
        ctx.clipboard_h = canvas.height;
      }
    }
    function board_onpasteclicked(name){
      var canvas = document.getElementById(name);
      var ctx = canvas.getContext('2d');
      if(ctx.cake.myop=='select'){
        if(ctx.clipboard_s){
          ctx.cake.mybasis.x = ctx.clipboard_x;
          ctx.cake.mybasis.y = ctx.clipboard_y;
          ctx.cake.mybasis.w = ctx.clipboard_w;
          ctx.cake.mybasis.h = ctx.clipboard_h;
          ctx.cake.mybasis.dx = 0;
          ctx.cake.mybasis.dy = 0;
          ctx.cake.mybasis.dw = 0;
          ctx.cake.mybasis.dh = 0;
          ctx.cake.mybasis.clipboard = ctx.clipboard_s;
          ctx.cake.mybasis.a = 'copy';
        }
      }else{
        if(ctx.clipboard_s){
          ctx.putImageData(ctx.clipboard_s, ctx.clipboard_x,ctx.clipboard_y);
          ctx.cake.s = ctx.getImageData(0,0, canvas.width,canvas.height);
        }
      }
      board_redraw(ctx,canvas);
    }
    function board_onn1clicked(id,name){
      var canvas1 = document.getElementById("1-"+name);
      var canvas2 = document.getElementById("2-"+name);
      canvas1.style.zIndex = 1;
      canvas2.style.zIndex = 0;
    }
    function board_onn2clicked(id,name){
      var canvas1 = document.getElementById("1-"+name);
      var canvas2 = document.getElementById("2-"+name);
      canvas1.style.zIndex = 0;
      canvas2.style.zIndex = 1;
...
console.log('board_redraw','op=',ctx.cake.myop,'id=',canvas.id);
      ...
      if(ctx.cake.myop=='select'){//board_redraw
        if(o.mybasis.clipboard){
          let x = o.mybasis.x+o.mybasis.dx;
          let y = o.mybasis.y+o.mybasis.dy;
          let w = o.mybasis.w+o.mybasis.dw;
          let h = o.mybasis.h+o.mybasis.dh;
          ctx.putImageData(o.mybasis.clipboard, x,y);
        }
        board_draw_hilite(o,ctx,canvas);
      }
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='circle'){//board_redraw
        if(o.myfig.s){
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='hexagon'){//board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='pentagon'){//board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='rect'){//board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='tri'){//board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='line'){//board_redraw
        if(o.myfig.s){
          ctx.clearRect(0,0, canvas.width,canvas.height);
          ctx.putImageData(o.myfig.s,0,0);
        }
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh==''){//board_redraw
      }
...
console.log('3',a,b,c,d,e,f);
    ...
    function board_scale(vx,vy,ctx,canvas){
      var o = ctx.cake;
      if(ctx.cake.myop=='pencil'){
        o.myfig.w *= vx;
        o.myfig.h *= vy;
      }else if(ctx.cake.myop=='ball'){
        if(o.hit_ball){
    ...
    function board_ontextchanged(value,name){
      ...
      var canvas1 = document.getElementById("1-"+name);//name attribute of Input field holds the 'boardid' of the canvas
      var canvas2 = document.getElementById("2-"+name);//name attribute of Input field holds the 'boardid' of the canvas
      var ctx1 = canvas1.getContext('2d');
      var ctx2 = canvas2.getContext('2d');
      board_settext(value,ctx1,canvas1);
      board_settext(value,ctx2,canvas2);
      board_redraw(ctx1,canvas1);
      board_redraw(ctx2,canvas2);
    }
...
console.log('board_start','op=',ctx.cake.myop,'id=',canvas.id,'altKey=',ctx.altKey,'shiftKey=',ctx.shiftKey);
      ...
      if(ctx.cake.myop=='select'){ //board_start
        if(o.mybasis.clipboard==null){
console.log('clipboard is null');
          o.mybasis.s = ctx.getImageData(0,0, canvas.width,canvas.height);
          o.myfig.s = null;
          //reset the hilite rectangle
...
console.log('clipboard is not null');
          if(ctx.altKey){
            ctx.clearRect(0,0, canvas.width,canvas.height);
            if(o.mybasis.s){
              ctx.putImageData(o.mybasis.s, 0,0);
            }
            ctx.putImageData(o.mybasis.clipboard, o.mybasis.x+o.mybasis.dx, o.mybasis.y+o.mybasis.dy);
            if(ctx.shiftKey){
              //create a hole in o.mybasis.s
              ctx.clearRect(o.mybasis.x+o.mybasis.dx, o.mybasis.y+o.mybasis.dy, o.mybasis.w,o.mybasis.h);
              o.mybasis.s = ctx.getImageData(0,0, canvas.width,canvas.height);
              ctx.putImageData(o.mybasis.clipboard, o.mybasis.x+o.mybasis.dx, o.mybasis.y+o.mybasis.dy);
            }
            board_draw_hilite(o,ctx,canvas);
...
console.log('board_start eraser');
        o.myfig.x = ctx.posx0;
        o.myfig.y = ctx.posy0;
        o.myfig.w = 0;
        o.myfig.h = 0;
...
console.log('board_drag','select','a=',o.mybasis.a);
        //DRAG  
        if(o.mybasis.a=='hilite'){
          ...
          if(o.mybasis.w && o.mybasis.h){
            o.mybasis.clipboard = ctx.getImageData(o.mybasis.x,o.mybasis.y, o.mybasis.w,o.mybasis.h);
          }else{
            o.mybasis.clipboard = null;
          }
          board_draw_hilite(o,ctx,canvas);
        ...
        if(o.mybasis.a=='drag'){
          ...
          if(o.mybasis.clipboard){
            ctx.putImageData(o.mybasis.clipboard, 
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='circle'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='hexagon'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='pentagon'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='rect'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='tri'){//board_drag
        //DRAG  
        let posx0 = ctx.posx0;
        let posy0 = ctx.posy0;
        let posx2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='pencil' && o.myfig.sh=='line'){//board_drag
        //DRAG  
        let x1 = ctx.posx0;
        let y1 = ctx.posy0;
        let x2 = ctx.posx2;
      ...
      if(ctx.cake.myop=='pencil' && !o.myfig.sh){//board_drag
        if(ctx.shiftKey){
