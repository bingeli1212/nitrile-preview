...
//console.log('x-intercept','y0=',y0,'yi=',yi,'x0=',x0,'xii=',xii,'sign0=',sign0,'sign=',sign);
    ...
    function ball_start(ctx,canvas){
      ...
      if(ctx.note.downball){
        let ball = ctx.note.downball
        ...
        ctx.note.downcorner = downcorner;
        console.log('downcorner=',downcorner);
      } else {
        ctx.note.balls.forEach((ball) => {
          ...
          if(ctx.isPointInStroke(ctx.posx0,ctx.posy0)){
            console.log('downball=',ball);
            ctx.note.downball = ball;
          }
        });
      }
      ball_redraw(ctx,canvas);
