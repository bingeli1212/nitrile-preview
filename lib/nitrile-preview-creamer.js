...
class NitrilePreviewCreamer extends NitrilePreviewContex {
  ...
  constructor(parser) {
    ...
    this.icon_hollowbox = '{\\square}'; //BALLOT BOX WITH CHECK
    this.icon_checkedbox = '{\\blacksquare}'; //BALLOT BOX            
  ...
  to_document() {
    var style_setupbodyfont = this.conf_to_string('bodyfont','dejavu,10pt,ss');
