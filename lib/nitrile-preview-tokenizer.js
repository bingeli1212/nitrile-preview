...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  ///
  to_align_math(str,style,used,isdmath){
  ...
  ///
  to_literal_math(str,style,used,isdmath){
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\sqrt':
          ...
          o.push(`<g transform="scale(1,${h/this.fs})"> <use fill="currentColor" xlink:href="#${idr_}" /> </g>`);
  ...
  to_fenced(m,fence1,fence2,used,type){
    ...
    var o = [];
    if(fence1=='\\lbrack'||fence1=='('||fence1=='\\lvert'||fence1=='\\lbrace'){
    ...
    if(fence2=='\\rbrack'||fence2==')'||fence2=='\\rvert'||fence2=='\\rbrace'){
