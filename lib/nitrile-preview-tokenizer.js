...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  to_align_math(str,style,used,isdmath,extra_css=''){
    var m = this.to_svgmath(str,style,used);
    var {w,h,mid,s} = m;
  ...
  ///
  to_innersvg_math(str,style,used){
    ...
    var pref = {...style,compact:0,frac:0,array:0};
      ...
      switch (v[0]) {
        ...
        case '\\sup':
          ...
          if (    v[1] === '\\dsum' || 
            ...
            var nh1_ = h1_    *1;
            var nmid1_ = mid1_*1
            var sub_rate = this.droot_rate;
            var sup_rate = this.droot_rate;
