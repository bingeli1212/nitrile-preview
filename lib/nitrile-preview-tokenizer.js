...
const re_token = /\\;|\\,|\\:|\\\\|\\\{|\\\}|\\begin\{\w+\}|\\end\{\w+\}|(\\mathcal|\\mathbf|\\mathbb|\\mathrm|\\mathit)\s*\{[A-Za-z0-9]*\}|&[a-zA-Z][a-zA-Z0-9]*;|\\[a-zA-Z]+|'+|./ug;
...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  to_svgmath (math,style,type) {
    ...
    var defs = [];
    s = this.to_outer_svg(s,0,0,w*1.333,h*1.333,w,h,mid,defs,type,pref);
  ...
  to_outer_svg(s,x,y,vw,vh,w,h,mid,defs,type,style){
    ///type:='\\pipe' or '\\math'
    mid = mid||'0';
    var opt = '';
    var css = '';
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\leftright':
          ...
          if(v[0]==='\\leftright'){
            ...
            if(v[0] === '\\pipe' || v[0] === '\\math'){
              let deltaw = this.get_protrude_by_id(this.my_last_id)*this.fs/12;//this depends on the last char being processed
              ...
              var vw = w*1.333;
              var vh = h*1.333;
              s = this.to_outer_svg(s,x,y,vw,vh,w,h,mid,defs,type,pref);
            }
        ...
        case '\\overrightarrow':
          ...
          if(1){
            ...
            if(0){
              ...
              o.push(`<line x1='0pt'    y1='1.5pt' x2='${w}pt'     y2='1.5pt' style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
              o.push(`<line x1='${w}pt' y1='1.5pt' x2='${w-2.5}pt' y2='3pt'   style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
              o.push(`<line x1='${w}pt' y1='1.5pt' x2='${w-2.5}pt' y2='0pt'   style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
            }
          }else{
            o.push(`<g transform='translate(${lead*1.333} ${sunk*1.333})'> ${s_} </g>`);
            o.push(`<line x1='0pt' y1='1.5pt' x2='${w}pt' y2='1.5pt' style='stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
        ...
        case '\\overleftrightarrow':
          ...
          if(1){
            ...
            if(0){
              ...
              //o.push(`<g transform='translate(${lead*1.333},0) scale(${w_/wa_},1)' > <use xlink:href='#${ida_}'/> </g>`);
              o.push(`<line x1='0pt'    y1='1.5pt' x2='${w}pt'     y2='1.5pt' style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
              o.push(`<line x1='0pt'    y1='1.5pt' x2='2.5pt'      y2='3pt'   style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
              o.push(`<line x1='0pt'    y1='1.5pt' x2='2.5pt'      y2='0pt'   style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
              o.push(`<line x1='${w}pt' y1='1.5pt' x2='${w-2.5}pt' y2='3pt'   style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
              o.push(`<line x1='${w}pt' y1='1.5pt' x2='${w-2.5}pt' y2='0pt'   style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
            }
          }else{
        ...
        case '\\underleftrightarrow':
          ...
          o.push(`<line x1='0pt'    y1='${h-1.5}pt' x2='2.5pt'      y2='${h-3.0}pt' style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
          o.push(`<line x1='0pt'    y1='${h-1.5}pt' x2='2.5pt'      y2='${h    }pt' style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
          o.push(`<line x1='${w}pt' y1='${h-1.5}pt' x2='${w-2.5}pt' y2='${h-3.0}pt' style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
          o.push(`<line x1='${w}pt' y1='${h-1.5}pt' x2='${w-2.5}pt' y2='${h    }pt' style='stroke-width:1pt; stroke:inherit; fill:none; font-size:${this.fs}pt;'/>`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\sqrt':
          ...
          /// the \sqrt symbol
          o.push(`<svg width='${lead+1}pt' height='${h-sunk/2}pt' viewBox='0 0 ${(lead+1)*1.333} ${hr_*1.333}' preserveAspectRatio='none' > <use xlink:href='#${idr_}' /> </svg>`);
        ...
        case '\\sfrac':
          ...
          o.push(s2_);
          o.push(`</svg>`);
          o.push(`<line x1='${w1_+w3_+1}pt' y1='0' x2='${w1_-1}pt' y2='${h}pt' />`);
          return [w,h,mid,o.join('\n'),0,0,''];
          break;
        ...
        case '\\binom':
          ...
          var [w,h,mid,s,g,q,id] = this.to_frac(m1,m2,frac,isline);
          var o = [];
          var x = 0;
          var y = 0;
          var sy = h/this.fh;
  ...
  to_frac(m1,m2,frac,isline){
    ...
    if(isline){
      o.push(`<line x1='0pt' y1='${top_h+xhh}pt' x2='${w}pt' y2='${top_h+xhh}pt' />`);
    }
    var s = o.join('\n');
