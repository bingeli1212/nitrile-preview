...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  to_fenced(m,fence1,fence2,used,type){
    ...
    var o = [];
    if(fence1=='\\lbrack'||fence1=='('||fence1=='\\lvert'){
    ...
    if(fence2=='\\rbrack'||fence2==')'||fence2=='\\rvert'){
  ...
  insert_fence(x,y,w,h,fence,used,o){
    ...
    if(fence=='\\lbrack'){
      ...
      var [id1,w1,op1] = this.findIdByElement('\\lmoustache',used);
      var [id3,w3,op3] = this.findIdByElement('\\rmoustache',used);
      o.push(`<use fill="currentColor" transform="translate(${x*1.333},${0*1.333}) scale(1,${M})" xlink:href="#${id1}" />`);
      o.push(`<use fill="currentColor" transform="translate(${x*1.333},${(m)*1.333}) scale(1,${M})" xlink:href="#${id3}" />`);
    }else if(fence=='\\rbrace'){
      var [id1,w1,op1] = this.findIdByElement('\\rmoustache',used);
      var [id3,w2,op2] = this.findIdByElement('\\lmoustache',used);
      o.push(`<use fill="currentColor" transform="translate(${x*1.333},${0*1.333}) scale(1,${M})" xlink:href="#${id1}" />`);
      o.push(`<use fill="currentColor" transform="translate(${x*1.333},${(m)*1.333}) scale(1,${M})" xlink:href="#${id3}" />`);
    }
  }
