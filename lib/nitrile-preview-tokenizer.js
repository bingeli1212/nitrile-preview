...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  to_phrase_root(cnt1,cnt2,style){
    var n = cnt2;
    var n = n||'?';
    var used = new Set();
    var m1 = this.to_innersvg_math(cnt1,used,style);
  ...
  to_phrase_overleftrightarrow(cnt1,style){
    var used = new Set();
    var m1 = this.to_innersvg_math(cnt1,used,style);
    var [w_,h_,mid_,s_,g_,q_,id_] = m1;
    var lead = 2.5;
  ...
  to_phrase_overrightarrow(cnt1,style){
    var used = new Set();
    var m1 = this.to_innersvg_math(cnt1,used,style);
    var [w_,h_,mid_,s_,g_,q_,id_] = m1;
    var lead = 2.5;
  ...
  to_phrase_underleftrightarrow(cnt1,style){
    var used = new Set();
    var m1 = this.to_innersvg_math(cnt1,used,style);
    var [w_,h_,mid_,s_,g_,q_,id_] = m1;
    var lead = 2.5; ///the arrow will protrude from either end for 2pt
  ...
  to_phrase_underrightarrow(cnt1,style){
    var used = new Set();
    var m1 = this.to_innersvg_math(cnt1,used,style);
    var [w_,h_,mid_,s_,g_,q_,id_] = m1;
    var lead = 2.5; ///the arrow will protrude from either end for 2pt
  ...
  to_phrase_subsup(cnt1,cnt2,cnt3,style){
    var used = new Set();
    var m1 = this.to_innersvg_math(cnt1,used,style);
    var m2 = this.to_innersvg_math(cnt2,used,style);
  ...
  to_innersvg_math(math,used,style){
    ...
    var l = this.toSubsup(l);
    //l = ['\\brace',l];//need to use '\\brace' here because it exports the 'used' to the caller, so that it does not need to build 'defs'
