...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  constructor (translator) {
    ...
    this.iscex = 0;
    this.my_last_id = '';
    this.dy = 0.75;//0.75em dy for each text element. If it has been shown that bottom part of
  ...
  buildup_defs(used,pref){
    ...
    for (var mathSymbol of pjson.mathSymbols) {
      ...
      if (used.has(id)) {
        ...
        defs.push(`<text id='${id}' dy='${dy}pt' textLength='${width}pt' lengthAdjust='${adjust}' style='stroke:none;fill:${myfill};font-size:${this.fs}pt;font-style:${fontstyle};'>${unicode}</text>`);
      }
    }
    for(var key of my_math_variants_keys){
      for (var mathSymbol of pjson.fontVariants[key]) {
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\sqrt':
          ...
          o.push(`<g transform='scale(1,${h/this.fs})' > <use xlink:href='#${idr_}' /> </g>`);
          ...
          if(1){
            ...
            o.push(`<g transform='translate(${lead*1.333},1) scale(${w_/ws_},1)' > <use xlink:href='#${ids_}'/> </g>`);
          }else{
            var bar_y = 1;
