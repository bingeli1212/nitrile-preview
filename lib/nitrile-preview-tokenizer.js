...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\dbinom':
          ...
          o.push(`<use transform='translate(${(x+w1+padding+w+padding)*1.333},${y}) scale(1,${sy})' xlink:href='#${id2}' />`);
          var s = o.join('\n');
  ...
  to_fenced(m,fence1,fence2,used,type){
    ...
    var sx = 1;
    var o = [];
    o.push(`<use transform='scale(${sx},${sy1})' xlink:href='#${id1}' />`);
    o.push(`<g transform='translate(${(w1+padding)*1.333},0)' > ${s} </g>`);
    o.push(`<use transform='translate(${(w1+padding+w+padding)*1.333},0) scale(${sx},${sy2})' xlink:href='#${id2}' />`);
  ...
  to_phrase_int(style,cnt1,cnt2,cnt3){
    ...
    if(style.displaymath){
      ...
      var s = `<use xlink:href='#${idtop}'/><use transform='translate(0,${this.fs*1.333})' xlink:href='#${idbot}'/>`;
