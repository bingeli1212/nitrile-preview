...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  to_limits(id1_,w1_,s1_,m2,m3,enlarge_rate){
    var [w2_,h2_,mid2_,s2_,g2_,q2_,id2_] = m2;
    var [w3_,h3_,mid3_,s3_,g3_,q3_,id3_] = m3;
    var o = [];
    var h1_ = this.fs;
    var mid1_ = h1_*0.5;
    var nw1_ = w1_    *enlarge_rate;
    var nh1_ = h1_    *enlarge_rate;
    var nmid1_ = mid1_*enlarge_rate;
    var adjustment = this.fh/this.fs;
    var nw2_ = w2_*this.sub_rate*adjustment;
    var nh2_ = h2_*this.sub_rate*adjustment;
    var nw3_ = w3_*this.sup_rate*adjustment;
    ...
    //o.push(`<svg x='${dx1_}pt' y='${h}pt' width='${nw1_}pt' height='${nh1_}pt' viewBox='0 0 ${w1_*1.333} ${h1_*1.333}' preserveAspectRatio='none'>`);
    var exh = (this.fh-this.fs)*1.5;
    o.push(`<g transform='translate(${dx1_*1.333},${(h-exh)*1.333}) scale(${enlarge_rate})'>`)
    o.push(s1_);
    o.push(`</g>`);
    //o.push(`</svg>`);
    h += nh1_;
  ...
  to_phrase_sum(style,cnt1,cnt2,cnt3){
    var used = new Set();
    if(style.displaymath||1){///TESTING
      ...
      var s = `<use xlink:href='#${id}' />`;
      var m = this.to_limits(id,w,s,m1,m2,this.summation_enlarge_rate);//stack them up and down
