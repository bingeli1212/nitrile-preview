...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  constructor (translator) {
    ...
    this.bracelevel = 0;
    this.re_svg = /^<svg\b([^<>]*>)(.*)$/s;
    this.re_entity = /^(&#x[0-9A-Za-z]+;|&#[0-9]+;)\s*(.*)$/s;
    this.re_segment = /^(\\;|\\,|\\:|\\begin\{\w+\}|\\end\{\w+\}|\\text\{.*?\}|\\hrule\{.*?\}|&[a-zA-Z][a-zA-Z0-9]*;|\\[a-zA-Z]+|'+|.)\s*(.*)/s;///this needs to have a 's' because the SVG's could have newline in it and without it only part of the SVG will be captured in the second argument
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\text':
          ...
          return this.to_text_element(str);
          break;
