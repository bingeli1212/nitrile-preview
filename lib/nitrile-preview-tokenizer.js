...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  to_fenced(m,fence1,fence2,used){
    ...
    if(id1=='myLB'){
      ...
      o.push(`<use transform='                                              scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(0,${h*0.5*1.333})                   scale(1,${sy})' xlink:href='#${bot_id}' />`);
      ...
      o.push(`<use transform='translate(0,0)                                scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(0,${h*0.5*1.333})                   scale(1,${sy})' xlink:href='#${bot_id}' />`);
      o.push(`<use transform='translate(${w1h*1.333},0)                     scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${w1h*1.333},${h*0.5*1.333})        scale(1,${sy})' xlink:href='#${bot_id}' />`);
      w1 = w1h + w1h;
    }else{
      o.push(`<use transform='scale(1,${h/h1})' xlink:href='#${id1}' />`);
    }
    if(id2=='myRB'){
      ...
      o.push(`<use transform='translate(${(w1+w)*1.333},0)                  scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${(w1+w)*1.333},${h*0.5*1.333})     scale(1,${sy})' xlink:href='#${bot_id}' />`);
      ...
      o.push(`<use transform='translate(${(w1+w)*1.333},0)                  scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${(w1+w)*1.333},${h*0.5*1.333})     scale(1,${sy})' xlink:href='#${bot_id}' />`);
      o.push(`<use transform='translate(${(w1+w+w2h)*1.333},0)              scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${(w1+w+w2h)*1.333},${h*0.5*1.333}) scale(1,${sy})' xlink:href='#${bot_id}' />`);
      w2 = w2h + w2h;
    }else{
      o.push(`<use transform='translate(${(w1+w)*1.333},0) scale(1,${h/h2})' xlink:href='#${id2}' />`);
    }
