...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  to_fenced(m,fence1,fence2,used){
    ...
    if(id1=='myLB'){
      ...
      o.push(`<use transform='translate(${x1},${y1})                        scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${x1},${y2})                        scale(1,${sy})' xlink:href='#${bot_id}' />`);
      ...
      o.push(`<use transform='translate(${x1},${y1})                        scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${x1},${y2})                        scale(1,${sy})' xlink:href='#${bot_id}' />`);
      o.push(`<use transform='translate(${x1+(w1h)*1.333},${y1})            scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${x1+(w1h)*1.333},${y2})            scale(1,${sy})' xlink:href='#${bot_id}' />`);
      w1 = w1h + w1h;
    }else{
      o.push(`<use transform='translate(${x1},${y1})                        scale(1,${SY})' xlink:href='#${id1}' />`);
    }
    ///
    var x2 = (w1+w)*1.333;
    ///
    if(id2=='myRB'){
      ...
      o.push(`<use transform='translate(${x2},${y1})                        scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${x2},${y2})                        scale(1,${sy})' xlink:href='#${bot_id}' />`);
      ...
      o.push(`<use transform='translate(${x2},${y1})                        scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${x2},${y2})                        scale(1,${sy})' xlink:href='#${bot_id}' />`);
      o.push(`<use transform='translate(${x2+(w2h)*1.333},${y1})            scale(1,${sy})' xlink:href='#${top_id}' />`);
      o.push(`<use transform='translate(${x2+(w2h)*1.333},${y2})            scale(1,${sy})' xlink:href='#${bot_id}' />`);
      w2 = w2h + w2h;
    }else{
      o.push(`<use transform='translate(${x2},${y1})                        scale(1,${SY})' xlink:href='#${id2}' />`);
    }
    o.push(`<g transform='translate(${w1*1.333},0)' > ${s} </g>`);
    w += w1 + w2;
    var newv = [w,h,mid,o.join('\n'),0,0,''];
