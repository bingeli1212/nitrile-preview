...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  constructor (translator) {
    ...
    this.vertical_gap = 2;//in pts for \\newline
    ...
    this.text_dy_pt = this.dy*12+1.5;
    ...
    if (v === undefined || v === null) {
      ...
      switch (v[0]) {
        ...
        case '\\sqrt':
          ...
          /// the sqrt symbol needs to be placed inside a inner-svg so that the protruding spike at the top is clipped off
          o.push(`<svg width='${lead}pt' height='${h-sunk/2}pt' viewBox='0 0 ${wr_*1.333} ${hr_*1.333}' preserveAspectRatio='none' > <use xlink:href='#${idr_}' /> </svg>`);
