...
class NitrilePreviewTokenizer extends NitrilePreviewBase {
  ...
  constructor (translator) {
    ...
    this.re_segment = /^(\\;|\\,|\\:|\\begin\{\w+\}|\\end\{\w+\}|\\text\{.*?\}|&[a-zA-Z][a-zA-Z0-9]*;|\\[a-zA-Z]+|'+|.)\s*(.*)/s;///this needs to have a 's' because the SVG's could have newline in it and without it only part of the SVG will be captured in the second argument
