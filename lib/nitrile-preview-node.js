...
class NitrilePreviewNode extends NitrilePreviewBase {
  ...
  async to_translator_document_async (filename) {
    ...
    await this.run_translator(filename,parser,translator,'',false);
  }
  ...
  async to_camper_document_async (filename) {
    ...
    await parser.read_master_async();
    await parser.read_import_async();
    await this.run_translator(filename,parser,'camper','',false);
  }
  ...
  async to_creamer_document_async (filename) {
    ...
    await parser.read_master_async();
    await parser.read_import_async();
    await this.run_translator(filename,parser,'creamer','',false);
  }
