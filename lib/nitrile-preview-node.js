...
const { NitrilePreviewGleamer } = require('./nitrile-preview-gleamer');
...
class NitrilePreviewNode {
  ...
  async to_gleamer_document_async (filename) {
    ...
    const data = translator.to_gleamer_document();
  ...
  async to_contex_document_async (filename) {
