...
class NitrilePreviewNode {
  ...
  async to_slide_document_async (filename) {
    ...
    var myfile = await this.run_translator(filename,parser,'slide','');
  }
  ...
  async to_beamer_document_async (filename) {
    ...
    await parser.read_master_async();
    await parser.read_import_async();
    var myfile = await this.run_translator(filename,parser,'beamer','pdflatex');
  }
  ...
  async to_creamer_document_async (filename) {
    ...
    await parser.read_master_async();
    await parser.read_import_async();
    var myfile = await this.run_translator(filename,parser,'creamer','');
  }
  ...
  async to_program_document_async (filename) {
    ...
    var myfile  = await this.run_translator(filename,parser,one,program);
    to_view_file(myfile);
  }

  async run_translator (filename,parser,one,program) {
  ...
  to_view_file(filename){
    let dname = path.dirname(filename);
