...
class NitrilePreviewContex extends NitrilePreviewTranslator {
  ...
  constructor(parser) {
    ...
    this.contex_interlinespace = 'line=10.0pt';
    this.contex_interlinespace_verbatim = 'line=8.0pt';
    this.contex_interlinespace_small = 'line=8.0pt';
  ...
  phrase_to_hrule(style,cnt){
    ...
    if(!wd){
      return `\\inframed[width=10mm,frame=off,bottomframe=on]{\\strut}`;
    }else{
      return `\\inframed[width=${wd},frame=off,bottomframe=on]{\\strut}`;
    }
  }
  //////////////////////////////////////////////////////////////////////////////////////
  //
