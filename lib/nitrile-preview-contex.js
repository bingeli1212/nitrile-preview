...
class NitrilePreviewContex extends NitrilePreviewTranslator {
  ...
  constructor(parser) {
    ...
    this.bodyfontsuit = 'linux';
    this.bodyfontvariant = '';
  ...
  to_preamble_fonts(){
    ...
    for(let font of this.fonts){
      let {fid,fontname,program} = font;
      if(program=='serif'||program=='sans'||program=='mono'||program=='math'){
        all.push(`\\definefontfamily[${fid}][${program}][${fontname}]`);
      }else if(program=='contex'){
  ...
  to_preamble_essentials(){
    ...
    all.push(`  headstyle=normal, style=normal, align=flushleft, margin=1em,`);
    all.push(`  alternative=hanging, width=broad]`);
    all.push(`\\definealternativestyle [myfontsmaller]  [\\switchtobodyfont[${this.bodyfontsize*0.9}pt]] []`);
    all.push(`\\usesymbols[mvs]`);
  ...
  samp_to_text(style,samp){
    ...
    s_interlinespace = `\\switchtobodyfont[${this.bodyfontsize*0.9}pt]\\setupinterlinespace[line=${this.bodyfontsize*0.9*this.contex_bodylineheight}pt]`;
