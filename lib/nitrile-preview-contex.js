  ...
  text_to_typeface (type,cnt,cnt2) {
    ...
    switch (type) {
      ...
      case 'FRAC': {
        ...
        return `\\math{\\displaystyle\\frac{${cnt}}{${cnt2}}}`;
        break;
      }
      case 'frac': {
      ...
      case 'binom': {
        cnt2 = cnt2||'\\questiondown';
        return `\\math{\\binom{${cnt}}{${cnt2}}}`;
        break;
      }
      case 'root': {
        cnt2 = cnt2||'\\questiondown';
        return `\\math{\\sqrt[${cnt2}]{${cnt}}}`;
        break;
      }
      case 'overline': {
        return `\\math{\\overline{${cnt}}}`;
        break;
      }
      case 'overleftrightarrow': {
        return `\\math{\\overleftrightarrow{${cnt}}}`;
        break;
      }
      case 'overrightarrow': {
        return `\\math{\\overrightarrow{${cnt}}}`;
        break;
      }
      case 'underleftrightarrow': {
        return `\\math{\\underleftrightarrow{${cnt}}}`;
        break;
      }
      case 'underrightarrow': {
        return `\\math{\\underrightarrow{${cnt}}}`;
        break;
      }
      case 'sup': {
        return `\\high{${cnt}}`
