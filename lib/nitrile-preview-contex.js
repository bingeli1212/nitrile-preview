...
class NitrilePreviewContex extends NitrilePreviewTranslator {
  ...
  constructor(parser) {
    ...
    this.contex_interlinespace_verbatim = 'line=9.5pt';
    this.contex_interlinespace_small = 'line=9.5pt';
  ...
  to_preamble_fonts(){
    ...
    all.push(`\\definefontfamily [linux] [mono]  [libertinusmono] [rscale=0.87]`);
