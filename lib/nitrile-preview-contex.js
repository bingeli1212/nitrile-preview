...
class NitrilePreviewContex extends NitrilePreviewTranslator {
  ...
  smooth (line) {
    ...
    while(line.length){
      if((v=re_entity.exec(line))!==null){
        ...
        safe+=s;
        continue;
      }else if((v=re_char.exec(line))!==null){
        s = v[1];
        line = v[2];
        switch(s) {
          // case  "’":     s = "{\\char39}" ; break;
  ...
  to_preamble_core(){
    ...
    all.push(`\\definefontfamily[free][serif][freeserif]`);
    all.push(`\\definefontfamily[free][sans][freesans]`);
    all.push(`\\definefontfamily[free][tt][freemono]`);
    all.push(`\\definefontfamily[roboto][serif][roboto]`);
    all.push(`\\definefontfamily[roboto][sans][roboto]`);
    all.push(`\\definefontfamily[roboto][tt][robotomono]`);
    all.push(`\\definefontfamily[dingbats][serif][zapfdingbats]`);
    all.push(`\\definefontfamily[dingbats][sans][zapfdingbats]`);
    all.push(`\\definefontfamily[dingbats][tt][zapfdingbats]`);
    all.push(`\\definefontfamily[unifont][serif][unifont]`);
    all.push(`\\definefontfamily[unifont][sans][unifont]`);
    all.push(`\\definefontfamily[unifont][tt][unifont]`);
    all.push(`\\definefontfamily[noto][serif][notoserif]`);
    all.push(`\\definefontfamily[noto][sans][notosans]`);
    all.push(`\\definefontfamily[noto][tt][notosansmono]`);
    ...
    all.push(`\\stoptypescript`);
    all.push(`\\definetypeface[free][rm][serif][free]`);
    all.push(`\\definetypeface[free][ss][sans][free]`);
    all.push(`\\definetypeface[free][tt][mono][free]`);
    all.push(`\\usetypescript[free][uc]`);
    all.push(`%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`);
    all.push(`%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`);
    ...
    all.push(`\\stoptypescript`);
    all.push(`\\definetypeface[roboto][rm][serif][roboto]`);
    all.push(`\\definetypeface[roboto][ss][sans][roboto]`);
    all.push(`\\definetypeface[roboto][tt][mono][roboto]`);
    all.push(`\\usetypescript[roboto][uc]`);
    all.push(`%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`);
    all.push(`%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`);
    ...
    all.push(`\\stoptypescript`);
    all.push(`\\definetypeface[dejavu][rm][serif][dejavu]`);
    all.push(`\\definetypeface[dejavu][ss][sans][dejavu]`);
    all.push(`\\definetypeface[dejavu][tt][mono][dejavu]`);
    all.push(`\\usetypescript[dejavu][uc]`);
    all.push(`%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`);
    all.push(`%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`);
