...
class NitrilePreviewContex extends NitrilePreviewTranslator {
  ...
  hdgs_to_chapter(title,label,idnum,idcap,partnum,chapternum,level,style){
    ...
    o.push('');
    o.push(`\\startchapter[title={${chapternum} ~ ${title}},reference={${label}},bookmark={${raw}}]`);
    return o.join('\n')
  }
  hdgs_to_section(title,label,idnum,idcap,partnum,chapternum,level,style){
    ...
    o.push('');
    o.push(`\\startsection[title={${chapternum}.${level} ~ ${title}},reference={${label}},bookmark={${raw}}]`);
    return o.join('\n')
  } 
  hdgs_to_subsection(title,label,idnum,idcap,partnum,chapternum,level,style){
    ...
    var label = label||`chapternum.${chapternum}.${level}`;
    o.push('');
    o.push(`\\startsubsection[title={${chapternum}.${level} ~ ${title}},reference={${label}},bookmark={${raw}}]`);
    return o.join('\n')
  } 
  hdgs_to_subsubsection(title,label,idnum,idcap,partnum,chapternum,level,style){
    ...
    var label = label||`chapternum.${chapternum}.${level}`;
    o.push('');
    o.push(`\\startsubsubsection[title={${chapternum}.${level} ~ ${title}},reference={${label}},bookmark={${raw}}]`);
    return o.join('\n')
  }
  //////////////////////////////////////////////////////////////////////////
  ///
  ...
  to_preamble_essentials(){
    ...
    all.push(`\\placebookmarks[part,chapter,section,subsection]`);
