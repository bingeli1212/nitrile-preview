...
class NitrilePreviewContex extends NitrilePreviewTranslator {
  ...
  float_to_equation(title,ss,style){
  ...
  float_to_listing(title,ss,style){
  ...
  float_to_longtable(title,ss,style) {
    ...
    let text = this.rows_to_longtable(title, rows, style);
    return text;
  }
  float_to_columns(title,ss,style){
  ...
  float_to_verbatim(title,ss,style){
  ...
  float_to_blockquote(title,ss,style){
    var clusters = this.ss_to_clusters(ss);
  ...
  rows_to_longtable(title, rows, g) {
    var fr = g.fr || '';
