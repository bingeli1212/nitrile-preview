...
class NitrilePreviewParser extends NitrilePreviewBase {
  ...
  read_para (lines,n) {
    ...
    return {sig, hdgn, rank, id, caste: id, title, label, subtitles, level, name, fname, style, buffers, switches, dict, vmap, bodyrow, body, nblank, para, parser};//plitems is current not used
  }
  is_han (cc) {
    ///
