...
class NitrilePreviewParser extends NitrilePreviewBase {
  ...
  read_para (lines,n,hdgn) {
    ...
    return {sig, hdgn, rank, id, title, label, level, fname, style, body, nblank, para, plitems};
  }
  is_han (cc) {
    ///
  ...
  async read_import_async(){
    ...
    items.forEach((item,i,arr) => {
      ...
      this.blocks.push({sig, name, hdgn, rank, id, title, label, partnum, chapternum, level, fname, style:this.style, body, nblank, para, plitems});
      if(subparser){
