...
class NitrilePreviewParser extends NitrilePreviewBase {
  ...
  constructor() {
    ...
    this.style = {};
    this.buff = {};
    this.save = {};//save/restore of bundles, save per 'id'
    this.dict = [];
    this.vmap = [];
    this.data = {};
    this.memo = {};
  ...
  read_para (lines,n) {
    ...
    // update style with buff and vmap
    let parser = this;
    ...
    return {sig, hdgn, rank, id, caste: id, title, label, subtitles, level, name, fname, style, bodyrow, body, nblank, para, parser};//plitems is current not used
  }
  is_han (cc) {
    ///
