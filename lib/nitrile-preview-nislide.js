...
class NitrilePreviewSlide extends NitrilePreviewHtml {
  ...
  write_frame_folder(id,frame,subframes){
    ...
    all.push(`<h1 class='TITLE'    style='${css_title}' > <a style='text-decoration:none' href='#toc'> ${id} ${this.uncode(frame.style,frame.title)} </a> </h1>`);
  ...
  write_one_frame(id,subid,frame,issub,topframe){
    ...
    if(subid){
      all.push(`<h1 class='TITLE'    style='${css_title}' > <a style='text-decoration:none' href='#frame${id}.'> ${id} ${this.uncode(topframe.style,topframe.title)} </a> </h1>`);
      all.push(`<h2 class='TITLE2' style='${css_subtitle};text-decoration:underline' > <a style='text-decorationb:none' href='#frame${id}.'> ${id}.${subid} ${this.uncode(frame.style,frame.title)} </a> </h2>`);
    }else{
      all.push(`<h1 class='TITLE'    style='${css_title}' > <a style='text-decoration:none' href='#toc'> ${id} ${this.uncode(topframe.style,topframe.title)} </a> </h1>`);
      all.push(`<h2 class='TITLE2' style='${css_subtitle}' > &#160; </h2>`);
    }
    //
