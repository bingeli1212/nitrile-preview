...
function canvas_onmousedown(canvas){
  var cx = canvas.getContext("2d");
  if(event.button==0){
    cx.d.posx0 = Math.round((event.clientX-canvas.getBoundingClientRect().x)/canvas.getBoundingClientRect().width*canvas.width);
    cx.d.posy0 = Math.round((event.clientY-canvas.getBoundingClientRect().y)/canvas.getBoundingClientRect().height*canvas.height);
console.log('cx.d.posx0=',cx.d.posx0);
console.log('cx.d.posy0=',cx.d.posy0);
...
function canvas_onmousemove(canvas){
  ...
  cx.d.posx2 = Math.round((event.clientX-canvas.getBoundingClientRect().x)/canvas.getBoundingClientRect().width*canvas.width);
  cx.d.posy2 = Math.round((event.clientY-canvas.getBoundingClientRect().y)/canvas.getBoundingClientRect().height*canvas.height);
  cx.d.shiftKey = event.shiftKey;
  cx.d.altKey   = event.altKey;
