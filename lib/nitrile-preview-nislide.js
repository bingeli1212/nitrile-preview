...
function canvas_move(ctx,canvas){
  if(ctx.d && ctx.d.type=='ball'){
    if(ctx.d.moveflag){
      ctx.d.movedistx = ctx.d.posx2 - ctx.d.posx0;
      ctx.d.movedisty = ctx.d.posy2 - ctx.d.posy0;
      canvas_redraw(ctx,canvas);
    }
    if(ctx.d.rotateflag){
...
function canvas_redraw_ball(ctx,canvas){
  var hiliteball = null;
  ctx.clearRect(0,0,canvas.width,canvas.height);
