...
class NitrilePreviewXelatex extends NitrilePreviewLatex {
  ...
  to_document() {
    ...
    ///these are the title lines to be placed before \maketitle
    var titlelines = this.to_titlelines();
    ///these are for deciding what document class is
    ...
    var newfontfamily = this.conf_to_list('xelatex.newfontfamily');
