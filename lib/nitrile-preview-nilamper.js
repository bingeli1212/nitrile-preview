...
`;
  ...
  to_titlelines(){
    ...
    if (1) {
      titlelines.push(`\\title{${this.uncode(this.parser.style,mytitle)}}`);
      titlelines.push(`\\author{${this.uncode(this.parser.style,myauthor)}}`);
      titlelines.push(`\\date{${this.uncode(this.parser.style,mydate)}}`);
    }
    return titlelines;
  }
  to_tocpagelines(){
