...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  g_to_svg_fontfamily_str(g) {
    var ss = [];
    var f = this.g_to_text_fontfamily_flag(g);
    switch(f){
      case 't':
        ss.push('monospace');
        break;
  ...
  g_to_svg_fontstyle_str(g) {
    var ss = [];
    var f = this.g_to_text_fontstyle_flag(g);
    switch(f){
      case 'i':
        ss.push('italic');
        break;
  ...
  g_to_svg_fontweight_str(g) {
    var ss = [];
    var f = this.g_to_text_fontweight_flag(g);
    switch(f){
      case 'b':
        ss.push('bold');
        break;
  ...
  g_to_svg_textdecoration_str(g) {
    var ss = [];
    var f = this.g_to_text_textdecoration_flag(g);
    switch(f){
      case 's':
