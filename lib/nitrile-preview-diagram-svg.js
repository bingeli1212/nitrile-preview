...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_output(){
    ...
    var img = `<svg width='${this.fix(width)}' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" viewBox='0 0 ${this.fix(vw)} ${this.fix(vh)}' >${svgtext}</svg>`;
