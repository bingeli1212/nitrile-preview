...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_output(){
    ...
    if(this.background=="grid"){
      ...
      o.push(`<rect x="0" y="0" width="${vw}" height="${vh}" fill="url(#${bgid})" stroke="currentColor" opacity="${backgroundalpha}" />`);
    }
    ///all svg.
    o.push(s);
    ///width and height
    ...
    ///border
    if(this.style.frame){
      p.border = "thin solid currentColor";
    }else{
      p.border = "";
    }
    var imgsrc = "";
    ...
    if(this.my_images.length){
      ...
      var img = `<img style="border:${p.border};width:${p.width}mm;height:${p.height}mm;" src="${imgsrc}" id="${imgid}" onload="img_onload(this)"/>`;
      var wlt = `<img align="left"  style="border:${p.border};width:${p.width}mm;height:${p.height}mm;" src="${imgsrc}" id="${imgid}" onload="img_onload(this)"/>`;
      var wrt = `<img align="right" style="border:${p.border};width:${p.width}mm;height:${p.height}mm;" src="${imgsrc}" id="${imgid}" onload="img_onload(this)"/>`;
    }else{
      var svgtext = o.join("\n");
      var svg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" viewBox="0 0 ${this.fix(vw)} ${this.fix(vh)}" onmouseup="mouseup(this)" onmousemove="mousemove(this)" preserveAspectRatio="none">${ball_script}${svgtext}</svg>`;
    ...
    var output = { img,wlt,wrt,imgsrc,imgid,viewport_width,viewport_height,viewport_unit,viewport_grid,vw,vh,svgtext,subtitle,svg };
    return(output);
  }
  localx(x) {
  ...
  p_arrow(coords,_g){
    ...
    for(var item of items){
      ...
      if(this.has_strokes(g)){
        o.push(`<path d="${s}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" />`);
      }
    }
    var img = o.join(' ');
    var img = `<g transform="translate(${this.origin_x*this.u},${-this.origin_y*this.u}) translate(0,${this.viewport_height*this.u}) scale(${this.origin_sx},${this.origin_sy}) translate(0,${-this.viewport_height*this.u})"> ${img} </g>`;
  ...
  p_revarrow(coords,_g){
    ...
    for(var item of items){
      ...
      if(this.has_strokes(g)){
        o.push(`<path d="${s}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-start="url(#${id2})" />`);
      }
    }
    var img = o.join(' ');
    var img = `<g transform="translate(${this.origin_x*this.u},${-this.origin_y*this.u}) translate(0,${this.viewport_height*this.u}) scale(${this.origin_sx},${this.origin_sy}) translate(0,${-this.viewport_height*this.u})"> ${img} </g>`;
  ...
  p_dblarrow(coords,_g){
    ...
    for(var item of items){
      ...
      let id2 = this.create_arrowhead('start',g);
      if(this.has_strokes(g)){
        o.push(`<path d="${s}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" marker-start="url(#${id2})" />`);
      }
    }
    var img = o.join(' ');
    var img = `<g transform="translate(${this.origin_x*this.u},${-this.origin_y*this.u}) translate(0,${this.viewport_height*this.u}) scale(${this.origin_sx},${this.origin_sy}) translate(0,${-this.viewport_height*this.u})"> ${img} </g>`;
  ...
  p_line(x1,y1,x2,y2,g){
    ...
    if(this.has_strokes(g)){
      if(arrowhead==1){
        let id1 = this.create_arrowhead('end',g);
        o.push(`<line x1="${this.fix(x1)}" y1="${this.fix(y1)}" x2="${this.fix(x2)}" y2="${this.fix(y2)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" />`);
      }else if(arrowhead==2){
        let id2 = this.create_arrowhead('start',g);
        o.push(`<line x1="${this.fix(x1)}" y1="${this.fix(y1)}" x2="${this.fix(x2)}" y2="${this.fix(y2)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-start="url(#${id2})" />`);
      }else if(arrowhead==3){
        let id1 = this.create_arrowhead('end',g);
        let id2 = this.create_arrowhead('start',g);
        o.push(`<line x1="${this.fix(x1)}" y1="${this.fix(y1)}" x2="${this.fix(x2)}" y2="${this.fix(y2)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" marker-start="url(#${id2})" />`);
      }else{
  ...
  p_qbezier_line(x0,y0, x1,y1, x2,y2, g){
    ...
    if(this.has_strokes(g)){
      if(arrowhead==1){
        let id1 = this.create_arrowhead('end',g);
        o.push(`<path d="M ${this.fix(x0)},${this.fix(y0)} Q ${this.fix(x1)},${this.fix(y1)},${this.fix(x2)},${this.fix(y2)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" />`);
      }else if(arrowhead==2){
        let id2 = this.create_arrowhead('start',g);
        o.push(`<path d="M ${this.fix(x0)},${this.fix(y0)} Q ${this.fix(x1)},${this.fix(y1)},${this.fix(x2)},${this.fix(y2)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-start="url(#${id2})" />`);
      }else if(arrowhead==3){
        let id1 = this.create_arrowhead('end',g);
        let id2 = this.create_arrowhead('start',g);
        o.push(`<path d="M ${this.fix(x0)},${this.fix(y0)} Q ${this.fix(x1)},${this.fix(y1)},${this.fix(x2)},${this.fix(y2)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" marker-start="url(#${id2})" />`);
      }else{
  ...
  p_bezier_line(x0,y0, x1,y1, x2,y2, x3,y3, g){
    ...
    if(this.has_strokes(g)){
      if(arrowhead==1){
        let id1 = this.create_arrowhead('end',g);
        o.push(`<path d="M ${this.fix(x0)},${this.fix(y0)} C ${this.fix(x1)},${this.fix(y1)},${this.fix(x2)},${this.fix(y2)},${this.fix(x3)},${this.fix(y3)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" />`);
      }else if(arrowhead==2){
        let id2 = this.create_arrowhead('start',g);
        o.push(`<path d="M ${this.fix(x0)},${this.fix(y0)} C ${this.fix(x1)},${this.fix(y1)},${this.fix(x2)},${this.fix(y2)},${this.fix(x3)},${this.fix(y3)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-start="url(#${id2})" />`);
      }else if(arrowhead==3){
        let id1 = this.create_arrowhead('end',g);
        let id2 = this.create_arrowhead('start',g);
        o.push(`<path d="M ${this.fix(x0)},${this.fix(y0)} C ${this.fix(x1)},${this.fix(y1)},${this.fix(x2)},${this.fix(y2)},${this.fix(x3)},${this.fix(y3)}" fill="none" ${this.g_to_svg_drawonly_str(g)} marker-end="url(#${id1})" marker-start="url(#${id2})" />`);
      }else{
