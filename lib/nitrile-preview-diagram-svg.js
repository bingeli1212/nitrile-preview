...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_output(){
    ...
    if(this.my_images.length){
      ...
      var img = `<img style="border:${p.border};width:${p.width}mm;height:${p.height}mm;" src="${imgsrc}" id="${imgid}" onload="img_onload(this)"> </img>`;
      if(this.style.stretch){
        var img = `<img style="border:${p.border};width:100%;" src="${imgsrc}" id="${imgid}" onload="img_onload(this)"> </img>`;
      }
    }else{
      var svgtext = o.join("\n");
