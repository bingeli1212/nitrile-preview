...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  to_diagram(style,ss){
    ...
    return { images,svgtext,subtitle,ballscript,style };
  }
  localx(x) {
  ...
  p_grid(density,g){
    var o = [];
    o.push(`hlingrid(0,${this.viewport_height*density},1,${this.viewport_height}*u,${this.viewport_width}*u) ;`);
    o.push(`vlingrid(0,${this.viewport_width*density},1,${this.viewport_width}*u,${this.viewport_height}*u) ;`);
    var img = o.join(' ');
