...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_output(){
    ...
    var svgtext = o.join('\n');
    ///subtitle
    var img = `<svg width='${vw}' height='${vh}' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" stroke="currentColor" >${svgtext}</svg>`;
