...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  p_header(opt,x,y,vpw,vph,txts,g){
    ...
    if(is_math){
      ...
      if(opt=='l'){
        return `<text x="${5}" y="${5}" font-size="${fontsize}pt" text-anchor="start" ${this.g_to_svg_textdraw_str(g)} dy="0.9em">${txt}</text>`;
      }else if(opt=='r'){
        return `<text x="${vpw-5}" y="${5}" font-size="${fontsize}pt" text-anchor="end" ${this.g_to_svg_textdraw_str(g)} dy="0.9em">${txt}</text>`;
      }else{
        return `<text x="${vpw/2}" y="${5}" font-size="${fontsize}pt" text-anchor="middle" ${this.g_to_svg_textdraw_str(g)} dy="0.9em">${txt}</text>`;
      }
    }
  }
