...
class NitrilePreviewDiagramSVG extends NitrilePreviewDiagram {
  ...
  do_output(){
    ...
    if(this.my_images.length){
      ...
      var text = `<img src="${imgsrc}" id="${imgid}" alt="${imgsrc}" />`;
    }else{
      var svgtext = o.join("\n");
    ...
    var output = { img,imgsrc,imgid,viewport_width,viewport_height,viewport_unit,viewport_grid,vw,vh,svgtext,subtitle,svg,text };
    return(output);
  }
  localx(x) {
