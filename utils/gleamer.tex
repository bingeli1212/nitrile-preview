...
\startsection[title={{\switchtobodyfont[zapfdingbats]❖} Adding \math{{5}} and \math{{\sqrt {- 4}}}},reference={undefined},bookmark={Adding &math{5} and &math{\sqrt{-4}}}]
\startsubsection[title={Answer is 6}]
...
{\symbol[martinvogel 2][CircPipe]} A. One\crlf
{\symbol[martinvogel 2][CircPipe]} B. Two\crlf
{\symbol[martinvogel 2][CircPipe]} C. Three\crlf
{\symbol[martinvogel 2][CircSteel]} D. Four }]
...
\framed[location=middle, % vertically centered
